...
import { useHasColorPanel, useHasTextPanel, useHasBackgroundPanel } from './color-panel.js';
...
const ColorPanel = ({
  ...
  const encodeColorValue = useCallback(colorValue => {
  ...
  const encodeGradientValue = useCallback(gradientValue => {
  ...
  const items = useMemo(() => [showTextPanel && {
    label: __('Text'),
