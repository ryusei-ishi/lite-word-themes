...
function UncontrolledInnerBlocks(props) {
  ...
  if (nestingLevel >= MAX_NESTING_DEPTH) {
    return /*#__PURE__*/_jsx(WarningMaxDepthExceeded, {
      clientId: clientId
    });
  }
  return /*#__PURE__*/_jsx(LayoutProvider, {
    value: layout,
...
const InnerBlocks = props => {
  ...
  return props.value && props.onChange ? /*#__PURE__*/_jsx(ControlledInnerBlocks, {
    ...allProps
  }) : /*#__PURE__*/_jsx(UncontrolledInnerBlocks, {
    ...allProps
  });
};
