...
function Player({
  ...
  const containerStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.container, _styles.default.containerDark);
  const iconStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.icon, _styles.default.iconDark);
  const iconDisabledStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.iconDisabled, _styles.default.iconDisabledDark);
  const isDisabled = isUploadFailed || isUploadInProgress;
  const finalIconStyle = {
    ...iconStyle,
    ...(isDisabled && iconDisabledStyle)
  };
  const iconContainerStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.iconContainer, _styles.default.iconContainerDark);
  const titleContainerStyle = {
    ..._styles.default.titleContainer,
    ...(isIOS ? _styles.default.titleContainerIOS : _styles.default.titleContainerAndroid)
  };
  const titleStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.title, _styles.default.titleDark);
  const uploadFailedStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.uploadFailed, _styles.default.uploadFailedDark);
  const subtitleStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.subtitle, _styles.default.subtitleDark);
  const finalSubtitleStyle = {
    ...subtitleStyle,
    ...(isUploadFailed && uploadFailedStyle)
  };
  const buttonBackgroundStyle = (0, _useGlobalStylesContext.useEditorColorScheme)(_styles.default.buttonBackground, _styles.default.buttonBackgroundDark);
  let title = '';
  let extension = '';
  if (src) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.TouchableWithoutFeedback, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_primitives.View, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_primitives.View, {
      ...
      }), !isDisabled && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.TouchableWithoutFeedback, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_primitives.View, {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Text, {
            ...
            children: (0, _i18n.__)('OPEN')
          })
        })
      }), isIOS && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeVideo.default, {
        source: {
          uri: src
        },
        paused: paused,
...
var _default = exports.default = (0, _compose.withPreferredColorScheme)(Player);
