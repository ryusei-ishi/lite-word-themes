...
exports.GlobalStylesContext = void 0;
...
exports.getMergedGlobalStyles = void 0;
exports.parseStylesVariables = parseStylesVariables;
exports.useGlobalStyles = exports.useEditorColorScheme = void 0;
...
const GlobalStylesContext = exports.GlobalStylesContext = (0, _element.createContext)({
  style: {}
});
  ...
  variables.forEach(variable => {
    ...
    if (variable === 'fontSize') {
      ...
      stylesBase = stylesBase.replace(fontSizeRegex, (_$1, $2) => {
        const parsedFontSize = (0, _components.getPxFromCssUnit)($2, {
          width,
          height,
...
function normalizeFontSizes(fontSizes) {
  ...
  keysToProcess.forEach(key => {
    normalizedFontSizes[key] = fontSizes[key].map(fontSizeObject => {
      fontSizeObject.sizePx = (0, _components.getPxFromCssUnit)(fontSizeObject.size, {
...
function useMobileGlobalStylesColors(type = 'colors') {
  ...
  const [defaultPaletteValue] = (0, _useSettings.useSettings)(defaultPaletteSetting);
  ...
  const defaultPalette = defaultPaletteValue !== null && defaultPaletteValue !== void 0 ? defaultPaletteValue : _defaults.SETTINGS_DEFAULTS.colors;
