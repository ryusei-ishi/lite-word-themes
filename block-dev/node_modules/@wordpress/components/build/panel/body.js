...
function UnforwardedPanelBody(props, ref) {
  ...
  const classes = (0, _clsx.default)('components-panel__body', className, {
    'is-opened': isOpened
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    className: classes,
    ref: (0, _compose.useMergeRefs)([nodeRef, ref]),
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(PanelBodyTitle, {
      icon: icon,
...
const PanelBodyTitle = (0, _element.forwardRef)(({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("h2", {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_button.default, {
      ...
      }), title, icon && /*#__PURE__*/(0, _jsxRuntime.jsx)(_icon.default, {
        icon: icon,
