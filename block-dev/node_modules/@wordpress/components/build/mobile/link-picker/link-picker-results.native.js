...
function LinkPickerResults({
  ...
  const spinner = !hasAllSuggestions && meetsThreshold(query) && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_bottomSheetContext.BottomSheetConsumer, {
    children: ({
      listProps
      ...
      renderItem: ({
        item
      }) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_bottomSheet.default.LinkSuggestionItemCell, {
        suggestion: item,
