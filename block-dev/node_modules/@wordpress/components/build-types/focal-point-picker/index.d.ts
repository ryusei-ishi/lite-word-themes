 ...
 * ```
 */
export declare function FocalPointPicker({ __nextHasNoMarginBottom, __next40pxDefaultSize, autoPlay, className, help, label, onChange, onDrag, onDragEnd, onDragStart, resolvePoint, url, value: valueProp, ...restProps }: WordPressComponentProps<FocalPointPickerProps, 'div', false>): import("react").JSX.Element;
