 ...
 * ```
 */
export declare const InputControlSuffixWrapper: import("../context").WordPressComponent<"div", InputControlSuffixWrapperProps & import("react").RefAttributes<any>, true>;
