 ...
 * ```
 */
export declare const InputControlPrefixWrapper: import("../context").WordPressComponent<"div", InputControlPrefixWrapperProps & import("react").RefAttributes<any>, true>;
