...
exports.HierarchicalTermSelector = HierarchicalTermSelector;
...
function HierarchicalTermSelector({
  ...
  const availableTermsTree = (0, _element.useMemo)(() => sortBySelected((0, _terms.buildTermsTree)(availableTerms), terms),
  ...
  const renderTerms = renderedTerms => {
    return renderedTerms.map(term => {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        }), !!term.children.length && /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
  ...
  const filterLabel = (_taxonomy$labels$sear = taxonomy?.labels?.search_items) !== null && _taxonomy$labels$sear !== void 0 ? _taxonomy$labels$sear : (0, _i18n.__)('Search Terms');
  const groupLabel = (_taxonomy$name = taxonomy?.name) !== null && _taxonomy$name !== void 0 ? _taxonomy$name : (0, _i18n.__)('Terms');
  const showFilter = availableTerms.length >= MIN_TERMS_COUNT_FOR_FILTER;
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_components.Flex, {
    direction: "column",
    gap: "4",
    children: [showFilter && /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.TextControl, {
      __nextHasNoMarginBottom: true,
      label: filterLabel,
      value: filterValue,
      onChange: setFilter
    ...
    }), !loading && hasCreateAction && /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.FlexItem, {
    ...
    }), showForm && /*#__PURE__*/(0, _jsxRuntime.jsx)("form", {
      onSubmit: onAddTerm,
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_components.Flex, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_components.TextControl, {
          ...
          required: true
        }), !!availableTerms.length && /*#__PURE__*/(0, _jsxRuntime.jsx)(_components.TreeSelect, {
          __next40pxDefaultSize: true,
          __nextHasNoMarginBottom: true,
...
var _default = exports.default = (0, _components.withFilters)('editor.PostTaxonomyType')(HierarchicalTermSelector);
