...
import { Button, Dropdown, ComboboxControl, ExternalLink } from '@wordpress/components';
...
function PostParentToggle({
  ...
  const parentTitle = useMemo(() => !parentPost ? __('None') : getTitle(parentPost), [parentPost]);
...
export function ParentRow() {
  const homeUrl = useSelect(select => select(coreStore).getUnstableBase()?.home, []);
  ...
  return /*#__PURE__*/_jsx(PostPanelRow, {
    ...
    children: /*#__PURE__*/_jsx(Dropdown, {
      ...
      renderToggle: ({
        isOpen,
        onToggle
      }) => /*#__PURE__*/_jsx(PostParentToggle, {
        isOpen: isOpen,
        onClick: onToggle
      }),
      renderContent: ({
