...
const incorrectLevelContent = [/*#__PURE__*/_jsx("br", {}, "incorrect-break"), /*#__PURE__*/_jsx("em", {
  children: __('(Incorrect heading level)')
}, "incorrect-message")];
const singleH1Headings = [/*#__PURE__*/_jsx("br", {}, "incorrect-break-h1"), /*#__PURE__*/_jsx("em", {
  children: __('(Your theme may already use a H1 for the post title)')
}, "incorrect-message-h1")];
const multipleH1Headings = [/*#__PURE__*/_jsx("br", {}, "incorrect-break-multiple-h1"), /*#__PURE__*/_jsx("em", {
  children: __('(Multiple H1 headings are not recommended)')
...
export default function DocumentOutline({
  ...
  if (headings.length < 1) {
    return /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx(EmptyOutlineIllustration, {}), /*#__PURE__*/_jsx("p", {
        children: __('Navigate the structure of your document and address issues like empty or incorrect heading levels.')
      })]
    });
  }
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    children: /*#__PURE__*/_jsxs("ul", {
      children: [hasTitle && /*#__PURE__*/_jsx(DocumentOutlineItem, {
        level: __('Title'),
        isValid: true,
        onSelect: onSelect,
        href: `#${titleNode.id}`,
        ...
        return /*#__PURE__*/_jsxs(DocumentOutlineItem, {
          ...
          children: [item.isEmpty ? emptyHeadingContent : getTextContent(create({
