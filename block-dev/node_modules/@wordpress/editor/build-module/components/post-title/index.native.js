...
export function insertContentWithTitle(title, content, onUpdateTitle, onUpdateContent, value = create({
  text: ''
})) {
  if (!content.length) {
    return;
...
class PostTitle extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_jsx(View, {
      ...
      children: /*#__PURE__*/_jsx(RichText.Raw, {
        ref: this.setRef,
        accessibilityLabel: this.getTitle(title, postType),
        tagName: "p",
