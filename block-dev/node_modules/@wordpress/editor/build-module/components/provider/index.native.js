...
import { parse, serialize, getUnregisteredTypeHandlerName, getBlockType, createBlock, pasteHandler } from '@wordpress/blocks';
import { withDispatch, withSelect } from '@wordpress/data';
import { compose } from '@wordpress/compose';
import { applyFilters } from '@wordpress/hooks';
import { store as blockEditorStore, getGlobalStyles, getColorsAndGradients } from '@wordpress/block-editor';
...
class NativeEditorProvider extends Component {
  ...
  componentDidMount() {
    ...
    this.subscriptionParentReplaceBlock = subscribeReplaceBlock(payload => {
    ...
    this.subscriptionParentShowNotice = subscribeShowNotice(payload => {
    ...
    this.subscriptionOnContentUpdate = subscribeToContentUpdate(data => {
  ...
  render() {
    ...
    return /*#__PURE__*/_jsxs(_Fragment, {
      ...
      }), /*#__PURE__*/_jsx(EditorHelpTopics, {
