...
function __experimentalCloneSanitizedBlock(block, mergeAttributes = {}, newInnerBlocks) {
  const clientId = (0, _uuid.v4)();
  const sanitizedAttributes = (0, _utils.__experimentalSanitizeBlockAttributes)(block.name, {
    ...block.attributes,
    ...mergeAttributes
  });
  return {
...
const getBlockTypesForPossibleFromTransforms = blocks => {
  ...
  const allBlockTypes = (0, _registration.getBlockTypes)();
...
const getBlockTypesForPossibleToTransforms = blocks => {
  ...
  return blockNames.map(_registration.getBlockType);
};
...
function getBlockTransforms(direction, blockTypeOrName) {
  ...
  if (blockTypeOrName === undefined) {
    return (0, _registration.getBlockTypes)().map(({
      name
