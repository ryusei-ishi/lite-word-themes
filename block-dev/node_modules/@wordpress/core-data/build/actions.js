...
exports.receiveDefaultTemplateId = receiveDefaultTemplateId;
...
function receiveEntityRecords(kind, name, records, query, invalidateCache = false, edits, meta) {
  ...
  let action;
  if (query) {
    action = (0, _queriedData.receiveQueriedItems)(records, query, edits, meta);
  } else {
    action = (0, _queriedData.receiveItems)(records, edits, meta);
  }
  return {
    ...action,
    kind,
...
function receiveThemeGlobalStyleRevisions(currentId, revisions) {
  (0, _deprecated.default)("wp.data.dispatch( 'core' ).receiveThemeGlobalStyleRevisions()", {
    since: '6.5.0',
