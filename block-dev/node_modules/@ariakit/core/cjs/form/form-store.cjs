...
function hasMessages(object) {
  return Object.keys(object).some((key) => {
    if (_BTUHABP4cjs.isObject.call(void 0, object[key])) {
...
function set(values, path, value) {
  ...
  const key = k;
  const isIntegerKey = _BTUHABP4cjs.isInteger.call(void 0, key);
  const nextValues = isIntegerKey ? values || [] : values || {};
  const nestedValues = nextValues[key];
  const result = rest.length && (Array.isArray(nestedValues) || _BTUHABP4cjs.isObject.call(void 0, nestedValues)) ? set(nestedValues, rest, value) : value;
  if (isIntegerKey) {
  ...
  return _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, values), { [key]: result });
}
  ...
  for (const key of keys) {
    ...
    if (Array.isArray(currentValue)) {
      result[key] = currentValue.map((v) => {
        if (_BTUHABP4cjs.isObject.call(void 0, v)) {
          return setAll(v, value);
        }
        return value;
      });
    } else if (_BTUHABP4cjs.isObject.call(void 0, currentValue)) {
...
function createFormStore(props = {}) {
  ...
  const values = _BTUHABP4cjs.defaultValue.call(void 0, 
    props.values,
    syncState == null ? void 0 : syncState.values,
    props.defaultValues,
    {}
  );
  const errors = _BTUHABP4cjs.defaultValue.call(void 0, 
    props.errors,
    syncState == null ? void 0 : syncState.errors,
    props.defaultErrors,
    {}
  );
  const touched = _BTUHABP4cjs.defaultValue.call(void 0, 
    props.touched,
  ...
  const initialState = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, collection.getState()), {
    ...
    errors,
    touched,
    validating: _BTUHABP4cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.validating, false),
    submitting: _BTUHABP4cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitting, false),
    submitSucceed: _BTUHABP4cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitSucceed, 0),
    submitFailed: _BTUHABP4cjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitFailed, 0),
    valid: !hasMessages(errors)
  });
  const form = _3QF3ODTRcjs.createStore.call(void 0, initialState, collection, props.store);
  ...
  const callbacks = _3QF3ODTRcjs.createStore.call(void 0, callbacksInitialState, syncCallbacks);
  _3QF3ODTRcjs.setup.call(void 0, form, () => _3QF3ODTRcjs.init.call(void 0, callbacks));
  ...
  return _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, collection), form), {
    names: createNames(),
    ...
    setError: (name, error) => form.setState("errors", (errors2) => {
      ...
      const nextError = _BTUHABP4cjs.applyState.call(void 0, error, prevError);
