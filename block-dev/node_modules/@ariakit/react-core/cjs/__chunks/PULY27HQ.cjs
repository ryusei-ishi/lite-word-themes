...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _OUWHJLQHcjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _OUWHJLQHcjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  const useState2 = React.useCallback(
    (keyOrSelector) => useStoreState(store, keyOrSelector),
    [store]
  );
  const memoizedStore = React.useMemo(
    () => _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, store), { useState: useState2 }),
    [store, useState2]
  );
  const updateStore = _OUWHJLQHcjs.useEvent.call(void 0, () => {
    setStore((store2) => createStore(_3IVNQNIVcjs.__spreadValues.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), store2.getState())));
  });
