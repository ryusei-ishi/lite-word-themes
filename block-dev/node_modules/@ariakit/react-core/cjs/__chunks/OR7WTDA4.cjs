...
var _EFOAIXM5cjs = require('./EFOAIXM5.cjs');
...
function usePreventBodyScroll(contentElement, contentId, enabled) {
  const isRootDialog = _EFOAIXM5cjs.useRootDialog.call(void 0, {
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const setScrollbarWidthProperty = () => _YS72JDSEcjs.setCSSProperty.call(void 0, 
      documentElement,
      "--scrollbar-width",
      `${scrollbarWidth}px`
    );
    const paddingProperty = getPaddingProperty(documentElement);
    const setStyle = () => _YS72JDSEcjs.assignStyle.call(void 0, body, {
      overflow: "hidden",
    ...
    const setIOSStyle = () => {
      ...
      const restoreStyle = _YS72JDSEcjs.assignStyle.call(void 0, body, {
        position: "fixed",
        overflow: "hidden",
