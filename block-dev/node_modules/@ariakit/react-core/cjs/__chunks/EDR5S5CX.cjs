...
var _DYIDES27cjs = require('./DYIDES27.cjs');
...
var useFocusable = _AWEKOM65cjs.createHook.call(void 0, 
  function useFocusable2(_a) {
    ...
    const onKeyDownCapture = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
    ...
    const autoFocusOnShow = _react.useContext.call(void 0, _DYIDES27cjs.FocusableContext);
    const autoFocusRef = _OUWHJLQHcjs.useEvent.call(void 0, (element) => {
      if (!focusable) return;
      if (!autoFocus) return;
      if (!element) return;
    ...
    const tagName = _OUWHJLQHcjs.useTagName.call(void 0, ref);
    const nativeTabbable = focusable && isNativeTabbable(tagName);
    const supportsDisabled = focusable && supportsDisabledAttribute(tagName);
    const styleProp = props.style;
    const style = _react.useMemo.call(void 0, () => {
      if (trulyDisabled) {
        return _3IVNQNIVcjs.__spreadValues.call(void 0, { pointerEvents: "none" }, styleProp);
      }
      return styleProp;
    ...
    props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      ...
      ref: _OUWHJLQHcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
      style,
...
var Focusable = _AWEKOM65cjs.forwardRef.call(void 0, function Focusable2(props) {
