...
function getRefProperty(element) {
  ...
  const props = _3IVNQNIVcjs.__spreadValues.call(void 0, {}, element.props);
  return props.ref || element.ref;
}
function mergeProps(base, overrides) {
  const props = _3IVNQNIVcjs.__spreadValues.call(void 0, {}, base);
  for (const key in overrides) {
    ...
    if (key === "style") {
      const prop = "style";
      props[prop] = base[prop] ? _3IVNQNIVcjs.__spreadValues.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, base[prop]), overrides[prop]) : overrides[prop];
      continue;
    }
