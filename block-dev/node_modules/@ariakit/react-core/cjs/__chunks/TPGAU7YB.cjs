...
var _55G3CDVQcjs = require('./55G3CDVQ.cjs');
...
function useCollectionRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _55G3CDVQcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _PULY27HQcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _OUWHJLQHcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _OUWHJLQHcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _OUWHJLQHcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
  ...
  const getItemProps = _react.useCallback.call(void 0, 
    (item, index) => {
      ...
      return _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, itemProps), baseItemProps), {
        style: _3IVNQNIVcjs.__spreadValues.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, itemProps.style), baseItemProps.style)
      });
    },
  ...
  const style = _react.useMemo.call(void 0, 
    () => _3IVNQNIVcjs.__spreadValues.call(void 0, {
      flex: "none",
      position: "relative",
  ...
  return _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), { children });
}
var CollectionRenderer = _AWEKOM65cjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
