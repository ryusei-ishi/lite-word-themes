...
var _PNSA4OTLcjs = require('./PNSA4OTL.cjs');
...
function useEventOutside({
  ...
  const callListener = _OUWHJLQHcjs.useEvent.call(void 0, listener);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onEvent = (event) => {
      ...
      if (focused && !_MUQXBDURcjs.isElementMarked.call(void 0, target, contentElement.id)) return;
      callListener(event);
    };
...
function useHideOnInteractOutside(store, hideOnInteractOutside, domReady) {
  const open = store.useState("open");
  const previousMouseDownRef = _PNSA4OTLcjs.usePreviousMouseDownRef.call(void 0, open);
  const props = { store, domReady, capture: true };
  useEventOutside(_3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), {
    type: "click",
    listener: (event) => {
      const { contentElement } = store.getState();
      ...
      if (!_MUQXBDURcjs.isElementMarked.call(void 0, previousMouseDown, contentElement == null ? void 0 : contentElement.id)) return;
