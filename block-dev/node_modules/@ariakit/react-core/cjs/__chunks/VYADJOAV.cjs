...
var useCompositeContainer = _AWEKOM65cjs.createHook.call(void 0, function useCompositeContainer2(_a) {
  ...
  const open = (collapseToEnd = false) => {
    ...
    queueMicrotask(() => {
      ...
      if (_dom.isTextField.call(void 0, tabbable) || tabbable.isContentEditable) {
        _BV5PE6PZcjs.selectTextField.call(void 0, tabbable, collapseToEnd);
      }
    });
  };
  const close = () => {
  ...
  const renderedItems = _PULY27HQcjs.useStoreState.call(void 0, store, "renderedItems");
...
var CompositeContainer = _AWEKOM65cjs.forwardRef.call(void 0, function CompositeContainer2(props) {
