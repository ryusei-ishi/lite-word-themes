...
function createWalkTreeSnapshot(id, elements) {
  ...
  const markElement = (element) => {
    cleanups.push(_YS72JDSEcjs.setProperty.call(void 0, element, getSnapshotPropertyName(id), true));
  };
  walkTreeOutside(id, elements, markElement);
  return _misc.chain.call(void 0, _YS72JDSEcjs.setProperty.call(void 0, body, getSnapshotPropertyName(id), true), () => {
