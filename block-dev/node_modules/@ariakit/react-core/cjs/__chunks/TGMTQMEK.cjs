...
var _I2B6AUM7cjs = require('./I2B6AUM7.cjs');


var _4LJ6O7GMcjs = require('./4LJ6O7GM.cjs');
...
var _54XFMNDScjs = require('./54XFMNDS.cjs');
...
var usePortal = _AWEKOM65cjs.createHook.call(void 0, function usePortal2(_a) {
  var _b = _a, {
    preserveTabOrder,
  ...
  const refProp = _OUWHJLQHcjs.useMergeRefs.call(void 0, ref, props.ref);
  const context = _react.useContext.call(void 0, _4LJ6O7GMcjs.PortalContext);
  ...
  _OUWHJLQHcjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    _54XFMNDScjs.setRef.call(void 0, portalRef, portalEl);
    if (isPortalInDocument) return;
    return () => {
      portalEl.remove();
      _54XFMNDScjs.setRef.call(void 0, portalRef, null);
    };
  ...
  props = _OUWHJLQHcjs.useWrapElement.call(void 0, 
    ...
    (element) => {
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _4LJ6O7GMcjs.PortalContext.Provider, { value: portalNode || context, children: element });
...
var Portal = _AWEKOM65cjs.forwardRef.call(void 0, function Portal2(props) {
