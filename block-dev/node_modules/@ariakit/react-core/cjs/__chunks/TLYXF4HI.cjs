...
var _TPGAU7YBcjs = require('./TPGAU7YB.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _TPGAU7YBcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer(_a) {
  ...
  const context = _BZ34A7Q7cjs.useCompositeContext.call(void 0, );
  store = store || context;
  const orientation = _PULY27HQcjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _PULY27HQcjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
  ...
  const activeId = _PULY27HQcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _TPGAU7YBcjs.useCollectionRenderer.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
    ...
    children: (item) => {
      var _a2;
      const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), {
...
var CompositeRenderer = _AWEKOM65cjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
