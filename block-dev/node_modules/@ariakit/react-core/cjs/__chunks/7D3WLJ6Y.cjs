...
var _ONFSQI2Xcjs = require('./ONFSQI2X.cjs');
...
function useDialogStoreProps(store, update, props) {
  return _ONFSQI2Xcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _PULY27HQcjs.useStore.call(void 0, Core.createDialogStore, props);
