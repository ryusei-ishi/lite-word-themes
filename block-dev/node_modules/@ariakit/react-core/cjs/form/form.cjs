...
var useForm = _AWEKOM65cjs.createHook.call(void 0, function useForm2(_a) {
  var _b = _a, {
    store,
  ...
  const defaultValues = _OUWHJLQHcjs.useInitialValue.call(void 0, values);
  ...
  const onSubmit = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
  ...
  const onReset = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
  ...
  props = _OUWHJLQHcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _TRKXX6UWcjs.FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const tagName = _OUWHJLQHcjs.useTagName.call(void 0, ref, TagName);
...
var Form = _AWEKOM65cjs.forwardRef.call(void 0, function Form2(props) {
