...
var _TRKXX6UWcjs = require('../__chunks/TRKXX6UW.cjs');


var _PYKELHKQcjs = require('../__chunks/PYKELHKQ.cjs');
...
var useFormLabel = _AWEKOM65cjs.createHook.call(void 0, 
  function useFormLabel2(_a) {
    ...
    const context = _TRKXX6UWcjs.useFormContext.call(void 0, );
    store = store || context;
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), { id: id || item.id, name, type: "label" });
        if (getItemProp) {
    ...
    const fieldTagName = _OUWHJLQHcjs.useTagName.call(void 0, field == null ? void 0 : field.element, "input");
    ...
    props = _PYKELHKQcjs.useCollectionItem.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props), { getItem }));
    return props;
  }
);
var FormLabel = _AWEKOM65cjs.memo.call(void 0, 
  _AWEKOM65cjs.forwardRef.call(void 0, function FormLabel2(props) {
