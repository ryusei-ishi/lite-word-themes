...
var _QC5YVEX2cjs = require('../__chunks/QC5YVEX2.cjs');


var _OWLCE773cjs = require('../__chunks/OWLCE773.cjs');


var _GEDABTB5cjs = require('../__chunks/GEDABTB5.cjs');
require('../__chunks/BV5PE6PZ.cjs');
require('../__chunks/BZ34A7Q7.cjs');
require('../__chunks/55G3CDVQ.cjs');
require('../__chunks/5XC2EBLV.cjs');
require('../__chunks/CQ3ILEKO.cjs');
require('../__chunks/NRLE3XE7.cjs');
require('../__chunks/EDR5S5CX.cjs');
require('../__chunks/DYIDES27.cjs');




var _AWEKOM65cjs = require('../__chunks/AWEKOM65.cjs');
...
var _OUWHJLQHcjs = require('../__chunks/OUWHJLQH.cjs');
...
var useCombobox = _AWEKOM65cjs.createHook.call(void 0, 
  function useCombobox2(_a) {
    ...
    const context = _QC5YVEX2cjs.useComboboxProviderContext.call(void 0, );
    store = store || context;
    ...
    const [valueUpdated, forceValueUpdate] = _OUWHJLQHcjs.useForceUpdate.call(void 0, );
    ...
    _OUWHJLQHcjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    ...
    const getAutoSelectIdProp = _OUWHJLQHcjs.useEvent.call(void 0, getAutoSelectId);
    ...
    _OUWHJLQHcjs.useUpdateEffect.call(void 0, () => {
      var _a2, _b2;
    ...
    const showOnChangeProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, showOnChange != null ? showOnChange : canShow);
    const setValueOnChangeProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, 
      // If the combobox is combined with tags, the value will be set by the tag
      // input component.
      setValueOnChange != null ? setValueOnChange : !store.tag
    );
    const onChange = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
    ...
    const onCompositionEnd = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = true;
    ...
    const blurActiveItemOnClickProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, 
      blurActiveItemOnClick != null ? blurActiveItemOnClick : () => !!(store == null ? void 0 : store.getState().includesBaseElement)
    );
    const setValueOnClickProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, setValueOnClick);
    const showOnClickProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, showOnClick != null ? showOnClick : canShow);
    const onMouseDown = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
    ...
    const showOnKeyPressProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, showOnKeyPress != null ? showOnKeyPress : canShow);
    ...
    const onBlur = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = false;
    ...
    props = _GEDABTB5cjs.useComposite.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      focusable
    }, props), {
    ...
    props = _OWLCE773cjs.usePopoverAnchor.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props));
    return _3IVNQNIVcjs.__spreadValues.call(void 0, { autoComplete: "off" }, props);
  }
);
var Combobox = _AWEKOM65cjs.forwardRef.call(void 0, function Combobox2(props) {
