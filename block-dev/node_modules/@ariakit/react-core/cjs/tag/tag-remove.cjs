...
var _MMWRTFBGcjs = require('../__chunks/MMWRTFBG.cjs');
...
var _RVQKZ37Ucjs = require('../__chunks/RVQKZ37U.cjs');
...
var TagName = "button";
var useTagRemove = _AWEKOM65cjs.createHook.call(void 0, 
  function useTagRemove2(_a) {
    ...
    const setRemoveId = _react.useContext.call(void 0, _LO2HIMYXcjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _LO2HIMYXcjs.TagValueContext);
    ...
    const removeOnClickProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, removeOnClick);
    const onClick = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
    ...
    const touchDevice = _MMWRTFBGcjs.useTouchDevice.call(void 0, ) && withinTag;
    props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      ...
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _RVQKZ37Ucjs.Role.span, { render: props.render }) : props.render
    });
    return props;
  }
);
var TagRemove = _AWEKOM65cjs.forwardRef.call(void 0, function TagRemove2(props) {
