...
var _CINY3Q6Qcjs = require('../__chunks/CINY3Q6Q.cjs');
require('../__chunks/PYKELHKQ.cjs');
require('../__chunks/35VA3E7J.cjs');


var _LO2HIMYXcjs = require('../__chunks/LO2HIMYX.cjs');
...
var useTagInput = _AWEKOM65cjs.createHook.call(void 0, 
  function useTagInput2(_a) {
    ...
    const context = _LO2HIMYXcjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const addValueOnPasteProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, addValueOnPaste);
    const onPaste = _OUWHJLQHcjs.useEvent.call(void 0, (event) => {
    ...
    const setValueOnChangeProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, setValueOnChange);
    const addValueOnChangeProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, addValueOnChange);
    ...
    const removeOnBackspaceProp = _OUWHJLQHcjs.useBooleanEvent.call(void 0, removeOnBackspace);
    ...
    props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      ...
      ref: _OUWHJLQHcjs.useMergeRefs.call(void 0, store.setInputElement, props.ref),
      onPaste,
      onChange,
      onKeyDown
    });
    props = _CINY3Q6Qcjs.useCompositeItem.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store, tabbable }, props));
    return props;
  }
);
var TagInput = _AWEKOM65cjs.forwardRef.call(void 0, function TagInput2(props) {
