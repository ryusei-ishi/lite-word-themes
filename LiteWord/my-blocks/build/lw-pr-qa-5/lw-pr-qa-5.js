...
/* harmony export */   openModeOptions: () => (/* binding */ openModeOptions)
/* harmony export */ });
/**
 * lw-pr-qa-5 — 設定の選択肢
 */

// 回答の出し方。値は style.scss の .qa-5--<value> と対になっている
var openModeOptions = [{
  label: '押すと開く（アコーディオン）',
  value: 'accordion'
}, {
...
/* harmony import */ var _inspector_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inspector.js */ "./src/lw-pr-qa-5/inspector.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-5/helpers.js");
...
function Edit(_ref) {
  ...
  var list = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(items);
  var hintList = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeHints)(hints);
  ...
  var setItemsAttr = function setItemsAttr(next) {
    return setAttributes({
      items: next
    });
  };
  var addItem = function addItem() {
    return setItemsAttr([].concat(_toConsumableArray(list), [{
      text_q: '新しい質問',
      text_a: '新しい回答',
      keywords: ''
    }]));
  ...
  var removeItem = function removeItem(i) {
    return setItemsAttr(list.filter(function (_, idx) {
      return idx !== i;
    }));
  };
  var updateItem = function updateItem(i, key, value) {
    return setItemsAttr(list.map(function (item, idx) {
      return idx === i ? _objectSpread(_objectSpread({}, item), {}, _defineProperty({}, key, value)) : item;
    }));
  };
  var moveItem = function moveItem(from, to) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_inspector_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    className: "qa-5__search"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qa-5__field"
    ...
    d: _helpers_js__WEBPACK_IMPORTED_MODULE_3__.SEARCH_ICON_PATH
    ...
    type: "button",
    className: "qa-5__clear",
    "aria-label": "\u5165\u529B\u3092\u6D88\u3059"
  }, "\xD7")), hintList.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "qa-5__hints"
  }, /*#__PURE__*/React.createElement("span", {
    className: "qa-5__hints-label"
  }, hintLabel), hintList.map(function (h, i) {
    return /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "qa-5__hint",
      key: i
    }, h);
  }))), showCount && /*#__PURE__*/React.createElement("p", {
    className: "qa-5__count"
  }, /*#__PURE__*/React.createElement("span", {
    className: "qa-5__count-shown"
  }, list.length), /*#__PURE__*/React.createElement("span", {
    className: "qa-5__count-unit"
  }, "\u4EF6")), /*#__PURE__*/React.createElement("div", {
    className: "qa-5__list"
    ...
    variant: "secondary",
    onClick: addItem
  }, "\u8CEA\u554F\u3092\u8FFD\u52A0\u3059\u308B")), /*#__PURE__*/React.createElement("div", {
    className: "qa-5__empty-preview"
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SEARCH_ICON_PATH: () => (/* binding */ SEARCH_ICON_PATH),
...
/* harmony export */   safeHints: () => (/* binding */ safeHints),
...
function blockStyle(a) {
  return {
    '--qa5-max-w': a.maxWidth === 0 ? '100%' : "".concat(a.maxWidth, "px"),
    '--qa5-gap': "".concat(a.itemGap, "px"),
    '--qa5-label-w': "".concat(a.labelWidth, "px"),
    '--qa5-main': a.mainColor,
    '--qa5-search-bg': a.searchBg,
    '--qa5-q-color': a.qLabelColor,
    '--qa5-a-color': a.aLabelColor,
    '--qa5-line': a.lineColor,
    '--qa5-label-size-pc': "".concat(a.labelFontSizePc, "px"),
    '--qa5-label-size-sp': "".concat(a.labelFontSizeSp, "px"),
    '--qa5-q-size-pc': "".concat(a.qFontSizePc, "px"),
    '--qa5-q-size-sp': "".concat(a.qFontSizeSp, "px"),
    '--qa5-a-size-pc': "".concat(a.aFontSizePc, "px"),
    '--qa5-a-size-sp': "".concat(a.aFontSizeSp, "px")
  };
}

// ブロックに付けるクラス。回答の出し方を CSS 側へ渡す
function rootClass(a, extra) {
  return ['lw-pr-qa-5', "qa-5--".concat(a.openMode), extra].filter(Boolean).join(' ');
}
...
function safeHints(hints) {
  return Array.isArray(hints) ? hints.filter(function (h) {
    return h && h.trim();
  }) : [];
}
...
var SEARCH_ICON_PATH = 'M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z';

/***/ }),

/***/ "./src/lw-pr-qa-5/index.js":
/*!*********************************!*\
  !*** ./src/lw-pr-qa-5/index.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-qa-5/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-qa-5/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-qa-5/block.json");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit.js */ "./src/lw-pr-qa-5/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save.js */ "./src/lw-pr-qa-5/save.js");
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants.js */ "./src/lw-pr-qa-5/constants.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-5/helpers.js");
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
...
function Inspector(_ref) {
  ...
  var maxWidth = attributes.maxWidth,
    ...
    showCount = attributes.showCount,
    noResultText = attributes.noResultText,
    noResultLinkText = attributes.noResultLinkText,
    noResultLinkUrl = attributes.noResultLinkUrl,
    mainColor = attributes.mainColor,
    searchBg = attributes.searchBg,
  ...
  var hintList = Array.isArray(hints) ? hints : [];
  var updateHint = function updateHint(i, value) {
    return setAttributes({
      hints: hintList.map(function (h, idx) {
        return idx === i ? value : h;
      })
    });
  };
  var removeHint = function removeHint(i) {
    return setAttributes({
      hints: hintList.filter(function (_, idx) {
        return idx !== i;
      })
    });
  };
  var addHint = function addHint() {
    return setAttributes({
      hints: [].concat(_toConsumableArray(hintList), [''])
    });
  };
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    variant: "secondary",
    onClick: addHint,
    disabled: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeHints)(hints).length >= 6,
    style: {
      marginTop: '8px'
    }
  }, "\uFF0B \u8A00\u8449\u3092\u8FFD\u52A0\uFF085\u500B\u307E\u3067\u304C\u304A\u3059\u3059\u3081\uFF09")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: "\u898B\u3064\u304B\u3089\u306A\u304B\u3063\u305F\u3068\u304D",
    initialOpen: false
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextareaControl, {
    label: "\u51FA\u3059\u6587\u7AE0",
    ...
    label: "\u56DE\u7B54\u306E\u51FA\u3057\u65B9",
    value: openMode,
    options: _constants_js__WEBPACK_IMPORTED_MODULE_3__.openModeOptions,
    onChange: function onChange(v) {
      return setAttributes({
        openMode: v
      });
  ...
  }, "\u4E3B\u306A\u8272\uFF08\u30A2\u30A4\u30B3\u30F3\u30FB\u62BC\u3057\u305F\u8A00\u8449\uFF09"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: mainColor,
  ...
  }, "\u691C\u7D22\u7A93\u306E\u307E\u308F\u308A\u306E\u5730\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: searchBg,
    onChange: function onChange(c) {
      return setAttributes({
        searchBg: c || '#f6f6f6'
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-5/helpers.js");
/**
 * lw-pr-qa-5 — 保存HTML
...
function Save(_ref) {
  ...
  var placeholder = attributes.placeholder,
    ...
    textFont = attributes.textFont,
    items = attributes.items;
  var list = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.safeItems)(items);
  var hintList = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.safeHints)(hints);
  ...
  return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
    ...
    d: _helpers_js__WEBPACK_IMPORTED_MODULE_1__.SEARCH_ICON_PATH
  })), /*#__PURE__*/React.createElement("input", {
    type: "text",
    className: "qa-5__input",
    placeholder: placeholder,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Q"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
      tagName: "span",
      className: "qa-5__q-text",
      value: c.text_q,
      ...
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(labelFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(labelFontWeight)
    }, "A"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
      tagName: "p",
      className: "qa-5__a-text",
      value: c.text_a,
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(textFont)
    ...
    className: "qa-5__empty"
  }, /*#__PURE__*/React.createElement("p", {
    className: "qa-5__empty-text"
  }, noResultText), noResultLinkUrl && /*#__PURE__*/React.createElement("a", {
    className: "qa-5__empty-link",
    href: noResultLinkUrl
  }, noResultLinkText)));
}
...
/***/ "./src/lw-pr-qa-5/block.json":
/*!***********************************!*\
  !*** ./src/lw-pr-qa-5/block.json ***!
  \***********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-qa-5","version":"1.0.0","title":"よくある質問 05（検索して探す）","category":"lw-faq","icon":"search","description":"検索窓つきのよくある質問。言葉を入れるとその場で絞り込みます。見つからなかったときの行き先も出せます。質問が15件以上あるページに向きます。","aiHint":{"description":"よくある質問（検索して探す）。上に検索窓があり、打つとその場で絞り込む。よく検索される言葉のボタンつき。0件のときは問い合わせ先を出す。質問が15件以上あるFAQに向く","excludeFromAutoSelect":false,"contentAttributes":["items","hints","noResultText"],"imageAttributes":[],"notes":"items は [{ text_q, text_a, keywords }] の配列。keywords は**表示されない検索用の言葉**（空白区切り）。「駐車場」の質問に「車 パーキング とめる」を入れておくと、その語でも当たる。⚠️ 検索はひらがな・カタカナ・全角半角・大文字小文字を同じものとして扱う（view.js が正規化する）。漢字とかなの違いは吸収しないので、かなで探されそうな語は keywords に入れること。🚨 検索窓・件数・「見つかりません」は JS が動いたときだけ出る。JS 無しでは全部の質問が開いた状態で縦に並ぶだけなので壊れない。⚠️ hints（よく検索される言葉）は3〜5個。多いと2行になって窮屈になる。⚠️ noResultLinkUrl を空のままにするとリンクは出ない（文章だけ出る）。⚠️ 検索を使うのは質問が15件以上あるときだけ。5件しか無いページに検索窓を置くと、かえって探させることになる。"},"supports":{"anchor":true,"className":true},"attributes":{"maxWidth":{"type":"number","default":860},"openMode":{"type":"string","default":"accordion"},"placeholder":{"type":"string","default":"キーワードで探す（例：駐車場）"},"hintLabel":{"type":"string","default":"よく検索される言葉"},"hints":{"type":"array","default":["駐車場","キャンセル","支払い","子ども"]},"showCount":{"type":"boolean","default":true},"noResultText":{"type":"string","default":"その言葉では見つかりませんでした。別の言い方でお試しいただくか、直接おたずねください。"},"noResultLinkText":{"type":"string","default":"お問い合わせはこちら"},"noResultLinkUrl":{"type":"string","default":""},"mainColor":{"type":"string","default":"var(--color-main)"},"searchBg":{"type":"string","default":"#f6f6f6"},"lineColor":{"type":"string","default":"#e0e0e0"},"itemGap":{"type":"number","default":20},"labelWidth":{"type":"number","default":34},"qLabelColor":{"type":"string","default":"var(--color-main)"},"aLabelColor":{"type":"string","default":"var(--color-accent)"},"labelFont":{"type":"string","default":"Roboto"},"labelFontWeight":{"type":"string","default":""},"labelFontSizePc":{"type":"number","default":18},"labelFontSizeSp":{"type":"number","default":16},"textFont":{"type":"string","default":""},"qFontSizePc":{"type":"number","default":17},"qFontSizeSp":{"type":"number","default":15},"aFontSizePc":{"type":"number","default":15},"aFontSizeSp":{"type":"number","default":14},"schemaOutput":{"type":"boolean","default":true},"items":{"type":"array","default":[{"text_q":"駐車場はありますか？","text_a":"建物の裏に3台ぶんございます。満車のときは近くのコインパーキングをご案内します。","keywords":"車 パーキング とめる"},{"text_q":"支払い方法を教えてください","text_a":"現金のほか、各種クレジットカードと電子マネーがお使いいただけます。","keywords":"カード 現金 電子マネー"},{"text_q":"キャンセル料はかかりますか？","text_a":"前日までのご連絡なら無料です。当日のお取り消しは半額をいただいております。","keywords":"取り消し 変更 キャンセル料"},{"text_q":"子どもを連れて行っても大丈夫ですか？","text_a":"はい。お子さま連れの方も多くいらっしゃいます。ベビーカーのまま入っていただけます。","keywords":"こども 子連れ ベビーカー 赤ちゃん"}]}},"editorScript":"file:./lw-pr-qa-5.js","viewScript":"file:./view.js","no":5}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-qa-5"], () => (__webpack_require__("./src/lw-pr-qa-5/index.js")))
