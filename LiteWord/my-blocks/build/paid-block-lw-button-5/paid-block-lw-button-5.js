...
/***/ "./src/paid-block-lw-button-5/index.js":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-button-5/index.js ***!
  \*********************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-lw-button-5/style.scss");
...
var iconSvgOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.rightButtonIconSvgArr)();

/* ─ ヘルパー：SVG に色を付与 ─ */
var iconWithColor = function iconWithColor(svg, color) {
  return svg ? svg.replace('<svg', "<svg style=\"fill:".concat(color, ";color:").concat(color, ";\"")) : '';
};

/* ─ デフォルトボタン ─ */
var defaultBtn = function defaultBtn() {
  return {
    enabled: true,
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var blockId = attributes.blockId,
      ...
      gapX = attributes.gapX,
      gapY = attributes.gapY,
    ...
    var _wp$element = wp.element,
      ...
      createElement = _wp$element.createElement; // ✧ WP 環境ではこれでも可
    var generatedId = blockId || "lwbtn-".concat(clientId.slice(0, 8));
    useEffect(function () {
      // ★ 修正
      if (!blockId) {
        setAttributes({
    ...
    var updateBtn = function updateBtn(i, k, v) {
      var arr = _toConsumableArray(buttons);
      arr[i] = _objectSpread(_objectSpread({}, arr[i]), {}, _defineProperty({}, k, v));
      setAttributes({
        buttons: arr
      });
    };
    var posClass = "position_".concat(position);
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "paid-block-lw-button-5 ".concat(posClass),
      style: {
        columnGap: "".concat(gapX, "px"),
        rowGap: "".concat(gapY, "px")
      }
    });
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        label: "\u30DC\u30BF\u30F3 ".concat(i + 1, " \u3092\u8868\u793A\u3059\u308B"),
        checked: btn.enabled,
        onChange: function onChange(v) {
          return updateBtn(i, 'enabled', v);
        },
        help: btn.enabled ? 'このボタンは表示されます' : 'このボタンは非表示になります'
      })), btn.enabled && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      }, "\uD83D\uDD17 \u30EA\u30F3\u30AF\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.URLInput, {
        label: "\u30EA\u30F3\u30AF\u5148URL",
        value: btn.btnUrl,
        onChange: function onChange(v) {
          return updateBtn(i, 'btnUrl', v);
        },
      ...
      }, "\uD83C\uDFA8 \u8272\u3068\u30C6\u30AD\u30B9\u30C8"), /*#__PURE__*/React.createElement("div", {
        style: {
          marginBottom: '15px'
        }
      }, /*#__PURE__*/React.createElement("p", {
      ...
      }, "\uD83C\uDF08 \u30DC\u30BF\u30F3\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: btn.bgColor,
        onChange: function onChange(v) {
          return updateBtn(i, 'bgColor', v);
        }
      })), /*#__PURE__*/React.createElement("div", {
        style: {
          marginBottom: '15px'
      ...
      }, "\uD83D\uDCDD \u6587\u5B57\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: btn.textColor,
        onChange: function onChange(v) {
          return updateBtn(i, 'textColor', v);
        }
      ...
      }, "\u2728 \u30A2\u30A4\u30B3\u30F3\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "\u30A2\u30A4\u30B3\u30F3\u3092\u8868\u793A\u3059\u308B",
        checked: btn.iconVisible,
        onChange: function onChange(v) {
          return updateBtn(i, 'iconVisible', v);
        },
        help: "\u30DC\u30BF\u30F3\u306B\u30A2\u30A4\u30B3\u30F3\u3092\u8868\u793A\u3057\u305F\u3044\u5834\u5408\u306F\u30AA\u30F3\u306B\u3057\u3066\u304F\u3060\u3055\u3044"
      }), btn.iconVisible && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        label: "\uD83C\uDFAF \u30A2\u30A4\u30B3\u30F3\u306E\u7A2E\u985E",
        value: btn.selectedIcon,
        options: iconSvgOptions,
        onChange: function onChange(v) {
          return updateBtn(i, 'selectedIcon', v);
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\uD83D\uDCD0 \u30A2\u30A4\u30B3\u30F3\u306E\u30B5\u30A4\u30BA (%)",
        value: btn.iconWidth,
        onChange: function onChange(v) {
          return updateBtn(i, 'iconWidth', v);
        },
        min: 10,
        max: 100,
      ...
      }, "\uD83C\uDFA8 \u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: btn.iconColor,
        onChange: function onChange(v) {
          return updateBtn(i, 'iconColor', v);
        }
      })))), /*#__PURE__*/React.createElement("div", {
        style: {
          border: '1px solid #e0e0e0',
      ...
      }, "\uD83D\uDD8D\uFE0F \u67A0\u7DDA\u306E\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\uD83D\uDD32 \u5916\u67A0\u7DDA\u306E\u592A\u3055 (px)",
        value: btn.outerBorderWidth,
        onChange: function onChange(v) {
          return updateBtn(i, 'outerBorderWidth', v);
        },
        min: 0,
        max: 10,
        help: "\u30DC\u30BF\u30F3\u5168\u4F53\u306E\u5916\u5074\u306E\u67A0\u7DDA\u3067\u3059"
      }), btn.outerBorderWidth > 0 && /*#__PURE__*/React.createElement("div", {
        style: {
          marginBottom: '15px'
        }
      }, /*#__PURE__*/React.createElement("p", {
      ...
      }, "\uD83C\uDFA8 \u5916\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: btn.outerBorderColor,
        onChange: function onChange(v) {
          return updateBtn(i, 'outerBorderColor', v);
        }
      })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\uD83D\uDCE6 \u5185\u67A0\u7DDA\u306E\u592A\u3055 (px)",
        value: btn.borderWidth,
        onChange: function onChange(v) {
          return updateBtn(i, 'borderWidth', v);
        },
        min: 0,
        max: 10,
        help: "\u30DC\u30BF\u30F3\u5185\u5074\u306E\u67A0\u7DDA\u3067\u3059"
      }), btn.borderWidth > 0 && /*#__PURE__*/React.createElement("div", {
        style: {
          marginTop: '15px'
        }
      }, /*#__PURE__*/React.createElement("p", {
      ...
      }, "\uD83C\uDFA8 \u5185\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: btn.borderColor,
        onChange: function onChange(v) {
          return updateBtn(i, 'borderColor', v);
        }
      })))));
    })), buttons.map(function (btn, i) {
      if (!btn.enabled) return null;
      var id = "".concat(generatedId, "-").concat(i + 1); // ★ 修正
      return /*#__PURE__*/React.createElement("div", {
        key: i,
        id: id,
        className: "a_inner",
        style: {
          border: "".concat(btn.outerBorderWidth, "px solid ").concat(btn.outerBorderColor),
      ...
      }, btn.iconVisible && btn.selectedIcon && /*#__PURE__*/React.createElement("span", {
        className: "icon-svg"
      }, /*#__PURE__*/React.createElement("span", {
        className: "icon-svg-inner",
        style: {
          width: "".concat(btn.iconWidth, "%"),
          textDecoration: 'none'
        },
        ...
        className: "a_background",
        style: {
          background: btn.bgColor
        }
      }), /*#__PURE__*/React.createElement("div", {
        className: "a_in_border",
        style: {
  ...
  /* ───────── save ───────── */save: function save(_ref2) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, buttons.map(function (btn, i) {
      if (!btn.enabled) return null;
      var id = "".concat(blockId, "-").concat(i + 1);
      var hasMainText = btn.btnText && btn.btnText.trim() !== '';
      var hasSubText = btn.subText && btn.subText.trim() !== '';
      return /*#__PURE__*/React.createElement("div", {
        key: i,
        id: id,
        className: "a_inner",
      ...
      })), (hasMainText || hasSubText) && /*#__PURE__*/React.createElement("span", {
        className: "text_in"
      }, hasMainText && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
        tagName: "span",
        className: "text_main",
        value: btn.btnText
      }), hasSubText && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
        tagName: "span",
        className: "text_sub",
        value: btn.subText
      }))), /*#__PURE__*/React.createElement("div", {
...
/***/ "./src/paid-block-lw-button-5/editor.scss":
/*!************************************************!*\
  !*** ./src/paid-block-lw-button-5/editor.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-button-5/style.scss":
/*!***********************************************!*\
  !*** ./src/paid-block-lw-button-5/style.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-button-5/block.json":
/*!***********************************************!*\
  !*** ./src/paid-block-lw-button-5/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-lw-button-5","version":"1.0.0","title":"リンクボタン 05","category":"lw-button","icon":"button","description":"有料リンクボタン（スタイル05）","supports":{"anchor":true},"attributes":{"blockId":{"type":"string"},"fontWeight":{"type":"string","default":"400"},"FontSet":{"type":"string","default":""},"position":{"type":"string","default":"center"},"gapX":{"type":"number","default":12},"gapY":{"type":"number","default":12},"borderRadius":{"type":"number","default":12},"buttons":{"type":"array","default":[{"enabled":true,"btnText":"03-0000-0000","subText":"受付時間 10:00～17:00","bgColor":"var(--color-main)","textColor":"#ffffff","btnUrl":"","openNewTab":false,"selectedIcon":"<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 512 512\\"><path d=\\"M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z\\"/></svg>","iconVisible":true,"iconWidth":34,"iconColor":"#ffffff","outerBorderWidth":0,"outerBorderColor":"var(--color-main)","borderWidth":1,"borderColor":"#ffffff"},{"enabled":true,"btnText":"03-0000-0000","subText":"受付時間 10:00～17:00","bgColor":"var(--color-main)","textColor":"#ffffff","btnUrl":"","openNewTab":false,"selectedIcon":"<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 512 512\\"><path d=\\"M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z\\"/></svg>","iconVisible":true,"iconWidth":34,"iconColor":"#ffffff","outerBorderWidth":0,"outerBorderColor":"var(--color-main)","borderWidth":1,"borderColor":"#ffffff"},{"enabled":true,"btnText":"03-0000-0000","subText":"受付時間 10:00～17:00","bgColor":"var(--color-main)","textColor":"#ffffff","btnUrl":"","openNewTab":false,"selectedIcon":"<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 512 512\\"><path d=\\"M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z\\"/></svg>","iconVisible":true,"iconWidth":34,"iconColor":"#ffffff","outerBorderWidth":0,"outerBorderColor":"var(--color-main)","borderWidth":1,"borderColor":"#ffffff"}]}},"editorScript":"file:./paid-block-lw-button-5.js","editorStyle":["file:./editor.css","file:../../../assets/css/font_style.min.css","file:../../../assets/css/editor_block_side.min.css"],"style":"file:./style.css","no":5}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-lw-button-5": 0,
/******/ 			"./style-paid-block-lw-button-5": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-lw-button-5"], () => (__webpack_require__("./src/paid-block-lw-button-5/index.js")))
