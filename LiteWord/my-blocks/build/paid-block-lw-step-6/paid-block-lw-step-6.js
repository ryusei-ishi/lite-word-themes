...
/***/ "./src/paid-block-lw-step-6/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-lw-step-6/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-lw-step-6/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-lw-step-6/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-lw-step-6/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  /* ───────────────────── エディター側 ───────────────────── */edit: function edit(_ref) {
    ...
    var updateContent = function updateContent(i, key, val) {
      return updateContentMulti(i, _defineProperty({}, key, val));
    };
    /* 画像を選び直したときに URL と alt をまとめて入れ替えるため、複数キー版を用意する */
    var updateContentMulti = function updateContentMulti(i, patch) {
      var arr = contents.map(function (item, idx) {
        return idx === i ? _objectSpread(_objectSpread({}, item), patch) : item;
      });
      setAttributes({
        contents: arr
      });
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30B9\u30BF\u30A4\u30EB\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u753B\u50CF\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: borderColor,
      onChange: function onChange(v) {
        return setAttributes({
          borderColor: v
      ...
      label: "\u753B\u50CF aspect-ratio \u9AD8\u3055 (400 / ".concat(imageAspectH || 0, "px)"),
      value: imageAspectH,
      onChange: function onChange(v) {
        return setAttributes({
          imageAspectH: v
      ...
      max: 800,
      step: 10
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30BF\u30A4\u30C8\u30EB\u30BF\u30B0",
      value: titleTag,
      options: [{
        label: 'h3',
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30BF\u30A4\u30C8\u30EB\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: fontColorLi,
      onChange: function onChange(v) {
        return setAttributes({
          fontColorLi: v
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30BF\u30A4\u30C8\u30EB\u4E0B\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      ...
      min: 0,
      max: 10
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("p", null, "\u8AAC\u660E\u6587\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: fontColorLiP,
      onChange: function onChange(v) {
        return setAttributes({
          fontColorLiP: v
    ...
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: "\u756A\u53F7\u3092\u8868\u793A\u3059\u308B",
      checked: showNumber,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }, "\u756A\u53F7\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: numberBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          numberBgColor: v
    ...
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("p", null, "\u30EA\u30B9\u30C8\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: liBorderColor,
      onChange: function onChange(v) {
        return setAttributes({
          liBorderColor: v
      ...
      min: 0,
      max: 100
    }))), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        value: c.number,
        onChange: function onChange(v) {
          return updateContent(i, 'number', v.replace(/<[^>]+>/g, ''));
        },
      ...
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(Tag, props, /*#__PURE__*/React.createElement(React.Fragment, null, c.image && /*#__PURE__*/React.createElement("div", {
        className: "image",
        style: {
      ...
      }), c.image && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isDestructive: true,
        style: {
          marginLeft: '8px'
        },
        onClick: function onClick() {
          return updateContent(i, 'image', '');
        }
      }, "\u753B\u50CF\u3092\u524A\u9664"), c.image && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u753B\u50CF\u306E\u8AAC\u660E\uFF08alt\uFF09",
        help: "\u76EE\u306E\u898B\u3048\u306A\u3044\u65B9\u3084\u691C\u7D22\u30A8\u30F3\u30B8\u30F3\u306B\u3001\u3053\u306E\u753B\u50CF\u304C\u4F55\u304B\u3092\u4F1D\u3048\u308B\u6587\u3067\u3059\u3002\u4F8B\uFF1A\u30AB\u30A6\u30F3\u30BB\u30EA\u30F3\u30B0\u3092\u53D7\u3051\u308B\u5973\u6027",
        value: c.alt || '',
        onChange: function onChange(v) {
          return updateContent(i, 'alt', v);
        },
        style: {
          marginTop: '12px',
          maxWidth: '400px'
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkFromItem)(c, 'url'),
        onChange: function onChange(patch) {
          return updateContentMulti(i, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkToItem)(patch, 'url'));
        }
      ...
      className: "paid-block-lw-step-6__add_btn",
      isSecondary: true,
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B")));
  },
  /* ───────────────────── 保存側 ───────────────────── */save: function save(_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      ...
      var props = c.url ? {
        href: c.url,
        'data-lw-link-type': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromItem)(c, 'url').linkType,
        'data-lw-link-id': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromItem)(c, 'url').linkId,
        className: 'link'
      } : {
        className: 'link'
      };
...
/***/ "./src/paid-block-lw-step-6/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-lw-step-6/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-6/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-6/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-6/block.json":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-6/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-lw-step-6","version":"1.0.0","title":"step 06","category":"lw-step","icon":"lightbulb","supports":{"anchor":true},"editorScript":"file:./paid-block-lw-step-6.js","aiHint":{"description":"画像+番号付きステップ。画像+タイトル+説明のカード配列。ビジュアル重視の手順紹介に","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":["contents.image"]},"no":6,"attributes":{"fontLi":{"type":"string","default":""},"fontColorLi":{"type":"string","default":""},"fontWeightLi":{"type":"string","default":"600"},"titleFontSizeClass":{"type":"string","default":"font_size_m"},"fontLiP":{"type":"string","default":""},"fontColorLiP":{"type":"string","default":"var(--color-black)"},"fontWeightLiP":{"type":"string","default":"400"},"textFontSizeClass":{"type":"string","default":"font_size_m"},"borderColor":{"type":"string","default":"var(--color-main)"},"borderSize":{"type":"number","default":0},"imageBorderRadius":{"type":"number","default":0},"imageObjectFit":{"type":"string","default":"cover"},"imageAspectH":{"type":"number","default":300},"titleTag":{"type":"string","default":"h3"},"titleBorderColor":{"type":"string","default":"var(--color-main)"},"titleBorderSize":{"type":"number","default":2},"numberBgColor":{"type":"string","default":"var(--color-main)"},"showNumber":{"type":"boolean","default":true},"liBorderColor":{"type":"string","default":"#ccc"},"liBorderSize":{"type":"number","default":1},"liBorderRadius":{"type":"number","default":0},"contents":{"type":"array","source":"query","selector":".paid-block-lw-step-6__li","query":{"image":{"type":"string","source":"attribute","selector":"img","attribute":"src"},"alt":{"type":"string","source":"attribute","selector":"img","attribute":"alt","default":""},"ttl":{"type":"string","source":"html","selector":".ttl"},"text":{"type":"string","source":"html","selector":".paid-block-lw-step-6__text"},"url":{"type":"string","source":"attribute","selector":".link","attribute":"href","default":""},"number":{"type":"string","source":"text","selector":".number > span"},"linkType":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-type"},"linkId":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-id"}},"default":[{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/9.webp","ttl":"難関校合格実績","text":"〇〇中学、××高校など、難関校への高い合格実績が自慢です。経験豊富なプロ講師陣が、志望校合格まで徹底的にサポートします。","number":""},{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/5.webp","ttl":"合格への最短ルート","text":"長年の指導ノウハウを結集したオリジナル教材とカリキュラムで、基礎から応用まで無駄なく効率的に学力を伸ばし、合格へと導きます。","number":""},{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/3.webp","ttl":"自習室完備＆質問OK","text":"静かで集中できる自習室を完備しています。わからないことはいつでも講師に質問可能。学習相談や進路指導も充実、安心して学習に専念できます。","number":""}]}}}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-lw-step-6": 0,
/******/ 			"./style-paid-block-lw-step-6": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-lw-step-6"], () => (__webpack_require__("./src/paid-block-lw-step-6/index.js")))
