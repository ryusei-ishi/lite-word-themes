...
/* harmony export */   labelStyleOptions: () => (/* binding */ labelStyleOptions),
...
/* harmony import */ var _inspector_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inspector.js */ "./src/lw-pr-qa-6/inspector.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-6/helpers.js");
...
function Edit(_ref) {
  ...
  var list = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeGroups)(groups);
  var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
    className: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.rootClass)(attributes, 'is-js'),
    style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.blockStyle)(attributes)
  });
  var setGroups = function setGroups(next) {
    return setAttributes({
      groups: next
    });
  };
  var addGroup = function addGroup() {
    return setGroups([].concat(_toConsumableArray(list), [{
      label: '新しい分類',
      items: [{
        text_q: '新しい質問',
        text_a: '新しい回答'
  ...
  var removeGroup = function removeGroup(i) {
    return setGroups(list.filter(function (_, idx) {
      return idx !== i;
    }));
  };
  var updateGroupLabel = function updateGroupLabel(i, value) {
    return setGroups(list.map(function (g, idx) {
      return idx === i ? _objectSpread(_objectSpread({}, g), {}, {
        label: value
      }) : g;
    }));
  };
  var moveGroup = function moveGroup(from, to) {
  ...
  var setItems = function setItems(gi, items) {
    return setGroups(list.map(function (g, idx) {
      return idx === gi ? _objectSpread(_objectSpread({}, g), {}, {
        items: items
      }) : g;
    }));
  };
  var addItem = function addItem(gi) {
    return setItems(gi, [].concat(_toConsumableArray((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(list[gi])), [{
      text_q: '新しい質問',
      text_a: '新しい回答'
    }]));
  };
  var removeItem = function removeItem(gi, i) {
    return setItems(gi, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(list[gi]).filter(function (_, idx) {
      return idx !== i;
    }));
  };
  var updateItem = function updateItem(gi, i, key, value) {
    return setItems(gi, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(list[gi]).map(function (item, idx) {
      return idx === i ? _objectSpread(_objectSpread({}, item), {}, _defineProperty({}, key, value)) : item;
    }));
  };
  var moveItem = function moveItem(gi, from, to) {
    var items = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(list[gi]);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_inspector_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attributes: attributes,
    setAttributes: setAttributes
  }), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("nav", {
    className: "qa-6__nav",
    "aria-label": "\u3088\u304F\u3042\u308B\u8CEA\u554F\u306E\u5206\u985E"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qa-6__nav-inner"
  }, navTitle && /*#__PURE__*/React.createElement("p", {
    className: "qa-6__nav-title"
  }, navTitle), /*#__PURE__*/React.createElement("ul", {
    className: "qa-6__nav-list"
  }, list.map(function (g, i) {
    return /*#__PURE__*/React.createElement("li", {
      className: "qa-6__nav-li",
      key: i
    }, /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: i === 0 ? 'qa-6__nav-link is-active' : 'qa-6__nav-link',
      "data-qa6-nav": String(i)
    }, /*#__PURE__*/React.createElement("span", {
      className: "qa-6__nav-text"
    }, g.label), showCount && /*#__PURE__*/React.createElement("span", {
      className: "qa-6__nav-count"
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(g).length)));
  })))), /*#__PURE__*/React.createElement("div", {
    className: "qa-6__main"
  }, list.map(function (g, i) {
    return /*#__PURE__*/React.createElement("section", {
      className: "qa-6__group",
      key: i,
      "data-qa6-group": String(i)
    }, /*#__PURE__*/React.createElement("div", {
      className: "qa-6__group-tools"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
      label: "\u5206\u985E ".concat(i + 1, " \u306E\u540D\u524D"),
      value: g.label || '',
      onChange: function onChange(v) {
        return updateGroupLabel(i, v);
      },
      __nextHasNoMarginBottom: true
    }), /*#__PURE__*/React.createElement("div", {
      className: "qa-6__group-buttons"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      size: "small",
      variant: "secondary",
      disabled: i === 0,
      onClick: function onClick() {
        return moveGroup(i, i - 1);
      }
    }, "\u2191"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      size: "small",
      variant: "secondary",
    ...
    }, "\u5206\u985E\u3092\u524A\u9664"))), /*#__PURE__*/React.createElement("h3", {
      className: "qa-6__group-title"
    }, g.label), (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(g).map(function (c, j) {
      return /*#__PURE__*/React.createElement("dl", {
        className: "qa-6__item",
        key: j
      }, /*#__PURE__*/React.createElement("dt", null, /*#__PURE__*/React.createElement("span", {
        className: "qa-6__mark qa-6__mark--q",
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.labelText)('Q', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
        tagName: "p",
        className: "qa-6__q",
        value: c.text_q,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(textFont),
        onChange: function onChange(v) {
          return updateItem(i, j, 'text_q', v);
        },
        placeholder: "\u8CEA\u554F\u3092\u5165\u529B..."
      })), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("span", {
        className: "qa-6__mark qa-6__mark--a",
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.labelText)('A', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
        tagName: "p",
        className: "qa-6__a",
        value: c.text_a,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(textFont),
        onChange: function onChange(v) {
          return updateItem(i, j, 'text_a', v);
        },
        placeholder: "\u56DE\u7B54\u3092\u5165\u529B..."
      })), /*#__PURE__*/React.createElement("div", {
        className: "qa-6__tools"
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
        size: "small",
        variant: "secondary",
        disabled: j === 0,
        onClick: function onClick() {
          return moveItem(i, j, j - 1);
        }
      }, "\u2191"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
        size: "small",
        variant: "secondary",
        disabled: j === (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.safeItems)(g).length - 1,
        onClick: function onClick() {
          return moveItem(i, j, j + 1);
        }
      }, "\u2193"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    ...
    className: "qa-6__add qa-6__add--group"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    variant: "primary",
    onClick: addGroup
  }, "\uFF0B \u5206\u985E\u3092\u8FFD\u52A0\u3059\u308B")))));
...
/* harmony export */   fontAttr: () => (/* binding */ fontAttr),
/* harmony export */   labelText: () => (/* binding */ labelText),
/* harmony export */   rootClass: () => (/* binding */ rootClass),
/* harmony export */   safeGroups: () => (/* binding */ safeGroups),
/* harmony export */   safeItems: () => (/* binding */ safeItems),
/* harmony export */   weightStyle: () => (/* binding */ weightStyle)
/* harmony export */ });
/**
...
function blockStyle(a) {
  return {
    '--qa6-max-w': a.maxWidth === 0 ? '100%' : "".concat(a.maxWidth, "px"),
    '--qa6-nav-w': "".concat(a.navWidth, "px"),
    '--qa6-sticky-top': "".concat(a.stickyTop, "px"),
    '--qa6-gap': "".concat(a.itemGap, "px"),
    '--qa6-label-w': "".concat(a.labelWidth, "px"),
    '--qa6-main': a.mainColor,
    '--qa6-nav-bg': a.navBg,
    '--qa6-q-color': a.qLabelColor,
    '--qa6-a-color': a.aLabelColor,
    '--qa6-line': a.lineColor,
    '--qa6-title-size-pc': "".concat(a.groupTitleSizePc, "px"),
    '--qa6-title-size-sp': "".concat(a.groupTitleSizeSp, "px"),
    '--qa6-label-size-pc': "".concat(a.labelFontSizePc, "px"),
    '--qa6-label-size-sp': "".concat(a.labelFontSizeSp, "px"),
    '--qa6-q-size-pc': "".concat(a.qFontSizePc, "px"),
    '--qa6-q-size-sp': "".concat(a.qFontSizeSp, "px"),
    '--qa6-a-size-pc': "".concat(a.aFontSizePc, "px"),
    '--qa6-a-size-sp': "".concat(a.aFontSizeSp, "px")
  };
}
function rootClass(a, extra) {
  return ['lw-pr-qa-6', "qa-6--nav-".concat(a.navPosition), extra].filter(Boolean).join(' ');
}
function labelText(prefix, index, labelStyle) {
  if (labelStyle === 'number') {
    return "".concat(prefix).concat(index + 1);
  }
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-qa-6/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-qa-6/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-qa-6/block.json");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit.js */ "./src/lw-pr-qa-6/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save.js */ "./src/lw-pr-qa-6/save.js");
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants.js */ "./src/lw-pr-qa-6/constants.js");
/**
...
var fontOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.fontOptionsArr)();
var fontWeightOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.fontWeightOptionsArr)();
function Inspector(_ref) {
  var attributes = _ref.attributes,
    setAttributes = _ref.setAttributes;
  var maxWidth = attributes.maxWidth,
    navWidth = attributes.navWidth,
    navPosition = attributes.navPosition,
    stickyTop = attributes.stickyTop,
    showCount = attributes.showCount,
    navTitle = attributes.navTitle,
    mainColor = attributes.mainColor,
    navBg = attributes.navBg,
    lineColor = attributes.lineColor,
    itemGap = attributes.itemGap,
    labelStyle = attributes.labelStyle,
    labelWidth = attributes.labelWidth,
    qLabelColor = attributes.qLabelColor,
    aLabelColor = attributes.aLabelColor,
    groupTitleSizePc = attributes.groupTitleSizePc,
    groupTitleSizeSp = attributes.groupTitleSizeSp,
    labelFont = attributes.labelFont,
    labelFontWeight = attributes.labelFontWeight,
    labelFontSizePc = attributes.labelFontSizePc,
    labelFontSizeSp = attributes.labelFontSizeSp,
    textFont = attributes.textFont,
    qFontSizePc = attributes.qFontSizePc,
    qFontSizeSp = attributes.qFontSizeSp,
    aFontSizePc = attributes.aFontSizePc,
    aFontSizeSp = attributes.aFontSizeSp,
    schemaOutput = attributes.schemaOutput;
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    label: "\u7F6E\u304F\u5834\u6240",
    value: navPosition,
    options: _constants_js__WEBPACK_IMPORTED_MODULE_3__.navPositionOptions,
    onChange: function onChange(v) {
      return setAttributes({
        navPosition: v
      });
  ...
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalHeading, {
    level: 4,
    style: {
      margin: '16px 0 8px'
    }
  }, "\u4E00\u89A7\u306E\u5730\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: navBg,
  ...
  }, "\u3044\u307E\u8AAD\u3093\u3067\u3044\u308B\u5206\u985E\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: mainColor,
    onChange: function onChange(c) {
      return setAttributes({
        mainColor: c || 'var(--color-main)'
      });
    }
  ...
  }, "\u533A\u5207\u308A\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: lineColor,
    onChange: function onChange(c) {
      return setAttributes({
        lineColor: c || '#e0e0e0'
    ...
    label: "\u30E9\u30D9\u30EB\u306E\u5F62\u5F0F",
    value: labelStyle,
    options: _constants_js__WEBPACK_IMPORTED_MODULE_3__.labelStyleOptions,
    onChange: function onChange(v) {
      return setAttributes({
        labelStyle: v
      });
  ...
  }, "Q \u30E9\u30D9\u30EB\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: qLabelColor,
    onChange: function onChange(c) {
      return setAttributes({
        qLabelColor: c || 'var(--color-main)'
      });
    }
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalHeading, {
    level: 4,
  ...
  }, "A \u30E9\u30D9\u30EB\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: aLabelColor,
    onChange: function onChange(c) {
      return setAttributes({
        aLabelColor: c || 'var(--color-accent)'
      });
    }
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-6/helpers.js");
/**
 * lw-pr-qa-6 — 保存HTML
...
function Save(_ref) {
  ...
  var showCount = attributes.showCount,
    ...
    textFont = attributes.textFont,
    groups = attributes.groups;
  var list = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.safeGroups)(groups);
  var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps.save({
    className: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.rootClass)(attributes),
    style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.blockStyle)(attributes)
  });
  return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("nav", {
    className: "qa-6__nav",
    "aria-label": "\u3088\u304F\u3042\u308B\u8CEA\u554F\u306E\u5206\u985E"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qa-6__nav-inner"
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      className: "qa-6__nav-count"
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.safeItems)(g).length)));
  })))), /*#__PURE__*/React.createElement("div", {
    className: "qa-6__main"
  }, list.map(function (g, i) {
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: "qa-6__group-title"
    }, g.label), (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.safeItems)(g).map(function (c, j) {
      return /*#__PURE__*/React.createElement("dl", {
        className: "qa-6__item",
        key: j
      }, /*#__PURE__*/React.createElement("dt", null, /*#__PURE__*/React.createElement("span", {
        className: "qa-6__mark qa-6__mark--q",
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.labelText)('Q', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
        tagName: "p",
        className: "qa-6__q",
        value: c.text_q,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(textFont)
      })), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("span", {
        className: "qa-6__mark qa-6__mark--a",
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.labelText)('A', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
        tagName: "p",
        className: "qa-6__a",
        value: c.text_a,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(textFont)
...
/***/ "./src/lw-pr-qa-6/block.json":
/*!***********************************!*\
  !*** ./src/lw-pr-qa-6/block.json ***!
  \***********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-qa-6","version":"1.0.0","title":"よくある質問 06（左に分類・2カラム）","category":"lw-faq","icon":"align-pull-left","description":"左に分類の一覧がスクロールしてもついてくる2カラムのよくある質問。質問は右に全部並びます。いま何の分類を読んでいるかが常に分かります。","aiHint":{"description":"よくある質問（2カラム・左に分類が追従）。左の分類一覧がスクロールに追従し、いま読んでいる分類が光る。右に質問が分類ごとに全部並ぶ。分類が5個以上ある大きめのFAQに向く","excludeFromAutoSelect":false,"contentAttributes":["groups"],"imageAttributes":[],"notes":"groups は [{ label, items:[{ text_q, text_a }] }] の入れ子配列（lw-pr-qa-4 と同じ形なので入れ替えやすい）。⚠️ 分類は4〜8個。3個以下なら2カラムにする意味が薄く lw-pr-qa-4（タブ）で足りる。🚨 左の一覧は JS が動いたときだけ出る（view.js が .is-js を付ける）。JS 無しでは分類の見出しつき1カラムになるだけで壊れない。🚨 見出し（h3）に id を書かない作りにしてある。同じテンプレを2ページに貼っても id が重複しないよう、飛び先は data-qa6-group の番号で JS が探している。⚠️ 追従は position:sticky。**このブロックを overflow:hidden の中に入れると効かなくなる**（lw-bg-1 の帯の中は大丈夫だが、独自CSSで囲うときは注意）。⚠️ 飛んだときの止まる位置は、固定ヘッダーの高さを view.js が測って避けている。stickyTop はそれとは別で、左の一覧が画面上端から何px下で止まるかの設定。"},"supports":{"anchor":true,"className":true},"attributes":{"maxWidth":{"type":"number","default":1100},"navWidth":{"type":"number","default":240},"navPosition":{"type":"string","default":"left"},"stickyTop":{"type":"number","default":100},"showCount":{"type":"boolean","default":true},"navTitle":{"type":"string","default":""},"mainColor":{"type":"string","default":"var(--color-main)"},"navBg":{"type":"string","default":"#f7f7f7"},"lineColor":{"type":"string","default":"#e0e0e0"},"itemGap":{"type":"number","default":22},"labelStyle":{"type":"string","default":"plain"},"labelWidth":{"type":"number","default":34},"qLabelColor":{"type":"string","default":"var(--color-main)"},"aLabelColor":{"type":"string","default":"var(--color-accent)"},"groupTitleSizePc":{"type":"number","default":20},"groupTitleSizeSp":{"type":"number","default":17},"labelFont":{"type":"string","default":"Roboto"},"labelFontWeight":{"type":"string","default":""},"labelFontSizePc":{"type":"number","default":18},"labelFontSizeSp":{"type":"number","default":16},"textFont":{"type":"string","default":""},"qFontSizePc":{"type":"number","default":17},"qFontSizeSp":{"type":"number","default":15},"aFontSizePc":{"type":"number","default":15},"aFontSizeSp":{"type":"number","default":14},"schemaOutput":{"type":"boolean","default":true},"groups":{"type":"array","default":[{"label":"はじめての方","items":[{"text_q":"予約は必要ですか？","text_a":"ご予約なしでもお受けしています。土曜は埋まりやすいので、お電話いただけると確実です。"},{"text_q":"はじめてでも大丈夫ですか？","text_a":"はじめての方が半分以上です。当日は10分ほどお話をうかがってから始めます。"}]},{"label":"料金・お支払い","items":[{"text_q":"追加料金はかかりますか？","text_a":"表示している金額のほかにいただくものはありません。"},{"text_q":"カードは使えますか？","text_a":"現金のほか、各種クレジットカードと電子マネーがお使いいただけます。"}]},{"label":"ご予約・変更","items":[{"text_q":"当日でも変更できますか？","text_a":"前日までにご連絡いただければ、料金はかかりません。"}]},{"label":"アクセス","items":[{"text_q":"駐車場はありますか？","text_a":"建物の裏に3台ぶんございます。満車のときは近くのコインパーキングをご案内します。"}]}]}},"editorScript":"file:./lw-pr-qa-6.js","viewScript":"file:./view.js","no":6}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-qa-6"], () => (__webpack_require__("./src/lw-pr-qa-6/index.js")))
