...
var btnIconOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.leftButtonIconSvgArr)();
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var MaxWidth = attributes.MaxWidth,
      BtnGap = attributes.BtnGap,
      BtnClm = attributes.BtnClm,
      BtnClmSp = attributes.BtnClmSp,
      backgroundImage = attributes.backgroundImage,
      bgGradient = attributes.bgGradient,
      filterOpacity = attributes.filterOpacity,
      fontLi = attributes.fontLi,
      ListBorderRadius = attributes.ListBorderRadius,
      fontWeightLi = attributes.fontWeightLi,
      titleText = attributes.titleText,
      titleBottomText = attributes.titleBottomText,
      hideTitle = attributes.hideTitle,
      contents = attributes.contents,
      colorLiSvg = attributes.colorLiSvg,
      colorLiBg = attributes.colorLiBg,
      colorLiText = attributes.colorLiText,
      colorLiBorder = attributes.colorLiBorder,
      ListBorderSize = attributes.ListBorderSize,
      backgroundSwitch = attributes.backgroundSwitch,
      colorLiBgOpacity = attributes.colorLiBgOpacity;
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-link-list-1 ".concat(backgroundSwitch ? 'bg_visible' : 'bg_hidden'),
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }), backgroundImage && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isDestructive: true,
      onClick: removeBackgroundImage,
      style: {
        marginBottom: '10px'
      }
    }, "\u80CC\u666F\u753B\u50CF\u3092\u524A\u9664"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u8272",
      value: bgGradient,
      options: bgOptions,
      onChange: function onChange(v) {
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: colorLiSvg,
      onChange: function onChange(c) {
        return setAttributes({
          colorLiSvg: c
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u5916\u67A0\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: colorLiBorder,
      onChange: function onChange(c) {
        return setAttributes({
          colorLiBorder: c
      ...
      max: 100,
      step: 1
    }))), /*#__PURE__*/React.createElement("div", blockProps, !hideTitle && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: "h2",
      ...
      className: "lw-link-list-1__inner clm_".concat(BtnClm, " clm_sp_").concat(BtnClmSp),
      style: {
        maxWidth: MaxWidth,
        gap: "".concat(BtnGap, "px")
      }
    }, contents.map(function (content, idx) {
      return /*#__PURE__*/React.createElement("li", {
        className: "lw-link-list-1__li",
        key: idx
      }, /*#__PURE__*/React.createElement("a", {
        className: "lw-link-list-1__link",
        style: {
          borderRadius: "".concat(ListBorderRadius, "px"),
          border: "".concat(ListBorderSize, "px solid ").concat(colorLiBorder)
        }
      }, /*#__PURE__*/React.createElement("div", {
        className: "btn_bg_color",
        style: {
          backgroundColor: colorLiBg,
          opacity: "".concat(colorLiBgOpacity, "%")
        }
      }), /*#__PURE__*/React.createElement("div", {
        ...
        className: "lw-link-list-1__text"
      }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "p",
        value: content.text,
        onChange: function onChange(v) {
          return updateContent(idx, 'text', v);
        },
        placeholder: "\u30C6\u30AD\u30B9\u30C8\u3092\u5165\u529B",
        ...
        className: "lw-link-list-1__item-controls"
        ...
        onClick: function onClick() {
          return removeContent(idx);
        },
        "aria-label": "\u524A\u9664"
      }, "\u524A\u9664")), /*#__PURE__*/React.createElement("label", null, "\u30EA\u30F3\u30AF"), /*#__PURE__*/React.createElement("input", {
        type: "text",
        value: content.link,
        onChange: function onChange(e) {
          return updateContent(idx, 'link', e.target.value);
        },
        placeholder: "\u30EA\u30F3\u30AF\u3092\u5165\u529B"
      }), /*#__PURE__*/React.createElement(_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.LinkPicker, {
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromItem)(content, 'link'),
        onChange: function onChange(patch) {
          return updateContentMulti(idx, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToItem)(patch, 'link'));
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        label: "\u30A2\u30A4\u30B3\u30F3\u306E\u9078\u629E",
        value: content.icon,
        ...
        onChange: function onChange(v) {
          return updateContent(idx, 'icon', v);
        }
      }));
    })), /*#__PURE__*/React.createElement("button", {
      className: "lw-link-list-1__add_btn",
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B"), /*#__PURE__*/React.createElement("div", {
      className: "lw-link-list-1__filter",
      style: {
  ...
  save: function save(_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, !hideTitle && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "h2",
      className: "lw-link-list-1__title",
      value: titleText
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        href: content.link,
        "data-lw-link-type": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(content, 'link').linkType,
        "data-lw-link-id": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(content, 'link').linkId,
        className: "lw-link-list-1__link",
        style: {
          borderRadius: "".concat(ListBorderRadius, "px"),
          border: "".concat(ListBorderSize, "px solid ").concat(colorLiBorder)
...
/***/ "./src/lw-link-list-1/editor.scss":
/*!****************************************!*\
  !*** ./src/lw-link-list-1/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-link-list-1"], () => (__webpack_require__("./src/lw-link-list-1/index.js")))
