...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-list-7/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-list-7/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-list-7/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  /* ────────────────────  エディタ側  ──────────────────── */edit: function edit(_ref) {
    ...
    var fontLi = attributes.fontLi,
      ...
      innerRowGapPc = attributes.innerRowGapPc,
      innerColumnGapPc = attributes.innerColumnGapPc,
      innerRowGapSp = attributes.innerRowGapSp,
      innerColumnGapSp = attributes.innerColumnGapSp,
    ...
    var gtcPc = columnWidths.map(function (w) {
      return "".concat(w, "fr");
    }).join(' ');
    var gtcSp = columnWidthsSp.length > 0 ? columnWidthsSp.map(function (w) {
      return "".concat(w, "fr");
    }).join(' ') : gtcPc;
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      ...
      style: {
        '--list-7-gtc-pc': gtcPc,
        '--list-7-gtc-sp': gtcSp,
        '--list-7-inner-row-gap-pc': "".concat(innerRowGapPc, "px"),
        '--list-7-inner-column-gap-pc': "".concat(innerColumnGapPc, "px"),
        '--list-7-inner-row-gap-sp': "".concat(innerRowGapSp >= 0 ? innerRowGapSp : innerRowGapPc, "px"),
        '--list-7-inner-column-gap-sp': "".concat(innerColumnGapSp >= 0 ? innerColumnGapSp : innerColumnGapPc, "px"),
        '--list-7-row-gap-pc': "".concat(rowGapPc, "px"),
        '--list-7-column-gap-pc': "".concat(columnGapPc, "px"),
        '--list-7-row-gap-sp': "".concat(rowGapSp >= 0 ? rowGapSp : rowGapPc, "px"),
        '--list-7-column-gap-sp': "".concat(columnGapSp >= 0 ? columnGapSp : columnGapPc, "px"),
        '--list-7-font-size-pc': "".concat(fontSizePc, "px"),
        '--list-7-font-size-sp': "".concat(fontSizeSp >= 0 ? fontSizeSp : fontSizePc, "px")
      }
    });

    /* グループ操作 */
    var addGroup = function addGroup() {
      var newGroups = [].concat(_toConsumableArray(listGroups), [{
        contents: [{
          text: '新しいテキスト'
        }]
      }]);
    ...
    var removeGroup = function removeGroup(groupIndex) {
      if (listGroups.length <= 1) return;
      var newGroups = listGroups.filter(function (_, idx) {
    ...
    /* カラム数変更 (PC) */
    var changeColumnCount = function changeColumnCount(newCount) {
      var currentCount = columnWidths.length;
      var newWidths;
      if (newCount > currentCount) {
        newWidths = [].concat(_toConsumableArray(columnWidths), _toConsumableArray(Array(newCount - currentCount).fill(1)));
      } else {
    ...
    /* カラム数変更 (SP) */
    var changeColumnCountSp = function changeColumnCountSp(newCount) {
      if (newCount === 0) {
        // 0 = PCを継承
        setAttributes({
          columnWidthsSp: []
      ...
      var currentCount = columnWidthsSp.length || columnWidths.length;
      var newWidths;
      if (columnWidthsSp.length === 0) {
        // PCから初期値をコピー
        newWidths = columnWidths.slice(0, newCount);
        if (newCount > columnWidths.length) {
          newWidths = [].concat(_toConsumableArray(newWidths), _toConsumableArray(Array(newCount - columnWidths.length).fill(1)));
        }
      } else if (newCount > currentCount) {
        newWidths = [].concat(_toConsumableArray(columnWidthsSp), _toConsumableArray(Array(newCount - currentCount).fill(1)));
      } else {
    ...
    /* 行操作（グループ内） */
    var addContent = function addContent(groupIndex) {
      var newGroups = _toConsumableArray(listGroups);
      newGroups[groupIndex] = _objectSpread(_objectSpread({}, newGroups[groupIndex]), {}, {
        contents: [].concat(_toConsumableArray(newGroups[groupIndex].contents), [{
          text: '新しいテキスト'
        }])
      });
      setAttributes({
    ...
    var removeContent = function removeContent(groupIndex, itemIndex) {
      var newGroups = _toConsumableArray(listGroups);
      newGroups[groupIndex] = _objectSpread(_objectSpread({}, newGroups[groupIndex]), {}, {
        contents: newGroups[groupIndex].contents.filter(function (_, idx) {
    ...
    var updateContent = function updateContent(groupIndex, itemIndex, key, val) {
      var newGroups = _toConsumableArray(listGroups);
      var newContents = _toConsumableArray(newGroups[groupIndex].contents);
      newContents[itemIndex] = _objectSpread(_objectSpread({}, newContents[itemIndex]), {}, _defineProperty({}, key, val));
      newGroups[groupIndex] = _objectSpread(_objectSpread({}, newGroups[groupIndex]), {}, {
    ...
    /* 順番入れ替え関数（グループ内） */
    var moveItem = function moveItem(groupIndex, itemIndex, direction) {
      var contents = listGroups[groupIndex].contents;
      var targetIndex = itemIndex + direction;
      if (targetIndex < 0 || targetIndex >= contents.length) return;
      var newGroups = _toConsumableArray(listGroups);
      var reordered = _toConsumableArray(contents);
      var _reordered$splice = reordered.splice(itemIndex, 1),
    ...
    var iconSpanStyle = {
      width: "".concat(iconSize, "em")
    };
    var textSpanStyle = {
      width: "calc(100% - ".concat(iconSize, "em)")
    };
    var textStyle = {
    ...
    var SvgIcon = /*#__PURE__*/React.createElement("svg", {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "PC\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E0\u6570",
      ...
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        key: "pc-".concat(index),
        label: "".concat(index + 1, "\u5217\u76EE\u306E\u5E45 (fr)"),
        value: width,
        onChange: function onChange(v) {
          var newWidths = _toConsumableArray(columnWidths);
          newWidths[index] = v;
          setAttributes({
            columnWidths: newWidths
          });
    ...
    }, "SP\u8A2D\u5B9A (0\u3067PC\u7D99\u627F)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E0\u6570",
      ...
      max: 6,
      step: 1
    }), columnWidthsSp.length > 0 && columnWidthsSp.map(function (width, index) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        key: "sp-".concat(index),
        label: "".concat(index + 1, "\u5217\u76EE\u306E\u5E45 (fr)"),
        value: width,
        onChange: function onChange(v) {
          var newWidths = _toConsumableArray(columnWidthsSp);
          newWidths[index] = v;
          setAttributes({
            columnWidthsSp: newWidths
          });
    ...
    }, "\u9593\u9694 PC"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u884C\u9593\u9694 (px)",
      value: rowGapPc,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }, "\u9593\u9694 SP (-1\u3067PC\u7D99\u627F)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u884C\u9593\u9694 (px)",
      value: rowGapSp,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      render: function render(_ref2) {
        var open = _ref2.open;
        return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          className: "components-button is-primary",
          onClick: open
        }, iconUrl ? 'アイコンを変更' : 'アイコンをアップロード'), iconUrl && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          isLink: true,
          isDestructive: true,
    ...
    }), iconUrl && /*#__PURE__*/React.createElement("p", {
      style: {
        marginTop: '12px'
      }
      ...
      max: 5,
      step: 0.1
    }), !iconUrl && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      style: {
        marginBottom: "8px"
      }
    }, "\u30A2\u30A4\u30B3\u30F3\u8272 (SVG\u7528)"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: colorLiSvg,
      onChange: function onChange(c) {
        return setAttributes({
          colorLiSvg: c
    ...
    }, "\u6587\u5B57\u30B5\u30A4\u30BA"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC (px)",
      value: fontSizePc,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      className: "custom_inner"
    }, listGroups.map(function (group, groupIndex) {
      return /*#__PURE__*/React.createElement("div", {
        className: "lw-pr-list-7__group",
        key: groupIndex
      }, /*#__PURE__*/React.createElement("ul", {
        className: "lw-pr-list-7__inner ".concat(colClass),
        style: innerStyle
      }, group.contents.map(function (content, itemIndex) {
        return /*#__PURE__*/React.createElement("li", {
          className: "lw-pr-list-7__li",
          key: itemIndex,
          style: {
            position: 'relative'
          }
          ...
          className: "lw-pr-list-7__text"
        }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
          tagName: "p",
          value: content.text,
          "data-lw_font_set": fontLi,
          onChange: function onChange(v) {
            return updateContent(groupIndex, itemIndex, 'text', v);
          },
          placeholder: "\u30C6\u30AD\u30B9\u30C8\u3092\u5165\u529B",
          style: _objectSpread(_objectSpread({}, textStyle), textSpanStyle)
        })), /*#__PURE__*/React.createElement("div", {
          className: "lw-table-item-controls"
        }, /*#__PURE__*/React.createElement("button", {
          type: "button",
          onClick: function onClick() {
            return moveItem(groupIndex, itemIndex, -1);
          },
          ...
          onClick: function onClick() {
            return removeContent(groupIndex, itemIndex);
          },
          "aria-label": "\u524A\u9664"
        }, "\u524A\u9664")));
      })), /*#__PURE__*/React.createElement("div", {
        className: "lw-pr-list-7__group-controls"
      }, /*#__PURE__*/React.createElement("button", {
        className: "lw-pr-list-7__add_btn",
        onClick: function onClick() {
          return addContent(groupIndex);
        }
      }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0"), listGroups.length > 1 && /*#__PURE__*/React.createElement("button", {
        className: "lw-pr-list-7__remove_group_btn",
        onClick: function onClick() {
          return removeGroup(groupIndex);
        }
      }, "\u30B0\u30EB\u30FC\u30D7\u524A\u9664")));
    })), /*#__PURE__*/React.createElement("button", {
      className: "lw-pr-list-7__add_group_btn",
      onClick: addGroup
    }, "\u30B0\u30EB\u30FC\u30D7\u3092\u8FFD\u52A0\u3059\u308B")));
  },
  /* ────────────────────  保存  ──────────────────── */save: function save(_ref3) {
    ...
    var SvgIconSave = /*#__PURE__*/React.createElement("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 448 512",
      style: {
        fill: colorLiSvg
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("ul", {
        ...
        return /*#__PURE__*/React.createElement("li", {
          ...
          src: iconUrl
        }) : SvgIconSave), /*#__PURE__*/React.createElement("span", {
          className: "lw-pr-list-7__text"
...
/***/ "./src/lw-pr-list-7/block.json":
/*!*************************************!*\
  !*** ./src/lw-pr-list-7/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-list-7","version":"1.0.0","title":"PR list 07","category":"lw-list","icon":"lightbulb","description":"カスタマイズ可能なリストブロック","aiDescription":"高機能なチェックリスト。枠線、背景、カラム数、アイコンなど細かくカスタマイズ可能。特徴一覧や対応サービスの列挙に最適。","aiNotes":"このブロックは最も柔軟なリスト。colClassで1列/2列切替、iconUrlでカスタムアイコン設定可能。noBorderで枠線なしに。","aiHint":{"description":"高機能チェックリスト。カラム分割+グループ化対応。カスタムアイコン可。特徴一覧・対応サービス列挙に","excludeFromAutoSelect":false,"contentAttributes":["listGroups"],"imageAttributes":["iconUrl"]},"supports":{"anchor":true},"attributes":{"fontLi":{"type":"string","default":"","ai_description":"リストテキストのフォント"},"fontWeightLi":{"type":"string","default":"","ai_description":"リストテキストのフォントウェイト"},"fontSizePc":{"type":"number","default":16,"ai_description":"テキストサイズPC（px）"},"fontSizeSp":{"type":"number","default":-1,"ai_description":"テキストサイズSP（px）。-1でPCを継承"},"textColor":{"type":"string","default":"","ai_description":"テキスト色"},"colorLiSvg":{"type":"string","default":"var(--color-main)","ai_description":"チェックマーク色。var(--color-main)推奨"},"iconUrl":{"type":"string","default":"","ai_description":"カスタムアイコン画像URL。空でデフォルトチェックマーク"},"iconSize":{"type":"number","default":1.2,"ai_description":"アイコンサイズ（em）。0.8～2.0"},"bgColor":{"type":"string","default":"#fff","ai_description":"背景色"},"colClass":{"type":"string","default":"clm_1","ai_description":"カラム数クラス。\'clm_1\'（1列）/\'clm_2\'（2列）"},"columnWidths":{"type":"array","default":[1,2],"ai_description":"各カラムの幅比率（fr単位の配列）。例: [1,2]で1:2の比率"},"columnWidthsSp":{"type":"array","default":[],"ai_description":"SP時の各カラムの幅比率。空でPCを継承"},"innerRowGapPc":{"type":"number","default":20,"ai_description":"カラム間の行間隔PC（px）"},"innerColumnGapPc":{"type":"number","default":20,"ai_description":"カラム間の列間隔PC（px）"},"innerRowGapSp":{"type":"number","default":-1,"ai_description":"カラム間の行間隔SP（px）。-1でPCを継承"},"innerColumnGapSp":{"type":"number","default":-1,"ai_description":"カラム間の列間隔SP（px）。-1でPCを継承"},"rowGapPc":{"type":"number","default":20,"ai_description":"リスト内の行間隔PC（px）"},"columnGapPc":{"type":"number","default":20,"ai_description":"リスト内の列間隔PC（px）"},"rowGapSp":{"type":"number","default":-1,"ai_description":"リスト内の行間隔SP（px）。-1でPCを継承"},"columnGapSp":{"type":"number","default":-1,"ai_description":"リスト内の列間隔SP（px）。-1でPCを継承"},"listGroups":{"type":"array","default":[{"contents":[{"text":"リストテキスト1"},{"text":"リストテキスト2"},{"text":"リストテキスト3"}]},{"contents":[{"text":"リストテキスト1"},{"text":"リストテキスト2"},{"text":"リストテキスト3"}]}],"ai_description":"リストグループ配列。各グループがcontents配列を持つ"}},"editorScript":"file:./lw-pr-list-7.js","no":7}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-list-7"], () => (__webpack_require__("./src/lw-pr-list-7/index.js")))
