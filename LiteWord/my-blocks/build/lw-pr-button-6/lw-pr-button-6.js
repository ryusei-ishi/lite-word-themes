...
/***/ "./src/lw-pr-button-6/block.json":
/*!***************************************!*\
  !*** ./src/lw-pr-button-6/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-button-6","version":"1.0.0","title":"ボタン 06","category":"lw-button","icon":"button","description":"グリッドレイアウトのボタンブロック。複数ボタンを配置可能。","aiHint":{"description":"グリッドレイアウト複数ボタン。2〜4個のボタンを格子状に配置。ナビゲーション・サービス一覧のリンクに","excludeFromAutoSelect":false,"contentAttributes":["button6Buttons"],"imageAttributes":[],"notes":"✅ **`url` が空でも `href=\\"#\\"` に落ちる**（`lw-button-03` と違って安全）。🚨 **枠線 `button6BorderColor` と矢印 `button6ArrowColor` の既定が `var(--color-main)`。**背景は白・文字は黒なので読めなくなりはしないが、明るいサイト色だと**枠線が消えてボタンに見えない**。`color-mix(in srgb, var(--color-main) 50%, #000)` にする。`button6Buttons` は `[{text, linkType, url, isBlank}]`（`textMain` ではない）。3つ以上並べるなら `button6ColumnsPc` を明示する（既定は2）。スマホは1列のままにするのが読みやすい。矢印を出すなら `button6ShowArrow: true`。"},"supports":{"anchor":true,"className":true},"attributes":{"button6Buttons":{"type":"array","default":[{"text":"リンクテキスト","url":"","isBlank":false},{"text":"リンクテキスト","url":"","isBlank":false}],"aiHint":{"role":"list","contentGuide":"ボタン配列。各要素に text(4〜15文字) と url を設定。2〜4個","example":[{"text":"サービス紹介","url":"/service/"},{"text":"料金プラン","url":"/pricing/"}]}},"button6MaxWidthPc":{"type":"number","default":600},"button6MaxWidthSp":{"type":"number","default":-1},"button6ColumnsPc":{"type":"number","default":2},"button6ColumnsSp":{"type":"number","default":1},"button6RowGapPc":{"type":"number","default":16},"button6RowGapSp":{"type":"number","default":-1},"button6ColumnGapPc":{"type":"number","default":24},"button6ColumnGapSp":{"type":"number","default":8},"button6PaddingTopPc":{"type":"number","default":12},"button6PaddingRightPc":{"type":"number","default":12},"button6PaddingBottomPc":{"type":"number","default":12},"button6PaddingLeftPc":{"type":"number","default":12},"button6PaddingTopSp":{"type":"number","default":-1},"button6PaddingRightSp":{"type":"number","default":-1},"button6PaddingBottomSp":{"type":"number","default":-1},"button6PaddingLeftSp":{"type":"number","default":-1},"button6MinHeightPc":{"type":"number","default":64},"button6MinHeightSp":{"type":"number","default":56},"button6PositionPc":{"type":"string","default":"center"},"button6PositionSp":{"type":"string","default":""},"button6FontSizePc":{"type":"number","default":16},"button6FontSizeSp":{"type":"number","default":15},"button6BorderWidthPc":{"type":"number","default":2},"button6BorderWidthSp":{"type":"number","default":1},"button6BorderStyle":{"type":"string","default":"solid"},"button6BorderColor":{"type":"string","default":"var(--color-main)"},"button6TextColor":{"type":"string","default":"#000000"},"button6BorderRadiusPc":{"type":"number","default":10},"button6BorderRadiusSp":{"type":"number","default":-1},"button6BgColor":{"type":"string","default":"#ffffff"},"button6FontSet":{"type":"string","default":""},"button6FontWeight":{"type":"string","default":""},"button6ShowArrow":{"type":"boolean","default":false},"button6TextAlign":{"type":"string","default":"center"},"button6ArrowColor":{"type":"string","default":"var(--color-main)"}},"editorScript":"file:./lw-pr-button-6.js","no":6}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-button-6/block.json");
...
/* harmony import */ var _affiliate_link_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../affiliate-link.js */ "./src/affiliate-link.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  edit: function edit(_ref) {
    ...
    var button6Buttons = attributes.button6Buttons,
      button6MaxWidthPc = attributes.button6MaxWidthPc,
      button6MaxWidthSp = attributes.button6MaxWidthSp,
      button6ColumnsPc = attributes.button6ColumnsPc,
      button6ColumnsSp = attributes.button6ColumnsSp,
      button6RowGapPc = attributes.button6RowGapPc,
      button6RowGapSp = attributes.button6RowGapSp,
      button6ColumnGapPc = attributes.button6ColumnGapPc,
      button6ColumnGapSp = attributes.button6ColumnGapSp,
      button6PaddingTopPc = attributes.button6PaddingTopPc,
      button6PaddingRightPc = attributes.button6PaddingRightPc,
      button6PaddingBottomPc = attributes.button6PaddingBottomPc,
      button6PaddingLeftPc = attributes.button6PaddingLeftPc,
      button6PaddingTopSp = attributes.button6PaddingTopSp,
      button6PaddingRightSp = attributes.button6PaddingRightSp,
      button6PaddingBottomSp = attributes.button6PaddingBottomSp,
      button6PaddingLeftSp = attributes.button6PaddingLeftSp,
      button6MinHeightPc = attributes.button6MinHeightPc,
      button6MinHeightSp = attributes.button6MinHeightSp,
      button6PositionPc = attributes.button6PositionPc,
      button6PositionSp = attributes.button6PositionSp,
      button6FontSizePc = attributes.button6FontSizePc,
      button6FontSizeSp = attributes.button6FontSizeSp,
      button6BorderWidthPc = attributes.button6BorderWidthPc,
      button6BorderWidthSp = attributes.button6BorderWidthSp,
      button6BorderStyle = attributes.button6BorderStyle,
      button6BorderColor = attributes.button6BorderColor,
      button6TextColor = attributes.button6TextColor,
      button6BorderRadiusPc = attributes.button6BorderRadiusPc,
      button6BorderRadiusSp = attributes.button6BorderRadiusSp,
      button6BgColor = attributes.button6BgColor,
      button6FontSet = attributes.button6FontSet,
      button6FontWeight = attributes.button6FontWeight,
      button6ShowArrow = attributes.button6ShowArrow,
      button6TextAlign = attributes.button6TextAlign,
      button6ArrowColor = attributes.button6ArrowColor;
    var ARROW_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M471.1 297.4C483.6 309.9 483.6 330.2 471.1 342.7L279.1 534.7C266.6 547.2 246.3 547.2 233.8 534.7C221.3 522.2 221.3 501.9 233.8 489.4L403.2 320L233.9 150.6C221.4 138.1 221.4 117.8 233.9 105.3C246.4 92.8 266.7 92.8 279.2 105.3L471.2 297.3z"/></svg>';

    /* ボタン操作関数 */
    var updateButton = function updateButton(index, key, value) {
      var newButtons = _toConsumableArray(button6Buttons);
      newButtons[index] = _objectSpread(_objectSpread({}, newButtons[index]), {}, _defineProperty({}, key, value));
      setAttributes({
        button6Buttons: newButtons
      });
    };

    /* リンク設定のように複数の項目をまとめて更新する用 */
    var updateButtonMany = function updateButtonMany(index, patch) {
      var newButtons = _toConsumableArray(button6Buttons);
      newButtons[index] = _objectSpread(_objectSpread({}, newButtons[index]), patch);
      setAttributes({
        button6Buttons: newButtons
      });
    };
    var addButton = function addButton() {
      setAttributes({
        button6Buttons: [].concat(_toConsumableArray(button6Buttons), [{
          text: "リンクテキスト",
          linkType: "url",
          url: "",
          isBlank: false
    ...
    var removeButton = function removeButton(index) {
      var newButtons = button6Buttons.filter(function (_, i) {
        return i !== index;
      });
      setAttributes({
        button6Buttons: newButtons
    ...
    var moveButton = function moveButton(index, direction) {
      var newButtons = _toConsumableArray(button6Buttons);
      var newIndex = index + direction;
      if (newIndex < 0 || newIndex >= newButtons.length) return;
      var _ref2 = [newButtons[newIndex], newButtons[index]];
      newButtons[index] = _ref2[0];
      newButtons[newIndex] = _ref2[1];
      setAttributes({
        button6Buttons: newButtons
      });
    };
    ...
    /* padding値を生成 */
    var paddingPcVal = "".concat(button6PaddingTopPc, "px ").concat(button6PaddingRightPc, "px ").concat(button6PaddingBottomPc, "px ").concat(button6PaddingLeftPc, "px");
    var paddingSpVal = "".concat(button6PaddingTopSp >= 0 ? button6PaddingTopSp : button6PaddingTopPc, "px ").concat(button6PaddingRightSp >= 0 ? button6PaddingRightSp : button6PaddingRightPc, "px ").concat(button6PaddingBottomSp >= 0 ? button6PaddingBottomSp : button6PaddingBottomPc, "px ").concat(button6PaddingLeftSp >= 0 ? button6PaddingLeftSp : button6PaddingLeftPc, "px");
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-pr-button-6"
    });
    var wrapStyle = {
      "--button-6-max-width-pc": "".concat(button6MaxWidthPc, "px"),
      "--button-6-max-width-sp": button6MaxWidthSp >= 0 ? "".concat(button6MaxWidthSp, "px") : "".concat(button6MaxWidthPc, "px"),
      "--button-6-gtc-pc": button6ColumnsPc,
      "--button-6-gtc-sp": button6ColumnsSp,
      "--button-6-row-gap-pc": "".concat(button6RowGapPc, "px"),
      "--button-6-row-gap-sp": button6RowGapSp >= 0 ? "".concat(button6RowGapSp, "px") : "".concat(button6RowGapPc, "px"),
      "--button-6-column-gap-pc": "".concat(button6ColumnGapPc, "px"),
      "--button-6-column-gap-sp": button6ColumnGapSp >= 0 ? "".concat(button6ColumnGapSp, "px") : "".concat(button6ColumnGapPc, "px"),
      "--button-6-item-padding-pc": paddingPcVal,
      "--button-6-item-padding-sp": paddingSpVal,
      "--button-6-item-min-height-pc": "".concat(button6MinHeightPc, "px"),
      "--button-6-item-min-height-sp": "".concat(button6MinHeightSp, "px"),
      "--button-6-item-position-pc": button6PositionPc,
      "--button-6-item-position-sp": button6PositionSp || button6PositionPc,
      "--button-6-item-fontsize-pc": "".concat(button6FontSizePc, "px"),
      "--button-6-item-fontsize-sp": "".concat(button6FontSizeSp, "px"),
      "--button-6-item-bd-width-pc": "".concat(button6BorderWidthPc, "px"),
      "--button-6-item-bd-width-sp": button6BorderWidthSp >= 0 ? "".concat(button6BorderWidthSp, "px") : "".concat(button6BorderWidthPc, "px"),
      ...
      "--button-6-item-border-radius-pc": "".concat(button6BorderRadiusPc, "px"),
      "--button-6-item-border-radius-sp": button6BorderRadiusSp >= 0 ? "".concat(button6BorderRadiusSp, "px") : "".concat(button6BorderRadiusPc, "px"),
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u57FA\u672C\u8A2D\u5B9A",
      initialOpen: true
    }, button6Buttons.map(function (button, index) {
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, "\u30DC\u30BF\u30F3 ", index + 1), /*#__PURE__*/React.createElement("div", {
        style: {
          display: "flex",
          gap: "4px"
        }
        ...
        onChange: function onChange(v) {
          return updateButton(index, "isBlank", v);
        }
      }), /*#__PURE__*/React.createElement(_affiliate_link_js__WEBPACK_IMPORTED_MODULE_6__.AffiliateToggle, {
        checked: button.isAffiliate,
        onChange: function onChange(v) {
          return updateButtonMany(index, v ? {
            isAffiliate: true,
            isBlank: true
          } : {
            isAffiliate: false
    ...
    }, "+ \u30DC\u30BF\u30F3\u3092\u8FFD\u52A0")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30D5\u30A9\u30F3\u30C8\u8A2D\u5B9A",
      initialOpen: false
    ...
    }, "\u5217\u6570\uFF08\u30AB\u30E9\u30E0\u6570\uFF09"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
    ...
    }, "\u9593\u9694 (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u884C\u9593 PC",
    ...
    }, "\u4F59\u767D PC (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u4E0A",
      value: button6PaddingTopPc,
      onChange: function onChange(v) {
        return setAttributes({
          button6PaddingTopPc: v
        });
      },
      min: 0,
      max: 40,
    ...
    }, "\u6700\u5C0F\u9AD8\u3055 (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
      value: button6MinHeightPc,
      onChange: function onChange(v) {
        return setAttributes({
          button6MinHeightPc: v
        });
      },
      min: 32,
      max: 120,
    ...
    }, "\u30D5\u30A9\u30F3\u30C8\u30B5\u30A4\u30BA (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
    ...
    }, "\u30DC\u30FC\u30C0\u30FC\u5E45 (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
      value: button6BorderWidthPc,
      onChange: function onChange(v) {
        return setAttributes({
          button6BorderWidthPc: v
        });
      },
      min: 0,
      max: 10,
    ...
    }, "\u30DC\u30FC\u30C0\u30FC\u30B9\u30BF\u30A4\u30EB"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      ...
      onChange: function onChange(color) {
        return setAttributes({
          button6BorderColor: color || "#000000"
        });
      }
    }), /*#__PURE__*/React.createElement("hr", {
      style: {
    ...
    }, "\u89D2\u4E38 (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
      value: button6BorderRadiusPc,
      onChange: function onChange(v) {
        return setAttributes({
          button6BorderRadiusPc: v
        });
      },
      min: 0,
      max: 50,
    ...
    }), button6ShowArrow && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.__experimentalHeading, {
      level: 4,
      style: {
        marginTop: "12px",
        marginBottom: "8px"
      }
    }, "\u30A2\u30A4\u30B3\u30F3\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: button6ArrowColor,
      onChange: function onChange(color) {
        return setAttributes({
          button6ArrowColor: color || "var(--color-main)"
        });
      }
    })), /*#__PURE__*/React.createElement("hr", {
      style: {
    ...
    }, "\u30C6\u30AD\u30B9\u30C8\u914D\u7F6E"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      ...
      className: "lw-pr-button-6__wrap",
      style: wrapStyle
    }, button6Buttons.map(function (button, index) {
      return /*#__PURE__*/React.createElement("div", {
        key: index,
        ...
        value: button.text,
        onChange: function onChange(v) {
          return updateButton(index, "text", v);
        },
        placeholder: "\u30EA\u30F3\u30AF\u30C6\u30AD\u30B9\u30C8",
        "data-lw_font_set": button6FontSet,
        style: {
          fontWeight: button6FontWeight
        }
      }), button6ShowArrow && /*#__PURE__*/React.createElement("span", {
        className: "icon",
        style: {
          fill: button6ArrowColor
        },
  ...
  save: function save(_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      var lp = (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_5__.lwLinkProps)(button);
      return /*#__PURE__*/React.createElement("a", {
        key: index,
        href: lp.href,
        className: "lw-pr-button-6__item",
        target: button.isBlank ? "_blank" : undefined,
        rel: (0,_affiliate_link_js__WEBPACK_IMPORTED_MODULE_6__.lwRel)({
          newTab: button.isBlank,
          affiliate: button.isAffiliate
        }),
