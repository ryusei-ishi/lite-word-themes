...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-solution-2","version":"1.0.0","title":"ソリューション 02","category":"lw-content","icon":"lightbulb","aiHint":{"description":"ソリューションカード。タイトル+画像+テキストの配列。課題解決の提案に","excludeFromAutoSelect":false,"contentAttributes":["title","items"],"imageAttributes":["items.imgSrc"]},"supports":{"anchor":true},"attributes":{"blockId":{"type":"string"},"title":{"type":"string","default":"このな事が解決できます","source":"html","selector":".paid-block-solution-2_inner > .ttl"},"colorMain":{"type":"string","default":"var(--color-main)"},"items":{"type":"array","source":"query","selector":".paid-block-solution-2_inner .list li","query":{"imgSrc":{"type":"string","source":"attribute","selector":"img","attribute":"src"},"alt":{"type":"string","source":"attribute","selector":"img","attribute":"alt","default":""},"text":{"type":"string","source":"html","selector":"p"},"imageSize":{"type":"string","source":"attribute","selector":".img_wrap","attribute":"data-imagesize"}},"default":[{"imgSrc":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/icon/people_1.svg","text":"テキストテキストテキストテキストテキス","imageSize":"icon"},{"imgSrc":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/icon/en_5.svg","text":"テキストテキストテキストテキストテキスト","imageSize":"icon"},{"imgSrc":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/icon/ambulance_1.svg","text":"テキストテキストテキストテキストテキスト","imageSize":"icon"}]}},"editorScript":"file:./paid-block-solution-2.js","no":2}');
