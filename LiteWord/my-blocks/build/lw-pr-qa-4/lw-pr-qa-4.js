...
/* harmony export */   tabAlignOptions: () => (/* binding */ tabAlignOptions),
/* harmony export */   tabStyleOptions: () => (/* binding */ tabStyleOptions)
/* harmony export */ });
/**
 * lw-pr-qa-4 — 設定の選択肢
...
/* harmony import */ var _inspector_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inspector.js */ "./src/lw-pr-qa-4/inspector.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-4/helpers.js");
...
function Edit(_ref) {
  ...
  var list = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeGroups)(groups);
  ...
  var current = Math.min(active, Math.max(list.length - 1, 0));
  var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.rootClass)(attributes, 'is-js'),
    style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.blockStyle)(attributes)
  });
  ...
  var addGroup = function addGroup() {
    setGroups([].concat(_toConsumableArray(list), [{
      label: '新しい分類',
      items: [{
        text_q: '新しい質問',
        text_a: '新しい回答'
  ...
  var removeGroup = function removeGroup(i) {
    setGroups(list.filter(function (_, idx) {
      return idx !== i;
    }));
    setActive(0);
  };
  ...
  var addItem = function addItem(gi) {
    return setItems(gi, [].concat(_toConsumableArray((0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(list[gi])), [{
      text_q: '新しい質問',
      text_a: '新しい回答'
    }]));
  };
  var removeItem = function removeItem(gi, i) {
    return setItems(gi, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(list[gi]).filter(function (_, idx) {
      return idx !== i;
    }));
  };
  var updateItem = function updateItem(gi, i, key, value) {
    return setItems(gi, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(list[gi]).map(function (item, idx) {
      return idx === i ? _objectSpread(_objectSpread({}, item), {}, _defineProperty({}, key, value)) : item;
    }));
  };
  var moveItem = function moveItem(gi, from, to) {
    var items = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(list[gi]);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_inspector_js__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attributes: attributes,
    setAttributes: setAttributes
  }), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
    className: "qa-4__tabs",
    role: "tablist"
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: "qa-4__tab-label"
    }, g.label), showCount && /*#__PURE__*/React.createElement("span", {
      className: "qa-4__tab-count"
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(g).length));
  })), list[current] && /*#__PURE__*/React.createElement("div", {
    className: "qa-4__group-tools"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: "\u3053\u306E\u5206\u985E\u306E\u540D\u524D\uFF08\u30BF\u30D6\u306E\u6587\u5B57\uFF09",
    value: list[current].label || '',
    onChange: function onChange(v) {
      return updateGroupLabel(current, v);
    },
    help: "\u5168\u89D26\u5B57\u307E\u3067\u306B\u3059\u308B\u3068\u3001\u30B9\u30DE\u30DB\u3067\u3082\u30BF\u30D6\u304C\u6298\u308C\u307E\u305B\u3093",
    __nextHasNoMarginBottom: true
  }), /*#__PURE__*/React.createElement("div", {
    className: "qa-4__group-buttons"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    size: "small",
    variant: "secondary",
    disabled: current === 0,
    onClick: function onClick() {
      return moveGroup(current, current - 1);
    }
  }, "\u5206\u985E\u3092\u524D\u3078"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    size: "small",
    variant: "secondary",
  ...
  }, "\u5206\u985E\u3092\u5F8C\u308D\u3078"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    size: "small",
    variant: "secondary",
    isDestructive: true,
    disabled: list.length <= 1,
    onClick: function onClick() {
      return removeGroup(current);
    }
  }, "\u3053\u306E\u5206\u985E\u3092\u524A\u9664"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    size: "small",
    variant: "primary",
    onClick: addGroup
  }, "\uFF0B \u5206\u985E\u3092\u8FFD\u52A0"))), /*#__PURE__*/React.createElement("div", {
    className: "qa-4__panels"
  }, list.map(function (g, i) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "qa-4__panel-title"
    }, g.label), (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(g).map(function (c, j) {
      return /*#__PURE__*/React.createElement("dl", {
        className: "qa-4__item",
        key: j
      }, /*#__PURE__*/React.createElement("dt", null, /*#__PURE__*/React.createElement("span", {
        className: "qa-4__mark qa-4__mark--q",
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.labelText)('Q', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "p",
        className: "qa-4__q",
        value: c.text_q,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.fontAttr)(textFont),
        onChange: function onChange(v) {
        ...
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.fontAttr)(labelFont),
        style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.weightStyle)(labelFontWeight)
      }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.labelText)('A', j, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "p",
        className: "qa-4__a",
        value: c.text_a,
        "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.fontAttr)(textFont),
        ...
        size: "small",
        variant: "secondary",
        disabled: j === (0,_helpers_js__WEBPACK_IMPORTED_MODULE_4__.safeItems)(g).length - 1,
        onClick: function onClick() {
          return moveItem(i, j, j + 1);
        }
      }, "\u2193"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
...
function blockStyle(a) {
  return {
    '--qa4-max-w': a.maxWidth === 0 ? '100%' : "".concat(a.maxWidth, "px"),
    '--qa4-gap': "".concat(a.itemGap, "px"),
    '--qa4-label-w': "".concat(a.labelWidth, "px"),
    ...
    '--qa4-label-size-pc': "".concat(a.labelFontSizePc, "px"),
    '--qa4-label-size-sp': "".concat(a.labelFontSizeSp, "px"),
    '--qa4-q-size-pc': "".concat(a.qFontSizePc, "px"),
    '--qa4-q-size-sp': "".concat(a.qFontSizeSp, "px"),
    '--qa4-a-size-pc': "".concat(a.aFontSizePc, "px"),
    '--qa4-a-size-sp': "".concat(a.aFontSizeSp, "px")
  };
}

// ブロックに付けるクラス。タブの形と寄せを CSS 側へ渡す
function rootClass(a, extra) {
  return ['lw-pr-qa-4', "qa-4--".concat(a.tabStyle), "qa-4--align-".concat(a.tabAlign), extra].filter(Boolean).join(' ');
}
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-qa-4/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-qa-4/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-qa-4/block.json");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit.js */ "./src/lw-pr-qa-4/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save.js */ "./src/lw-pr-qa-4/save.js");
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants.js */ "./src/lw-pr-qa-4/constants.js");
/**
...
function Inspector(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    label: "\u30BF\u30D6\u306E\u5F62",
    value: tabStyle,
    options: _constants_js__WEBPACK_IMPORTED_MODULE_3__.tabStyleOptions,
    onChange: function onChange(v) {
      return setAttributes({
        tabStyle: v
      });
    ...
    label: "\u30BF\u30D6\u306E\u5BC4\u305B",
    value: tabAlign,
    options: _constants_js__WEBPACK_IMPORTED_MODULE_3__.tabAlignOptions,
    onChange: function onChange(v) {
      return setAttributes({
        tabAlign: v
      });
  ...
  }, "\u9078\u3070\u308C\u3066\u3044\u308B\u30BF\u30D6\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: mainColor,
  ...
  }, "\u9078\u3070\u308C\u3066\u3044\u308B\u30BF\u30D6\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
  ...
  }, "\u307B\u304B\u306E\u30BF\u30D6\u306E\u5730\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: tabBg,
    onChange: function onChange(c) {
      return setAttributes({
        tabBg: c || '#f0f0f0'
  ...
  }, "\u307B\u304B\u306E\u30BF\u30D6\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.ColorPalette, {
    value: tabTextColor,
    onChange: function onChange(c) {
      return setAttributes({
        tabTextColor: c || '#444444'
      });
    }
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-4/helpers.js");
/**
 * lw-pr-qa-4 — 保存HTML
...
/***/ "./src/lw-pr-qa-4/block.json":
/*!***********************************!*\
  !*** ./src/lw-pr-qa-4/block.json ***!
  \***********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-qa-4","version":"1.0.0","title":"よくある質問 04（タブで分ける）","category":"lw-faq","icon":"category","description":"上のタブで分類を切り替えるよくある質問。押した分類の質問だけが下に出ます。質問が多くてもページが長くなりません。","aiHint":{"description":"よくある質問（タブ切替）。上に分類のタブを並べ、押すとその分類の質問だけ出る。分類が3〜6個あり、合計15件以上あるFAQに向く","excludeFromAutoSelect":false,"contentAttributes":["groups"],"imageAttributes":[],"notes":"groups は [{ label, items:[{ text_q, text_a }] }] の入れ子配列。label が分類名（タブの文字）。⚠️ タブの文字は全角6字までにする。375px でタブが2行に折れると分類の切れ目が分からなくなる（横スクロールで逃がしてあるが、短いほうが読みやすい）。⚠️ 分類は3〜6個。2個ならタブにする意味が無く lw-qa-1 で足りる。7個を超えると横スクロールが長くなるので lw-pr-qa-6（左に分類が追従する2カラム）にする。🚨 JS が動かない環境では全部の分類がそのまま縦に出る（分類名は panel-title として出る）。壊れない作りなので心配しなくてよい。⚠️ showCount を true にするとタブに件数が出る。件数は save() のときに数えた固定値ではなく items.length なので、質問を足せば自動で変わる。"},"supports":{"anchor":true,"className":true},"attributes":{"maxWidth":{"type":"number","default":0},"tabStyle":{"type":"string","default":"pill"},"tabAlign":{"type":"string","default":"center"},"showCount":{"type":"boolean","default":true},"mainColor":{"type":"string","default":"var(--color-main)"},"tabBg":{"type":"string","default":"#f0f0f0"},"tabTextColor":{"type":"string","default":"#444444"},"activeTextColor":{"type":"string","default":"#ffffff"},"lineColor":{"type":"string","default":"#e0e0e0"},"itemGap":{"type":"number","default":24},"labelStyle":{"type":"string","default":"plain"},"labelWidth":{"type":"number","default":34},"qLabelColor":{"type":"string","default":"var(--color-main)"},"aLabelColor":{"type":"string","default":"var(--color-accent)"},"labelFont":{"type":"string","default":"Roboto"},"labelFontWeight":{"type":"string","default":""},"labelFontSizePc":{"type":"number","default":18},"labelFontSizeSp":{"type":"number","default":16},"textFont":{"type":"string","default":""},"qFontSizePc":{"type":"number","default":17},"qFontSizeSp":{"type":"number","default":15},"aFontSizePc":{"type":"number","default":15},"aFontSizeSp":{"type":"number","default":14},"schemaOutput":{"type":"boolean","default":true},"groups":{"type":"array","default":[{"label":"はじめての方","items":[{"text_q":"予約は必要ですか？","text_a":"ご予約なしでもお受けしています。ただし土曜は埋まりやすいので、お電話いただけると確実です。"},{"text_q":"はじめてでも大丈夫？","text_a":"はじめての方が半分以上です。当日は10分ほどお話をうかがってから始めます。"}]},{"label":"料金・お支払い","items":[{"text_q":"追加料金はかかりますか？","text_a":"表示している金額のほかにいただくものはありません。"},{"text_q":"カードは使えますか？","text_a":"現金のほか、各種クレジットカードと電子マネーがお使いいただけます。"}]},{"label":"ご予約・変更","items":[{"text_q":"当日でも変更できますか？","text_a":"前日までにご連絡いただければ、料金はかかりません。"}]}]}},"editorScript":"file:./lw-pr-qa-4.js","viewScript":"file:./view.js","no":4}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-qa-4"], () => (__webpack_require__("./src/lw-pr-qa-4/index.js")))
