...
/***/ "./src/paid-block-content-5/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-content-5/index.js ***!
  \*******************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-content-5/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-content-5/block.json");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-content-5/style.scss");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var pcImage = attributes.pcImage,
      spImage = attributes.spImage,
      imgAlt = attributes.imgAlt,
      pcTitle = attributes.pcTitle,
      spTitle = attributes.spTitle,
      pcBody = attributes.pcBody,
      textColumns = attributes.textColumns,
      ...
      contsMaxWidth = attributes.contsMaxWidth,
    ...
    var finalAlt = imgAlt || pcTitle;
    var finalSpTitle = spTitle || pcTitle;
    var spTitleWithBr = finalSpTitle.replace(/\n/g, '<br>');

    /* 見出しタグ */
    var Tag = "h".concat(headingLevel);
    /* 中央寄せ用 style とmax-width */
    var contsStyle = verticalCenter ? {
      alignItems: 'center',
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, [1, 2, 3, 4, 5, 6].map(function (lvl) {
      ...
      title: "\u753B\u50CF\u3084\u30EC\u30A4\u30A2\u30A6\u30C8",
      initialOpen: true
    }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "PC\u7528\u753B\u50CF")), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      ...
      render: function render(_ref2) {
        ...
        return /*#__PURE__*/React.createElement("div", {
        ...
        }, pcImage && /*#__PURE__*/React.createElement("img", {
          src: pcImage,
          alt: "",
          style: {
            maxWidth: '100%',
          ...
          variant: "secondary",
          onClick: open
        }, pcImage ? 'PC画像を変更' : 'PC画像を選択'), pcImage && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          variant: "secondary",
          onClick: function onClick() {
            return setAttributes({
              pcImage: '',
    ...
    }), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "SP\u7528\u753B\u50CF (\u7A7A\u306A\u3089PC\u753B\u50CF)")), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: function onSelect(m) {
        return setAttributes({
          spImage: m.url
        });
      ...
      render: function render(_ref3) {
        ...
        return /*#__PURE__*/React.createElement("div", {
        ...
        }, spImage && /*#__PURE__*/React.createElement("img", {
          src: spImage,
          alt: "",
          style: {
            maxWidth: '100%',
          ...
          variant: "secondary",
          onClick: open
        }, spImage ? 'SP画像を変更' : 'SP画像を選択'), spImage && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          variant: "secondary",
          onClick: function onClick() {
            return setAttributes({
              spImage: ''
      ...
      label: "PC\u753B\u50CF\u30A2\u30B9\u30DA\u30AF\u30C8\u6BD4 (500 / ".concat(aspectRatioHeight, ")"),
      ...
      style: {
        aspectRatio: "500 / ".concat(aspectRatioHeight)
      },
      src: pcImage,
      alt: finalAlt
    }), (spImage || pcImage) && /*#__PURE__*/React.createElement(Tag, {
      className: "ttl",
      style: {
        fontWeight: spTitleFontWeight,
        color: spTitleColor
      },
      "data-lw_font_set": spTitleFont,
      dangerouslySetInnerHTML: {
        __html: spTitleWithBr
      }
  ...
  save: function save(_ref4) {
    ...
    var finalSpImage = spImage || pcImage;
    var finalAlt = imgAlt || pcTitle;
    var finalSpTitle = (spTitle || pcTitle).replace(/\n/g, '<br>');
    var Tag = "h".concat(headingLevel);
    var contsStyle = verticalCenter ? {
      alignItems: 'center',
      maxWidth: "".concat(contsMaxWidth, "px")
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      src: pcImage,
      alt: finalAlt
    }), (spImage || pcImage) && /*#__PURE__*/React.createElement("img", {
      className: "on_800px",
      src: finalSpImage,
      alt: finalAlt
    }), (spImage || pcImage) && /*#__PURE__*/React.createElement(Tag, {
...
/***/ "./src/paid-block-content-5/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-content-5/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-content-5/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-content-5/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-content-5": 0,
/******/ 			"./style-paid-block-content-5": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-content-5"], () => (__webpack_require__("./src/paid-block-content-5/index.js")))
