...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-custom-title-15/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-custom-title-15/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-custom-title-15/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var mainTitle = attributes.mainTitle,
      ...
      _attributes$afterColo = attributes.afterColor,
      afterColor = _attributes$afterColo === void 0 ? 'var(--color-main)' : _attributes$afterColo,
      _attributes$afterMarg = attributes.afterMarginTopPc,
      afterMarginTopPc = _attributes$afterMarg === void 0 ? 1 : _attributes$afterMarg,
      _attributes$afterMarg2 = attributes.afterMarginTopSp,
      afterMarginTopSp = _attributes$afterMarg2 === void 0 ? 0.8 : _attributes$afterMarg2,
      _attributes$afterHeig = attributes.afterHeightPc,
      afterHeightPc = _attributes$afterHeig === void 0 ? 4 : _attributes$afterHeig,
      _attributes$afterHeig2 = attributes.afterHeightSp,
      afterHeightSp = _attributes$afterHeig2 === void 0 ? 4 : _attributes$afterHeig2,
      _attributes$afterWidt = attributes.afterWidthPc,
      afterWidthPc = _attributes$afterWidt === void 0 ? 50 : _attributes$afterWidt,
      _attributes$afterWidt2 = attributes.afterWidthSp,
      afterWidthSp = _attributes$afterWidt2 === void 0 ? 50 : _attributes$afterWidt2,
      _attributes$fontSizeP = attributes.fontSizePc,
      fontSizePc = _attributes$fontSizeP === void 0 ? 16 : _attributes$fontSizeP,
      _attributes$fontSizeS = attributes.fontSizeSp,
      fontSizeSp = _attributes$fontSizeS === void 0 ? 16 : _attributes$fontSizeS,
      mainFontWeight = attributes.mainFontWeight,
      subFontWeight = attributes.subFontWeight,
      positionPc = attributes.positionPc,
      positionSp = attributes.positionSp;

    // 配置オプション
    var positionOptionsPc = [{
      label: '中央',
      value: ''
    }, {
      label: '左寄せ',
      value: 'position_left_pc'
    }, {
      label: '右寄せ',
      value: 'position_right_pc'
    }];
    var positionOptionsSp = [{
      label: 'PCと同じ',
      value: ''
    }, {
      label: '中央',
      value: 'position_center_sp'
    }, {
      label: '左寄せ',
      value: 'position_left_sp'
    }, {
      label: '右寄せ',
      value: 'position_right_sp'
    }];
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-pr-custom-title-15".concat(positionPc ? " ".concat(positionPc) : '').concat(positionSp ? " ".concat(positionSp) : ''),
      style: {
        ...
        '--title-15-after-mt-pc': "".concat(afterMarginTopPc, "em"),
        '--title-15-after-mt-sp': "".concat(afterMarginTopSp, "em"),
        '--title-15-after-h-pc': "".concat(afterHeightPc, "px"),
        '--title-15-after-h-sp': "".concat(afterHeightSp, "px"),
        '--title-15-after-w-pc': "".concat(afterWidthPc, "px"),
        '--title-15-after-w-sp': "".concat(afterWidthSp, "px"),
        '--title-15-font-size_pc': "".concat(fontSizePc, "px"),
        '--title-15-font-size_sp': "".concat(fontSizeSp, "px")
      }
    });
    return /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, [1, 2, 3, 4, 5].map(function (level) {
    ...
    }), showSubTitle && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC\u7248 \u4E0A\u30DE\u30FC\u30B8\u30F3 (em)",
    ...
    }, "\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: afterColor,
      onChange: function onChange(value) {
        return setAttributes({
          afterColor: value || 'var(--color-main)'
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC\u7248 \u9AD8\u3055 (px)",
      ...
      style: {
        fontWeight: mainFontWeight || undefined
      }
    }), showSubTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: "span",
      className: "sub",
      value: subTitle,
  ...
  save: function save(_ref2) {
    ...
    var mainTitle = attributes.mainTitle,
      ...
      subMarginTopSp = attributes.subMarginTopSp,
      showSubTitle = attributes.showSubTitle,
      _attributes$afterColo2 = attributes.afterColor,
      afterColor = _attributes$afterColo2 === void 0 ? 'var(--color-main)' : _attributes$afterColo2,
      _attributes$afterMarg3 = attributes.afterMarginTopPc,
      afterMarginTopPc = _attributes$afterMarg3 === void 0 ? 1 : _attributes$afterMarg3,
      _attributes$afterMarg4 = attributes.afterMarginTopSp,
      afterMarginTopSp = _attributes$afterMarg4 === void 0 ? 0.8 : _attributes$afterMarg4,
      _attributes$afterHeig3 = attributes.afterHeightPc,
      afterHeightPc = _attributes$afterHeig3 === void 0 ? 4 : _attributes$afterHeig3,
      _attributes$afterHeig4 = attributes.afterHeightSp,
      afterHeightSp = _attributes$afterHeig4 === void 0 ? 4 : _attributes$afterHeig4,
      _attributes$afterWidt3 = attributes.afterWidthPc,
      afterWidthPc = _attributes$afterWidt3 === void 0 ? 50 : _attributes$afterWidt3,
      _attributes$afterWidt4 = attributes.afterWidthSp,
      afterWidthSp = _attributes$afterWidt4 === void 0 ? 50 : _attributes$afterWidt4,
      _attributes$fontSizeP2 = attributes.fontSizePc,
      fontSizePc = _attributes$fontSizeP2 === void 0 ? 16 : _attributes$fontSizeP2,
      _attributes$fontSizeS2 = attributes.fontSizeSp,
      fontSizeSp = _attributes$fontSizeS2 === void 0 ? 16 : _attributes$fontSizeS2,
      mainFontWeight = attributes.mainFontWeight,
      subFontWeight = attributes.subFontWeight,
      positionPc = attributes.positionPc,
      positionSp = attributes.positionSp;
    ...
    return /*#__PURE__*/React.createElement(TagName, blockProps, mainTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      className: "main",
      value: mainTitle,
      style: mainFontWeight ? {
        fontWeight: mainFontWeight
      } : undefined
    }), showSubTitle && subTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      className: "sub",
      value: subTitle,
      style: subFontWeight ? {
...
/***/ "./src/lw-pr-custom-title-15/editor.scss":
/*!***********************************************!*\
  !*** ./src/lw-pr-custom-title-15/editor.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-custom-title-15/style.scss":
/*!**********************************************!*\
  !*** ./src/lw-pr-custom-title-15/style.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-custom-title-15/block.json":
/*!**********************************************!*\
  !*** ./src/lw-pr-custom-title-15/block.json ***!
  \**********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-custom-title-15","version":"1.0.0","title":"見出しタイトル 15","no":1,"category":"lw-heading","icon":"editor-textcolor","description":"メインタイトルとサブタイトルを表示する見出しブロック","aiDescription":"セクションの見出し。日本語メインタイトルとサブタイトルの2段構成。サブタイトルの上マージンを調整可能。シンプルで汎用的な見出しブロック。各セクションの冒頭に配置。","aiNotes":"このブロックはセクションタイトルとして使用。h2が基本。FVブロックの直後など、セクション区切りに配置。サブタイトルは任意で設定。","aiHint":{"description":"高機能見出し。メイン+サブタイトル+下線装飾。フォントサイズ・太さ・配置を細かく調整可能","excludeFromAutoSelect":false,"contentAttributes":["mainTitle","subTitle"],"imageAttributes":[]},"supports":{"anchor":true},"attributes":{"mainTitle":{"type":"string","default":"タイトル","ai_description":"メインタイトル（日本語）。3～15文字でセクション内容を表現。例：「サービス紹介」「会社概要」「お問い合わせ」"},"subTitle":{"type":"string","default":"サブタイトル","ai_description":"サブタイトル。5～20文字で補足説明や英語表記。例：「Services」「About Us」「Contact」。不要なら空文字"},"headingLevel":{"type":"number","default":2,"ai_description":"見出しレベル（1-6）。セクションタイトルなので通常は2（h2）を維持"},"subMarginTopPc":{"type":"number","default":0.2,"ai_description":"サブタイトルの上マージン（em、PC）。通常はデフォルト値を維持"},"subMarginTopSp":{"type":"number","default":0.2,"ai_description":"サブタイトルの上マージン（em、スマホ）。通常はデフォルト値を維持"},"showSubTitle":{"type":"boolean","default":true,"ai_description":"サブタイトルを表示するかどうか。不要な場合はfalseに設定"},"afterColor":{"type":"string","default":"var(--color-main)","ai_description":"タイトル下の線の色。var(--color-main)でサイトカラーと統一"},"afterMarginTopPc":{"type":"number","default":1,"ai_description":"タイトル下の線の上マージン（em、PC）"},"afterMarginTopSp":{"type":"number","default":0.8,"ai_description":"タイトル下の線の上マージン（em、スマホ）"},"afterHeightPc":{"type":"number","default":4,"ai_description":"タイトル下の線の高さ（px、PC）"},"afterHeightSp":{"type":"number","default":4,"ai_description":"タイトル下の線の高さ（px、スマホ）"},"afterWidthPc":{"type":"number","default":50,"ai_description":"タイトル下の線の幅（px、PC）"},"afterWidthSp":{"type":"number","default":50,"ai_description":"タイトル下の線の幅（px、スマホ）"},"fontSizePc":{"type":"number","default":16,"ai_description":"ベースフォントサイズ（px、PC）"},"fontSizeSp":{"type":"number","default":16,"ai_description":"ベースフォントサイズ（px、スマホ）"},"mainFontWeight":{"type":"string","default":"","ai_description":"メインタイトルのフォントの太さ"},"subFontWeight":{"type":"string","default":"","ai_description":"サブタイトルのフォントの太さ"},"positionPc":{"type":"string","default":"","ai_description":"PC版のテキスト配置（空=中央、position_left_pc=左、position_right_pc=右）"},"positionSp":{"type":"string","default":"","ai_description":"スマホ版のテキスト配置（空=中央、position_left_sp=左、position_right_sp=右）"}},"editorScript":"file:./lw-pr-custom-title-15.js"}');
...
/******/ 		var installedChunks = {
/******/ 			"lw-pr-custom-title-15": 0,
/******/ 			"./style-lw-pr-custom-title-15": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-custom-title-15"], () => (__webpack_require__("./src/lw-pr-custom-title-15/index.js")))
