...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-banner-info-01","version":"1.0.0","title":"バナー 01（3カラム）","category":"lw-banner","icon":"images-alt2","aiHint":{"description":"画像バナー3カラム。画像+タイトル+説明+リンクのカード3枚。サービス紹介・メニュー案内に","excludeFromAutoSelect":false,"contentAttributes":["items"],"imageAttributes":[]},"supports":{"anchor":true},"attributes":{"filterBackgroundColor":{"type":"string","default":"#000"},"filterOpacity":{"type":"number","default":0.45},"titleFontFamily":{"type":"string","default":"Noto Sans JP"},"titleFontWeight":{"type":"string","default":"600"},"pFontFamily":{"type":"string","default":"Noto Sans JP"},"pFontWeight":{"type":"string","default":"400"},"items":{"type":"array","default":[{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://picsum.photos/1000/1000?random=1","linkUrl":"","openInNewTab":false},{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://picsum.photos/1000/1000?random=2","linkUrl":"","openInNewTab":false},{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://picsum.photos/1000/1000?random=3","linkUrl":"","openInNewTab":false}]}},"editorScript":"file:./lw-banner-info-01.js","no":3}');
