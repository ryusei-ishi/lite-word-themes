...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  edit: function edit(props) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_6__.lwLinkFromAttrs)(props.attributes, LINK_KEYS),
      onChange: function onChange(patch) {
        return props.setAttributes((0,_link_picker_js__WEBPACK_IMPORTED_MODULE_6__.lwLinkToAttrs)(patch, LINK_KEYS));
      }
  ...
  save: function save(props) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      className: "btn",
      href: buttonUrl,
      "data-lw-link-type": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_6__.lwLinkDataPropsFromAttrs)(props.attributes, LINK_KEYS).linkType,
      "data-lw-link-id": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_6__.lwLinkDataPropsFromAttrs)(props.attributes, LINK_KEYS).linkId,
      value: buttonText,
      style: {
        borderRadius: "".concat(buttonRadius, "px")
      }
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-content-6","version":"1.0.0","title":"Content 06","category":"lw-content","icon":"format-image","editorScript":"file:./paid-block-content-6.js","aiHint":{"description":"画像+テキスト+ボタン2カラム。シンプルな左右配置。反転可能。サービス概要説明に","excludeFromAutoSelect":false,"contentAttributes":["textContent","buttonText","buttonUrl"],"imageAttributes":["imageUrl"]},"supports":{"anchor":true},"attributes":{"alignRight":{"type":"boolean","default":false},"imageUrl":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/women/7.webp"},"imageAlt":{"type":"string","default":""},"textContent":{"type":"string","default":"テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト"},"buttonText":{"type":"string","default":"Learn More"},"buttonUrl":{"type":"string","default":"#"},"buttonLinkType":{"type":"string","default":"url"},"buttonPageId":{"type":"number","default":0},"buttonCategoryId":{"type":"number","default":0},"showButton":{"type":"boolean","default":true},"buttonRadius":{"type":"number","default":0}},"no":6}');
