...
/***/ "./src/paid-block-lw-button-4/index.js":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-button-4/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-lw-button-4/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-lw-button-4/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-lw-button-4/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  /* ── 編集画面 ─────────────────── */edit: function edit(props) {
    ...
    var blockId = attributes.blockId,
      ...
      iconVisible = attributes.iconVisible,
    ...
    if (!blockId) {
      setAttributes({
        blockId: "lwbtn-".concat(clientId.slice(0, 8))
      });
    }
    var fontSizeClass = "font_size_".concat(fontSize);
    var pcClass = "position_".concat(position);
    var spClass = positionSp ? "position_".concat(positionSp, "_sp") : '';
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }), iconVisible && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\uD83C\uDFAF \u30A2\u30A4\u30B3\u30F3\u306E\u7A2E\u985E",
      value: selectedIcon,
    ...
    }, "\uD83C\uDFA8 \u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: borderColor,
      onChange: function onChange(v) {
        return setAttributes({
          borderColor: v
      ...
      id: blockId,
      className: "a_inner ".concat(fontSizeClass),
      style: {
    ...
    }), iconVisible && selectedIcon && /*#__PURE__*/React.createElement("div", {
      className: "icon-svg",
  ...
  /* ── フロント保存 ───────────────────────────── */save: function save(_ref) {
    ...
    var pcClass = "position_".concat(position);
    var spClass = positionSp ? "position_".concat(positionSp, "_sp") : '';
    var pcStyle = "#".concat(blockId, "{max-width:").concat(maxWidth, "px;}");
    var spStyle = "@media (max-width:500px){#".concat(blockId, "{max-width:").concat(maxWidthSp, "px;}}");
    var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
      className: "paid-block-lw-button-4 ".concat(pcClass, " ").concat(spClass)
    });
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("style", null, pcStyle + spStyle), /*#__PURE__*/React.createElement("div", {
      id: blockId,
      className: "a_inner ".concat(fontSizeClass),
      style: {
        borderRadius: "".concat(borderRadius, "px")
...
/***/ "./src/paid-block-lw-button-4/editor.scss":
/*!************************************************!*\
  !*** ./src/paid-block-lw-button-4/editor.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-button-4/style.scss":
/*!***********************************************!*\
  !*** ./src/paid-block-lw-button-4/style.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-lw-button-4": 0,
/******/ 			"./style-paid-block-lw-button-4": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-lw-button-4"], () => (__webpack_require__("./src/paid-block-lw-button-4/index.js")))
