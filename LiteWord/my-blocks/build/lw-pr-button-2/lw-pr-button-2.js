...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-button-2/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-button-2/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-button-2/block.json");
...
var iconOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.rightButtonIconSvgArr)();
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(props) {
    ...
    var textSub = attributes.textSub,
      ...
      paddingVertical = attributes.paddingVertical,
      paddingHorizontal = attributes.paddingHorizontal,
      subMarginBottom = attributes.subMarginBottom,
      iconRight = attributes.iconRight,
      iconRightColor = attributes.iconRightColor,
      iconRightSize = attributes.iconRightSize,
      iconRightPosition = attributes.iconRightPosition,
    ...
    // ブロックのクラス名を生成
    var blockClassName = "lw-pr-button-2 ".concat(btnAlign);
    if (btnAlignSp !== 'default' && btnAlignSp !== '') {
      blockClassName += " sp_".concat(btnAlignSp);
    }
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }), !bgGradient.includes('gradient') && !bgGradient.includes('linear') && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '10px'
      }
    }, /*#__PURE__*/React.createElement("p", {
      ...
      onChange: function onChange(newBg) {
        return setAttributes({
          bgGradientHover: newBg
        });
      },
      help: "\u30D7\u30EA\u30BB\u30C3\u30C8\u304B\u3089\u9078\u629E\uFF08\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u5BFE\u5FDC\uFF09"
    }), !bgGradientHover.includes('gradient') && !bgGradientHover.includes('linear') && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '10px'
      }
    }, /*#__PURE__*/React.createElement("p", {
    ...
    }, "\uD83C\uDFA8 \u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\uD83C\uDF11 \u5F71\u306E\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u6A2A\u65B9\u5411 (px)",
      value: shadowX,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      className: "text_sub",
      style: {
        marginBottom: "".concat(subMarginBottom, "px"),
        color: textColorSub,
      ...
      style: {
        padding: "".concat(paddingVertical, "em ").concat(paddingHorizontal, "em"),
      ...
      style: {
        right: "".concat(iconRightPosition, "px"),
...
/***/ "./src/lw-pr-button-2/editor.scss":
/*!****************************************!*\
  !*** ./src/lw-pr-button-2/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-button-2/block.json":
/*!***************************************!*\
  !*** ./src/lw-pr-button-2/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-button-2","version":"1.0.0","title":"PRボタン 02","category":"lw-button","icon":"button","description":"プレミアムリンクボタン（スタイル02）","aiHint":{"description":"グラデーション背景の2段テキストボタン。問い合わせ・予約誘導に。振動アニメーション対応","excludeFromAutoSelect":false,"contentAttributes":["textMain","textSub","btnUrl"],"imageAttributes":[]},"supports":{"anchor":true,"className":true},"attributes":{"isAffiliate":{"type":"boolean","default":false},"textSub":{"type":"string","default":"＼ テキストテキストテキスト ／","aiHint":{"role":"subheading","contentGuide":"補足テキスト。＼ ／で囲む。10〜20文字","example":"＼ 24時間受付中 ／"}},"textMain":{"type":"string","default":"お問い合わせはこちら","aiHint":{"role":"button","contentGuide":"メインボタンテキスト。5〜15文字","example":"お問い合わせはこちら"}},"btnUrl":{"type":"string","default":"","aiHint":{"role":"url","contentGuide":"遷移先URL"}},"openNewTab":{"type":"boolean","default":false,"aiHint":{"skip":true}},"btnAlign":{"type":"string","default":"center","aiHint":{"skip":true}},"btnAlignSp":{"type":"string","default":"default","aiHint":{"skip":true}},"bgGradient":{"type":"string","default":"linear-gradient(135deg, #224394 0%, #12346f 100%)","aiHint":{"skip":true}},"bgGradientHover":{"type":"string","default":"linear-gradient(135deg, #1a3470 0%, #0e285a 100%)","aiHint":{"skip":true}},"textColorMain":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"textColorSub":{"type":"string","default":"#000000","aiHint":{"skip":true}},"FontSet":{"type":"string","default":"","aiHint":{"skip":true}},"fontWeightMain":{"type":"string","default":"500","aiHint":{"skip":true}},"fontWeightSub":{"type":"string","default":"500","aiHint":{"skip":true}},"fontSizeMain":{"type":"number","default":20,"aiHint":{"skip":true}},"fontSizeMainSp":{"type":"number","default":18,"aiHint":{"skip":true}},"fontSizeSub":{"type":"number","default":16,"aiHint":{"skip":true}},"maxWidth":{"type":"number","default":340,"aiHint":{"skip":true}},"maxWidthSp":{"type":"number","default":300,"aiHint":{"skip":true}},"borderRadius":{"type":"number","default":64,"aiHint":{"skip":true}},"paddingVertical":{"type":"number","default":1.2,"aiHint":{"skip":true}},"paddingHorizontal":{"type":"number","default":1,"aiHint":{"skip":true}},"subMarginBottom":{"type":"number","default":6,"aiHint":{"skip":true}},"iconRight":{"type":"string","default":"","aiHint":{"skip":true}},"iconRightColor":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"iconRightSize":{"type":"number","default":20,"aiHint":{"skip":true}},"iconRightPosition":{"type":"number","default":20,"aiHint":{"skip":true}},"transitionDuration":{"type":"number","default":0.3,"aiHint":{"skip":true}},"shakeAnimation":{"type":"boolean","default":false,"aiHint":{"skip":true}},"shakeInterval":{"type":"number","default":3,"aiHint":{"skip":true}},"shakeIntensity":{"type":"string","default":"normal","aiHint":{"skip":true}},"shadowX":{"type":"number","default":0,"aiHint":{"skip":true}},"shadowY":{"type":"number","default":0,"aiHint":{"skip":true}},"shadowBlur":{"type":"number","default":6,"aiHint":{"skip":true}},"shadowOpacity":{"type":"number","default":0.2,"aiHint":{"skip":true}},"btnLinkType":{"type":"string","default":"url","aiHint":{"skip":true}},"btnPageId":{"type":"number","default":0,"aiHint":{"skip":true}},"btnCategoryId":{"type":"number","default":0,"aiHint":{"skip":true}}},"editorScript":"file:./lw-pr-button-2.js","no":2}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-button-2"], () => (__webpack_require__("./src/lw-pr-button-2/index.js")))
