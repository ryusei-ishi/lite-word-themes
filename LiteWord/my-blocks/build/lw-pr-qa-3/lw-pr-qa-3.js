...
/* harmony import */ var _inspector_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inspector.js */ "./src/lw-pr-qa-3/inspector.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-3/helpers.js");
...
function Edit(_ref) {
  ...
  var labelStyle = attributes.labelStyle,
    labelFont = attributes.labelFont,
    labelFontWeight = attributes.labelFontWeight,
    textFont = attributes.textFont,
    qFontWeight = attributes.qFontWeight,
    aFontWeight = attributes.aFontWeight,
  ...
  var addContent = function addContent() {
    return setAttributes({
      contents: [].concat(_toConsumableArray(contents), [{
        text_q: '新しい質問',
        text_a: '新しい回答'
      }])
    });
  };
  var removeContent = function removeContent(i) {
    return setAttributes({
      contents: contents.filter(function (_, idx) {
        return idx !== i;
      })
    });
  };
  ...
  // 並び替え。to が範囲外なら何もしない
  var moveContent = function moveContent(from, to) {
    if (to < 0 || to >= contents.length) {
      return;
    }
    var next = _toConsumableArray(contents);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_inspector_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  }), /*#__PURE__*/React.createElement("div", blockProps, contents.map(function (c, i) {
    return /*#__PURE__*/React.createElement("dl", {
      className: "qa-3__item",
      key: i
    ...
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.labelText)('Q', i, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
      tagName: "p",
      className: "qa-3__q_text",
      value: c.text_q,
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(textFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.weightStyle)(qFontWeight),
      onChange: function onChange(v) {
        return updateContent(i, 'text_q', v);
      },
      placeholder: "\u8CEA\u554F\u3092\u5165\u529B..."
      ...
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(labelFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.weightStyle)(labelFontWeight)
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.labelText)('A', i, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
      tagName: "p",
      className: "qa-3__a_text",
      value: c.text_a,
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.fontAttr)(textFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.weightStyle)(aFontWeight),
      onChange: function onChange(v) {
        return updateContent(i, 'text_a', v);
      },
      placeholder: "\u56DE\u7B54\u3092\u5165\u529B..."
    })), /*#__PURE__*/React.createElement("div", {
      className: "qa-3__tools"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      size: "small",
      variant: "secondary",
      disabled: i === 0,
      onClick: function onClick() {
        return moveContent(i, i - 1);
      }
    }, "\u2191"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      size: "small",
      variant: "secondary",
...
function blockStyle(a) {
  return {
    '--qa3-max-w': a.maxWidth === 0 ? '100%' : "".concat(a.maxWidth, "px"),
    '--qa3-gap': "".concat(a.itemGap, "px"),
    '--qa3-label-w': "".concat(a.labelWidth, "px"),
    '--qa3-q-color': a.qLabelColor,
    '--qa3-a-color': a.aLabelColor,
    '--qa3-line': a.lineColor,
    '--qa3-label-size-pc': "".concat(a.labelFontSizePc, "px"),
    '--qa3-label-size-sp': "".concat(a.labelFontSizeSp, "px"),
    '--qa3-q-size-pc': "".concat(a.qFontSizePc, "px"),
    '--qa3-q-size-sp': "".concat(a.qFontSizeSp, "px"),
    '--qa3-a-size-pc': "".concat(a.aFontSizePc, "px"),
    '--qa3-a-size-sp': "".concat(a.aFontSizeSp, "px")
  };
}
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-qa-3/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-qa-3/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-qa-3/block.json");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit.js */ "./src/lw-pr-qa-3/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save.js */ "./src/lw-pr-qa-3/save.js");
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants.js */ "./src/lw-pr-qa-3/constants.js");
/**
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/lw-pr-qa-3/helpers.js");
/**
 * lw-pr-qa-3 — 保存HTML
...
function Save(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", blockProps, contents.map(function (c, i) {
    return /*#__PURE__*/React.createElement("dl", {
      className: "qa-3__item",
      key: i
    }, /*#__PURE__*/React.createElement("dt", null, /*#__PURE__*/React.createElement("span", {
    ...
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.labelText)('Q', i, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
      tagName: "p",
      className: "qa-3__q_text",
      value: c.text_q,
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(textFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(qFontWeight)
    })), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("span", {
      className: "label",
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(labelFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(labelFontWeight)
    }, (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.labelText)('A', i, labelStyle)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
      tagName: "p",
      className: "qa-3__a_text",
      value: c.text_a,
      "data-lw_font_set": (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.fontAttr)(textFont),
      style: (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.weightStyle)(aFontWeight)
    })));
  }));
}
...
/***/ "./src/lw-pr-qa-3/block.json":
/*!***********************************!*\
  !*** ./src/lw-pr-qa-3/block.json ***!
  \***********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-qa-3","version":"1.0.0","title":"よくある質問 03","category":"lw-faq","icon":"editor-help","description":"開閉しないシンプルなよくある質問。Q と A を罫線区切りで縦に並べます。","aiHint":{"description":"よくある質問（開閉なし）。QとAを罫線区切りで縦に並べる。最初から全部読ませたいFAQに","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"supports":{"anchor":true,"className":true},"attributes":{"maxWidth":{"type":"number","default":0},"itemGap":{"type":"number","default":24},"labelStyle":{"type":"string","default":"plain"},"labelWidth":{"type":"number","default":32},"qLabelColor":{"type":"string","default":"var(--color-main)"},"aLabelColor":{"type":"string","default":"var(--color-accent)"},"lineColor":{"type":"string","default":"#e0e0e0"},"labelFont":{"type":"string","default":"Roboto"},"labelFontWeight":{"type":"string","default":""},"labelFontSizePc":{"type":"number","default":18},"labelFontSizeSp":{"type":"number","default":16},"textFont":{"type":"string","default":""},"qFontWeight":{"type":"string","default":""},"aFontWeight":{"type":"string","default":""},"qFontSizePc":{"type":"number","default":17},"qFontSizeSp":{"type":"number","default":15},"aFontSizePc":{"type":"number","default":15},"aFontSizeSp":{"type":"number","default":14},"contents":{"type":"array","source":"query","selector":".qa-3__item","query":{"text_q":{"type":"string","source":"html","selector":".qa-3__q_text"},"text_a":{"type":"string","source":"html","selector":".qa-3__a_text"}},"default":[{"text_q":"質問テキストをここに入力します","text_a":"回答テキストをここに入力します。開閉しないので、読ませたい内容をそのまま書いてください。"},{"text_q":"質問テキストをここに入力します","text_a":"回答テキストをここに入力します。開閉しないので、読ませたい内容をそのまま書いてください。"},{"text_q":"質問テキストをここに入力します","text_a":"回答テキストをここに入力します。開閉しないので、読ませたい内容をそのまま書いてください。"}]}},"editorScript":"file:./lw-pr-qa-3.js","no":3}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-qa-3"], () => (__webpack_require__("./src/lw-pr-qa-3/index.js")))
