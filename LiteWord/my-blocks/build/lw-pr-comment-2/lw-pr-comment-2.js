...
/***/ "./src/lw-pr-comment-2/block.json":
/*!****************************************!*\
  !*** ./src/lw-pr-comment-2/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-comment-2","version":"1.0.0","title":"吹き出しコメント 02（全幅・名前無し）","category":"lw-comment","icon":"format-chat","description":"吹き出しスタイルのコメントブロック。画像とテキストを配置。","aiHint":{"description":"吹き出しコメント（全幅）。写真+コメント。本人の言葉を短く見せる。院長挨拶・スタッフの一言に","excludeFromAutoSelect":false,"contentAttributes":["comment2Text"],"imageAttributes":["comment2ImageUrl"],"notes":"名前欄を持たないので、誰の言葉かは直前の見出しか直後のプロフィールで示す。経歴表の前に置くと「履歴書」ではなく「人物」に見える。"},"supports":{"anchor":true,"className":true},"attributes":{"comment2MaxWidth":{"type":"number","default":800},"comment2ImagePosition":{"type":"string","default":"left"},"comment2ImageUrl":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/women/6.webp"},"comment2ImageId":{"type":"number","default":0},"comment2ImageAlt":{"type":"string","default":""},"comment2ImageWidthPc":{"type":"number","default":160},"comment2ImageWidthSp":{"type":"number","default":80},"comment2ImageBdWidthPc":{"type":"number","default":2},"comment2ImageBdWidthSp":{"type":"number","default":-1},"comment2ImageBdColorPc":{"type":"string","default":"#3C7FC3"},"comment2ImageBdColorSp":{"type":"string","default":""},"comment2ImageBg":{"type":"string","default":"#ffffff"},"comment2Text":{"type":"string","default":"ここにコメントを入力"},"comment2TextColor":{"type":"string","default":"#3C7FC3"},"comment2TextBg":{"type":"string","default":"#F0FCFF"},"comment2TextMtPc":{"type":"number","default":24},"comment2TextMtSp":{"type":"number","default":8},"comment2TextFontsizePc":{"type":"number","default":17},"comment2TextFontsizeSp":{"type":"number","default":16},"comment2TextBdrPc":{"type":"number","default":12},"comment2TextBdrSp":{"type":"number","default":8},"comment2TriangleTop":{"type":"number","default":20},"comment2FontSet":{"type":"string","default":""},"comment2FontWeight":{"type":"string","default":""}},"editorScript":"file:./lw-pr-comment-2.js","no":2}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-comment-2/block.json");
...
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var comment2MaxWidth = attributes.comment2MaxWidth,
      comment2ImagePosition = attributes.comment2ImagePosition,
      comment2ImageUrl = attributes.comment2ImageUrl,
      comment2ImageId = attributes.comment2ImageId,
      comment2ImageAlt = attributes.comment2ImageAlt,
      comment2ImageWidthPc = attributes.comment2ImageWidthPc,
      comment2ImageWidthSp = attributes.comment2ImageWidthSp,
      comment2ImageBdWidthPc = attributes.comment2ImageBdWidthPc,
      comment2ImageBdWidthSp = attributes.comment2ImageBdWidthSp,
      comment2ImageBdColorPc = attributes.comment2ImageBdColorPc,
      comment2ImageBdColorSp = attributes.comment2ImageBdColorSp,
      comment2ImageBg = attributes.comment2ImageBg,
      comment2Text = attributes.comment2Text,
      comment2TextColor = attributes.comment2TextColor,
      comment2TextBg = attributes.comment2TextBg,
      comment2TextMtPc = attributes.comment2TextMtPc,
      comment2TextMtSp = attributes.comment2TextMtSp,
      comment2TextFontsizePc = attributes.comment2TextFontsizePc,
      comment2TextFontsizeSp = attributes.comment2TextFontsizeSp,
      comment2TextBdrPc = attributes.comment2TextBdrPc,
      comment2TextBdrSp = attributes.comment2TextBdrSp,
      comment2TriangleTop = attributes.comment2TriangleTop,
      comment2FontSet = attributes.comment2FontSet,
      comment2FontWeight = attributes.comment2FontWeight;
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-pr-comment-2"
    });
    var wrapStyle = {
      "--comment-2-max-width": "".concat(comment2MaxWidth, "px"),
      "--comment-2-image-width-pc": "".concat(comment2ImageWidthPc, "px"),
      "--comment-2-image-width-sp": "".concat(comment2ImageWidthSp, "px"),
      "--comment-2-image-bd-width-pc": "".concat(comment2ImageBdWidthPc, "px"),
      "--comment-2-image-bd-width-sp": comment2ImageBdWidthSp >= 0 ? "".concat(comment2ImageBdWidthSp, "px") : "".concat(comment2ImageBdWidthPc, "px"),
      ...
      "--comment-2-text-mt-pc": "".concat(comment2TextMtPc, "px"),
      "--comment-2-text-mt-sp": "".concat(comment2TextMtSp, "px"),
      "--comment-2-text-fontsize-pc": "".concat(comment2TextFontsizePc, "px"),
      "--comment-2-text-fontsize-sp": "".concat(comment2TextFontsizeSp, "px"),
      "--comment-2-text-bdr-pc": "".concat(comment2TextBdrPc, "px"),
      "--comment-2-text-bdr-sp": "".concat(comment2TextBdrSp, "px"),
      "--comment-2-triangle-top": "".concat(comment2TriangleTop, "%")
    };
    var wrapClassName = "lw-pr-comment-2__wrap".concat(comment2ImagePosition === "right" ? " image_right" : "");
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      render: function render(_ref2) {
        ...
        }, comment2ImageUrl ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
    ...
    }, "\u753B\u50CF\u30B5\u30A4\u30BA (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
      value: comment2ImageWidthPc,
      onChange: function onChange(v) {
        return setAttributes({
          comment2ImageWidthPc: v
        });
      },
      min: 40,
      max: 300,
    ...
    }, "\u30DC\u30FC\u30C0\u30FC\u8272 PC"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: comment2ImageBdColorPc,
      onChange: function onChange(color) {
        return setAttributes({
          comment2ImageBdColorPc: color || "#3C7FC3"
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.__experimentalHeading, {
      level: 4,
    ...
    }, "\u30DC\u30FC\u30C0\u30FC\u8272 SP\uFF08\u7A7A\u3067PC\u7D99\u627F\uFF09"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: comment2ImageBdColorSp,
      onChange: function onChange(color) {
        return setAttributes({
          comment2ImageBdColorSp: color || ""
        });
      }
    }), /*#__PURE__*/React.createElement("hr", {
      style: {
      ...
      onChange: function onChange(color) {
        return setAttributes({
          comment2TextColor: color || "#3C7FC3"
        });
      }
    }), /*#__PURE__*/React.createElement("hr", {
      style: {
    ...
    }, "\u4E0A\u30DE\u30FC\u30B8\u30F3 (px)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "PC",
    ...
    }, "\u5439\u304D\u51FA\u3057\u4E09\u89D2\u306E\u4F4D\u7F6E (%)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u4E0A\u304B\u3089\u306E\u4F4D\u7F6E",
      value: comment2TriangleTop,
      onChange: function onChange(v) {
        return setAttributes({
          comment2TriangleTop: v
        });
      },
      min: 0,
      max: 100,
      ...
      className: "lw-pr-comment-2__image"
    }, comment2ImageUrl ? /*#__PURE__*/React.createElement("img", {
      src: comment2ImageUrl,
      alt: comment2ImageAlt
    }) : /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-comment-2__image_placeholder"
    }, /*#__PURE__*/React.createElement("span", null, "\u753B\u50CF"))), /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-comment-2__text"
...
LW_1169_OLD.comment2ImageUrl["default"] = "https://placehold.co/200x200/e8e8e8/999999?text=Image";
