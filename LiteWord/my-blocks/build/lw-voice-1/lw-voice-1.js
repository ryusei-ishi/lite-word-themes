...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(props) {
    ...
    var testimonials = attributes.testimonials,
      h2Title = attributes.h2Title,
      h2FontSet = attributes.h2FontSet,
      h2FontWeight = attributes.h2FontWeight,
      h2TextColor = attributes.h2TextColor,
      nameTextColor = attributes.nameTextColor,
      nameBackgroundColor = attributes.nameBackgroundColor,
      nameFontSet = attributes.nameFontSet,
      nameFontWeight = attributes.nameFontWeight,
      h3TextColor = attributes.h3TextColor,
      h3FontSet = attributes.h3FontSet,
      h3FontWeight = attributes.h3FontWeight,
      pTextColor = attributes.pTextColor,
      pFontSet = attributes.pFontSet,
      pFontWeight = attributes.pFontWeight,
      backgroundColor = attributes.backgroundColor;

    // testimonial追加
    var addTestimonial = function addTestimonial() {
      var newTestimonial = {
        name: '新しい名前',
        title: '新しいタイトル',
        content: '新しいコンテンツ'
      ...
      setAttributes({
        testimonials: [].concat(_toConsumableArray(testimonials), [newTestimonial])
      });
    };

    // testimonial削除
    var removeTestimonial = function removeTestimonial(index) {
      var updatedTestimonials = testimonials.filter(function (_, i) {
        return i !== index;
      });
      setAttributes({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "\u30B3\u30F3\u30C6\u30F3\u30C4 \u8FFD\u52A0\u3068\u524A\u9664")), testimonials.map(function (testimonial, index) {
    ...
    }, "\u30B3\u30F3\u30C6\u30F3\u30C4\u3092\u8FFD\u52A0")), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.PanelColorSettings, {
      title: "\u5168\u4F53\u306E\u80CC\u666F\u8272",
      colorSettings: [{
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        onChange: function onChange(value) {
          return updateTestimonial(index, 'name', value);
        },
        placeholder: "\u540D\u524D\u3092\u5165\u529B"
      })), /*#__PURE__*/React.createElement("div", {
        className: "lw-voice-1__text"
      }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "h3",
        value: testimonial.title,
        onChange: function onChange(value) {
          return updateTestimonial(index, 'title', value);
        },
        placeholder: "\u30BF\u30A4\u30C8\u30EB\u3092\u5165\u529B",
        style: {
          color: h3TextColor,
        ...
        onChange: function onChange(value) {
          return updateTestimonial(index, 'content', value);
        },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-voice-1"], () => (__webpack_require__("./src/lw-voice-1/index.js")))
