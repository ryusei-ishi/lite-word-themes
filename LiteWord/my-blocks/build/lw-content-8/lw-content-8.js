...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  /* ---------- エディタ ---------- */edit: function edit(_ref) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      min: 800,
      max: 2000
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: liBorderColor,
      onChange: function onChange(v) {
        return setAttributes({
          liBorderColor: v
      ...
      min: 0,
      max: 10
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u4E0A\u4F59\u767D (px)",
      value: liPaddingTop,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30B5\u30D6\u30BF\u30A4\u30C8\u30EB\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      ...
      min: 0,
      max: 10
    }), /*#__PURE__*/React.createElement("p", null, "\u30B5\u30D6\u30BF\u30A4\u30C8\u30EB\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: subFontColor,
      onChange: function onChange(v) {
        return setAttributes({
          subFontColor: v
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30B5\u30D6\u30BF\u30A4\u30C8\u30EB\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: subBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          subBgColor: v
      ...
      min: 30,
      max: 100
    }), /*#__PURE__*/React.createElement("p", null, "\u30DC\u30BF\u30F3\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: btnBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          btnBgColor: v
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30DC\u30BF\u30F3\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: btnFontColor,
      onChange: function onChange(v) {
        return setAttributes({
          btnFontColor: v
      ...
      min: 10,
      max: 30
    }), /*#__PURE__*/React.createElement("p", null, "\u30DC\u30BF\u30F3\u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      ...
      return /*#__PURE__*/React.createElement("li", {
      ...
      }, /*#__PURE__*/React.createElement(React.Fragment, null, showSub && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "span",
        className: "sub",
        value: item.sub,
        onChange: function onChange(v) {
          return updateContent(idx, 'sub', v);
        },
        placeholder: "\u30B5\u30D6\u30C6\u30AD\u30B9\u30C8",
        ...
        value: item.main,
        onChange: function onChange(v) {
          return updateContent(idx, 'main', v);
        },
        placeholder: "\u30E1\u30A4\u30F3\u30C6\u30AD\u30B9\u30C8",
        ...
        value: item.url || '',
        onChange: function onChange(v) {
          return updateContent(idx, 'url', v);
        },
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromItem)(item, 'url'),
        onChange: function onChange(patch) {
          return updateContentMulti(idx, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToItem)(patch, 'url'));
        }
      }), item.url && showButton && /*#__PURE__*/React.createElement("div", {
        className: "link_btn",
        style: {
        ...
        onChange: function onChange(v) {
          return updateContent(idx, 'btnText', v);
        },
        placeholder: "\u8A73\u7D30\u306F\u3053\u3061\u3089"
  ...
  /* ---------- 保存 ---------- */save: function save(_ref2) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      ...
      var linkProps = item.url ? {
        href: item.url,
        'data-lw-link-type': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(item, 'url').linkType,
        'data-lw-link-id': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(item, 'url').linkId,
        className: 'link'
      } : {
        className: 'link'
      };
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-content-8"], () => (__webpack_require__("./src/lw-content-8/index.js")))
