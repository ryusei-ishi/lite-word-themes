...
/***/ "./src/shin-gas-station-01-company-01/index.js":
/*!*****************************************************!*\
  !*** ./src/shin-gas-station-01-company-01/index.js ***!
  \*****************************************************/
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(props) {
    ...
    var colorOuter = attributes.colorOuter,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      value: fontDt,
      options: fontOptions,
      onChange: function onChange(newFontDt) {
        return setAttributes({
          fontDt: newFontDt
        });
      }
      ...
      onChange: function onChange(newFontWeightDt) {
        return setAttributes({
          fontWeightDt: newFontWeightDt
        });
      }
    })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30C6\u30AD\u30B9\u30C8\u306E\u90E8\u5206\u306E\u8A2D\u5B9A"
      ...
      value: fontDd,
      options: fontOptions,
      onChange: function onChange(newFontDd) {
        return setAttributes({
          fontDd: newFontDd
        });
      }
      ...
      value: fontWeightDd,
      options: fontWeightOptions,
      onChange: function onChange(newFontWeightDd) {
        return setAttributes({
          fontWeightDd: newFontWeightDd
        });
      }
    }))), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      className: "shin-gas-station-01-company-01__inner",
      style: {
        borderColor: colorOuter
      }
    }, contents.map(function (content, index) {
      return /*#__PURE__*/React.createElement("dl", {
        className: "shin-gas-station-01-company-01__dl",
        key: index
        ...
        className: "shin-gas-station-01-company-01__remove_btn",
        onClick: function onClick() {
          return removeContent(index);
        }
      }, "\u524A\u9664"));
    })), /*#__PURE__*/React.createElement("button", {
      className: "shin-gas-station-01-company-01__add_btn",
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B")));
  },
...
/***/ "./src/shin-gas-station-01-company-01/editor.scss":
/*!********************************************************!*\
  !*** ./src/shin-gas-station-01-company-01/editor.scss ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-company-01/style.scss":
/*!*******************************************************!*\
  !*** ./src/shin-gas-station-01-company-01/style.scss ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-company-01/block.json":
/*!*******************************************************!*\
  !*** ./src/shin-gas-station-01-company-01/block.json ***!
  \*******************************************************/
/***/ ((module) => {
...
/******/ 		var installedChunks = {
/******/ 			"shin-gas-station-01-company-01": 0,
/******/ 			"./style-shin-gas-station-01-company-01": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-shin-gas-station-01-company-01"], () => (__webpack_require__("./src/shin-gas-station-01-company-01/index.js")))
