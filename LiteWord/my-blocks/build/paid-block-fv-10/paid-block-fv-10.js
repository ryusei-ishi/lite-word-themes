...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-fv-10/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-fv-10/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-fv-10/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  /* ====================================================== */edit: function edit(_ref) {
    ...
    var backgroundImage = attributes.backgroundImage,
      ...
      innerFilterBg = attributes.innerFilterBg,
      innerFilterBorderColor = attributes.innerFilterBorderColor,
      innerFilterBorderWidth = attributes.innerFilterBorderWidth,
      innerFilterBorderRadius = attributes.innerFilterBorderRadius,
      innerFilterShadowColor = attributes.innerFilterShadowColor,
      innerFilterShadowOffsetX = attributes.innerFilterShadowOffsetX,
      innerFilterShadowOffsetY = attributes.innerFilterShadowOffsetY,
      innerFilterShadowBlur = attributes.innerFilterShadowBlur,
      innerFilterShadowSpread = attributes.innerFilterShadowSpread,
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "paid-block-fv-10 ".concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp)
    });
    ...
    var onChangeBg = function onChangeBg(media) {
      return setAttributes({
        backgroundImage: media.url
      });
    };
    var onChangeBgSp = function onChangeBgSp(media) {
      return setAttributes({
    ...
    /* --- 影の box-shadow 文字列生成 --- */
    var boxShadow = "".concat(innerFilterShadowOffsetX, "px ").concat(innerFilterShadowOffsetY, "px ").concat(innerFilterShadowBlur, "px ").concat(innerFilterShadowSpread, "px ").concat(innerFilterShadowColor);
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u7DDA\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: innerFilterBorderColor,
      onChange: function onChange(c) {
        return setAttributes({
          innerFilterBorderColor: c
        });
      }
      ...
      title: "\u30A4\u30F3\u30CA\u30FC\u30D5\u30A3\u30EB\u30BF\u30FC\u5F71",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", null, "\u5F71\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: innerFilterShadowColor,
      onChange: function onChange(c) {
        return setAttributes({
          innerFilterShadowColor: c
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "X\u30AA\u30D5\u30BB\u30C3\u30C8 (px)",
      ...
      style: {
        ...
        borderWidth: "".concat(innerFilterBorderWidth, "px"),
        borderStyle: innerFilterBorderWidth ? 'solid' : 'none',
        borderRadius: "".concat(innerFilterBorderRadius, "px"),
        boxShadow: boxShadow
      }
    })), /*#__PURE__*/React.createElement("div", {
      className: "filter",
  ...
  /* ====================================================== */save: function save(_ref2) {
    ...
    }), backgroundImage && /*#__PURE__*/React.createElement("picture", {
      className: "bg_image"
...
/***/ "./src/paid-block-fv-10/editor.scss":
/*!******************************************!*\
  !*** ./src/paid-block-fv-10/editor.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-10/style.scss":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-10/style.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-10/block.json":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-10/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-fv-10","version":"1.0.0","title":"固定ページタイトル 10（下層用）","category":"lw-firstview","icon":"cover-image","editorScript":"file:./paid-block-fv-10.js","aiHint":{"description":"下層ページ用シンプルFV。中央タイトル+背景画像+フィルター装飾。プレミアムデザイン","excludeFromAutoSelect":false,"contentAttributes":["mainTitle"],"imageAttributes":["backgroundImage","backgroundImageSp"]},"supports":{"anchor":true},"attributes":{"backgroundImage":{"type":"string","default":""},"backgroundImageSp":{"type":"string","default":""},"mainTitle":{"type":"string","default":"ページタイトル"},"filterBackgroundColor":{"type":"string","default":"#FFF8D4"},"filterOpacity":{"type":"number","default":1},"innerFilterBg":{"type":"string","default":"#FC99AA"},"innerFilterBorderColor":{"type":"string","default":"#FFFFFF"},"innerFilterBorderWidth":{"type":"number","default":4},"innerFilterBorderRadius":{"type":"number","default":12},"innerFilterShadowColor":{"type":"string","default":"rgba(0,0,0,0.06)"},"innerFilterShadowOffsetX":{"type":"number","default":0},"innerFilterShadowOffsetY":{"type":"number","default":3},"innerFilterShadowBlur":{"type":"number","default":6},"innerFilterShadowSpread":{"type":"number","default":0},"textColor":{"type":"string","default":"#fff"},"minHeightPc":{"type":"string","default":"min-h-pc-400px"},"minHeightTb":{"type":"string","default":"min-h-tb-360px"},"minHeightSp":{"type":"string","default":"min-h-sp-280px"},"titleFontSizeClass":{"type":"string","default":"font_size_m"}},"no":10}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-fv-10"], () => (__webpack_require__("./src/paid-block-fv-10/index.js")))
