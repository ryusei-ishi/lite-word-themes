...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-19/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-19/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-19/block.json");
...
var styleVars = function styleVars(a) {
  var _a$maxWidth, _a$filterOpacity, _a$titleFontSizePc, _a$titleFontSizeSp, _a$ctaBorderRadius;
  return {
    '--fv19-max-width': "".concat((_a$maxWidth = a.maxWidth) !== null && _a$maxWidth !== void 0 ? _a$maxWidth : 1000, "px"),
    '--fv19-bg': a.bgColor,
    '--fv19-filter-color': a.filterColor,
    '--fv19-filter-opacity': String((_a$filterOpacity = a.filterOpacity) !== null && _a$filterOpacity !== void 0 ? _a$filterOpacity : 0.82),
    '--fv19-eyebrow-color': a.eyebrowColor,
    '--fv19-title-color': a.titleColor,
    '--fv19-title-weight': a.titleFontWeight,
    '--fv19-title-size-pc': "".concat((_a$titleFontSizePc = a.titleFontSizePc) !== null && _a$titleFontSizePc !== void 0 ? _a$titleFontSizePc : 46, "px"),
    '--fv19-title-size-sp': "".concat((_a$titleFontSizeSp = a.titleFontSizeSp) !== null && _a$titleFontSizeSp !== void 0 ? _a$titleFontSizeSp : 29, "px"),
    ...
    '--fv19-cta-radius': "".concat((_a$ctaBorderRadius = a.ctaBorderRadius) !== null && _a$ctaBorderRadius !== void 0 ? _a$ctaBorderRadius : 9, "px"),
    '--fv19-safe-color': a.safeColor,
    '--fv19-safe-mark': a.safeMarkColor
  };
};
var rootClass = function rootClass(a) {
  return ['lw-pr-fv-19', a.minHeightPc, a.minHeightTb, a.minHeightSp, a.textAlign === 'left' ? 'align_left' : 'align_center', a.ctaOrder === 'cta-first' ? 'cta_first' : 'tel_first'].filter(Boolean).join(' ');
};
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      showTel = attributes.showTel,
      telKicker = attributes.telKicker,
      telNumber = attributes.telNumber,
      telSub = attributes.telSub,
      telHref = attributes.telHref,
      telAsLink = attributes.telAsLink,
      telBgColor = attributes.telBgColor,
      telTextColor = attributes.telTextColor,
      telSubColor = attributes.telSubColor,
      showCta = attributes.showCta,
      ctaKicker = attributes.ctaKicker,
      ctaText = attributes.ctaText,
      ctaSub = attributes.ctaSub,
      ...
      showSafe = attributes.showSafe,
      _attributes$safeItems = attributes.safeItems,
      safeItems = _attributes$safeItems === void 0 ? [] : _attributes$safeItems,
      safeColor = attributes.safeColor,
      safeMarkColor = attributes.safeMarkColor;
    var HeadingTag = "h".concat(headingLevel);
    var updateSafe = function updateSafe(i, v) {
      return setAttributes({
        safeItems: safeItems.map(function (it, n) {
    ...
    var addSafe = function addSafe() {
      return setAttributes({
        safeItems: [].concat(_toConsumableArray(safeItems), [{
          text: '新しい一言'
        }])
      });
    };
    var removeSafe = function removeSafe(i) {
      return setAttributes({
        safeItems: safeItems.filter(function (_, n) {
          return n !== i;
        })
      });
    };
    var moveSafe = function moveSafe(i, d) {
      var to = i + d;
      if (to < 0 || to >= safeItems.length) return;
      var next = _toConsumableArray(safeItems);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u30B9\u30DE\u30DB\u7528\u306E\u80CC\u666F\u753B\u50CF\uFF08\u7A7A\u306A\u3089\u30D1\u30BD\u30B3\u30F3\u7528\uFF09"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: function onSelect(m) {
        return setAttributes({
          imageUrlSp: m.url
        });
    ...
    }), showTel && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u4E0A\u306E\u5C0F\u3055\u3044\u6587\u5B57",
      value: telKicker,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      help: "\u30D1\u30BD\u30B3\u30F3\u3067\u3082\u62BC\u3059\u3068\u767A\u4FE1\u3057\u307E\u3059\u3002\u5207\u308B\u3068\u62BC\u305B\u306A\u3044\u6587\u5B57\u306B\u306A\u308A\u307E\u3059\u3002"
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u4E0B\u306E\u5C0F\u3055\u3044\u6587\u5B57",
      value: telSub,
      onChange: function onChange(v) {
    ...
    }, "\u4E0B\u306E\u5C0F\u3055\u3044\u6587\u5B57\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: telSubColor,
      onChange: function onChange(v) {
        return setAttributes({
          telSubColor: v
    ...
    }), showCta && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u4E0A\u306E\u5C0F\u3055\u3044\u6587\u5B57",
      value: ctaKicker,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }), showSafe && /*#__PURE__*/React.createElement(React.Fragment, null, safeItems.map(function (it, i) {
    ...
    }, "\u4E00\u8A00\u3092\u8FFD\u52A0"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '16px 0 4px'
      }
    ...
    }, "\u5370\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: safeMarkColor,
      onChange: function onChange(v) {
        return setAttributes({
          safeMarkColor: v
      ...
      className: "this_wrap"
    }, showEyebrow && eyebrow && /*#__PURE__*/React.createElement("span", {
      className: "eyebrow"
      ...
      className: "two_cta"
    }, showTel && telNumber && /*#__PURE__*/React.createElement("span", {
      className: "cta_box tel"
    }, telKicker && /*#__PURE__*/React.createElement("span", {
      className: "k"
    }, telKicker), /*#__PURE__*/React.createElement("span", {
      className: "m"
    }, telNumber), telSub && /*#__PURE__*/React.createElement("span", {
      className: "s"
    }, telSub)), showCta && ctaText && /*#__PURE__*/React.createElement("span", {
      className: "cta_box form"
    }, ctaKicker && /*#__PURE__*/React.createElement("span", {
      className: "k"
    }, ctaKicker), /*#__PURE__*/React.createElement("span", {
      className: "m"
    }, ctaText), ctaSub && /*#__PURE__*/React.createElement("span", {
      className: "s"
    }, ctaSub))), showSafe && safeItems.length > 0 && /*#__PURE__*/React.createElement("ul", {
      className: "safe_list"
    }, safeItems.map(function (it, i) {
  ...
  save: function save(_ref4) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      ctaUrl = attributes.ctaUrl,
      showSafe = attributes.showSafe,
      _attributes$safeItems2 = attributes.safeItems,
      safeItems = _attributes$safeItems2 === void 0 ? [] : _attributes$safeItems2;
    var HeadingTag = "h".concat(headingLevel);
    ...
    var telNo = String(telHref !== null && telHref !== void 0 ? telHref : '').replace(/[^0-9+]/g, '');
    var telIsLink = telAsLink && telNo !== '';
    var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
      className: rootClass(attributes),
      style: styleVars(attributes)
    });
    var telInner = /*#__PURE__*/React.createElement(React.Fragment, null, telKicker && /*#__PURE__*/React.createElement("span", {
      className: "k"
    }, telKicker), /*#__PURE__*/React.createElement("span", {
      className: "m"
    }, telNumber), telSub && /*#__PURE__*/React.createElement("span", {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      className: "two_cta"
    }, showTel && telNumber && (telIsLink ? /*#__PURE__*/React.createElement("a", {
      className: "cta_box tel is_tel",
      href: "tel:".concat(telNo)
    }, telInner) : /*#__PURE__*/React.createElement("span", {
      className: "cta_box tel"
    }, telInner)), showCta && ctaText && /*#__PURE__*/React.createElement("a", {
      className: "cta_box form",
      href: ctaUrl,
...
/***/ "./src/lw-pr-fv-19/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-19/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-19","version":"1.0.0","title":"FV 19 リード獲得（電話とフォームの二択）","category":"lw-firstview","icon":"phone","editorScript":"file:./lw-pr-fv-19.js","aiHint":{"description":"リード獲得ページ専用のFV。電話とフォームを同じ大きさで並べ、どちらでも申し込めるようにする。それぞれに「所要時間」「受付時間」を添えられる。電話番号はそのまま tel: の発信リンクになる（パソコンでも押せる）。電話相談・体験の予約・見学会・登録の呼びかけに使う","excludeFromAutoSelect":false,"contentAttributes":["eyebrow","mainTitle","description","telKicker","telNumber","telHref","telSub","ctaKicker","ctaText","ctaSub","safeItems"],"imageAttributes":["imageUrlPc","imageUrlSp"],"notes":["🚨 telAsLink を true にすると、電話番号が tel: の発信リンクになる（画面幅に関係なく、パソコンでも押すと発信する）。false にすると押せない文字になる。番号は telNumber にハイフン込みで入れ、telHref には数字だけを入れる。","showTel を false にすると電話側が消えてCTAが1つだけになる。逆に showCta を false にすれば電話だけになる。どちらも消すと押す場所が無くなるので、片方は必ず残すこと。","safeItems は「番号を他社に渡しません」のような不安をほどく一行の並び。CTAのすぐ下に置くのが効く。空にすると帯ごと消える。","eyebrow は見出しの上に出る肩ラベル。左右に斜めの線が付く。空にすると消える。","🚨 自分から全幅になる背景ブロック。次の段も全幅の帯なら、あいだにスペーサーを置かない。"]},"supports":{"anchor":true},"attributes":{"backgroundType":{"type":"string","default":"image"},"imageUrlPc":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/background/6.webp"},"imageUrlSp":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"bgColor":{"type":"string","default":"#0a4653"},"filterColor":{"type":"string","default":"#0a4653"},"filterOpacity":{"type":"number","default":0.82},"minHeightPc":{"type":"string","default":"min-h-pc-560px"},"minHeightTb":{"type":"string","default":"min-h-tb-480px"},"minHeightSp":{"type":"string","default":""},"maxWidth":{"type":"number","default":1000},"textAlign":{"type":"string","default":"center"},"showEyebrow":{"type":"boolean","default":true},"eyebrow":{"type":"string","default":"相談だけでも大丈夫です"},"eyebrowColor":{"type":"string","default":"#a9e2ea"},"headingLevel":{"type":"number","default":1},"mainTitle":{"type":"string","default":"かける前に、<br>聞きたいことだけ"},"titleColor":{"type":"string","default":"#ffffff"},"titleFontWeight":{"type":"string","default":"700"},"titleFont":{"type":"string","default":""},"titleFontSizePc":{"type":"number","default":46},"titleFontSizeSp":{"type":"number","default":29},"description":{"type":"string","default":"お名前を言わなくても構いません。「いくらぐらいか」「うちでもできるか」だけでも、その場でお答えします。"},"descriptionColor":{"type":"string","default":"#cfe8ec"},"ctaOrder":{"type":"string","default":"tel-first"},"showTel":{"type":"boolean","default":true},"telKicker":{"type":"string","default":"いますぐ話す"},"telNumber":{"type":"string","default":"0120-000-000"},"telSub":{"type":"string","default":"平日 9:00–18:00 ／ 通話3分ほど"},"telHref":{"type":"string","default":"0120000000"},"telAsLink":{"type":"boolean","default":true},"telBgColor":{"type":"string","default":"#ffffff"},"telTextColor":{"type":"string","default":"#0a4653"},"telSubColor":{"type":"string","default":"#5d6b70"},"showCta":{"type":"boolean","default":true},"ctaKicker":{"type":"string","default":"文字でたずねる"},"ctaText":{"type":"string","default":"フォームで送る"},"ctaSub":{"type":"string","default":"24時間受付 ／ 入力は30秒"},"ctaUrl":{"type":"string","default":""},"ctaLinkType":{"type":"string","default":"url"},"ctaPageId":{"type":"number","default":0},"ctaCategoryId":{"type":"number","default":0},"ctaBgColor":{"type":"string","default":"#e8913a"},"ctaTextColor":{"type":"string","default":"#ffffff"},"ctaSubColor":{"type":"string","default":"#fff2df"},"ctaBorderRadius":{"type":"number","default":9},"showSafe":{"type":"boolean","default":true},"safeItems":{"type":"array","default":[{"text":"番号を他社に渡しません"},{"text":"折り返しは1回だけ"},{"text":"相談だけで終わってOK"}]},"safeColor":{"type":"string","default":"#bfe0e6"},"safeMarkColor":{"type":"string","default":"#7fc4d0"}},"no":19}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-19"], () => (__webpack_require__("./src/lw-pr-fv-19/index.js")))
