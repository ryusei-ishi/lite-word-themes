...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-fv-12/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-fv-12/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-fv-12/block.json");
 ...
 * =============================================================== */
var buildFv12Script = function buildFv12Script(_ref, legacy) {
  var videoSpeed = _ref.videoSpeed;
  ...
  var pick = legacy ? "  document.querySelectorAll('.lazy-video').forEach(v=>{" : "  var _scope = _root ? _root : document;\n  var _sel = _root ? '.lazy-video' : '.paid-block-fv-12 .lazy-video';\n  _scope.querySelectorAll(_sel).forEach(v=>{";
 ...
 * =============================================================== */
var renderFv12Save = function renderFv12Save(attributes, legacy) {
  var logoText = attributes.logoText,
    logoUrl = attributes.logoUrl,
    logoImg = attributes.logoImg,
    logoImgAlt = attributes.logoImgAlt,
    ...
    cta1BorderRadius = attributes.cta1BorderRadius,
    cta2Text = attributes.cta2Text,
    cta2Url = attributes.cta2Url,
    cta2Enable = attributes.cta2Enable,
    cta2BgColor = attributes.cta2BgColor,
    cta2TextColor = attributes.cta2TextColor,
    cta2BorderWidth = attributes.cta2BorderWidth,
    cta2BorderColor = attributes.cta2BorderColor,
    cta2BorderRadius = attributes.cta2BorderRadius,
    headline = attributes.headline,
    newsLabel = attributes.newsLabel,
    newsListVisible = attributes.newsListVisible,
    ...
    newsSourceType = attributes.newsSourceType,
    newsIds = attributes.newsIds,
    newsPostsNumber = attributes.newsPostsNumber,
  ...
  var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
    className: "paid-block-fv-12 ".concat(minHeightPc || 'min-h-pc-100vh', " ").concat(minHeightTb || 'min-h-tb-100vh', " ").concat(minHeightSp || 'min-h-sp-100vh')
  });
  ...
  return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("header", {
    ...
    style: {
      ...
      border: "".concat(cta1BorderWidth || 1, "px solid ").concat(cta1BorderColor || '#ffffff'),
      borderRadius: "".concat(cta1BorderRadius || 0, "px")
    }
  }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
    tagName: "span",
    value: cta1Text
    ...
    style: {
      ...
      border: "".concat(cta2BorderWidth || 1, "px solid ").concat(cta2BorderColor || '#ffffff'),
      borderRadius: "".concat(cta2BorderRadius || 0, "px")
    }
  }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
    tagName: "span",
    value: cta2Text
  })))), newsListVisible !== false && /*#__PURE__*/React.createElement("nav", {
    className: "fv-12_news_list",
    "data-source-type": newsSourceType,
    "data-post-ids": newsIds,
    "data-post-count": newsPostsNumber
  }, /*#__PURE__*/React.createElement("h3", null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
    tagName: "span",
    className: "text",
    value: newsLabel
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }), bgType === 'image' && bgImg && /*#__PURE__*/React.createElement("div", {
    className: "bg_image"
  ...
  (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_8__.name, {
    ...
    edit: function edit(_ref2) {
      ...
      var logoText = attributes.logoText,
        ...
        bgFilterGradient = attributes.bgFilterGradient,
        bgFilterOpacity = attributes.bgFilterOpacity,
        navMenuId = attributes.navMenuId,
        navMenuItems = attributes.navMenuItems,
        newsSourceType = attributes.newsSourceType,
        newsIds = attributes.newsIds,
        newsPostsNumber = attributes.newsPostsNumber,
      ...
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
        if (!navMenuId) return;
        _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_4___default()({
          path: "/wp/v2/menu-items?menus=".concat(navMenuId, "&per_page=100")
        }).then(function (items) {
          // アイテムをソート
          ...
          // 階層構造を構築
          var _buildHierarchy = function buildHierarchy() {
            ...
            return sortedItems.filter(function (item) {
              ...
              return {
                id: item.id,
                title: ((_item$title = item.title) === null || _item$title === void 0 ? void 0 : _item$title.rendered) || item.title,
                url: item.url,
                children: _buildHierarchy(item.id)
              };
            });
          };
          var hierarchicalMenu = _buildHierarchy();
          setAttributes({
            navMenuItems: hierarchicalMenu
          });
        })["catch"](function () {
      ...
      var _useState3 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)([]),
        ...
        previewPosts = _useState4[0],
        setPreviewPosts = _useState4[1];
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
        var path = '';
        if (newsSourceType === 'ids' && newsIds.trim()) {
          path = "/wp/v2/posts?include=".concat(newsIds.replace(/\s+/g, ''), "&_embed");
        } else {
          path = "/wp/v2/posts?per_page=".concat(newsPostsNumber, "&_embed");
        }
        _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_4___default()({
          path: path
        }).then(setPreviewPosts)["catch"](function () {
          return setPreviewPosts([]);
        });
      }, [newsSourceType, newsIds, newsPostsNumber]);

      /* --- ハンドラ --- */
      var onSelectBg = function onSelectBg(m) {
        return setAttributes({
          bgImg: m.url,
          bgImgAlt: m.alt || ''
        });
      };
      var onSelectLogo = function onSelectLogo(m) {
        return setAttributes({
          logoImg: m.url,
          logoImgAlt: m.alt || ''
        });
      };
      var onSelectVid = function onSelectVid(m) {
        return setAttributes({
          videoUrl: m.url
        });
      };
      ...
      /* --- CTA背景色変更ハンドラ --- */
      var handleCTA1BgColorChange = function handleCTA1BgColorChange(color) {
        if (cta1BgColor === 'transparent' && color) {
          var rgbaColor = color.includes('rgba') ? color : "rgba(".concat(hexToRgb(color), ", 0.7)");
          setAttributes({
            cta1BgColor: rgbaColor
          });
        } else {
          setAttributes({
            cta1BgColor: color
      ...
      var handleCTA2BgColorChange = function handleCTA2BgColorChange(color) {
        if (cta2BgColor === 'transparent' && color) {
          var rgbaColor = color.includes('rgba') ? color : "rgba(".concat(hexToRgb(color), ", 0.7)");
          setAttributes({
            cta2BgColor: rgbaColor
          });
        } else {
          setAttributes({
            cta2BgColor: color
      ...
      var showCTA1 = cta1Enable; // トグルボタンの状態のみで判定
      var showCTA2 = cta2Enable; // トグルボタンの状態のみで判定
      var showCTAWrap = showCTA1 || showCTA2;
      var showNewsSection = newsListVisible !== false;

      /* --- メニューオプション --- */
      var menuOpts = menus ? [{
        label: '--- メニューを選択 ---',
        value: '0'
      }].concat(_toConsumableArray(menus.map(function (m) {
        return {
          label: m.name,
          value: String(m.id)
        };
      ...
      var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
        className: "paid-block-fv-12 ".concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp)
      });
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      }), logoImg && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\u30ED\u30B4\u9AD8\u3055(%)",
        value: logoImgHeight,
        onChange: function onChange(v) {
          return setAttributes({
        ...
        title: "CTA\u30DC\u30BF\u30F3",
        initialOpen: false
      }, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("h3", null, "CTA1 \u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "CTA1\u3092\u8868\u793A",
        checked: cta1Enable,
        onChange: function onChange(v) {
          return setAttributes({
      ...
      }, "\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: 8
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta1BgPicker: !attributes.showCta1BgPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u8272\u3092\u9078\u629E"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
        onClick: function onClick() {
          return setAttributes({
            cta1BgColor: 'transparent'
          });
        }
      }, "\u900F\u660E")), attributes.showCta1BgPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta1BgPicker: false
          });
        }
      ...
      }, "\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: 8
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta1TextPicker: !attributes.showCta1TextPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u8272\u3092\u9078\u629E")), attributes.showCta1TextPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta1TextPicker: false
          });
        }
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
        color: cta1TextColor,
      ...
      }, "\u30DC\u30FC\u30C0\u30FC\u8272"), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: 8
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta1BorderPicker: !attributes.showCta1BorderPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u8272\u3092\u9078\u629E")), attributes.showCta1BorderPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta1BorderPicker: false
          });
        }
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
        ...
        min: 0,
        max: 50
      }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("h3", null, "CTA2 \u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "CTA2\u3092\u8868\u793A",
        checked: cta2Enable,
        onChange: function onChange(v) {
          return setAttributes({
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta2BgPicker: !attributes.showCta2BgPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u900F\u660E")), attributes.showCta2BgPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta2BgPicker: false
          });
        }
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
        color: cta2BgColor,
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta2TextPicker: !attributes.showCta2TextPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u8272\u3092\u9078\u629E")), attributes.showCta2TextPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta2TextPicker: false
          });
        }
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
        color: cta2TextColor,
        ...
        onClick: function onClick() {
          return setAttributes({
            showCta2BorderPicker: !attributes.showCta2BorderPicker
          });
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "secondary",
      ...
      }, "\u8272\u3092\u9078\u629E")), attributes.showCta2BorderPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        onClose: function onClose() {
          return setAttributes({
            showCta2BorderPicker: false
          });
        }
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
        ...
        title: "\u80CC\u666F(\u753B\u50CF/\u52D5\u753B)",
        initialOpen: false
      }, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        label: "\u30BF\u30A4\u30D7",
        value: bgType,
        options: [{
          label: '画像',
      ...
      }), bgType === 'image' && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
        allowedTypes: ['image'],
        value: bgImg,
        onSelect: onSelectBg,
        render: function render(_ref4) {
          var open = _ref4.open;
          return /*#__PURE__*/React.createElement(React.Fragment, null, bgImg && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
            src: bgImg,
            alt: "",
            style: {
              width: '100%',
      ...
      }), bgType === 'image' && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u80CC\u666F\u753B\u50CF\u306E\u8AAC\u660E\uFF08alt\uFF09",
      ...
      }, /*#__PURE__*/React.createElement("strong", null, "\u63A8\u5968\u52D5\u753B\u5F62\u5F0F:"), /*#__PURE__*/React.createElement("ul", {
        style: {
          marginTop: 8,
          marginBottom: 0
        }
      }, /*#__PURE__*/React.createElement("li", null, "MP4 (H.264) - \u5168\u30D6\u30E9\u30A6\u30B6\u5BFE\u5FDC"), /*#__PURE__*/React.createElement("li", null, "WebM - Chrome/Firefox\u5BFE\u5FDC"), /*#__PURE__*/React.createElement("li", null, "MOV - Safari/iOS\u306E\u307F")), /*#__PURE__*/React.createElement("p", {
        style: {
          marginTop: 8,
          marginBottom: 0,
          fontSize: '12px'
        }
      }, "\u203B100MB\u4EE5\u4E0A\u306E\u52D5\u753B\u306F\u8AAD\u307F\u8FBC\u307F\u304C\u9045\u304F\u306A\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059"))), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("h3", null, "\u80CC\u666F\u30D5\u30A3\u30EB\u30BF\u30FC\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u3092\u4F7F\u7528",
        checked: bgFilterType === 'gradient',
        onChange: function onChange(isGradient) {
          return setAttributes({
      ...
      }), bgFilterType === 'solid' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u30D5\u30A3\u30EB\u30BF\u30FC\u8272",
        value: bgFilterColor,
        ...
        colors: colors
      })) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.GradientPicker, {
        value: bgFilterGradient,
        onChange: function onChange(gradient) {
          return setAttributes({
            bgFilterGradient: gradient
          });
        },
        gradients: gradients,
        ...
        max: 100,
        step: 5,
        help: bgFilterType === 'gradient' ? 'グラデーション全体の透明度を調整します' : '単色フィルターの透明度を調整します'
      }), /*#__PURE__*/React.createElement("div", {
        style: {
          marginTop: 16
        }
      ...
      }, "\u30D5\u30A3\u30EB\u30BF\u30FC\u3092\u30EA\u30BB\u30C3\u30C8"))), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: "\u30CA\u30D3\u30E1\u30CB\u30E5\u30FC",
        initialOpen: false
      }, !menus && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null), menus && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        label: "\u30E1\u30CB\u30E5\u30FC",
        value: String(navMenuId),
        options: menuOpts,
        onChange: function onChange(v) {
          return setAttributes({
            navMenuId: parseInt(v, 10)
          });
        }
      })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: "NEWS\u8A2D\u5B9A",
        ...
        label: "NEWS\u30BB\u30AF\u30B7\u30E7\u30F3\u3092\u8868\u793A",
        checked: newsListVisible,
        onChange: function onChange(v) {
          return setAttributes({
            newsListVisible: v
          });
        }
      }), newsListVisible && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        label: "\u53D6\u5F97\u65B9\u6CD5",
      ...
      }), newsSourceType === 'latest' && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\u8868\u793A\u4EF6\u6570",
        value: newsPostsNumber,
        ...
        min: 1,
        max: 10
      }), newsSourceType === 'ids' && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u6295\u7A3FID(,\u533A\u5207\u308A)",
        value: newsIds,
        onChange: function onChange(v) {
          return setAttributes({
        ...
        value: minHeightPc,
        options: (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.minHeightPcClassOptionArr)(),
        onChange: function onChange(value) {
          return setAttributes({
            minHeightPc: value
          });
        }
      }), /*#__PURE__*/React.createElement("p", null, "\u30BF\u30D6\u30EC\u30C3\u30C8\u7528\u9AD8\u3055"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        value: minHeightTb,
        options: (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.minHeightTbClassOptionArr)(),
        onChange: function onChange(value) {
          return setAttributes({
            minHeightTb: value
          });
        }
      }), /*#__PURE__*/React.createElement("p", null, "\u30B9\u30DE\u30FC\u30C8\u30D5\u30A9\u30F3\u7528\u9AD8\u3055"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
        value: minHeightSp,
        options: (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.minHeightSpClassOptionArr)(),
        onChange: function onChange(value) {
          return setAttributes({
            minHeightSp: value
          });
      ...
      }) : /*#__PURE__*/React.createElement("li", null, "\u30E1\u30CB\u30E5\u30FC\u672A\u9078\u629E"))), /*#__PURE__*/React.createElement("div", {
        className: "ham_btn drawer_nav_open"
      }, /*#__PURE__*/React.createElement("div", {
        className: "in"
      }, /*#__PURE__*/React.createElement("div", null), /*#__PURE__*/React.createElement("div", null)))), /*#__PURE__*/React.createElement("div", {
      ...
      })))), showNewsSection && /*#__PURE__*/React.createElement("nav", {
        className: "fv-12_news_list"
      }, /*#__PURE__*/React.createElement("h3", null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "span",
        className: "text",
        value: newsLabel,
        onChange: function onChange(v) {
        ...
        className: "date"
      }, "2024.01.15"), /*#__PURE__*/React.createElement("span", {
        className: "title"
      }, "\u65B0\u3057\u3044\u30B5\u30FC\u30D3\u30B9\u3092\u958B\u59CB\u3057\u307E\u3057\u305F\u65B0\u3057\u3044\u30B5\u30FC\u30D3\u30B9\u3092\u958B\u59CB\u3057\u307E\u3057\u305F"))), /*#__PURE__*/React.createElement("li", {
        "data-news-no": "2"
      }, /*#__PURE__*/React.createElement("a", {
        href: "#"
      }, /*#__PURE__*/React.createElement("span", {
        className: "date"
      }, "2024.01.10"), /*#__PURE__*/React.createElement("span", {
        className: "title"
      }, "\u304A\u5BA2\u69D8\u306E\u58F0\u3092\u66F4\u65B0\u3057\u307E\u3057\u305F"))), /*#__PURE__*/React.createElement("li", {
        "data-news-no": "3"
      }, /*#__PURE__*/React.createElement("a", {
        href: "#"
      }, /*#__PURE__*/React.createElement("span", {
        className: "date"
      }, "2024.01.05"), /*#__PURE__*/React.createElement("span", {
        className: "title"
      }, "\u5E74\u672B\u5E74\u59CB\u306E\u55B6\u696D\u306B\u3064\u3044\u3066\u306E\u304A\u77E5\u3089\u305B"))), /*#__PURE__*/React.createElement("li", {
        "data-news-no": "4"
      }, /*#__PURE__*/React.createElement("a", {
        href: "#"
      }, /*#__PURE__*/React.createElement("span", {
        className: "date"
      }, "2024.01.01"), /*#__PURE__*/React.createElement("span", {
        className: "title"
      }, "\u65B0\u5E74\u306E\u3054\u6328\u62F6"))))), /*#__PURE__*/React.createElement("div", {
        className: "bg_filter",
        style: getBgFilterStyle()
      }), bgType === 'image' && bgImg && /*#__PURE__*/React.createElement("div", {
        className: "bg_image"
    ...
    deprecated: [{
      ...
      save: function save(_ref7) {
        ...
        return renderFv12Save(attributes, true);
      }
    }]
  });
  /* === duplicate‑check end === */
...
/***/ "./src/paid-block-fv-12/editor.scss":
/*!******************************************!*\
  !*** ./src/paid-block-fv-12/editor.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-12/style.scss":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-12/style.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-12/block.json":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-12/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-fv-12","version":"1.0.0","title":"FV 12 ヘッダーまで回り込む全画背景","category":"lw-firstview","icon":"cover-image","editorScript":"file:./paid-block-fv-12.js","aiHint":{"description":"全画面FV（ヘッダー回り込み）。ロゴ+ナビ+見出し+2CTA+ニュース。動画対応。ブランドサイトに","excludeFromAutoSelect":false,"contentAttributes":["logoText","headline","cta1Text","cta2Text","newsLabel"],"imageAttributes":["logoImg","bgImg"],"notes":"ナビメニュー+ニュース配列あり。最も複雑なFVブロック 🚨 背景写真が明るいときは bgFilterOpacity を55以上にする（既定の30では白い見出しとCTAが背景に溶ける・実測）。🚨 このブロックはロゴ・ナビ・CTA・お知らせまで自分で描くので、ページのヘッダー設定（header_select）を「非表示」にしないとヘッダーが二重になる。newsListVisible を true にすると最新のお知らせが下部に流れる。 ［2026-08-27 追記］navMenuItems（[{title,url}] の配列）が空だとヘッダー右上が器だけ出て空欄になる。必ず入れること。サイトのWPメニューとは連動せず保存HTMLに焼き込まれる。newsListVisible を false にすると下のお知らせ欄が消える。bgFilterType を gradient にすると bgFilterGradient（CSSの linear-gradient 文字列）が効き、上は写真が見えて下だけ暗くできる。薄いフィルタ（22など）だと白い見出しが読めないので、明るい写真では45以上にする。"},"supports":{"anchor":true},"attributes":{"logoText":{"type":"string","default":"LOGO"},"logoUrl":{"type":"string","default":""},"logoImg":{"type":"string","default":""},"logoImgAlt":{"type":"string","default":"","aiHint":{"role":"alt","contentGuide":"ロゴ画像の説明。店名や会社名をそのまま書く","example":"カフェ そらまめ"}},"logoImgHeight":{"type":"number","default":70},"cta1Text":{"type":"string","default":"ご相談はこちら"},"cta1Url":{"type":"string","default":"#"},"cta1LinkType":{"type":"string","default":"url"},"cta1PageId":{"type":"number","default":0},"cta1CategoryId":{"type":"number","default":0},"cta1Enable":{"type":"boolean","default":true},"cta1BgColor":{"type":"string","default":"transparent"},"cta1TextColor":{"type":"string","default":"#ffffff"},"cta1BorderWidth":{"type":"number","default":1},"cta1BorderColor":{"type":"string","default":"#ffffff"},"cta1BorderRadius":{"type":"number","default":100},"showCta1BgPicker":{"type":"boolean","default":false},"showCta1TextPicker":{"type":"boolean","default":false},"showCta1BorderPicker":{"type":"boolean","default":false},"cta2Text":{"type":"string","default":"お問い合わせ"},"cta2Url":{"type":"string","default":"#"},"cta2LinkType":{"type":"string","default":"url"},"cta2PageId":{"type":"number","default":0},"cta2CategoryId":{"type":"number","default":0},"cta2Enable":{"type":"boolean","default":true},"cta2BgColor":{"type":"string","default":"transparent"},"cta2TextColor":{"type":"string","default":"#ffffff"},"cta2BorderWidth":{"type":"number","default":1},"cta2BorderColor":{"type":"string","default":"#ffffff"},"cta2BorderRadius":{"type":"number","default":100},"showCta2BgPicker":{"type":"boolean","default":false},"showCta2TextPicker":{"type":"boolean","default":false},"showCta2BorderPicker":{"type":"boolean","default":false},"headline":{"type":"string","default":"キャッチフレーズテキスト<br>キャッチフレーズテキスト"},"newsLabel":{"type":"string","default":"NEWS"},"newsListVisible":{"type":"boolean","default":true},"bgType":{"type":"string","default":"image"},"bgImg":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/cafe/1.webp"},"bgImgAlt":{"type":"string","default":"","aiHint":{"role":"alt","contentGuide":"背景画像の説明。飾りなら空でよい","example":"木のテーブルに置かれたコーヒーカップ"}},"videoUrl":{"type":"string","default":""},"videoSpeed":{"type":"number","default":1},"bgFilterType":{"type":"string","default":"solid"},"bgFilterColor":{"type":"string","default":"#000000"},"bgFilterGradient":{"type":"string","default":""},"bgFilterOpacity":{"type":"number","default":30},"navMenuId":{"type":"number","default":0},"navMenuItems":{"type":"array","default":[]},"newsSourceType":{"type":"string","default":"latest"},"newsIds":{"type":"string","default":""},"newsPostsNumber":{"type":"number","default":4},"minHeightPc":{"type":"string","default":"min-h-pc-100vh"},"minHeightTb":{"type":"string","default":"min-h-tb-100vh"},"minHeightSp":{"type":"string","default":"min-h-sp-100vh"}},"no":12}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-fv-12"], () => (__webpack_require__("./src/paid-block-fv-12/index.js")))
