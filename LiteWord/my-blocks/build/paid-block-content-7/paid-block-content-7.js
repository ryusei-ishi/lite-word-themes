...
/***/ "./src/paid-block-content-7/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-content-7/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-content-7/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-content-7/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-content-7/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var pcColumns = attributes.pcColumns,
      fontLi = attributes.fontLi,
    ...
    /* PCカラムクラスの設定 */
    var columnClass = pcColumns === '2' ? 'clm_2' : '';
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      className: "paid-block-content-7__inner ".concat(columnClass)
    }, contents.map(function (c, i) {
      return /*#__PURE__*/React.createElement("li", {
        key: i,
        className: "paid-block-content-7__li"
        ...
        style: {
          ...
          color: fontColorLi,
          borderRadius: "".concat(titleBorderRadius, "px"),
        ...
        tagName: "p",
        className: "paid-block-content-7__text ".concat(textFontSizeClass),
        value: c.text,
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromItem)(c, 'url'),
        onChange: function onChange(patch) {
          return updateContentMulti(i, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToItem)(patch, 'url'));
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        className: "paid-block-content-7__remove_btn",
        isDestructive: true,
        onClick: function onClick() {
      ...
      className: "paid-block-content-7__add_btn",
      isSecondary: true,
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B")));
  },
  ...
  save: function save(_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      className: "paid-block-content-7__inner ".concat(columnClass).trim()
    }, contents.map(function (c, i) {
      var Tag = c.url ? 'a' : 'div';
      var props = c.url ? {
        href: c.url,
        'data-lw-link-type': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(c, 'url').linkType,
        'data-lw-link-id': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(c, 'url').linkId,
        className: 'link'
      } : {
        className: 'link'
      };
      return /*#__PURE__*/React.createElement("li", {
        key: i,
        className: "paid-block-content-7__li"
      }, createElement(Tag, props, /*#__PURE__*/React.createElement(React.Fragment, null, c.image && /*#__PURE__*/React.createElement("div", {
        className: "image",
        style: {
          borderRadius: "".concat(imageBorderRadius, "px"),
          borderColor: borderColor,
...
/***/ "./src/paid-block-content-7/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-content-7/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-content-7/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-content-7/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-content-7/block.json":
/*!*********************************************!*\
  !*** ./src/paid-block-content-7/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-content-7","version":"1.0.0","title":"Content 07","category":"lw-content","icon":"lightbulb","editorScript":"file:./paid-block-content-7.js","aiHint":{"description":"画像+タイトル+説明文のカード配列。3カラム。学習塾・スクール・サービス紹介に","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":["contents.image"]},"supports":{"anchor":true},"attributes":{"pcColumns":{"type":"string","default":"3"},"fontLi":{"type":"string","default":""},"fontColorLi":{"type":"string","default":""},"fontWeightLi":{"type":"string","default":"600"},"titleFontSizeClass":{"type":"string","default":"font_size_m"},"fontLiP":{"type":"string","default":""},"fontColorLiP":{"type":"string","default":"var(--color-black)"},"fontWeightLiP":{"type":"string","default":"400"},"textFontSizeClass":{"type":"string","default":"font_size_m"},"borderColor":{"type":"string","default":"var(--color-main)"},"borderSize":{"type":"number","default":0},"imageBorderRadius":{"type":"number","default":20},"titleTag":{"type":"string","default":"h3"},"titleBorderRadius":{"type":"number","default":8},"titleBorderColor":{"type":"string","default":"var(--color-main)"},"titleBorderSize":{"type":"number","default":8},"contents":{"type":"array","source":"query","selector":".paid-block-content-7__li","query":{"image":{"type":"string","source":"attribute","selector":"img","attribute":"src"},"alt":{"type":"string","source":"attribute","selector":"img","attribute":"alt","default":""},"ttl":{"type":"string","source":"html","selector":".ttl"},"text":{"type":"string","source":"html","selector":".paid-block-content-7__text"},"url":{"type":"string","source":"attribute","selector":".link","attribute":"href","default":""},"linkType":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-type"},"linkId":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-id"}},"default":[{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/9.webp","ttl":"難関校合格実績","text":"〇〇中学、××高校など、難関校への高い合格実績が自慢です。経験豊富なプロ講師陣が、志望校合格まで徹底的にサポートします。"},{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/5.webp","ttl":"合格への最短ルート","text":"長年の指導ノウハウを結集したオリジナル教材とカリキュラムで、基礎から応用まで無駄なく効率的に学力を伸ばし、合格へと導きます。"},{"image":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/school/3.webp","ttl":"自習室完備＆質問OK","text":"静かで集中できる自習室を完備しています。わからないことはいつでも講師に質問可能。学習相談や進路指導も充実、安心して学習に専念できます。"}]}},"no":7}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-content-7": 0,
/******/ 			"./style-paid-block-content-7": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-content-7"], () => (__webpack_require__("./src/paid-block-content-7/index.js")))
