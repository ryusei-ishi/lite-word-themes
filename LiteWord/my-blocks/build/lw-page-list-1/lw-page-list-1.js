...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/lw-page-list-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-page-list-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/lw-page-list-1/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var numberOfPages = attributes.numberOfPages,
    ...
    /* 全固定ページ取得 */
    var pages = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(function (select) {
    ...
    /* 階層オプション生成 */
    var buildOptions = function buildOptions(list) {
      if (!list) return [{
        label: '読み込み中…',
        value: 0
      }];
      ...
      list.forEach(function (p) {
        return (byParent[p.parent || 0] = byParent[p.parent || 0] || []).push(p);
      });
      var _walk = function walk(pid) {
        var depth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var acc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
        (byParent[pid] || []).sort(function (a, b) {
          return a.menu_order - b.menu_order || a.title.raw.localeCompare(b.title.raw);
        }).forEach(function (p) {
          acc.push({
            label: '　'.repeat(depth) + (p.title.rendered || '(無題)'),
            value: p.id
          });
          _walk(p.id, depth + 1, acc);
        });
        return acc;
      };
      return [{
        label: '現在ページを親にする（自動）',
        value: 0
      }].concat(_toConsumableArray(_walk(0)));
    };
    var orderOptions = [{
      label: '新着順',
      value: 'date_desc'
    ...
    return /*#__PURE__*/React.createElement("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)(), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u57FA\u672C\u8A2D\u5B9A",
      initialOpen: true
      ...
      min: 1,
      max: 100
    }), !pages && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u89AA\u30DA\u30FC\u30B8\uFF08\u968E\u5C64\u8868\u793A\uFF09",
      value: parentPageId,
      options: buildOptions(pages),
      onChange: function onChange(v) {
        return setAttributes({
          parentPageId: parseInt(v, 10)
        });
      }
      ...
      className: "page-list-1__wrap"
    }, Array.from({
      length: Math.min(numberOfPages, 6)
    }).map(function (_, i) {
      return /*#__PURE__*/React.createElement("li", {
        ...
        loading: "lazy",
        src: "https://picsum.photos/1000/1000?random=".concat(i),
        alt: ""
      })), /*#__PURE__*/React.createElement("div", {
        className: "in"
      }, /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement("span", null, "2025/07/10"))), /*#__PURE__*/React.createElement("h3", {
        "data-lw_font_set": titleFont,
        style: {
          fontWeight: titleFontWeight
        }
      }, "\u30B5\u30F3\u30D7\u30EB\u30DA\u30FC\u30B8\u30BF\u30A4\u30C8\u30EB"), showExcerpt && /*#__PURE__*/React.createElement("p", {
...
/***/ "./src/lw-page-list-1/editor.scss":
/*!****************************************!*\
  !*** ./src/lw-page-list-1/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-page-list-1/block.json":
/*!***************************************!*\
  !*** ./src/lw-page-list-1/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-page-list-1","version":"1.0.0","title":"固定ページ一覧 1","category":"lw-post","icon":"editor-ul","editorScript":"file:./lw-page-list-1.js","aiHint":{"description":"固定ページ一覧カード。サムネイル+タイトル+抜粋。サービスページ一覧・子ページナビに","excludeFromAutoSelect":false,"contentAttributes":["numberOfPages"],"imageAttributes":[],"notes":"動的ブロック。DBから固定ページを取得。親ページID指定可能"},"supports":{"anchor":true},"attributes":{"uid":{"type":"string","default":""},"numberOfPages":{"type":"number","default":6},"parentPageId":{"type":"number","default":0},"orderOption":{"type":"string","default":"date_desc"},"openInNewTab":{"type":"boolean","default":false},"filterText":{"type":"string","default":""},"imagePattern":{"type":"string","default":"ptn_1"},"showDate":{"type":"boolean","default":false},"showExcerpt":{"type":"boolean","default":true},"dateFont":{"type":"string","default":"Noto Sans JP"},"dateFontWeight":{"type":"string","default":"400"},"titleFont":{"type":"string","default":"Noto Sans JP"},"titleFontWeight":{"type":"string","default":"500"},"exFont":{"type":"string","default":"Noto Sans JP"},"exFontWeight":{"type":"string","default":"400"},"catBgColor":{"type":"string","default":"var(--color-main)"}},"no":5}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-page-list-1"], () => (__webpack_require__("./src/lw-page-list-1/index.js")))
