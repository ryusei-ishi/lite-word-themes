...
/***/ "./src/paid-block-voice-2/index.js":
/*!*****************************************!*\
  !*** ./src/paid-block-voice-2/index.js ***!
  \*****************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-voice-2/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-voice-2/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-voice-2/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var blockTitleMain = attributes.blockTitleMain,
      blockTitleSub = attributes.blockTitleSub,
      explanation = attributes.explanation,
      filterColor = attributes.filterColor,
      filterOpacity = attributes.filterOpacity,
      voiceSubNameFont = attributes.voiceSubNameFont,
      voiceSubNameFontWeight = attributes.voiceSubNameFontWeight,
      voiceSubNameFontColor = attributes.voiceSubNameFontColor,
      voiceMeinNameFont = attributes.voiceMeinNameFont,
      voiceMeinNameFontWeight = attributes.voiceMeinNameFontWeight,
      voiceMeinNameFontColor = attributes.voiceMeinNameFontColor,
      voiceCommentFont = attributes.voiceCommentFont,
      voiceCommentFontWeight = attributes.voiceCommentFontWeight,
      voiceCommentFontColor = attributes.voiceCommentFontColor,
      voiceThanksFont = attributes.voiceThanksFont,
      voiceThanksFontWeight = attributes.voiceThanksFontWeight,
      voiceThanksFontColor = attributes.voiceThanksFontColor,
      voices = attributes.voices;

    // voices 配列の要素を更新
    var updateVoice = function updateVoice(index, key, value) {
      var updated = _toConsumableArray(voices);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      title: "\u5168\u4F53\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u30BF\u30A4\u30C8\u30EB\u30FB\u8AAC\u660E\u306E\u8A2D\u5B9A\u306F\u3053\u3061\u3089\u304B\u3089"), /*#__PURE__*/React.createElement("p", null, "\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: filterColor,
      ...
      onChange: function onChange(color) {
        return setAttributes({
          voiceThanksFontColor: color
        });
      }
    }))), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      className: "paid-block-voice-2__wrap"
      ...
      className: "voice_list"
    }, voices.map(function (item, index) {
      return /*#__PURE__*/React.createElement("li", {
        ...
        value: item.thanks,
        onChange: function onChange(val) {
          return updateVoice(index, 'thanks', val);
        },
        ...
        value: item.sub,
        onChange: function onChange(val) {
          return updateVoice(index, 'sub', val);
        },
        placeholder: "\u80A9\u66F8\u304D"
        ...
        value: item.nameBig,
        onChange: function onChange(val) {
          return updateVoice(index, 'nameBig', val);
        },
        placeholder: "\u540D\u524D\u5927"
      }), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "span",
        ...
        onChange: function onChange(val) {
          return updateVoice(index, 'nameSmall', val);
        },
        placeholder: "\u540D\u524D\u5C0F"
      }))), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "p",
        ...
        value: item.comment,
        onChange: function onChange(val) {
          return updateVoice(index, 'comment', val);
        },
        placeholder: "\u30B3\u30E1\u30F3\u30C8"
    ...
    }, "\uFF0B \u58F0\u3092\u8FFD\u52A0")), /*#__PURE__*/React.createElement("div", {
      className: "filter",
      style: {
...
/***/ "./src/paid-block-voice-2/editor.scss":
/*!********************************************!*\
  !*** ./src/paid-block-voice-2/editor.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-voice-2/style.scss":
/*!*******************************************!*\
  !*** ./src/paid-block-voice-2/style.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-voice-2": 0,
/******/ 			"./style-paid-block-voice-2": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-voice-2"], () => (__webpack_require__("./src/paid-block-voice-2/index.js")))
