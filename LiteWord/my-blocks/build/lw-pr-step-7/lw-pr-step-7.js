...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-step-7/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-step-7/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-step-7/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var updateContent = function updateContent(idx, key, value) {
      var updated = contents.map(function (item, i) {
        return i === idx ? _objectSpread(_objectSpread({}, item), {}, _defineProperty({}, key, value)) : item;
      });
      setAttributes({
        contents: updated
      });
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      max: 3,
      step: 1
    }), /*#__PURE__*/React.createElement("p", null, "STEP\u756A\u53F7\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: circleBgColor,
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30AB\u30FC\u30C9\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: cardBgColor,
      onChange: function onChange(c) {
        return setAttributes({
          cardBgColor: c
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u30AB\u30FC\u30C9\u306E\u67A0\u7DDA\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: borderColor,
      onChange: function onChange(c) {
        return setAttributes({
          borderColor: c
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        className: "lw-pr-step-7-item-controls"
...
/***/ "./src/lw-pr-step-7/block.json":
/*!*************************************!*\
  !*** ./src/lw-pr-step-7/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-step-7","version":"1.0.0","title":"step 07","category":"lw-step","icon":"list-view","supports":{"anchor":true},"editorScript":"file:./lw-pr-step-7.js","aiHint":{"description":"円形番号付きカードステップ。3カラムグリッド。サービスフロー・手順紹介に","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"no":7,"attributes":{"circleBgColor":{"type":"string","default":"#4a9d9c"},"cardBgColor":{"type":"string","default":"#ffffff"},"borderColor":{"type":"string","default":"#e0e0e0"},"ulMaxWidth":{"type":"number","default":1200},"columnCountPc":{"type":"number","default":3},"columnCountSp":{"type":"number","default":2},"columnCount":{"type":"number"},"fontSizeClass":{"type":"string","default":"font_size_m"},"fontNo":{"type":"string","default":"Murecho"},"fontWeightNo":{"type":"string","default":"700"},"colorNo":{"type":"string","default":"#ffffff"},"titleTag":{"type":"string","default":"h3"},"fontH3":{"type":"string","default":""},"fontWeightH3":{"type":"string","default":"600"},"colorH3":{"type":"string","default":"#333333"},"fontP":{"type":"string","default":""},"fontWeightP":{"type":"string","default":"400"},"colorP":{"type":"string","default":"#666666"},"contents":{"type":"array","source":"query","selector":".lw-pr-step-7__li","query":{"title":{"type":"string","source":"html","selector":".lw-pr-step-7__li_title"},"text":{"type":"string","source":"html","selector":".lw-pr-step-7__li_text"}},"default":[{"title":"","text":"説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テ"},{"title":"","text":"説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テ"},{"title":"","text":"説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テキスト説明テ"}]}}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-step-7"], () => (__webpack_require__("./src/lw-pr-step-7/index.js")))
