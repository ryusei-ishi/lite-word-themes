...
/***/ "./src/shin-gas-station-01-button-01/index.js":
/*!****************************************************!*\
  !*** ./src/shin-gas-station-01-button-01/index.js ***!
  \****************************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/shin-gas-station-01-button-01/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/shin-gas-station-01-button-01/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/shin-gas-station-01-button-01/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(props) {
    ...
    // 実際に使用する背景色を決定
    var actualBgColor = colorMode === 'palette' ? customBgColor : bgGradient;
    ...
    }, "\uD83C\uDF08 \u80CC\u666F\u30C7\u30B6\u30A4\u30F3"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: colorMode === 'select' ? '🎯 選択式（簡単）' : '🎨 カラーパレット（自由）',
      checked: colorMode === 'palette',
      onChange: function onChange(value) {
        return setAttributes({
          colorMode: value ? 'palette' : 'select'
        });
      },
      help: colorMode === 'select' ? '用意されたデザインから選択できます。オンにするとカラーパレットで自由に色を選べます。' : '自由に色を選択できます。オフにすると用意されたデザインから選べます。'
    }), colorMode === 'select' && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '15px'
      }
    ...
    })), colorMode === 'palette' && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '15px'
      }
    ...
    }, "\u304A\u597D\u304D\u306A\u8272\u3092\u81EA\u7531\u306B\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044"))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: '20px'
      }
    }, /*#__PURE__*/React.createElement("p", {
    ...
    }, "\uD83D\uDCDA \u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: FontSet,
      options: fontOptions,
    ...
    }, "\uD83D\uDCAA \u6587\u5B57\u306E\u592A\u3055"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: fontWeight,
    ...
    }, "\uD83C\uDFAF \u30A2\u30A4\u30B3\u30F3\u306E\u7A2E\u985E"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: selectedIcon,
    ...
    })), selectedIcon && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
      style: {
        fontWeight: 'bold',
        marginBottom: '8px'
      }
    ...
    })), borderWidth > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
      style: {
        fontWeight: 'bold',
        marginBottom: '8px'
      }
    ...
    }), selectedIcon && /*#__PURE__*/React.createElement("div", {
      className: "icon-svg",
  ...
  save: function save(props) {
    var _props$attributes = props.attributes,
      ...
      bgGradient = _props$attributes.bgGradient,
      colorMode = _props$attributes.colorMode,
      customBgColor = _props$attributes.customBgColor,
...
/***/ "./src/shin-gas-station-01-button-01/editor.scss":
/*!*******************************************************!*\
  !*** ./src/shin-gas-station-01-button-01/editor.scss ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-button-01/style.scss":
/*!******************************************************!*\
  !*** ./src/shin-gas-station-01-button-01/style.scss ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-button-01/block.json":
/*!******************************************************!*\
  !*** ./src/shin-gas-station-01-button-01/block.json ***!
  \******************************************************/
/***/ ((module) => {
...
/******/ 		var installedChunks = {
/******/ 			"shin-gas-station-01-button-01": 0,
/******/ 			"./style-shin-gas-station-01-button-01": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-shin-gas-station-01-button-01"], () => (__webpack_require__("./src/shin-gas-station-01-button-01/index.js")))
