...
/***/ "./src/shin-gas-station-01-list-4/index.js":
/*!*************************************************!*\
  !*** ./src/shin-gas-station-01-list-4/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/shin-gas-station-01-list-4/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/shin-gas-station-01-list-4/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/shin-gas-station-01-list-4/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: function edit(props) {
    ...
    var removeContent = function removeContent(index) {
      var updatedContents = contents.filter(function (_, i) {
        return i !== index;
      });
      setAttributes({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, null, /*#__PURE__*/React.createElement("p", null, "\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u8272\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      label: "\u67A0\u306E\u8272",
      value: borderColor,
      onChange: function onChange(newBorderColor) {
        return setAttributes({
      ...
      min: 0,
      max: 10
    }), /*#__PURE__*/React.createElement("p", null, "\u30BF\u30A4\u30C8\u30EB\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      label: "\u30BF\u30A4\u30C8\u30EB\u306E\u6587\u5B57\u8272",
      value: fontColorLi,
      onChange: function onChange(newFontColorLi) {
        return setAttributes({
          fontColorLi: newFontColorLi
        });
      }
      ...
      value: fontLi,
      options: fontOptions,
      onChange: function onChange(newFontLi) {
        return setAttributes({
          fontLi: newFontLi
        });
      }
      ...
      onChange: function onChange(newFontWeightLi) {
        return setAttributes({
          fontWeightLi: newFontWeightLi
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u8AAC\u660E\u90E8\u5206\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      label: "\u8AAC\u660E\u90E8\u5206\u306E\u6587\u5B57\u8272",
      value: fontColorLiP,
      onChange: function onChange(newFontColorLiP) {
        return setAttributes({
          fontColorLiP: newFontColorLiP
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u8AAC\u660E\u90E8\u5206\u306E\u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E",
      value: fontLiP,
      options: fontOptions,
      onChange: function onChange(newFontLiP) {
        return setAttributes({
          fontLiP: newFontLiP
        });
      }
      ...
      value: fontWeightLiP,
      options: fontWeightOptions,
      onChange: function onChange(newFontWeightLiP) {
        return setAttributes({
          fontWeightLiP: newFontWeightLiP
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "STEP\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      label: "STEP\u306E\u6587\u5B57\u8272",
      value: stepFontColor,
      onChange: function onChange(newStepFontColor) {
        return setAttributes({
          stepFontColor: newStepFontColor
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "STEP\u306E\u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E",
      value: stepFont,
      options: fontOptions,
      onChange: function onChange(newStepFont) {
        return setAttributes({
          stepFont: newStepFont
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "STEP\u306E\u30D5\u30A9\u30F3\u30C8\u306E\u592A\u3055",
      ...
      options: fontWeightOptions,
      onChange: function onChange(newStepFontWeight) {
        return setAttributes({
          stepFontWeight: newStepFontWeight
        });
      }
    }))), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      className: "shin-gas-station-01-list-4__inner"
      ...
      return /*#__PURE__*/React.createElement("li", {
      ...
      }, content.image && /*#__PURE__*/React.createElement("div", {
        className: "image"
      ...
      }, "\u753B\u50CF\u3092\u524A\u9664"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
        className: "shin-gas-station-01-list-4__text"
        ...
        onChange: function onChange(value) {
          return updateContent(index, 'ttl', value);
        } // ← ttl を更新
        ,
        placeholder: "\u30BF\u30A4\u30C8\u30EB\u3092\u5165\u529B",
        style: {
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkFromItem)(content, 'url'),
        onChange: function onChange(patch) {
          return updateContentMulti(index, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkToItem)(patch, 'url'));
        }
      }), /*#__PURE__*/React.createElement("button", {
        className: "shin-gas-station-01-list-4__remove_btn",
        onClick: function onClick() {
          return removeContent(index);
        }
      }, "\u524A\u9664"));
    })), /*#__PURE__*/React.createElement("button", {
      className: "shin-gas-station-01-list-4__add_btn",
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B")));
  },
  save: function save(props) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("ul", {
      ...
      var TagName = content.url ? 'a' : 'div';
      var linkProps = content.url ? {
        href: content.url,
        'data-lw-link-type': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromItem)(content, 'url').linkType,
        'data-lw-link-id': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromItem)(content, 'url').linkId,
        className: 'link'
      } : {
        className: 'link'
      };
      ...
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(TagName, linkProps, /*#__PURE__*/React.createElement(React.Fragment, null, content.image && /*#__PURE__*/React.createElement("div", {
        className: "image"
      }, /*#__PURE__*/React.createElement("img", {
        src: content.image,
        alt: ""
...
/***/ "./src/shin-gas-station-01-list-4/editor.scss":
/*!****************************************************!*\
  !*** ./src/shin-gas-station-01-list-4/editor.scss ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-list-4/style.scss":
/*!***************************************************!*\
  !*** ./src/shin-gas-station-01-list-4/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/shin-gas-station-01-list-4/block.json":
/*!***************************************************!*\
  !*** ./src/shin-gas-station-01-list-4/block.json ***!
  \***************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/shin-gas-station-01-list-4","version":"1.0.0","title":"インフォリスト 4 shin info pattern 01","category":"lw-list","icon":"lightbulb","supports":{"anchor":true},"aiHint":{"description":"画像+タイトル+説明文のカードリスト。番号バッジ付き。サービス紹介・施設案内に。ショップテンプレート用","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"attributes":{"fontLi":{"type":"string","default":"","aiHint":{"skip":true}},"fontColorLi":{"type":"string","default":"var(--color-main)","aiHint":{"skip":true}},"fontWeightLi":{"type":"string","default":"600","aiHint":{"skip":true}},"fontLiP":{"type":"string","default":"","aiHint":{"skip":true}},"fontColorLiP":{"type":"string","default":"var(--color-black)","aiHint":{"skip":true}},"fontWeightLiP":{"type":"string","default":"400","aiHint":{"skip":true}},"stepFont":{"type":"string","default":"","aiHint":{"skip":true}},"stepFontColor":{"type":"string","default":"#fff","aiHint":{"skip":true}},"stepFontWeight":{"type":"string","default":"600","aiHint":{"skip":true}},"backgroundColor":{"type":"string","default":"#FAFAFA","aiHint":{"skip":true}},"borderColor":{"type":"string","default":"var(--color-main)","aiHint":{"skip":true}},"borderSize":{"type":"number","default":0,"aiHint":{"skip":true}},"contents":{"type":"array","source":"query","selector":".shin-gas-station-01-list-4__li","query":{"image":{"type":"string","source":"attribute","selector":"img","attribute":"src"},"ttl":{"type":"string","source":"html","selector":".shin-gas-station-01-list-4__text h4"},"text":{"type":"string","source":"html","selector":".shin-gas-station-01-list-4__text p"},"url":{"type":"string","source":"attribute","selector":".link","attribute":"href","default":""},"linkType":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-type"},"linkId":{"type":"string","source":"attribute","selector":".link","attribute":"data-lw-link-id"}},"default":[{"image":"https://lite-word.com/sample_img/shin/gas_station/content_1.webp","ttl":"タイトルタイトル","text":"テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト "},{"image":"https://lite-word.com/sample_img/shin/gas_station/content_1.webp","ttl":"タイトルタイトル","text":"テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト "},{"image":"https://lite-word.com/sample_img/shin/gas_station/content_1.webp","ttl":"タイトルタイトル","text":"テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト "}]}},"editorScript":"file:./shin-gas-station-01-list-4.js","no":15}');
...
/******/ 		var installedChunks = {
/******/ 			"shin-gas-station-01-list-4": 0,
/******/ 			"./style-shin-gas-station-01-list-4": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-shin-gas-station-01-list-4"], () => (__webpack_require__("./src/shin-gas-station-01-list-4/index.js")))
