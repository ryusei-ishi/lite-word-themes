...
/***/ "./src/paid-block-voice-3/index.js":
/*!*****************************************!*\
  !*** ./src/paid-block-voice-3/index.js ***!
  \*****************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-voice-3/style.scss");
...
var lwBlockDef = {
  ...
  edit: function edit(_ref) {
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
      var newId = "paid-block-voice-3-".concat(clientId);
    ...
    var updateVoice = function updateVoice(index, key, value) {
      var newVoices = voices.map(function (voice, i) {
        return i === index ? _objectSpread(_objectSpread({}, voice), {}, _defineProperty({}, key, value)) : voice;
      });
      setAttributes({
        voices: newVoices
      });
    ...
    var addVoice = function addVoice() {
      if (voices.length < 20) {
        setAttributes({
          voices: [].concat(_toConsumableArray(voices), [{
            name: '新しいお客様',
            age: '30代',
            job: '会社員',
    ...
    var removeVoice = function removeVoice(index) {
      if (voices.length > 1) {
        setAttributes({
          voices: voices.filter(function (_, i) {
            return i !== index;
          })
        });
      }
    ...
    /* 順番変更ヘルパー ------------------------------------------*/
    var moveVoiceUp = function moveVoiceUp(index) {
      if (index === 0) return;
      var newVoices = _toConsumableArray(voices);
      var _ref2 = [newVoices[index], newVoices[index - 1]];
      newVoices[index - 1] = _ref2[0];
      newVoices[index] = _ref2[1];
      setAttributes({
        voices: newVoices
      });
    };
    var moveVoiceDown = function moveVoiceDown(index) {
      if (index === voices.length - 1) return;
      var newVoices = _toConsumableArray(voices);
      var _ref3 = [newVoices[index + 1], newVoices[index]];
      newVoices[index] = _ref3[0];
      newVoices[index + 1] = _ref3[1];
      setAttributes({
        voices: newVoices
      });
    };
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u73FE\u5728 ", voices.length, " \u4EF6\u306E\u304A\u5BA2\u69D8\u306E\u58F0\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u3059"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isPrimary: true,
      onClick: addVoice,
      disabled: voices.length >= 20
    }, "+ \u304A\u5BA2\u69D8\u306E\u58F0\u3092\u8FFD\u52A0"), voices.length >= 20 && /*#__PURE__*/React.createElement("p", {
      style: {
        color: '#d63638',
        marginTop: '8px'
      }
    }, "\u203B \u6700\u592720\u4EF6\u307E\u3067\u767B\u9332\u3067\u304D\u307E\u3059")), voices.map(function (voice, index) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        key: index,
        title: "\u304A\u5BA2\u69D8\u306E\u58F0 ".concat(index + 1, ": ").concat(voice.name),
        initialOpen: false
        ...
        onClick: function onClick() {
          return moveVoiceUp(index);
        },
        disabled: index === 0,
        style: {
          flex: 1
        }
      }, "\u2191 \u4E0A\u306B\u79FB\u52D5"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isSecondary: true,
        onClick: function onClick() {
          return moveVoiceDown(index);
        },
        disabled: index === voices.length - 1,
        style: {
          flex: 1
        }
      }, "\u2193 \u4E0B\u306B\u79FB\u52D5")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u304A\u540D\u524D",
        value: voice.name,
        onChange: function onChange(v) {
          return updateVoice(index, 'name', v);
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u5E74\u4EE3",
        value: voice.age,
        onChange: function onChange(v) {
          return updateVoice(index, 'age', v);
        },
        placeholder: "\u4F8B: 30\u4EE3"
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u8077\u696D",
        value: voice.job,
        onChange: function onChange(v) {
          return updateVoice(index, 'job', v);
        },
        placeholder: "\u4F8B: \u4F1A\u793E\u54E1"
      }), /*#__PURE__*/React.createElement("p", {
        style: {
      ...
      }, /*#__PURE__*/React.createElement("strong", null, "\u5199\u771F")), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
        onSelect: function onSelect(media) {
          return updateVoice(index, 'photo', media.url);
        },
        allowedTypes: ['image'],
        value: voice.photo,
        render: function render(_ref4) {
          var open = _ref4.open;
          return /*#__PURE__*/React.createElement("div", null, voice.photo && /*#__PURE__*/React.createElement("img", {
            src: voice.photo,
        ...
        value: voice.excerpt,
        onChange: function onChange(v) {
          return updateVoice(index, 'excerpt', v);
        },
        rows: 3,
        ...
        value: voice.text,
        onChange: function onChange(v) {
          return updateVoice(index, 'text', v);
        },
        rows: 6,
      ...
      }, "\uD83D\uDDD1\uFE0F \u3053\u306E\u304A\u5BA2\u69D8\u306E\u58F0\u3092\u524A\u9664"), voices.length <= 1 && /*#__PURE__*/React.createElement("p", {
        style: {
          color: '#d63638',
          marginTop: '8px',
          fontSize: '12px'
    ...
    }, "\u304A\u540D\u524D\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: nameColor,
      onChange: function onChange(v) {
        return setAttributes({
          nameColor: v || '#333333'
    ...
    }, "\u629C\u7C8B\u6587\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: excerptColor,
      onChange: function onChange(v) {
        return setAttributes({
          excerptColor: v || '#666666'
        });
      }
    }), /*#__PURE__*/React.createElement("hr", {
      style: {
    ...
    }, "\u5E74\u4EE3\u30FB\u8077\u696D\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: metaColor,
      onChange: function onChange(v) {
        return setAttributes({
          metaColor: v || '#999999'
    ...
    }, "\u203B \u7A7A\u6B04\u306E\u5834\u5408\u306F\u30C6\u30FC\u30DE\u306E\u30C7\u30D5\u30A9\u30EB\u30C8\u8272\u304C\u4F7F\u7528\u3055\u308C\u307E\u3059"), /*#__PURE__*/React.createElement("hr", {
      style: {
        margin: '20px 0'
      }
    }), /*#__PURE__*/React.createElement("p", {
    ...
    }, "\u30DC\u30BF\u30F3\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: btnTextColor,
      onChange: function onChange(v) {
        return setAttributes({
          btnTextColor: v
    ...
    }, "\u203B \u7A7A\u6B04\u306E\u5834\u5408\u306F\u30C6\u30FC\u30DE\u306E\u30C7\u30D5\u30A9\u30EB\u30C8\u8272\u304C\u4F7F\u7528\u3055\u308C\u307E\u3059")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30D5\u30A9\u30F3\u30C8\u8A2D\u5B9A",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", {
      style: {
    ...
    }, "\u304A\u540D\u524D\u306E\u30D5\u30A9\u30F3\u30C8"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u30D5\u30A1\u30DF\u30EA\u30FC",
      value: nameFontSet,
      options: fontOptions,
      onChange: function onChange(v) {
    ...
    }, "\u629C\u7C8B\u6587\u306E\u30D5\u30A9\u30F3\u30C8"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u30D5\u30A1\u30DF\u30EA\u30FC",
      ...
      title: "\u30B9\u30E9\u30A4\u30C0\u30FC\u306E\u8868\u793A\u679A\u6570\u306A\u3069",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "600px\u4EE5\u4E0A")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u8868\u793A\u679A\u6570",
      ...
      max: 50,
      step: 2
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "900px\u4EE5\u4E0A")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u8868\u793A\u679A\u6570",
    ...
    }), showPagination && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
    ...
    }, "\uD83D\uDCE3 \u304A\u5BA2\u69D8\u306E\u58F0\u30B9\u30E9\u30A4\u30C0\u30FC"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: 0,
        color: '#666',
        fontSize: '14px'
      }
    }, voices.length, " \u4EF6\u306E\u304A\u5BA2\u69D8\u306E\u58F0\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u3059"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '8px 0 0',
        color: '#999',
        fontSize: '12px'
      }
    }, "\u203B \u5B9F\u969B\u306E\u30B9\u30E9\u30A4\u30C0\u30FC\u306F\u30D5\u30ED\u30F3\u30C8\u30A8\u30F3\u30C9\u3067\u8868\u793A\u3055\u308C\u307E\u3059")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
      ...
      }, index + 1), voice.photo && /*#__PURE__*/React.createElement("img", {
        src: voice.photo,
        alt: voice.alt || voice.name,
        style: {
          width: '60px',
      ...
      }, voice.name), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: '12px',
          color: '#666'
        }
...
/***/ "./src/paid-block-voice-3/editor.scss":
/*!********************************************!*\
  !*** ./src/paid-block-voice-3/editor.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-voice-3/style.scss":
/*!*******************************************!*\
  !*** ./src/paid-block-voice-3/style.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-voice-3/block.json":
/*!*******************************************!*\
  !*** ./src/paid-block-voice-3/block.json ***!
  \*******************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-voice-3","version":"1.0.0","title":"お客様の声 03 (スライダー・モーダル付き)","category":"lw-voice","icon":"format-quote","editorScript":"file:./paid-block-voice-3.js","aiHint":{"description":"お客様の声スライダー。写真+名前+年代+職業+抜粋+詳細モーダル。カルーセル表示。リッチなレビューに","excludeFromAutoSelect":false,"contentAttributes":["voices"],"imageAttributes":[],"notes":"blockId は空のままでよい（2026-08-26 にブロック側を直した。空なら読み込み時に自分で id を振って初期化する）。それ以前は空だと init-hide が外れずフロントで真っ白になっていた。"},"supports":{"anchor":true},"no":3,"attributes":{"blockId":{"type":"string"},"voices":{"type":"array","default":[{"name":"田中 美咲様","age":"30代","job":"会社員","photo":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/women/4.webp","alt":"田中様","excerpt":"とても丁寧な対応で、安心してお任せすることができました。想像以上の仕上がりに大満足です...","text":"とても丁寧な対応で、安心してお任せすることができました。想像以上の仕上がりに大満足です。\\n\\n初めての利用で不安もありましたが、最初のヒアリングから丁寧に対応していただき、こちらの要望を細かく聞いてくださいました。途中経過も随時報告していただけたので、安心して任せることができました。\\n\\n仕上がりも想像以上で、細部まで気を配っていただいたことが伝わってきます。友人にも自信を持って勧められるサービスです。本当にありがとうございました。"},{"name":"佐藤 健太様","age":"40代","job":"自営業","photo":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/women/5.webp","alt":"佐藤様","excerpt":"スピーディーな対応と、細かい要望にも応えていただき感謝しています。また利用したいです...","text":"スピーディーな対応と、細かい要望にも応えていただき感謝しています。また利用したいです。\\n\\n急な依頼にも関わらず、迅速に対応していただきました。こちらの細かい要望にも一つ一つ丁寧に答えていただき、期待以上の結果となりました。\\n\\nプロフェッショナルな仕事ぶりと柔軟な対応力に感動しました。次回もぜひお願いしたいと思います。長くお付き合いできるパートナーを見つけられて嬉しいです。"},{"name":"鈴木 明子様","age":"50代","job":"主婦","photo":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/reception/women/1.webp","alt":"鈴木様","excerpt":"初めての利用で不安でしたが、親切に説明していただき安心できました。結果も期待以上でした...","text":"初めての利用で不安でしたが、親切に説明していただき安心できました。結果も期待以上でした。\\n\\n専門的なことは全く分からない状態でしたが、一から丁寧に説明していただき、とても分かりやすかったです。質問にも快く答えていただき、安心して進めることができました。\\n\\n完成したものを見て、本当に驚きました。こんなに素晴らしい仕上がりになるとは思っていませんでした。感謝の気持ちでいっぱいです。"}]},"autoplayDelay":{"type":"number","default":4000},"loop":{"type":"boolean","default":true},"disableOnInteraction":{"type":"boolean","default":false},"showPagination":{"type":"boolean","default":true},"paginationClickable":{"type":"boolean","default":true},"showNavigation":{"type":"boolean","default":true},"sliderSpeed":{"type":"number","default":600},"slidesPerView600":{"type":"number","default":2},"slidesPerView900":{"type":"number","default":3},"spaceBetween600":{"type":"number","default":24},"spaceBetween900":{"type":"number","default":30},"maxWidthContainer":{"type":"number","default":1120},"cardBgColor":{"type":"string","default":"#ffffff"},"cardShadowColor":{"type":"string","default":"rgba(0, 0, 0, 0.08)"},"nameColor":{"type":"string","default":"#333333"},"excerptColor":{"type":"string","default":"#666666"},"metaColor":{"type":"string","default":"#999999"},"btnBgColor":{"type":"string","default":""},"btnTextColor":{"type":"string","default":""},"nameFontSet":{"type":"string","default":""},"nameFontWeight":{"type":"string","default":"600"},"excerptFontSet":{"type":"string","default":""},"excerptFontWeight":{"type":"string","default":"400"}}}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-voice-3": 0,
/******/ 			"./style-paid-block-voice-3": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-voice-3"], () => (__webpack_require__("./src/paid-block-voice-3/index.js")))
