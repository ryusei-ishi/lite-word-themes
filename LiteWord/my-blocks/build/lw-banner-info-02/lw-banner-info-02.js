...
/***/ "./src/lw-banner-info-02/index.js":
/*!****************************************!*\
  !*** ./src/lw-banner-info-02/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/lw-banner-info-02/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-banner-info-02/editor.scss");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils.js */ "./src/utils.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-banner-info-02/block.json");
...
// フォントオプションを変数に定義
var fontOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.fontOptionsArr)();
var fontWeightOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.fontWeightOptionsArr)();
var lwBlockDef = {
  edit: function edit(props) {
    ...
    var items = attributes.items,
      ...
      pFontFamily = attributes.pFontFamily,
    ...
    var updateItem = function updateItem(index, key, value) {
      return updateItemMulti(index, _defineProperty({}, key, value));
    };
    ...
    return /*#__PURE__*/React.createElement("nav", blockProps, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, items.map(function (item, index) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: "\u9805\u76EE ".concat(index + 1),
        key: index
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u30EA\u30F3\u30AF\u5148URL",
        value: item.linkUrl,
        onChange: function onChange(url) {
          return updateItem(index, 'linkUrl', url);
        }
      }), /*#__PURE__*/React.createElement(_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.LinkPicker, {
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromAttrs)(item, LINK_KEYS),
        onChange: function onChange(patch) {
          return updateItemMulti(index, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToAttrs)(patch, LINK_KEYS));
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "\u65B0\u898F\u30BF\u30D6\u3067\u958B\u304F",
        checked: item.openInNewTab,
        onChange: function onChange(value) {
          return updateItem(index, 'openInNewTab', value);
        }
      }), /*#__PURE__*/React.createElement("p", null, "\u753B\u50CF"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
        ...
        render: function render(_ref) {
          var open = _ref.open;
          return /*#__PURE__*/React.createElement(React.Fragment, null, item.imgUrl ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
            src: item.imgUrl,
            alt: "\u9078\u629E\u3055\u308C\u305F\u753B\u50CF",
            style: {
              maxWidth: '100%',
      ...
      }), item.imgUrl && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u753B\u50CF\u306E\u8AAC\u660E\uFF08alt\uFF09",
      ...
      title: "\u30D5\u30A3\u30EB\u30BF\u30FC\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      ...
      title: "\u30D5\u30A9\u30F3\u30C8\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u30BF\u30A4\u30C8\u30EB\u90E8\u5206"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E",
      ...
      onChange: function onChange(newFontWeight) {
        return setAttributes({
          titleFontWeight: newFontWeight
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u8AAC\u660E\u90E8\u5206"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E",
      value: pFontFamily,
      options: fontOptions,
      onChange: function onChange(newPFontFamily) {
        return setAttributes({
          pFontFamily: newPFontFamily
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u306E\u592A\u3055",
      value: pFontWeight,
      options: fontWeightOptions,
      onChange: function onChange(newPFontWeight) {
        return setAttributes({
          pFontWeight: newPFontWeight
        });
      }
    }))), /*#__PURE__*/React.createElement("ul", {
      className: "lw-banner-info-02__wrap"
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        "data-lw_font_set": titleFontFamily
  ...
  save: function save(props) {
    ...
    return /*#__PURE__*/React.createElement("nav", blockProps, /*#__PURE__*/React.createElement("ul", {
      className: "lw-banner-info-02__wrap"
    }, items.map(function (item, index) {
      // リンクの有無をチェック
      var hasLink = item.linkUrl && item.linkUrl.trim() !== '';
      var WrapperTag = hasLink ? 'a' : 'div';

      // プロパティ設定
      var wrapperProps = hasLink ? {
        href: item.linkUrl,
        'data-lw-link-type': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromAttrs)(item, LINK_KEYS).linkType,
        'data-lw-link-id': (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromAttrs)(item, LINK_KEYS).linkId,
      ...
      return /*#__PURE__*/React.createElement("li", {
        key: index
      }, /*#__PURE__*/React.createElement(WrapperTag, wrapperProps, item.imgUrl && /*#__PURE__*/React.createElement("img", {
        src: item.imgUrl,
        alt: item.alt || ''
      }), /*#__PURE__*/React.createElement("h3", {
        className: "title",
...
LW_1169_OLD.items["default"][3].imgUrl = "https://picsum.photos/1000/1000?random=4";
...
/***/ "./src/lw-banner-info-02/editor.scss":
/*!*******************************************!*\
  !*** ./src/lw-banner-info-02/editor.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-banner-info-02/style.scss":
/*!******************************************!*\
  !*** ./src/lw-banner-info-02/style.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-banner-info-02/block.json":
/*!******************************************!*\
  !*** ./src/lw-banner-info-02/block.json ***!
  \******************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-banner-info-02","version":"1.0.0","title":"バナー 02（4カラム）","category":"lw-banner","icon":"images-alt2","aiHint":{"description":"画像バナー4カラム。画像+タイトル+説明+リンクのカード4枚。メニュー・施設案内に","excludeFromAutoSelect":false,"contentAttributes":["items"],"imageAttributes":["items.imgUrl"]},"supports":{"anchor":true},"attributes":{"filterBackgroundColor":{"type":"string","default":"#000"},"filterOpacity":{"type":"number","default":0.45},"titleFontFamily":{"type":"string","default":"Noto Sans JP"},"titleFontWeight":{"type":"string","default":"600"},"pFontFamily":{"type":"string","default":"Noto Sans JP"},"pFontWeight":{"type":"string","default":"400"},"items":{"type":"array","default":[{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://lite-word.com/sample_img/shop/1.webp","alt":"","linkUrl":"","openInNewTab":false},{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://lite-word.com/sample_img/shop/2.webp","alt":"","linkUrl":"","openInNewTab":false},{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://lite-word.com/sample_img/shop/3.webp","alt":"","linkUrl":"","openInNewTab":false},{"title":"タイトルタイトル","description":"説明テキスト説明テキスト説明テキスト説明テキスト","imgUrl":"https://lite-word.com/sample_img/shop/4.webp","alt":"","linkUrl":"","openInNewTab":false}]}},"editorScript":"file:./lw-banner-info-02.js","no":4}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-banner-info-02"], () => (__webpack_require__("./src/lw-banner-info-02/index.js")))
