...
/***/ "./src/paid-block-lw-step-5/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-lw-step-5/index.js ***!
  \*******************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-lw-step-5/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-lw-step-5/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-lw-step-5/block.json");
...
/* HEX → RGBA 変換（影用） */
var hexToRgba = function hexToRgba() {
  var hex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '#000000';
  var a = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var h = hex.replace('#', '');
  var full = h.length === 3 ? h.split('').map(function (c) {
    return c + c;
  }).join('') : h.padEnd(6, '0');
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var bgGradient = attributes.bgGradient,
      ...
      shadowAlpha = attributes.shadowAlpha,
    ...
    var addContent = function addContent() {
      return setAttributes({
        contents: [].concat(_toConsumableArray(contents), [{
          no: "".concat(contents.length + 1, "\u6708"),
          title: '',
          text: ''
        }])
      });
    };
    var removeContent = function removeContent(idx) {
      return setAttributes({
    ...
    var updateContent = function updateContent(idx, key, val) {
      var updated = contents.map(function (item, i) {
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "paid-block-lw-step-5 ".concat(fontSizeClass)
    });
    ...
    var liStyle = {
      ...
      boxShadow: "0 0 ".concat(shadowBlur, "px ").concat(hexToRgba(shadowColor, shadowAlpha))
    };
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      max: 1280,
      step: 1
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u30FBSTEP \u756A\u53F7\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: bgGradient,
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        value: c.title,
        onChange: function onChange(v) {
          return updateContent(i, 'title', v);
        },
...
/***/ "./src/paid-block-lw-step-5/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-lw-step-5/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-5/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-5/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-5/block.json":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-5/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-lw-step-5","version":"1.0.0","title":"step 05","category":"lw-step","icon":"lightbulb","supports":{"anchor":true},"editorScript":"file:./paid-block-lw-step-5.js","aiHint":{"description":"影付きカード型ステップ。番号は月表記も可。ボーダー+シャドウ。タイムライン表示に","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"no":5,"attributes":{"bgGradient":{"type":"string","default":"var(--color-main)"},"ulMaxWidth":{"type":"number","default":1080},"fontSizeClass":{"type":"string","default":"font_size_m"},"borderWidth":{"type":"number","default":0},"borderStyle":{"type":"string","default":"solid"},"borderColor":{"type":"string","default":"var(--color-main)"},"shadowBlur":{"type":"number","default":6},"shadowColor":{"type":"string","default":"#000000"},"shadowAlpha":{"type":"number","default":0.16},"fontNo":{"type":"string","default":"Murecho"},"fontWeightNo":{"type":"string","default":"600"},"colorNo":{"type":"string","default":""},"titleTag":{"type":"string","default":"h3"},"fontH3":{"type":"string","default":""},"fontWeightH3":{"type":"string","default":""},"colorH3":{"type":"string","default":""},"fontP":{"type":"string","default":""},"fontWeightP":{"type":"string","default":""},"colorP":{"type":"string","default":""},"contents":{"type":"array","source":"query","selector":".lw-step__li","query":{"no":{"type":"string","source":"html","selector":".lw-step__li_no"},"title":{"type":"string","source":"html","selector":".lw-step__li_title"},"text":{"type":"string","source":"html","selector":".lw-step__li_text"}},"default":[{"no":"1月","title":"応募","text":"応募フォームより必要事項を入力し、送信してください。応募内容を確認し、追って担当者よりご連絡いたします。"},{"no":"2月","title":"書類選考","text":"ご応募いただいた内容をもとに、書類選考を行います。結果は1週間以内にメールにてお知らせいたします。"},{"no":"3月","title":"面接","text":"書類選考に通過された方には、担当者による面接を実施します。面接日時はご相談の上、決定いたします。"}]}}}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-lw-step-5": 0,
/******/ 			"./style-paid-block-lw-step-5": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-lw-step-5"], () => (__webpack_require__("./src/paid-block-lw-step-5/index.js")))
