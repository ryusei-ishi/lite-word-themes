...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/custom-title-5/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/custom-title-5/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/custom-title-5/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  edit: function edit(props) {
    ...
    var onChangeMainTitleColor = function onChangeMainTitleColor(color) {
      setAttributes({
        mainTitleColor: color
      });
    };
    var onChangeFontSize = function onChangeFontSize(value) {
      setAttributes({
        fontSize: value
      });
    };
    ...
    // フォントサイズに応じたクラス名を生成
    var fontSizeClass = fontSize === 'm' ? 'font_size_m' : fontSize === 's' ? 'font_size_s' : '';
    var className = fontSizeClass ? "custom-title-5 ".concat(fontSizeClass) : 'custom-title-5';
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: className,
      style: {
        borderColor: mainTitleColor
      }
    });
  ...
  save: function save(props) {
    ...
    return /*#__PURE__*/React.createElement(TagName, blockProps, subTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      className: "sub",
      value: subTitle,
      style: {
...
/***/ "./src/custom-title-5/editor.scss":
/*!****************************************!*\
  !*** ./src/custom-title-5/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-custom-title-5"], () => (__webpack_require__("./src/custom-title-5/index.js")))
