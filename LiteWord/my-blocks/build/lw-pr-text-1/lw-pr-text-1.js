...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-text-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-text-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-text-1/block.json");
...
// アニメーションパターン
var animationPatterns = [{
  label: '左から右へスライド',
  value: 'lw-pr-text-1-gradient-slide-anime-1'
}, {
  label: '右から左へスライド',
  value: 'lw-pr-text-1-gradient-slide-anime-2'
}, {
  label: '上から下へスライド',
  value: 'lw-pr-text-1-gradient-slide-anime-3'
}, {
  label: '下から上へスライド',
  value: 'lw-pr-text-1-gradient-slide-anime-4'
}, {
  label: 'ズーム',
  value: 'lw-pr-text-1-gradient-slide-anime-5'
}];
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(_ref) {
    ...
    var text = attributes.text,
      ...
      fontSizeTab = attributes.fontSizeTab,
      fontSizeSp = attributes.fontSizeSp,
      lineHeightPc = attributes.lineHeightPc,
      lineHeightTab = attributes.lineHeightTab,
      lineHeightSp = attributes.lineHeightSp,
      gradientPreset = attributes.gradientPreset,
      gradientColor1 = attributes.gradientColor1,
      gradientColor2 = attributes.gradientColor2,
      gradientColor3 = attributes.gradientColor3,
      gradientAngle = attributes.gradientAngle,
      animationPattern = attributes.animationPattern,
      animationTime = attributes.animationTime,
      animationEasing = attributes.animationEasing;

    // タグ名変更
    var onChangeTagName = function onChangeTagName(newTagName) {
    ...
    // プリセット変更時の処理
    var onChangeGradientPreset = function onChangeGradientPreset(value) {
      setAttributes({
      ...
      if (value !== 'custom' && presetGradients[value]) {
        var preset = presetGradients[value];
        setAttributes({
    ...
    // グラデーション値を生成
    var getGradientValue = function getGradientValue() {
      var color1 = gradientColor1 || '#3b82f6';
      var color2 = gradientColor2 || '#06b6d4';
      var color3 = gradientColor3 || '#3b82f6';
      var angle = gradientAngle || '270';
      return "linear-gradient(".concat(angle, "deg, ").concat(color1, ", ").concat(color2, ", ").concat(color3, ")");
    };

    // インラインスタイルを生成
    var inlineStyle = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, fontWeight && {
      fontWeight: fontWeight
    }), {}, {
      '--lw-text-align-pc': textAlignPc || 'left'
    }, textAlignSp && {
      '--lw-text-align-sp': textAlignSp
    }), {}, {
      '--lw-pr-text-1-font-size-pc': "".concat(fontSizePc, "em")
    }, fontSizeTab !== null && {
      '--lw-pr-text-1-font-size-tab': "".concat(fontSizeTab, "em")
    }), fontSizeSp !== null && {
      '--lw-pr-text-1-font-size-sp': "".concat(fontSizeSp, "em")
    }), {}, {
      '--lw-pr-text-1-line-height-pc': lineHeightPc
    }, lineHeightTab !== null && {
      '--lw-pr-text-1-line-height-tab': lineHeightTab
    }), lineHeightSp !== null && {
      '--lw-pr-text-1-line-height-sp': lineHeightSp
    }), {}, {
      '--lw-pr-text-1-gradient': getGradientValue(),
      '--lw-pr-text-1-gradient-anime-ptn': animationPattern,
      '--lw-pr-text-1-gradient-anime-time': "".concat(animationTime, "s"),
      '--lw-pr-text-1-gradient-anime-movement': animationEasing
    });

    // h1〜h4の時はwp-block-headingクラスを追加
    var isHeading = ['h1', 'h2', 'h3', 'h4'].includes(tagName);

    // クラス名を生成
    var className = ['lw-pr-text-1', isHeading && 'wp-block-heading', 'gradient-slide-anime'].filter(Boolean).join(' ');
    var TagName = tagName;
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, ['h1', 'h2', 'h3', 'h4', 'p', 'span'].map(function (tag) {
    ...
    }), fontSizeTab !== null && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isSmall: true,
      isDestructive: true,
      onClick: function onClick() {
        return setAttributes({
    ...
    }, "\u30BF\u30D6\u30EC\u30C3\u30C8\u8A2D\u5B9A\u3092\u30EA\u30BB\u30C3\u30C8\uFF08PC\u3068\u540C\u3058\uFF09"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30D5\u30A9\u30F3\u30C8\u30B5\u30A4\u30BA\uFF08SP\uFF09",
    ...
    }), fontSizeSp !== null && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isSmall: true,
      isDestructive: true,
      onClick: function onClick() {
        return setAttributes({
    ...
    }, "SP\u8A2D\u5B9A\u3092\u30EA\u30BB\u30C3\u30C8\uFF08\u30BF\u30D6\u30EC\u30C3\u30C8\u3068\u540C\u3058\uFF09"), /*#__PURE__*/React.createElement("p", {
      style: {
        marginTop: '16px',
        marginBottom: '8px',
        fontWeight: '600'
      }
    }, "\u884C\u9593"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u884C\u9593\uFF08PC\uFF09",
      value: lineHeightPc,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      step: 0.1,
      help: "PC\u3068\u540C\u3058\u306B\u3059\u308B\u5834\u5408\u306F\u30EA\u30BB\u30C3\u30C8\u3057\u3066\u304F\u3060\u3055\u3044"
    }), lineHeightTab !== null && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isSmall: true,
      isDestructive: true,
      onClick: function onClick() {
        return setAttributes({
      ...
      step: 0.1,
      help: "\u30BF\u30D6\u30EC\u30C3\u30C8\u3068\u540C\u3058\u306B\u3059\u308B\u5834\u5408\u306F\u30EA\u30BB\u30C3\u30C8\u3057\u3066\u304F\u3060\u3055\u3044"
    }), lineHeightSp !== null && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isSmall: true,
      isDestructive: true,
      onClick: function onClick() {
        return setAttributes({
    ...
    }, "SP\u8A2D\u5B9A\u3092\u30EA\u30BB\u30C3\u30C8\uFF08\u30BF\u30D6\u30EC\u30C3\u30C8\u3068\u540C\u3058\uFF09")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u8A2D\u5B9A",
      initialOpen: true
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u30D7\u30EA\u30BB\u30C3\u30C8",
    ...
    }, "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u82721"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u82722"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u82723"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
...
/***/ "./src/lw-pr-text-1/block.json":
/*!*************************************!*\
  !*** ./src/lw-pr-text-1/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-text-1","version":"1.0.0","title":"グラデーションテキスト 01","category":"lw-heading","icon":"admin-customizer","editorScript":"file:./lw-pr-text-1.js","editorStyle":["file:./editor.css","file:../../../assets/css/font_style.min.css","file:../../../assets/css/editor_block_side.min.css"],"style":"file:./style.css","supports":{"anchor":true},"attributes":{"text":{"type":"string","default":"SLIDE ANIMATION"},"tagName":{"type":"string","default":"h2"},"textAlignPc":{"type":"string","default":"left"},"textAlignSp":{"type":"string","default":""},"fontSet":{"type":"string","default":""},"fontWeight":{"type":"string","default":""},"fontSizePc":{"type":"number","default":1},"fontSizeTab":{"type":"number","default":null},"fontSizeSp":{"type":"number","default":null},"lineHeightPc":{"type":"number","default":1.5},"lineHeightTab":{"type":"number","default":null},"lineHeightSp":{"type":"number","default":null},"gradientPreset":{"type":"string","default":"preset-blue"},"gradientColor1":{"type":"string","default":"#3b82f6"},"gradientColor2":{"type":"string","default":"#06b6d4"},"gradientColor3":{"type":"string","default":"#3b82f6"},"gradientAngle":{"type":"string","default":"270"},"animationPattern":{"type":"string","default":"lw-pr-text-1-gradient-slide-anime-1"},"animationTime":{"type":"number","default":3},"animationEasing":{"type":"string","default":"linear"}},"no":1}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-text-1"], () => (__webpack_require__("./src/lw-pr-text-1/index.js")))
