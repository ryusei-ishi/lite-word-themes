...
/***/ "./src/paid-block-lw-step-4/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-lw-step-4/index.js ***!
  \*******************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-lw-step-4/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-lw-step-4/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-lw-step-4/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var addContent = function addContent() {
      var nextNo = String(contents.length + 1).padStart(2, '0');
      setAttributes({
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "paid-block-lw-step-4 ".concat(fontSizeClass)
    });
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      max: 1280,
      step: 1
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u30FBSTEP\u756A\u53F7\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: bgGradient,
  ...
  /* ======================================================
   * 3) 旧形式（useBlockProps.save なし）の受け皿
   * ==================================================== */
  deprecated: [{
...
/***/ "./src/paid-block-lw-step-4/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-lw-step-4/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-4/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-4/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-lw-step-4/block.json":
/*!*********************************************!*\
  !*** ./src/paid-block-lw-step-4/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-lw-step-4","version":"1.0.0","title":"step 04","category":"lw-step","icon":"lightbulb","supports":{"anchor":true},"editorScript":"file:./paid-block-lw-step-4.js","aiHint":{"description":"番号付きカード型ステップ。メインカラー番号+タイトル+説明。サービスフローに","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"no":4,"attributes":{"bgGradient":{"type":"string","default":"var(--color-main)"},"ulMaxWidth":{"type":"number","default":1080},"fontSizeClass":{"type":"string","default":"font_size_m"},"fontNo":{"type":"string","default":"Murecho"},"fontWeightNo":{"type":"string","default":"600"},"colorNo":{"type":"string","default":"var(--color-main)"},"titleTag":{"type":"string","default":"h3"},"fontH3":{"type":"string","default":""},"fontWeightH3":{"type":"string","default":""},"colorH3":{"type":"string","default":""},"fontP":{"type":"string","default":""},"fontWeightP":{"type":"string","default":""},"colorP":{"type":"string","default":""},"contents":{"type":"array","source":"query","selector":".lw-step__li","query":{"no":{"type":"string","source":"html","selector":".lw-step__li_no"},"title":{"type":"string","source":"html","selector":".lw-step__li_title"},"text":{"type":"string","source":"html","selector":".lw-step__li_text"}},"default":[{"no":"01","title":"応募","text":"応募フォームより必要事項を入力し、送信してください。応募内容を確認し、追って担当者よりご連絡いたします。"},{"no":"02","title":"書類選考","text":"ご応募いただいた内容をもとに、書類選考を行います。結果は1週間以内にメールにてお知らせいたします。"},{"no":"03","title":"面接","text":"書類選考に通過された方には、担当者による面接を実施します。面接日時はご相談の上、決定いたします。"}]}}}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-lw-step-4": 0,
/******/ 			"./style-paid-block-lw-step-4": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-lw-step-4"], () => (__webpack_require__("./src/paid-block-lw-step-4/index.js")))
