...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-17/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-17/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-17/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var backgroundImage = attributes.backgroundImage,
      ...
      breadcrumbColorPc = attributes.breadcrumbColorPc,
      breadcrumbColorSp = attributes.breadcrumbColorSp,
      minHeightPc = attributes.minHeightPc,
      minHeightTb = attributes.minHeightTb,
      minHeightSp = attributes.minHeightSp,
      mainTitleTag = attributes.mainTitleTag,
      bgImageLeftPc = attributes.bgImageLeftPc,
      bgImageLeftSp = attributes.bgImageLeftSp,
      bgImageRightPc = attributes.bgImageRightPc,
      bgImageRightSp = attributes.bgImageRightSp,
      bgImageOpacityPc = attributes.bgImageOpacityPc,
      bgImageOpacitySp = attributes.bgImageOpacitySp,
      bgImageLeftOpacityPc = attributes.bgImageLeftOpacityPc,
      bgImageLeftOpacitySp = attributes.bgImageLeftOpacitySp,
      bgImageRightOpacityPc = attributes.bgImageRightOpacityPc,
      bgImageRightOpacitySp = attributes.bgImageRightOpacitySp,
      marginBottomZero = attributes.marginBottomZero;

    // useBlockPropsは条件付きreturnの前に呼ぶ（Reactフックのルール）
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-pr-fv-17 ".concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp)
    });

    /* ▼ 現在編集中の投稿タイプを取得し、固定ページ以外なら警告を表示 */
    var currentPostType = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(function (select) {
      return select('core/editor').getCurrentPostType();
    });
    if (currentPostType !== 'page') {
      return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("p", null, "\u3053\u306E\u30D6\u30ED\u30C3\u30AF\u306F\u56FA\u5B9A\u30DA\u30FC\u30B8\u3067\u306E\u307F\u4F7F\u7528\u3067\u304D\u307E\u3059\u3002"));
    }
    ...
    var TagName = mainTitleTag || 'h1';
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, ['h1', 'h2', 'h3', 'p'].map(function (tag) {
      ...
      render: function render(_ref2) {
        var open = _ref2.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, backgroundImage && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
          src: backgroundImage,
          alt: "\u9078\u629E\u3057\u305F\u80CC\u666F\u753B\u50CF",
          style: {
            width: '100%',
    ...
    }, "\u30B9\u30DE\u30DB\u7528\u753B\u50CF"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: onChangeBackgroundImageSp,
      allowedTypes: ['image'],
      value: backgroundImageSp,
      render: function render(_ref3) {
        var open = _ref3.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, backgroundImageSp && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
    ...
    }, "PC\u7528 \u900F\u660E\u5EA6"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      value: bgImageOpacityPc,
      onChange: function onChange(value) {
        return setAttributes({
          bgImageOpacityPc: value
        });
      },
      min: 0,
      max: 1,
      step: 0.01
    }), /*#__PURE__*/React.createElement("p", null, "\u30B9\u30DE\u30DB\u7528 \u900F\u660E\u5EA6"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      value: bgImageOpacitySp,
      onChange: function onChange(value) {
        return setAttributes({
          bgImageOpacitySp: value
        });
      },
      min: 0,
      max: 1,
      ...
      render: function render(_ref4) {
        var open = _ref4.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, bgImageLeftPc && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
          src: bgImageLeftPc,
          alt: "\u9078\u629E\u3057\u305F\u5DE6\u5074\u80CC\u666F\u753B\u50CF\uFF08PC\uFF09",
          style: {
            width: '100%',
      ...
      render: function render(_ref5) {
        var open = _ref5.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, bgImageLeftSp && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
          src: bgImageLeftSp,
          alt: "\u9078\u629E\u3057\u305F\u5DE6\u5074\u80CC\u666F\u753B\u50CF\uFF08\u30B9\u30DE\u30DB\uFF09",
          style: {
            width: '100%',
      ...
      render: function render(_ref6) {
        var open = _ref6.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, bgImageRightPc && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
          src: bgImageRightPc,
          alt: "\u9078\u629E\u3057\u305F\u53F3\u5074\u80CC\u666F\u753B\u50CF\uFF08PC\uFF09",
          style: {
            width: '100%',
      ...
      render: function render(_ref7) {
        var open = _ref7.open;
        return /*#__PURE__*/React.createElement(React.Fragment, null, bgImageRightSp && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
          src: bgImageRightSp,
          alt: "\u9078\u629E\u3057\u305F\u53F3\u5074\u80CC\u666F\u753B\u50CF\uFF08\u30B9\u30DE\u30DB\uFF09",
          style: {
            width: '100%',
      ...
      title: "\u30D5\u30A3\u30EB\u30BF\u30FC\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u900F\u660E\u5EA6"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      value: filterOpacity,
      onChange: function onChange(value) {
        return setAttributes({
          filterOpacity: value
      ...
      title: "\u30D1\u30F3\u304F\u305A\u30EA\u30B9\u30C8\u306E\u8272",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", null, "PC"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: breadcrumbColorPc,
      onChange: function onChange(color) {
        return setAttributes({
          breadcrumbColorPc: color || ''
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30B9\u30DE\u30FC\u30C8\u30D5\u30A9\u30F3"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: breadcrumbColorSp,
      onChange: function onChange(color) {
        return setAttributes({
          breadcrumbColorSp: color || ''
        });
      }
    }), /*#__PURE__*/React.createElement("p", {
      style: {
    ...
    }, "\u7A7A\u306E\u307E\u307E\u306A\u3089\u3001\u4ECA\u307E\u3067\u3069\u304A\u308A\u30B5\u30A4\u30C8\u30AB\u30E9\u30FC\u3067\u8868\u793A\u3055\u308C\u307E\u3059\u3002", /*#__PURE__*/React.createElement("br", null), "PC\u3067\u306F\u30D1\u30F3\u304F\u305A\u304C\u5199\u771F\u306E\u4E0A\u306B\u91CD\u306A\u308B\u306E\u3067\u3001\u6697\u3044\u5199\u771F\u306E\u3068\u304D\u306F\u660E\u308B\u3044\u8272\u306B\u3057\u3066\u304F\u3060\u3055\u3044\u3002", /*#__PURE__*/React.createElement("br", null), "\u26A0\uFE0F \u30B9\u30DE\u30DB\u3067\u306F\u30D1\u30F3\u304F\u305A\u304C\u5199\u771F\u306E\u5916\uFF08\u4E0B\uFF09\u306B\u51FA\u307E\u3059\u3002PC\u3068\u30B9\u30DE\u30DB\u306F\u9023\u52D5\u3057\u306A\u3044\u306E\u3067\u3001\u30B9\u30DE\u30DB\u5074\u3082\u5909\u3048\u305F\u3044\u3068\u304D\u306F\u5225\u306B\u6307\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002", /*#__PURE__*/React.createElement("br", null), "\u306A\u304A\u300CHOME\u300D\u3060\u3051\u306B\u306A\u308B\u30DA\u30FC\u30B8\u3067\u306F\u3001\u30D1\u30F3\u304F\u305A\u81EA\u4F53\u304C\u8868\u793A\u3055\u308C\u307E\u305B\u3093\u3002")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30EC\u30A4\u30A2\u30A6\u30C8\u8A2D\u5B9A"
      ...
      value: minHeightTb,
      options: (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.minHeightTbClassOptionArr)(),
      onChange: function onChange(value) {
        return setAttributes({
          minHeightTb: value
        });
      ...
      value: minHeightSp,
      options: (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.minHeightSpClassOptionArr)(),
      onChange: function onChange(value) {
        return setAttributes({
          minHeightSp: value
        });
      ...
      onChange: function onChange(value) {
        return setAttributes({
          marginBottomZero: value
        });
      }
    }))), /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-fv-17_inner"
      ...
      className: "bg_image",
      style: {
        '--bg_image-op-pc': "".concat(bgImageOpacityPc),
        '--bg_image-op-sp': "".concat(bgImageOpacitySp)
      }
      ...
      style: {
        '--bg_image_left-op-pc': "".concat(bgImageLeftOpacityPc),
        '--bg_image_left-op-sp': "".concat(bgImageLeftOpacitySp)
      }
    }, bgImageLeftPc && /*#__PURE__*/React.createElement("img", {
      src: bgImageLeftPc,
      alt: "\u5DE6\u5074\u80CC\u666F\u753B\u50CF"
    })), /*#__PURE__*/React.createElement("div", {
      className: "bg_image_right",
      style: {
        '--bg_image_right-op-pc': "".concat(bgImageRightOpacityPc),
        '--bg_image_right-op-sp': "".concat(bgImageRightOpacitySp)
      }
    }, bgImageRightPc && /*#__PURE__*/React.createElement("img", {
      src: bgImageRightPc,
      alt: "\u53F3\u5074\u80CC\u666F\u753B\u50CF"
    })), /*#__PURE__*/React.createElement("div", {
      className: "bg_color",
...
/***/ "./src/lw-pr-fv-17/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-17/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-17","version":"1.0.0","title":"固定ページタイトル 17（下層用）","category":"lw-firstview","icon":"cover-image","description":"下層ページ用のコンパクトなファーストビュー","aiDescription":"下層ページ用のコンパクトなファーストビュー。英語のメインタイトルと短い説明文のみのシンプル構成。ポートフォリオ、実績一覧、ギャラリーなどビジュアル重視のページに最適。","aiNotes":"このブロックはh1タグを使用。タイトルは英語表記が基本（例：PORTFOLIO、WORKS）。説明文は短めに設定。背景色のみのシンプルデザイン。","aiHint":{"description":"下層ページ用コンパクトFV。左右背景画像+中央テキスト。ポートフォリオ・実績ページ向け","excludeFromAutoSelect":false,"contentAttributes":["mainTitle","description"],"imageAttributes":["backgroundImage","bgImageLeftPc","bgImageRightPc"],"notes":"下層ページ用。中央の背景写真の左右にもう2枚の写真を並べられる（bgImageLeftPc / bgImageRightPc）。🚨 中央の写真が明るいと文字が沈むので、filterOpacity は 0.7 以上にする（実測）。スマホでは左右の写真がほぼ見えなくなるので、bgImageLeft/RightOpacitySp は 0.1 前後にして中央の文字を優先する。"},"render":"file:./render.php","editorScript":"file:./lw-pr-fv-17.js","style":"file:./style.css","supports":{"anchor":true},"attributes":{"backgroundImage":{"type":"string","default":"","ai_description":"PC用背景画像の生成プロンプト（英語）。空の場合はfilterBackgroundColorのみ表示。通常は空のままでOK"},"backgroundImageSp":{"type":"string","default":"","ai_description":"スマホ用背景画像。通常は空のままでOK"},"mainTitle":{"type":"string","default":"PORTFOLIO","ai_description":"メインタイトル（英語推奨）。5～15文字の英語。例：「PORTFOLIO」「WORKS」「GALLERY」「CASE STUDY」"},"description":{"type":"string","default":"テキストを入力してください。","ai_description":"説明文。15～40文字程度で簡潔に。例：「これまでの実績をご紹介します」「制作事例をご覧ください」"},"filterBackgroundColor":{"type":"string","default":"var(--color-main)","ai_description":"画像よりz-indexが下にある、背景の色です。var(--color-main)を使用してサイトカラーと統一"},"filterOpacity":{"type":"number","default":0.95,"ai_description":"オーバーレイの不透明度（0-1）。0.95でほぼ背景色のみ表示"},"textColor":{"type":"string","default":"#fff","ai_description":"テキストの文字色。背景が濃い場合は#fff（白）を維持"},"breadcrumbColorPc":{"type":"string","default":"","ai_description":"パンくずリストの色（PC）。空なら従来どおりサイトカラー。PCではパンくずがFVの写真の上に重なるので、暗い写真のときは #fff など明るい色にする"},"breadcrumbColorSp":{"type":"string","default":"","ai_description":"パンくずリストの色（スマホ）。空ならPCの指定を使う。⚠️ スマホではパンくずがFVの外（下）に出るので、PCで白にした場合はここを暗い色にしないと読めなくなる"},"minHeightPc":{"type":"string","default":"min-h-pc-280px","ai_description":"PC表示時の最小高さ。コンパクトなデザインのため低めに設定"},"minHeightTb":{"type":"string","default":"min-h-tb-220px","ai_description":"タブレット表示時の最小高さ。通常はデフォルト値を維持"},"minHeightSp":{"type":"string","default":"min-h-sp-180px","ai_description":"スマホ表示時の最小高さ。通常はデフォルト値を維持"},"mainTitleTag":{"type":"string","default":"h1","ai_description":"タイトルのHTMLタグ。下層ページのメインタイトルなので通常は\'h1\'を維持"},"bgImageLeftPc":{"type":"string","default":"","ai_description":"左側背景画像（PC用）。装飾的な背景画像を配置"},"bgImageLeftSp":{"type":"string","default":"","ai_description":"左側背景画像（スマホ用）。レスポンシブ対応用"},"bgImageRightPc":{"type":"string","default":"","ai_description":"右側背景画像（PC用）。装飾的な背景画像を配置"},"bgImageRightSp":{"type":"string","default":"","ai_description":"右側背景画像（スマホ用）。レスポンシブ対応用"},"bgImageOpacityPc":{"type":"number","default":1,"ai_description":"メイン背景画像の透明度（PC用）。0〜1"},"bgImageOpacitySp":{"type":"number","default":1,"ai_description":"メイン背景画像の透明度（スマホ用）。0〜1"},"bgImageLeftOpacityPc":{"type":"number","default":1,"ai_description":"左側背景画像の透明度（PC用）。0〜1"},"bgImageLeftOpacitySp":{"type":"number","default":1,"ai_description":"左側背景画像の透明度（スマホ用）。0〜1"},"bgImageRightOpacityPc":{"type":"number","default":1,"ai_description":"右側背景画像の透明度（PC用）。0〜1"},"bgImageRightOpacitySp":{"type":"number","default":1,"ai_description":"右側背景画像の透明度（スマホ用）。0〜1"},"marginBottomZero":{"type":"boolean","default":false,"ai_description":"margin-bottomを0にする。パンくずリストによる自動マージン調整を無効化"}},"no":5}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-17"], () => (__webpack_require__("./src/lw-pr-fv-17/index.js")))
