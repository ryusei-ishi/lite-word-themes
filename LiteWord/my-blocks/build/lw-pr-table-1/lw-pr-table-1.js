...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-table-1/style.scss");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(_ref) {
    ...
    var columnCount = attributes.columnCount,
      hideTableHeader = attributes.hideTableHeader,
      cellWidth1 = attributes.cellWidth1,
      cellWidth2 = attributes.cellWidth2,
      cellWidth3 = attributes.cellWidth3,
      cellWidth4 = attributes.cellWidth4,
      cellWidth5 = attributes.cellWidth5,
      cellWidth6 = attributes.cellWidth6,
      cellWidth7 = attributes.cellWidth7,
      cellWidth8 = attributes.cellWidth8,
      cellWidth1Sp = attributes.cellWidth1Sp,
      cellWidth2Sp = attributes.cellWidth2Sp,
      cellWidth3Sp = attributes.cellWidth3Sp,
      cellWidth4Sp = attributes.cellWidth4Sp,
      cellWidth5Sp = attributes.cellWidth5Sp,
      cellWidth6Sp = attributes.cellWidth6Sp,
      cellWidth7Sp = attributes.cellWidth7Sp,
      cellWidth8Sp = attributes.cellWidth8Sp,
      radiusSize = attributes.radiusSize,
      headerBgColor = attributes.headerBgColor,
      headerTextColor = attributes.headerTextColor,
      useIndividualHeaderBg = attributes.useIndividualHeaderBg,
      cellBgColor = attributes.cellBgColor,
      cellTextColor = attributes.cellTextColor,
      shadowColor = attributes.shadowColor,
      fontFamilyHeader = attributes.fontFamilyHeader,
      fontWeightHeader = attributes.fontWeightHeader,
      fontSizeHeader = attributes.fontSizeHeader,
      fontSizeHeaderSp = attributes.fontSizeHeaderSp,
      lineHeightHeader = attributes.lineHeightHeader,
      fontFamilyRowHeader = attributes.fontFamilyRowHeader,
      fontWeightRowHeader = attributes.fontWeightRowHeader,
      fontSizeRowHeader = attributes.fontSizeRowHeader,
      fontSizeRowHeaderSp = attributes.fontSizeRowHeaderSp,
      lineHeightRowHeader = attributes.lineHeightRowHeader,
    ...
    // ヘッダー更新関数（テキスト）
    var updateHeaderText = function updateHeaderText(index, value) {
      ...
      if (typeof newHeaders[index] === 'string') {
        ...
        newHeaders[index] = _objectSpread(_objectSpread({}, newHeaders[index]), {}, {
          text: value
        });
      }
      setAttributes({
    ...
    // ヘッダー背景色更新関数
    var updateHeaderBgColor = function updateHeaderBgColor(index, color) {
      var newHeaders = _toConsumableArray(headers);
      if (typeof newHeaders[index] === 'string') {
        newHeaders[index] = {
          text: newHeaders[index],
          bgColor: color
        };
      } else {
        newHeaders[index] = _objectSpread(_objectSpread({}, newHeaders[index]), {}, {
    ...
    var addRow = function addRow() {
      var newCells = Array(columnCount - 1).fill({
        content: '新しいセル'
      });
      setAttributes({
    ...
    var handleColumnCountChange = function handleColumnCountChange(newCount) {
      ...
      var newHeaders = _toConsumableArray(headers);
      // 古い形式から新形式への変換
      newHeaders = newHeaders.map(function (header) {
      ...
      if (count - 1 > newHeaders.length) {
        var diff = count - 1 - newHeaders.length;
        for (var i = 0; i < diff; i++) {
          newHeaders.push({
            text: "\u30D7\u30E9\u30F3".concat(newHeaders.length + i + 1),
            bgColor: ''
          });
        }
      ...
      var newRows = rows.map(function (row) {
        var newCells = row.cells ? _toConsumableArray(row.cells) : [];
        if (count - 1 > newCells.length) {
          var _diff = count - 1 - newCells.length;
    ...
    // テーブル幅の計算
    var calculateTableWidth = function calculateTableWidth() {
      var width = cellWidth1;
    ...
    var calculateTableWidthSp = function calculateTableWidthSp() {
      var width = cellWidth1Sp;
    ...
    var getHeaderText = function getHeaderText(header) {
      return typeof header === 'string' ? header : header.text;
    };

    // ヘッダー背景色を取得
    var getHeaderBgColor = function getHeaderBgColor(header) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      min: 100,
      max: 800
    }), columnCount >= 2 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E02\u306E\u5E45 (px)",
      value: cellWidth2,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 3 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E03\u306E\u5E45 (px)",
      value: cellWidth3,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 4 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E04\u306E\u5E45 (px)",
      value: cellWidth4,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 5 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E05\u306E\u5E45 (px)",
      value: cellWidth5,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 6 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E06\u306E\u5E45 (px)",
      value: cellWidth6,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 7 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E07\u306E\u5E45 (px)",
      value: cellWidth7,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      min: 100,
      max: 800
    }), columnCount >= 8 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30AB\u30E9\u30E08\u306E\u5E45 (px)",
      value: cellWidth8,
      onChange: function onChange(value) {
        return setAttributes({
    ...
    }, "\u30D8\u30C3\u30C0\u30FC\u80CC\u666F\u8272(\u5171\u901A)"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: headerBgColor,
    ...
    }, "\u30D8\u30C3\u30C0\u30FC\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      ...
      onChange: function onChange(value) {
        return setAttributes({
          useIndividualHeaderBg: value
        });
      },
      help: "\u5404\u30D7\u30E9\u30F3\u3054\u3068\u306B\u7570\u306A\u308B\u80CC\u666F\u8272\u3092\u8A2D\u5B9A\u3067\u304D\u307E\u3059"
    }), useIndividualHeaderBg && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '20px',
        padding: '15px',
        background: '#f0f0f0',
    ...
    }, "\u5217\u30D8\u30C3\u30C0\u30FC\u500B\u5225\u80CC\u666F\u8272"), headers.map(function (header, i) {
      return i < columnCount - 1 && /*#__PURE__*/React.createElement("div", {
        key: i,
        style: {
          marginBottom: '15px'
        }
      ...
      }, getHeaderText(header) || "\u30AB\u30E9\u30E0".concat(i + 2)), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
        value: getHeaderBgColor(header),
        onChange: function onChange(color) {
          return updateHeaderBgColor(i, color);
        }
      }));
    })), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "\u30BB\u30EB\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cellBgColor,
      onChange: function onChange(color) {
        return setAttributes({
          cellBgColor: color
    ...
    }, "\u30BB\u30EB\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cellTextColor,
      onChange: function onChange(color) {
        return setAttributes({
          cellTextColor: color
      ...
      style: {
        '--lw-table-radius-size': "".concat(radiusSize, "px"),
        '--lw-table-cell-width-1': "".concat(cellWidth1, "px"),
        '--lw-table-cell-width-2': "".concat(cellWidth2, "px"),
        '--lw-table-cell-width-3': "".concat(cellWidth3, "px"),
        '--lw-table-cell-width-4': "".concat(cellWidth4, "px"),
        '--lw-table-cell-width-5': "".concat(cellWidth5, "px"),
        '--lw-table-cell-width-6': "".concat(cellWidth6, "px"),
        '--lw-table-cell-width-7': "".concat(cellWidth7, "px"),
        '--lw-table-cell-width-8': "".concat(cellWidth8, "px"),
        '--lw-table-cell-width-1-sp': "".concat(cellWidth1Sp, "px"),
        '--lw-table-cell-width-2-sp': "".concat(cellWidth2Sp, "px"),
        '--lw-table-cell-width-3-sp': "".concat(cellWidth3Sp, "px"),
        '--lw-table-cell-width-4-sp': "".concat(cellWidth4Sp, "px"),
        '--lw-table-cell-width-5-sp': "".concat(cellWidth5Sp, "px"),
        '--lw-table-cell-width-6-sp': "".concat(cellWidth6Sp, "px"),
        '--lw-table-cell-width-7-sp': "".concat(cellWidth7Sp, "px"),
        '--lw-table-cell-width-8-sp': "".concat(cellWidth8Sp, "px"),
        '--lw-table-gap-size': "".concat(gapSize, "px"),
        '--lw-table-column-count': columnCount,
        '--lw-table-width': "".concat(calculateTableWidth(), "px"),
        '--lw-table-width-sp': "".concat(calculateTableWidthSp(), "px"),
        // フォントサイズのCSS変数を追加
        '--lw-table-font-size-header': "".concat(fontSizeHeader, "px"),
        '--lw-table-font-size-header-sp': "".concat(fontSizeHeaderSp, "px"),
        '--lw-table-font-size-cell': "".concat(fontSizeCell, "px"),
        '--lw-table-font-size-cell-sp': "".concat(fontSizeCellSp, "px"),
        '--lw-table-font-size-row-header': "".concat(fontSizeRowHeader, "px"),
        '--lw-table-font-size-row-header-sp': "".concat(fontSizeRowHeaderSp, "px"),
        // 行間のCSS変数を追加
      ...
      return i < columnCount - 1 && /*#__PURE__*/React.createElement("div", {
        ...
        onChange: function onChange(value) {
          return updateHeaderText(i, value);
        },
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          fontSize: "".concat(fontSizeRowHeader, "px"),
  ...
  save: function save(_ref2) {
    ...
    return /*#__PURE__*/React.createElement("div", _extends({}, blockProps, {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return cellIndex < columnCount - 1 && /*#__PURE__*/React.createElement("div", {
          key: cellIndex,
          className: "cell",
          role: "cell",
          "data-lw_font_set": fontFamilyCell,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-table-1"], () => (__webpack_require__("./src/lw-pr-table-1/index.js")))
