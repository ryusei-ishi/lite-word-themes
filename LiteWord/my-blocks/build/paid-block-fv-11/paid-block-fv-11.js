...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-fv-11/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-fv-11/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-fv-11/block.json");
/* harmony import */ var _link_picker_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../link-picker.js */ "./src/link-picker.js");
...
var saveBlockFv11 = function saveBlockFv11(_ref) {
  ...
  var blockId = attributes.blockId,
    ...
    ctaLinkUrl = attributes.ctaLinkUrl,
    ctaOpenNewTab = attributes.ctaOpenNewTab,
    showCtaButton = attributes.showCtaButton,
    filterColor = attributes.filterColor,
    filterOpacity = attributes.filterOpacity;
  var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
    id: blockId,
    className: "".concat(layoutType === 'full' ? 'swiper paid-block-fv-11 max-w init-hide' : 'swiper paid-block-fv-11 init-hide', " ").concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp),
  ...
  var rootFinder = blockId ? "const selector = \"#".concat(blockId, "\";") : ['var _sc = document.currentScript;', 'var _root = ( _sc && _sc.closest ) ? _sc.closest(".paid-block-fv-11") : null;', 'if ( !_root ) _root = document.querySelector(".paid-block-fv-11:not([data-lw-init])");', 'if ( !_root ) return;', '_root.setAttribute("data-lw-init","1");', 'if ( !_root.id ) _root.id = "paid-block-fv-11-" + Math.random().toString(36).slice(2,10);', 'const selector = "#" + _root.id;'].join(String.fromCharCode(10));
  /* 色の指定も同じ理由。blockId が無いときはクラスで当てる */
  var cssRoot = blockId ? "#".concat(blockId) : '.paid-block-fv-11';
  ...
  return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
    className: "text_in center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "in"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "ttl"
  }, subTitle && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
    tagName: "span",
    className: "sub",
    value: subTitle
  ...
  }), showCtaButton && /*#__PURE__*/React.createElement("span", {
    className: "cta_btn"
  }, /*#__PURE__*/React.createElement("a", {
    href: ctaLinkUrl || '#',
    "data-lw-link-type": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromAttrs)(attributes, LINK_KEYS_CTA).linkType,
    "data-lw-link-id": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromAttrs)(attributes, LINK_KEYS_CTA).linkId,
    className: "btn_link",
    ...
    var spImgSrc = slide.spImgUrl || slide.pcImgUrl;
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      href: slide.linkUrl,
      "data-lw-link-type": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromAttrs)(slide, LINK_KEYS_SLIDE).linkType,
      "data-lw-link-id": (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkDataPropsFromAttrs)(slide, LINK_KEYS_SLIDE).linkId,
      target: "_blank",
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit: function edit(_ref2) {
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
      if (!blockId) {
        var uniqueId = "paid-block-fv-11-".concat(Date.now(), "-").concat(Math.floor(Math.random() * 10000));
        setAttributes({
          blockId: uniqueId
        });
      }
    ...
    var moveSlideUp = function moveSlideUp(index) {
      ...
      var _ref3 = [newSlides[index], newSlides[index - 1]];
      newSlides[index - 1] = _ref3[0];
      newSlides[index] = _ref3[1];
      setAttributes({
        slides: newSlides
      });
    };
    var moveSlideDown = function moveSlideDown(index) {
      ...
      var newSlides = _toConsumableArray(slides);
      var _ref4 = [newSlides[index + 1], newSlides[index]];
      newSlides[index] = _ref4[0];
      newSlides[index + 1] = _ref4[1];
      setAttributes({
        slides: newSlides
      });
    };
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      id: blockId,
      className: "".concat(layoutType === 'full' ? 'swiper paid-block-fv-11 max-w' : 'swiper paid-block-fv-11', " ").concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp),
      style: layoutType === 'fixed' ? {
        maxWidth: maxWidth
      } : {}
    });
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      title: "\u753B\u50CF\u30D5\u30A3\u30EB\u30BF\u30FC\u8A2D\u5B9A",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", null, "\u30D5\u30A3\u30EB\u30BF\u30FC\u30AB\u30E9\u30FC"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPicker, {
      color: filterColor,
    ...
    }), showCtaButton && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "CTA\u30EA\u30F3\u30AF\u5148 URL",
      value: ctaLinkUrl,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }), /*#__PURE__*/React.createElement(_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.LinkPicker, {
      link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkFromAttrs)(attributes, LINK_KEYS_CTA),
      onChange: function onChange(patch) {
        return setAttributes((0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkToAttrs)(patch, LINK_KEYS_CTA));
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: "\u65B0\u898F\u30BF\u30D6\u3067\u958B\u304F",
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onSelect: function onSelect(media) {
          return updateSlide(index, 'pcImgUrl', media.url);
        },
        allowedTypes: ['image'],
        ...
        onSelect: function onSelect(m) {
          return updateSlide(index, 'spImgUrl', m.url);
        },
        allowedTypes: ['image'],
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkFromAttrs)(slide, LINK_KEYS_SLIDE),
        onChange: function onChange(patch) {
          return updateSlideMulti(index, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_8__.lwLinkToAttrs)(patch, LINK_KEYS_SLIDE));
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isDestructive: true,
        onClick: function onClick() {
      ...
      className: "swiper-wrapper"
    }, slides[0] && slides[0].pcImgUrl && /*#__PURE__*/React.createElement("div", {
      className: "swiper-slide"
    }, /*#__PURE__*/React.createElement("picture", {
      className: "bg_img"
    }, /*#__PURE__*/React.createElement("source", {
      srcSet: slides[0].spImgUrl || slides[0].pcImgUrl,
      media: "(max-width:800px)"
    }), /*#__PURE__*/React.createElement("source", {
      srcSet: slides[0].pcImgUrl,
      media: "(min-width:801px)"
    }), /*#__PURE__*/React.createElement("img", {
      src: slides[0].pcImgUrl,
  ...
  deprecated: [{
    attributes: _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_7__.attributes), {}, {
      slides: _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_7__.attributes.slides), {}, {
        "default": [{
          "pcImgUrl": "https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/shop/6.webp",
          "spImgUrl": "",
          "altText": "スライド1のalt",
          "linkUrl": ""
        }, {
          "pcImgUrl": "https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/shop/2.webp",
          "spImgUrl": "",
          "altText": "スライド2のalt",
          "linkUrl": ""
        }]
...
/***/ "./src/paid-block-fv-11/editor.scss":
/*!******************************************!*\
  !*** ./src/paid-block-fv-11/editor.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-11/style.scss":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-11/style.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-fv-11/block.json":
/*!*****************************************!*\
  !*** ./src/paid-block-fv-11/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-fv-11","version":"1.0.0","title":"FV 11 背景画像スライダー","category":"lw-firstview","icon":"images-alt2","editorScript":"file:./paid-block-fv-11.js","aiHint":{"description":"背景画像スライダーFV。複数背景画像切替+サブタイトル+見出し+説明+CTAボタン。リッチなトップページに","excludeFromAutoSelect":false,"contentAttributes":["subTitle","mainTitle","descriptionText","buttonLabel"],"imageAttributes":["slides"],"notes":"blockId は空のままでよい（2026-08-26 にブロック側を直した。空なら読み込み時に自分で id を振って初期化する）。それ以前は空だと init-hide が外れずフロントで真っ白になっていた。 背景がスライドし、その上に固定の見出し・説明・CTAボタンが乗る。slides は3枚前後がちょうどよい。"},"supports":{"anchor":true},"attributes":{"blockId":{"type":"string"},"slides":{"type":"array","default":[{"pcImgUrl":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/shop/6.webp","spImgUrl":"","altText":"","linkUrl":""},{"pcImgUrl":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/shop/2.webp","spImgUrl":"","altText":"","linkUrl":""}]},"layoutType":{"type":"string","default":"full"},"maxWidth":{"type":"number","default":1200},"autoplayDelay":{"type":"number","default":3000},"sliderEffect":{"type":"string","default":"fade"},"crossFade":{"type":"boolean","default":true},"loop":{"type":"boolean","default":true},"disableOnInteraction":{"type":"boolean","default":false},"showPagination":{"type":"boolean","default":true},"paginationClickable":{"type":"boolean","default":true},"showNavigation":{"type":"boolean","default":true},"sliderSpeed":{"type":"number","default":1000},"paginationColor":{"type":"string","default":"#ffffff"},"nextButtonColor":{"type":"string","default":"#ffffff"},"minHeightPc":{"type":"string","default":"min-h-pc-480px"},"minHeightTb":{"type":"string","default":"min-h-tb-380px"},"minHeightSp":{"type":"string","default":"min-h-sp-320px"},"subTitle":{"type":"string","default":"サブタイトル"},"mainTitle":{"type":"string","default":"メインタイトル"},"descriptionText":{"type":"string","default":"サブテキストが入ります。ここは任意のテキストを入れてください。"},"buttonLabel":{"type":"string","default":"ボタンテキスト"},"ctaLinkUrl":{"type":"string","default":"#"},"ctaLinkType":{"type":"string","default":"url"},"ctaPageId":{"type":"number","default":0},"ctaCategoryId":{"type":"number","default":0},"ctaOpenNewTab":{"type":"boolean","default":false},"showCtaButton":{"type":"boolean","default":true},"filterColor":{"type":"string","default":"#000000"},"filterOpacity":{"type":"number","default":0.6}},"no":11}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-fv-11"], () => (__webpack_require__("./src/paid-block-fv-11/index.js")))
