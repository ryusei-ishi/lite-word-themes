...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-image-2/style.scss");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var borderRadiusEm = attributes.borderRadiusEm,
      ...
      alignClass = attributes.alignClass,
      items = attributes.items;

    /* 共通設定更新 */
    var updateAttr = function updateAttr(k, v) {
    ...
    var numClass = function numClass(i) {
      return "no_".concat(i + 1);
    };
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-image-2 ".concat(alignClass),
      style: {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      onChange: function onChange(v) {
        return updateAttr('borderRadiusEm', v);
      },
      min: 0,
      max: 5,
      step: 0.1
      ...
      value: aspectHeight,
      onChange: function onChange(v) {
        return updateAttr('aspectHeight', v);
      },
      min: 400,
      max: 1200,
      step: 10
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u30B3\u30F3\u30C6\u30CA max-width (".concat(maxWidthPx || '100% (制限なし)', ")"),
      value: maxWidthPx,
      onChange: function onChange(v) {
        return updateAttr('maxWidthPx', v);
      },
      min: 0,
      max: 2000,
      step: 10
      ...
      onChange: function onChange(v) {
        return updateAttr('alignClass', v);
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u672C\u6587\u30D5\u30A9\u30F3\u30C8",
      value: fontP,
      ...
      onChange: function onChange(v) {
        return updateAttr('fontWeightP', v);
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u672C\u6587\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: colorP,
      onChange: function onChange(c) {
        return updateAttr('colorP', c);
      }
    })), items.map(function (itm, idx) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        key: idx,
        title: "\u753B\u50CF ".concat(idx + 1, " \u306E\u8A2D\u5B9A"),
        initialOpen: false
        ...
        render: function render(_ref2) {
          var open = _ref2.open;
          return /*#__PURE__*/React.createElement(React.Fragment, null, itm.imgSrc && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
            src: itm.imgSrc,
      ...
      })), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("p", null, "\u30D5\u30A3\u30EB\u30BF\u30FC\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
        value: itm.fColor,
        onChange: function onChange(c) {
          return updateItem(idx, 'fColor', c);
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
        label: "\u30D5\u30A3\u30EB\u30BF\u30FC\u900F\u904E(0-1)",
        value: itm.fOpac,
        onChange: function onChange(v) {
          return updateItem(idx, 'fOpac', v);
        },
        min: 0,
        max: 1,
        step: 0.05
        ...
        onChange: function onChange(v) {
          return updateItem(idx, 'fBlend', v);
        }
      }));
    })), /*#__PURE__*/React.createElement("div", blockProps, items.map(function (itm, idx) {
      return /*#__PURE__*/React.createElement("div", {
        className: "image__inner ".concat(numClass(idx)),
        key: idx,
        style: {
          borderRadius: "".concat(borderRadiusEm, "em"),
          aspectRatio: "1000 / ".concat(aspectHeight)
        }
  ...
  save: function save(_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, items.map(function (itm, idx) {
      return /*#__PURE__*/React.createElement("div", {
        className: "image__inner ".concat(numClass(idx)),
        key: idx,
        style: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-image-2"], () => (__webpack_require__("./src/lw-image-2/index.js")))
