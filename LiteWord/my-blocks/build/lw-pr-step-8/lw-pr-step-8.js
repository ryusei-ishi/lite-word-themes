...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-step-8/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-step-8/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-step-8/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var bgGradient = attributes.bgGradient,
      ...
      stepNo = attributes.stepNo,
      liInPtPc = attributes.liInPtPc,
      liInPtSp = attributes.liInPtSp,
      stepBdrPc = attributes.stepBdrPc,
      stepBdrSp = attributes.stepBdrSp;
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      max: 1280,
      step: 1
    }), /*#__PURE__*/React.createElement("p", null, "\u67A0\u30FBSTEP\u756A\u53F7\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: bgGradient,
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorNo,
      onChange: function onChange(c) {
        return setAttributes({
          colorNo: c
      ...
      style: {
        ...
        '--step-8-bdr-pc': "".concat(stepBdrPc, "px"),
        '--step-8-bdr-sp': "".concat(stepBdrSp, "px")
      }
      ...
      style: {
        '--step-8-li-in-pt-pc': "".concat(liInPtPc, "em"),
        '--step-8-li-in-pt-sp': "".concat(liInPtSp, "em")
      }
...
/***/ "./src/lw-pr-step-8/block.json":
/*!*************************************!*\
  !*** ./src/lw-pr-step-8/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-step-8","version":"1.0.0","title":"step 04","category":"lw-step","icon":"lightbulb","description":"番号付きステップカード（スタイル2）","aiDescription":"01、02形式の番号付きステップカード。step-3の別デザイン。番号色をメインカラーに設定。採用フロー、サービス手順に最適。","aiNotes":"このブロックは番号付きカード型ステップ。colorNoで番号色を設定。bgGradientで背景色調整。","aiHint":{"description":"番号付きステップカード。01形式の番号+背景色。採用フロー・サービス手順に","excludeFromAutoSelect":false,"contentAttributes":[],"imageAttributes":[],"notes":"属性がスタイル系のみ。contents配列がないためテンプレート経由で使用"},"supports":{"anchor":true},"editorScript":"file:./lw-pr-step-8.js","no":4,"attributes":{"bgGradient":{"type":"string","default":"var(--color-main)","ai_description":"背景グラデーション色。var(--color-main)推奨"},"ulMaxWidth":{"type":"number","default":1080,"ai_description":"コンテンツ最大幅（px）"},"fontNo":{"type":"string","default":"Murecho","ai_description":"番号のフォント"},"fontWeightNo":{"type":"string","default":"600","ai_description":"番号のフォントウェイト"},"colorNo":{"type":"string","default":"var(--color-main)","ai_description":"番号の文字色。var(--color-main)推奨"},"stepNo":{"type":"string","default":"01","ai_description":"ステップ番号（01、02形式）"},"liInPtPc":{"type":"number","default":0.6,"ai_description":"コンテンツ余白（上）PC用"},"liInPtSp":{"type":"number","default":0.6,"ai_description":"コンテンツ余白（上）SP用"},"stepBdrPc":{"type":"number","default":10,"ai_description":"角丸PC用（px）"},"stepBdrSp":{"type":"number","default":10,"ai_description":"角丸SP用（px）"}}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-step-8"], () => (__webpack_require__("./src/lw-pr-step-8/index.js")))
