...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-20/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-20/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-20/block.json");
...
var styleVars = function styleVars(a) {
  var _a$maxWidth, _a$titleFontSizePc, _a$titleFontSizeSp, _a$ctaBorderRadius, _a$statsColumnsSp;
  return {
    '--fv20-panel-bg': a.panelBgColor,
    '--fv20-max-width': "".concat((_a$maxWidth = a.maxWidth) !== null && _a$maxWidth !== void 0 ? _a$maxWidth : 600, "px"),
    '--fv20-eyebrow-color': a.eyebrowColor,
    '--fv20-title-color': a.titleColor,
    '--fv20-title-weight': a.titleFontWeight,
    '--fv20-title-size-pc': "".concat((_a$titleFontSizePc = a.titleFontSizePc) !== null && _a$titleFontSizePc !== void 0 ? _a$titleFontSizePc : 44, "px"),
    '--fv20-title-size-sp': "".concat((_a$titleFontSizeSp = a.titleFontSizeSp) !== null && _a$titleFontSizeSp !== void 0 ? _a$titleFontSizeSp : 29, "px"),
    '--fv20-description-color': a.descriptionColor,
    '--fv20-cta-bg': a.ctaBgColor,
    '--fv20-cta-text': a.ctaTextColor,
    '--fv20-cta-sub': a.ctaSubColor,
    '--fv20-cta-radius': "".concat((_a$ctaBorderRadius = a.ctaBorderRadius) !== null && _a$ctaBorderRadius !== void 0 ? _a$ctaBorderRadius : 6, "px"),
    ...
    '--fv20-stats-cols-sp': String((_a$statsColumnsSp = a.statsColumnsSp) !== null && _a$statsColumnsSp !== void 0 ? _a$statsColumnsSp : 2)
  };
};
var rootClass = function rootClass(a) {
  return ['lw-pr-fv-20', a.imageSide === 'left' ? 'image_left' : 'image_right'].filter(Boolean).join(' ');
};
var topClass = function topClass(a) {
  return ['fv20_top', a.minHeightPc, a.minHeightTb, a.minHeightSp].filter(Boolean).join(' ');
};
var lwBlockDef = {
  edit: function edit(_ref) {
    var attributes = _ref.attributes,
      setAttributes = _ref.setAttributes;
    var panelBgColor = attributes.panelBgColor,
      ...
      showStats = attributes.showStats,
      _attributes$statsItem = attributes.statsItems,
      statsItems = _attributes$statsItem === void 0 ? [] : _attributes$statsItem,
      statsBgColor = attributes.statsBgColor,
      statsNumColor = attributes.statsNumColor,
      statsUnitColor = attributes.statsUnitColor,
      statsLabelColor = attributes.statsLabelColor,
      statsTopLineColor = attributes.statsTopLineColor,
      statsColumnsSp = attributes.statsColumnsSp;
    var HeadingTag = "h".concat(headingLevel);
    var updateStat = function updateStat(i, key, v) {
      return setAttributes({
        statsItems: statsItems.map(function (it, n) {
          return n === i ? _objectSpread(_objectSpread({}, it), {}, _defineProperty({}, key, v)) : it;
        })
      });
    };
    var addStat = function addStat() {
      return setAttributes({
        statsItems: [].concat(_toConsumableArray(statsItems), [{
          num: '0',
          unit: '件',
          label: '説明'
        }])
    ...
    var removeStat = function removeStat(i) {
      return setAttributes({
        statsItems: statsItems.filter(function (_, n) {
          return n !== i;
        })
      });
    };
    var moveStat = function moveStat(i, d) {
      var to = i + d;
      if (to < 0 || to >= statsItems.length) return;
      var next = _toConsumableArray(statsItems);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u6587\u7AE0\u5074\u306E\u9762\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: panelBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          panelBgColor: v
      ...
      help: "\u300C\u516810\u554F\u30FB3\u5206\u30FB\u767B\u9332\u4E0D\u8981\u300D\u306E\u3088\u3046\u306B\u3001\u304B\u304B\u308B\u6642\u9593\u3092\u66F8\u304D\u307E\u3059\u3002"
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u30EA\u30F3\u30AF\u5148\u306EURL",
      value: buttonUrl,
      onChange: function onChange(v) {
    ...
    }), showStats && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '4px 0 12px',
        fontSize: 12,
        color: '#a04a28'
      }
    }, "\uD83D\uDEA8 \u672C\u5F53\u306E\u6570\u5B57\u3060\u3051\u3092\u5165\u308C\u3066\u304F\u3060\u3055\u3044\u3002\u5B9F\u7E3E\u304C\u7121\u3044\u3068\u304D\u306F\u5E2F\u3054\u3068\u6D88\u3057\u307E\u3059\u3002"), statsItems.map(function (it, i) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        label: "".concat(i + 1, "\u3064\u3081\uFF1A\u6570\u5B57"),
        value: it.num,
        onChange: function onChange(v) {
          return updateStat(i, 'num', v);
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u5358\u4F4D",
        value: it.unit,
        onChange: function onChange(v) {
          return updateStat(i, 'unit', v);
        },
        help: "\u4EBA\u30FB\u4EF6\u30FB%\u30FB\u5206\u30FB\u5186 \u306A\u3069"
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u8AAC\u660E",
    ...
    }, "\u6570\u5B57\u3092\u8FFD\u52A0"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u30B9\u30DE\u30DB\u3067\u306E\u5217\u6570",
    ...
    }, "\u5E2F\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: statsBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          statsBgColor: v
    ...
    }, "\u6570\u5B57\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: statsNumColor,
      onChange: function onChange(v) {
        return setAttributes({
          statsNumColor: v
    ...
    }, "\u5358\u4F4D\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: statsUnitColor,
      onChange: function onChange(v) {
        return setAttributes({
          statsUnitColor: v
        });
    ...
    }, "\u8AAC\u660E\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: statsLabelColor,
      onChange: function onChange(v) {
        return setAttributes({
          statsLabelColor: v
        });
    ...
    }, "\u5E2F\u306E\u4E0A\u306E\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: statsTopLineColor,
      onChange: function onChange(v) {
        return setAttributes({
          statsTopLineColor: v
        });
      ...
      src: imageUrlPc,
      alt: imageAlt
    }))), showStats && statsItems.length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "stats_bar"
    }, statsItems.map(function (it, i) {
      return /*#__PURE__*/React.createElement("div", {
        className: "stat",
        key: i
      }, /*#__PURE__*/React.createElement("p", {
        className: "n"
      }, it.num, it.unit && /*#__PURE__*/React.createElement("span", {
        className: "u"
      }, it.unit)), it.label && /*#__PURE__*/React.createElement("p", {
        className: "l"
      }, it.label));
    }))));
  },
  save: function save(_ref4) {
    ...
    var imageUrlPc = attributes.imageUrlPc,
      imageUrlSp = attributes.imageUrlSp,
      imageAlt = attributes.imageAlt,
      showEyebrow = attributes.showEyebrow,
      eyebrow = attributes.eyebrow,
      ...
      buttonUrl = attributes.buttonUrl,
      showStats = attributes.showStats,
      _attributes$statsItem2 = attributes.statsItems,
      statsItems = _attributes$statsItem2 === void 0 ? [] : _attributes$statsItem2;
    var HeadingTag = "h".concat(headingLevel);
...
/***/ "./src/lw-pr-fv-20/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-20/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-20","version":"1.0.0","title":"FV 20 リード獲得（実績の数字つき）","category":"lw-firstview","icon":"chart-bar","editorScript":"file:./lw-pr-fv-20.js","aiHint":{"description":"リード獲得ページ専用のFV。左に色の面（見出し・説明・CTA）、右に写真、その真下に実績の数字を2〜5個ならべた帯が付く。CTAのすぐ近くに信頼の証が来るので、はじめて来た人でも押しやすい。自己診断・無料見積り・無料トライアル・キャンペーンに使う","excludeFromAutoSelect":false,"contentAttributes":["eyebrow","mainTitle","description","buttonText","buttonSub","statsItems"],"imageAttributes":["imageUrlPc","imageUrlSp"],"notes":["statsItems は { num, unit, label } の並び。num は数字だけ（12,480）、unit は単位（人・%・分・円）、label はその下の説明。2〜5個が読みやすく、4個が収まりがよい。空にすると帯ごと消える。","🚨 数字は必ず本当の数字を入れる。作った数字を置かない。実績が無いなら showStats を false にして帯ごと消す。","statsColumnsSp（スマホの列数）は既定 2。数字が長い（12,480 など）ときは 1 にする。","imageSide を left にすると写真が左・文章が右になる。同じ型を2ページ続けて使うときに変えると印象が変わる。","上段の高さは minHeightPc/Tb/Sp で決める。数字の帯はその外側に付くので、指定した高さ＋帯の分だけ縦に伸びる。","🚨 自分から全幅になる背景ブロック。次の段も全幅の帯なら、あいだにスペーサーを置かない。"]},"supports":{"anchor":true},"attributes":{"panelBgColor":{"type":"string","default":"#7a3340"},"imageUrlPc":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/background/6.webp"},"imageUrlSp":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"imageSide":{"type":"string","default":"right"},"minHeightPc":{"type":"string","default":"min-h-pc-440px"},"minHeightTb":{"type":"string","default":"min-h-tb-360px"},"minHeightSp":{"type":"string","default":""},"maxWidth":{"type":"number","default":600},"showEyebrow":{"type":"boolean","default":true},"eyebrow":{"type":"string","default":"10の質問に答えるだけ"},"eyebrowColor":{"type":"string","default":"#e9bfc6"},"headingLevel":{"type":"number","default":1},"mainTitle":{"type":"string","default":"いまのやり方、<br>3分で点検できます"},"titleColor":{"type":"string","default":"#ffffff"},"titleFontWeight":{"type":"string","default":"700"},"titleFont":{"type":"string","default":""},"titleFontSizePc":{"type":"number","default":44},"titleFontSizeSp":{"type":"number","default":29},"description":{"type":"string","default":"結果はその場に出ます。メールアドレスの登録も営業のご連絡もありません。"},"descriptionColor":{"type":"string","default":"#efd8dc"},"buttonText":{"type":"string","default":"無料で診断をはじめる"},"buttonSub":{"type":"string","default":"全10問・3分・登録不要"},"buttonUrl":{"type":"string","default":""},"buttonLinkType":{"type":"string","default":"url"},"buttonPageId":{"type":"number","default":0},"buttonCategoryId":{"type":"number","default":0},"ctaBgColor":{"type":"string","default":"#ffffff"},"ctaTextColor":{"type":"string","default":"#5a222d"},"ctaSubColor":{"type":"string","default":"#7a3340"},"ctaBorderRadius":{"type":"number","default":6},"showStats":{"type":"boolean","default":true},"statsItems":{"type":"array","default":[{"num":"12,480","unit":"人","label":"これまでの診断数"},{"num":"98","unit":"%","label":"「役に立った」の声"},{"num":"3","unit":"分","label":"終わるまでの時間"},{"num":"0","unit":"円","label":"最後まで無料"}]},"statsBgColor":{"type":"string","default":"#5a222d"},"statsNumColor":{"type":"string","default":"#ffffff"},"statsUnitColor":{"type":"string","default":"#c9903c"},"statsLabelColor":{"type":"string","default":"#e0c2c8"},"statsTopLineColor":{"type":"string","default":"#c9903c"},"statsColumnsSp":{"type":"number","default":2}}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-20"], () => (__webpack_require__("./src/lw-pr-fv-20/index.js")))
