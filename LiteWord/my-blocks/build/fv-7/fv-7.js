...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/fv-7/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/fv-7/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/fv-7/block.json");
...
var blockConfig = {
  edit: function edit(_ref) {
    ...
    var currentVideoType = videoType || 'media';
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "fv-7 ".concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp)
    });
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, [1, 2, 3, 4, 5].map(function (level) {
    ...
    }), currentVideoType === 'media' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      ...
      max: 2.0,
      step: 0.1
    })), currentVideoType === 'vimeo' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "Vimeo ID",
      value: vimeoId,
      onChange: function onChange(value) {
        return setAttributes({
    ...
    }), vimeoId && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '10px'
      }
    }, /*#__PURE__*/React.createElement("iframe", {
      src: "https://player.vimeo.com/video/".concat(vimeoId, "?background=1&autoplay=1&loop=1&muted=1"),
      style: {
        width: '100%',
        height: '200px'
      },
      ...
      className: "bg_image"
    }, currentVideoType === 'media' && videoUrl && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("video", {
      muted: true,
      playsInline: true,
    ...
    })), currentVideoType === 'vimeo' && vimeoId && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  save: function save(_ref3) {
    ...
    var shouldShowButton = showButton && buttonText && buttonText.trim() !== '';
...
var OLD_DEFAULT_VIDEO = 'https://cdn.pixabay.com/video/2023/11/19/189813-887078786_large.mp4';
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, _objectSpread(_objectSpread({}, blockConfig), {}, {
  deprecated: [{
    attributes: _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_6__.attributes), {}, {
      videoUrl: _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_6__.attributes.videoUrl), {}, {
        "default": OLD_DEFAULT_VIDEO
      })
    }),
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/fv-7","version":"1.0.0","title":"固定ページタイトル 07(トップ用・動画背景)","category":"lw-firstview","icon":"cover-image","editorScript":"file:./fv-7.js","supports":{"anchor":true},"aiHint":{"description":"動画背景FV。中央テキスト+ボタン+mp4/Vimeo背景。インパクト重視のトップページ向け","excludeFromAutoSelect":true,"excludeReason":"動画URLをAIが生成できないため。ユーザーが手動で動画を設定する","contentAttributes":["mainTitle","subTitle","description","buttonText","buttonUrl"],"imageAttributes":[]},"attributes":{"subTitle":{"type":"string","default":"初心者のためのWordPressテーマ","aiHint":{"role":"subheading","contentGuide":"英語表記 or サブキャッチ","example":"CREATIVE AGENCY"}},"mainTitle":{"type":"string","default":"LiteWord","aiHint":{"role":"heading","contentGuide":"キャッチコピー。5〜15文字","example":"映像で魅せる"}},"description":{"type":"string","default":"テキストテキストテキストテキストテキストテキスト","aiHint":{"role":"body","contentGuide":"サービスの価値を1〜2文で。20〜50文字","example":"私たちの映像制作で、あなたのビジネスを次のステージへ"}},"buttonText":{"type":"string","default":"詳細はこちら","aiHint":{"role":"button","contentGuide":"動詞形。4〜10文字","example":"お問い合わせ"}},"buttonUrl":{"type":"string","default":"","aiHint":{"role":"url","contentGuide":"#contact 等のページ内リンク推奨"}},"buttonLinkType":{"type":"string","default":"url"},"buttonPageId":{"type":"number","default":0},"buttonCategoryId":{"type":"number","default":0},"showButton":{"type":"boolean","default":true,"aiHint":{"skip":true}},"videoType":{"type":"string","default":"media","aiHint":{"skip":true}},"videoUrl":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/v/fv7_default.mp4","aiHint":{"skip":true,"note":"動画URLはユーザーが手動設定"}},"vimeoId":{"type":"string","default":"","aiHint":{"skip":true}},"filterColor":{"type":"string","default":"#000000","aiHint":{"skip":true}},"filterOpacity":{"type":"number","default":0.5,"aiHint":{"skip":true}},"videoSpeed":{"type":"number","default":1,"aiHint":{"skip":true}},"headingLevel":{"type":"number","default":1,"aiHint":{"skip":true}},"minHeightPc":{"type":"string","default":"","aiHint":{"skip":true}},"minHeightTb":{"type":"string","default":"","aiHint":{"skip":true}},"minHeightSp":{"type":"string","default":"","aiHint":{"skip":true}}},"no":7}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-fv-7"], () => (__webpack_require__("./src/fv-7/index.js")))
