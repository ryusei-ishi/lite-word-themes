...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  edit: function edit(props) {
    ...
    var linkUrl = attributes.linkUrl,
      ...
      listItem1 = attributes.listItem1,
      listItem2 = attributes.listItem2,
      listItem3 = attributes.listItem3,
      phoneNumber = attributes.phoneNumber,
      imageUrl = attributes.imageUrl,
      objectFit = attributes.objectFit,
      objectPosition = attributes.objectPosition,
      tapTelText = attributes.tapTelText,
      bgColor = attributes.bgColor,
      bdColor = attributes.bdColor,
      fontTel = attributes.fontTel,
      fontWeightTel = attributes.fontWeightTel;
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      value: fontTel,
      options: fontOptions,
      onChange: function onChange(newFontTel) {
      ...
      onChange: function onChange(newFontWeightTel) {
        return setAttributes({
          fontWeightTel: newFontWeightTel
        });
      }
      ...
      render: function render(_ref) {
        ...
        return /*#__PURE__*/React.createElement(React.Fragment, null, imageUrl && /*#__PURE__*/React.createElement("img", {
          ...
          onClick: open,
          variant: "secondary"
        }, "\u753B\u50CF\u3092\u9078\u629E"), ' ', /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      ...
      options: [{
        label: 'カバー (cover)',
        value: 'object_fit_cover'
      }, {
        label: 'コンテイン (contain)',
        value: 'object_fit_contain'
      }],
      ...
      options: [{
        label: '中央 (center)',
        value: 'object_position_center'
      }, {
        label: '上 (top)',
        value: 'object_position_top'
      }, {
        label: '下 (bottom)',
        value: 'object_position_bottom'
      }],
      onChange: function onChange(value) {
        return setAttributes({
      ...
      onChange: function onChange(color) {
        return setAttributes({
          bdColor: color || '#f45353'
        });
      }
    }))), /*#__PURE__*/React.createElement("div", {
      className: "paid-block-cta-3__inner"
    }, /*#__PURE__*/React.createElement("div", {
      className: "this_wrap",
      style: {
    ...
    }), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: "span",
      value: listItem1,
      onChange: function onChange(value) {
        return setAttributes({
      ...
      ,
      className: "".concat(objectFit, " ").concat(objectPosition)
    }))), /*#__PURE__*/React.createElement("div", {
      className: "tap_tel"
    }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: "p",
  ...
  save: function save(props) {
    ...
    var getPlainPhoneNumber = function getPlainPhoneNumber(richText) {
      if (!richText) return '';
      // HTMLタグを全て除去
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("a", {
      className: "this_wrap",
      href: plainPhoneNumber ? "tel:".concat(plainPhoneNumber) : '#',
      style: {
        backgroundColor: bgColor,
        borderColor: bdColor
      }
      ...
      tagName: "p",
      value: leadText
    }), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      value: listItem1
