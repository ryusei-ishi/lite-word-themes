...
/***/ "./src/paid-block-history-1/index.js":
/*!*******************************************!*\
  !*** ./src/paid-block-history-1/index.js ***!
  \*******************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/paid-block-history-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/paid-block-history-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/paid-block-history-1/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var yearText = attributes.yearText,
      yearTag = attributes.yearTag,
      fontYear = attributes.fontYear,
      fontWeightYear = attributes.fontWeightYear,
      colorYear = attributes.colorYear,
      yearBgColor = attributes.yearBgColor,
      pointColor = attributes.pointColor,
      pointBorderColor = attributes.pointBorderColor,
      fontDt = attributes.fontDt,
      fontWeightDt = attributes.fontWeightDt,
      colorDt = attributes.colorDt,
      fontDd = attributes.fontDd,
      fontWeightDd = attributes.fontWeightDd,
      colorDd = attributes.colorDd,
    ...
    /* 深いコピー用ユーティリティ */
    var deepCloneEvents = function deepCloneEvents(arr) {
    ...
    var addEvent = function addEvent() {
      setAttributes({
        events: [].concat(_toConsumableArray(deepCloneEvents(events)), [{
          month: '',
          desc: ''
        }])
      });
    };
    var removeEvent = function removeEvent(idx) {
      var list = deepCloneEvents(events).filter(function (_, i) {
        return i !== idx;
      });
      setAttributes({
        events: list
    ...
    var updateEvent = function updateEvent(idx, key, val) {
      var list = deepCloneEvents(events);
      list[idx][key] = val;
      setAttributes({
        events: list
      });
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      className: "history__events"
    }, events.map(function (e, i) {
      return /*#__PURE__*/React.createElement("div", {
        className: "history__events_row",
        key: i
      }, /*#__PURE__*/React.createElement("dt", {
        className: "history__dt"
      }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "time",
        value: e.month,
        onChange: function onChange(v) {
          return updateEvent(i, 'month', v);
        },
        "data-lw_font_set": fontDt,
        placeholder: "\u6708",
        style: {
          fontWeight: fontWeightDt,
          color: colorDt || undefined
        }
      })), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        tagName: "dd",
        ...
        value: e.desc,
        onChange: function onChange(v) {
          return updateEvent(i, 'desc', v);
        },
        "data-lw_font_set": fontDd,
        placeholder: "\u8AAC\u660E\u3092\u5165\u529B",
        style: {
          fontWeight: fontWeightDd,
          color: colorDd || undefined
        }
      }), /*#__PURE__*/React.createElement("button", {
        type: "button",
        className: "history__remove_btn",
  ...
  save: function save(_ref2) {
    ...
    var filtered = events.filter(function (e) {
      return String(e.month || '').trim() || String(e.desc || '').trim();
    });
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      className: "history__year",
      "aria-labelledby": "y".concat(String(yearText).replace(/[^0-9]/g, ''))
    }, /*#__PURE__*/React.createElement("div", {
      className: "history__point",
      style: {
        background: pointColor,
...
/***/ "./src/paid-block-history-1/editor.scss":
/*!**********************************************!*\
  !*** ./src/paid-block-history-1/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-history-1/style.scss":
/*!*********************************************!*\
  !*** ./src/paid-block-history-1/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-history-1/block.json":
/*!*********************************************!*\
  !*** ./src/paid-block-history-1/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/paid-block-history-1","version":"1.0.0","title":"沿革 01","category":"lw-table","icon":"schedule","editorScript":"file:./paid-block-history-1.js","editorStyle":["file:./editor.css","file:../../../assets/css/font_style.min.css","file:../../../assets/css/editor_block_side.min.css"],"style":"file:./style.css","supports":{"anchor":true},"no":1,"attributes":{"yearText":{"type":"string","default":"2003年"},"yearTag":{"type":"string","default":"h3"},"fontYear":{"type":"string","default":""},"fontWeightYear":{"type":"string","default":""},"colorYear":{"type":"string","default":""},"yearBgColor":{"type":"string","default":""},"pointColor":{"type":"string","default":"#ffffff"},"pointBorderColor":{"type":"string","default":"var(--color-main)"},"fontDt":{"type":"string","default":""},"fontWeightDt":{"type":"string","default":""},"colorDt":{"type":"string","default":""},"fontDd":{"type":"string","default":""},"fontWeightDd":{"type":"string","default":""},"colorDd":{"type":"string","default":""},"events":{"type":"array","source":"query","selector":".history__events_row","query":{"month":{"type":"string","source":"text","selector":"time"},"desc":{"type":"string","source":"html","selector":"dd"}},"default":[{"month":"4月","desc":"地域の福祉ニーズを把握するための住民説明会を開催。施設構想を共有し、支援者を募集。"},{"month":"7月","desc":"特定非営利活動法人として県の認証を取得し、地域福祉ネットワークづくりを本格始動。"},{"month":"8月","desc":"賃貸契約を締結し、小規模多機能施設を開設。利用者受け入れ準備を開始。"},{"month":"12月","desc":"初めての利用者を受け入れ。地域ボランティアによるサポート体制が整い、運営を本格化。"}]}}}');
...
/******/ 		var installedChunks = {
/******/ 			"paid-block-history-1": 0,
/******/ 			"./style-paid-block-history-1": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-history-1"], () => (__webpack_require__("./src/paid-block-history-1/index.js")))
