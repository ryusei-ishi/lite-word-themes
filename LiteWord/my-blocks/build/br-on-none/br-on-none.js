...
/* ---------- ブレークポイント定義 ---------- */
var BREAKPOINT_ON = [1050, 1000, 950, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 370, 350];
var BREAKPOINT_NONE = [1200, 1150, 1100, 1050, 1000, 950, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 350];
var BREAK_OPTIONS = [{
  label: '選択してください',
  value: ''
}].concat(_toConsumableArray(BREAKPOINT_ON.map(function (bp) {
  return {
    label: "".concat(bp, "px\u4EE5\u4E0B\u3067\u6539\u884C ON"),
    value: "on_".concat(bp, "px")
  };
})), _toConsumableArray(BREAKPOINT_NONE.map(function (bp) {
  return {
    label: "".concat(bp, "px\u4EE5\u4E0B\u3067\u6539\u884C OFF"),
    value: "none_".concat(bp, "px")
  };
})));
...
var Edit = function Edit(_ref) {
  ...
  var insertBreak = function insertBreak(cls) {
    if (!cls) return;
    var frag = (0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__.create)({
      html: "<span class=\"lw-br ".concat(cls, "\"></span>")
    });
...
/* ---------- フォーマット登録 ---------- */
(0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__.registerFormatType)('liteword/responsive-br', {
  title: 'レスポンシブ改行',
  tagName: 'span',
  className: 'lw-br',
  edit: Edit
