...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-goodbad-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-goodbad-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-goodbad-1/block.json");
...
function blockVars(a) {
  return {
    ...
    '--gb1-max-width': "".concat(a.maxWidth, "px"),
    '--gb1-radius': "".concat(a.borderRadius, "px"),
    '--gb1-border-w': "".concat(a.borderWidth, "px"),
    '--gb1-size': "".concat(a.fontSize, "px"),
    '--gb1-size-sp': "".concat(a.fontSizeSp, "px"),
    '--gb1-title-size': "".concat(a.titleFontSize, "px")
  };
}
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_6__), {}, {
  edit: function edit(_ref) {
    ...
    var goodTitle = attributes.goodTitle,
      badTitle = attributes.badTitle,
      goodItems = attributes.goodItems,
      badItems = attributes.badItems,
      goodMark = attributes.goodMark,
      badMark = attributes.badMark,
      layout = attributes.layout,
      goodBgColor = attributes.goodBgColor,
      goodBorderColor = attributes.goodBorderColor,
      goodTitleColor = attributes.goodTitleColor,
      badBgColor = attributes.badBgColor,
      badBorderColor = attributes.badBorderColor,
      badTitleColor = attributes.badTitleColor,
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "".concat(CLS, " is-").concat(layout),
      style: blockVars(attributes)
    });
    var column = function column(kind, title, titleKey, items, key, mark, bg, border, titleColor) {
      return /*#__PURE__*/React.createElement("div", {
        className: "".concat(CLS, "__col is-").concat(kind),
        style: {
          backgroundColor: bg,
          borderColor: border
        }
        ...
        tagName: "p",
        className: "".concat(CLS, "__title"),
        value: title,
        onChange: function onChange(v) {
          return setAttributes(_defineProperty({}, titleKey, v));
        },
        style: {
          color: titleColor
        },
        ...
        className: "".concat(CLS, "__list")
      }, (items || []).map(function (row, i) {
        return /*#__PURE__*/React.createElement("li", {
          key: i
        }, /*#__PURE__*/React.createElement("span", {
          className: "".concat(CLS, "__mark"),
          style: {
            color: titleColor
          }
        }, mark), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
          tagName: "span",
          className: "".concat(CLS, "__text"),
          value: row,
          onChange: function onChange(v) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      title: "\u8272",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", null, "\u826F\u3044\u70B9\u306E\u80CC\u666F"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: goodBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          goodBgColor: v || '#f2f8f4'
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u826F\u3044\u70B9\u306E\u67A0"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: goodBorderColor,
      onChange: function onChange(v) {
        return setAttributes({
          goodBorderColor: v || '#cfe4d6'
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u826F\u3044\u70B9\u306E\u898B\u51FA\u3057"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: goodTitleColor,
      onChange: function onChange(v) {
        return setAttributes({
          goodTitleColor: v || '#1f7a4d'
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u6C17\u306B\u306A\u308B\u70B9\u306E\u80CC\u666F"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: badBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          badBgColor: v || '#fbf5f4'
    ...
    }), /*#__PURE__*/React.createElement("p", null, "\u6C17\u306B\u306A\u308B\u70B9\u306E\u67A0"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: badBorderColor,
      onChange: function onChange(v) {
        return setAttributes({
          badBorderColor: v || '#e8d5d2'
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u6C17\u306B\u306A\u308B\u70B9\u306E\u898B\u51FA\u3057"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: badTitleColor,
      onChange: function onChange(v) {
        return setAttributes({
          badTitleColor: v || '#9c5a5a'
        });
      }
      ...
      className: "".concat(CLS, "__cols")
    }, column('good', goodTitle, 'goodTitle', goodItems, 'goodItems', goodMark, goodBgColor, goodBorderColor, goodTitleColor), column('bad', badTitle, 'badTitle', badItems, 'badItems', badMark, badBgColor, badBorderColor, badTitleColor))));
  },
  save: function save(_ref2) {
    ...
    var column = function column(kind, title, items, mark, bg, border, titleColor) {
      return /*#__PURE__*/React.createElement("div", {
        className: "".concat(CLS, "__col is-").concat(kind),
        style: {
          backgroundColor: bg,
        ...
        }, mark), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
          tagName: "span",
          className: "".concat(CLS, "__text"),
          value: row,
          style: {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      className: "".concat(CLS, "__cols")
    }, column('good', goodTitle, goodItems, goodMark, goodBgColor, goodBorderColor, goodTitleColor), column('bad', badTitle, badItems, badMark, badBgColor, badBorderColor, badTitleColor)));
  }
}));
...
/***/ "./src/lw-pr-goodbad-1/editor.scss":
/*!*****************************************!*\
  !*** ./src/lw-pr-goodbad-1/editor.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-goodbad-1/style.scss":
/*!****************************************!*\
  !*** ./src/lw-pr-goodbad-1/style.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-goodbad-1/block.json":
/*!****************************************!*\
  !*** ./src/lw-pr-goodbad-1/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-goodbad-1","version":"1.0.0","title":"メリット・デメリット 01","category":"lw-list","icon":"editor-ol","description":"良い点と気になる点を左右に並べて見せるブロックです。レビュー記事や比較記事で「正直に書いている」ことが伝わります。","aiHint":{"description":"メリットとデメリットを左右2つの箱に分けて並べる。レビュー記事・比較記事・商品紹介で、良い点と気になる点を対で見せるときに使う。スマホでは自動で縦に積む","excludeFromAutoSelect":false,"contentAttributes":["goodTitle","goodItems","badTitle","badItems"],"imageAttributes":[],"notes":"✅ **`goodItems` と `badItems` は文字列の配列**（1要素＝1行）。件数は左右で違っていてよい。✅ 空の行は出ない。✅ スマホ（750px以下）では自動で縦に積むので、`layout` を触らなくてよい。🚨 **デメリットを空にしないこと。** 良いことしか書いていないページは読む人にすぐ分かる。このブロックは「気になる点も書いてある」ことを見せるためにある。デメリットを書けないなら、このブロックを使う意味がない。🚨 効果を断定する言い方は薬機法・景品表示法で書けない（「治る」「必ず痩せる」など）。体験の形（「私の場合は〜でした」）にする。1行は15〜40文字が読みやすい。","contentGuide":"goodItems は3〜5行、badItems は2〜4行が読みやすい。デメリットは「致命的ではないが正直な点」を書くと信用される"},"supports":{"anchor":true,"className":true},"attributes":{"goodTitle":{"type":"string","default":"ここが良い"},"badTitle":{"type":"string","default":"気になる点"},"goodItems":{"type":"array","default":["良かった点を書いてください","使ってみて助かった点","ほかと比べて優れている点"],"aiHint":{"role":"list","contentGuide":"良い点。1行15〜40文字。3〜5行"}},"badItems":{"type":"array","default":["気になった点を正直に書いてください","人によっては合わないかもしれない点"],"aiHint":{"role":"list","contentGuide":"気になる点。1行15〜40文字。2〜4行。空にしない"}},"goodMark":{"type":"string","default":"○"},"badMark":{"type":"string","default":"△"},"layout":{"type":"string","default":"side"},"maxWidth":{"type":"number","default":720},"marginTop":{"type":"number","default":0},"marginBottom":{"type":"number","default":0},"borderRadius":{"type":"number","default":10},"borderWidth":{"type":"number","default":1},"fontSize":{"type":"number","default":15},"fontSizeSp":{"type":"number","default":14},"titleFontSize":{"type":"number","default":17},"goodBgColor":{"type":"string","default":"#f2f8f4"},"goodBorderColor":{"type":"string","default":"#cfe4d6"},"goodTitleColor":{"type":"string","default":"#1f7a4d"},"badBgColor":{"type":"string","default":"#fbf5f4"},"badBorderColor":{"type":"string","default":"#e8d5d2"},"badTitleColor":{"type":"string","default":"#9c5a5a"},"textColor":{"type":"string","default":"#444444"},"FontSet":{"type":"string","default":""}},"editorScript":"file:./lw-pr-goodbad-1.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-goodbad-1"], () => (__webpack_require__("./src/lw-pr-goodbad-1/index.js")))
