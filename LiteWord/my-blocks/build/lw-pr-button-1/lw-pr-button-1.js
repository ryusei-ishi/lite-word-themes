...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-button-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-button-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-button-1/block.json");
...
var iconMainOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.leftButtonIconSvgArr)();
var iconRightOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.rightButtonIconSvgArr)();
var bgOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.ButtonBackgroundOptionsArr)();
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(props) {
    ...
    var textSub = attributes.textSub,
      textMain = attributes.textMain,
      ...
      bgColorSub = attributes.bgColorSub,
      textColorMain = attributes.textColorMain,
      textColorSub = attributes.textColorSub,
      borderWidth = attributes.borderWidth,
      borderColor = attributes.borderColor,
      borderRadius = attributes.borderRadius,
      iconMain = attributes.iconMain,
      iconRight = attributes.iconRight,
      iconMainColor = attributes.iconMainColor,
      iconRightColor = attributes.iconRightColor,
      iconMainSize = attributes.iconMainSize,
      iconRightSize = attributes.iconRightSize,
      iconMainMarginRight = attributes.iconMainMarginRight,
      FontSet = attributes.FontSet,
      fontWeight = attributes.fontWeight,
      fontWeightSub = attributes.fontWeightSub,
      fontSizeMain = attributes.fontSizeMain,
      fontSizeMainSp = attributes.fontSizeMainSp,
      fontSizeSub = attributes.fontSizeSub,
      maxWidth = attributes.maxWidth,
      maxWidthSp = attributes.maxWidthSp,
      transitionDuration = attributes.transitionDuration,
      shakeAnimation = attributes.shakeAnimation,
      shakeInterval = attributes.shakeInterval,
      shakeIntensity = attributes.shakeIntensity,
    ...
    // wrap_btnのクラス名を生成
    var wrapBtnClassName = "wrap_btn ".concat(btnAlign);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u25BC \u30E1\u30A4\u30F3\u30C6\u30AD\u30B9\u30C8\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u592A\u3055",
      value: fontWeight,
    ...
    }, "\u25BC \u30B5\u30D6\u30C6\u30AD\u30B9\u30C8\u8A2D\u5B9A"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u592A\u3055",
      value: fontWeightSub,
      options: fontWeightOptions,
      onChange: function onChange(newWeight) {
        return setAttributes({
          fontWeightSub: newWeight
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u6587\u5B57\u30B5\u30A4\u30BA (px)",
    ...
    }, "\uD83C\uDF08 \u30DC\u30BF\u30F3\u306E\u80CC\u666F"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: bgColor,
      options: bgOptions,
      onChange: function onChange(newBg) {
        return setAttributes({
          bgColor: newBg
        });
      },
    ...
    }, "\u30AB\u30B9\u30BF\u30E0\u30AB\u30E9\u30FC:"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\uD83D\uDDB1\uFE0F \u30DB\u30D0\u30FC\u6642\u306E\u80CC\u666F"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: bgColorHover,
      options: bgOptions,
      onChange: function onChange(newBg) {
        return setAttributes({
    ...
    }, "\uD83C\uDFF7\uFE0F \u30B5\u30D6\u30C6\u30AD\u30B9\u30C8\u306E\u80CC\u666F"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      value: bgColorSub,
      options: bgOptions,
      onChange: function onChange(newBg) {
        return setAttributes({
    ...
    }), iconMain && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
    ...
    }, "\uD83C\uDFA8 \u30E1\u30A4\u30F3\u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: iconMainColor,
      onChange: function onChange(newColor) {
        return setAttributes({
          iconMainColor: newColor
        });
      }
    })))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u27A1\uFE0F \u53F3\u5074\u30A2\u30A4\u30B3\u30F3\u306E\u7A2E\u985E",
      value: iconRight,
      ...
      help: "\u30DC\u30BF\u30F3\u53F3\u5074\u306B\u8868\u793A\u3059\u308B\u30A2\u30A4\u30B3\u30F3"
    }), iconRight && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\uD83D\uDCCF \u53F3\u5074\u30A2\u30A4\u30B3\u30F3\u306E\u30B5\u30A4\u30BA (px)",
      value: iconRightSize,
      onChange: function onChange(value) {
        return setAttributes({
    ...
    }, "\uD83C\uDFA8 \u53F3\u5074\u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: iconRightColor,
      onChange: function onChange(newColor) {
        return setAttributes({
          iconRightColor: newColor
        });
      }
    }))))), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30EC\u30A4\u30A2\u30A6\u30C8\u8A2D\u5B9A",
    ...
    }), borderWidth > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '15px'
      }
    }, /*#__PURE__*/React.createElement("p", {
    ...
    }, "\uD83C\uDFA8 \u67A0\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: borderColor,
      onChange: function onChange(newColor) {
        return setAttributes({
    ...
    }, "\uD83C\uDFAD \u9707\u3048\u308B\u30A2\u30CB\u30E1\u30FC\u30B7\u30E7\u30F3"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      ...
      help: "\u30DC\u30BF\u30F3\u304C\u5B9A\u671F\u7684\u306B\u6A2A\u306B\u9707\u3048\u307E\u3059"
    }), shakeAnimation && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u9707\u3048\u306E\u5F37\u3055",
      ...
      style: {
        ...
        '--transition-duration': "".concat(transitionDuration, "s"),
        '--max-width-sp': "".concat(maxWidthSp, "px"),
        '--shake-interval': "".concat(shakeInterval, "s"),
        '--font-size-main': "".concat(fontSizeMain, "px"),
        '--font-size-main-sp': "".concat(fontSizeMainSp, "px"),
        '--font-size-sub': "".concat(fontSizeSub, "px"),
        maxWidth: "".concat(maxWidth, "px"),
        background: bgColor,
        border: "".concat(borderWidth, "px solid ").concat(borderColor),
        borderRadius: "".concat(borderRadius, "px"),
        boxShadow: "".concat(shadowX, "px ").concat(shadowY, "px ").concat(shadowBlur, "px rgba(0, 0, 0, ").concat(shadowOpacity, ")")
      }
      ...
      style: {
        ...
        fontSize: "".concat(fontSizeSub, "px")
      },
      ...
      style: {
        ...
        fontSize: "".concat(fontSizeMain, "px")
      },
      "data-lw_font_set": FontSet
    }, iconMain && /*#__PURE__*/React.createElement("span", {
      className: "icon",
      ...
      style: {
        fill: iconMainColor,
        width: "".concat(iconMainSize, "px"),
        marginRight: "".concat(iconMainMarginRight, "px")
      }
    }), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      value: textMain,
      onChange: function onChange(newText) {
...
/***/ "./src/lw-pr-button-1/editor.scss":
/*!****************************************!*\
  !*** ./src/lw-pr-button-1/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-button-1/block.json":
/*!***************************************!*\
  !*** ./src/lw-pr-button-1/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-button-1","version":"1.0.0","title":"PRボタン 01","category":"lw-button","icon":"button","description":"プレミアムリンクボタン（スタイル01）","aiHint":{"description":"2段テキスト+アイコン付きプレミアムボタン。角丸+影+振動アニメーション対応。CTA導線に","excludeFromAutoSelect":false,"contentAttributes":["textMain","textSub","btnUrl"],"imageAttributes":[]},"supports":{"anchor":true,"className":true},"attributes":{"isAffiliate":{"type":"boolean","default":false},"textSub":{"type":"string","default":"＼ テキストテキストテキスト ／","aiHint":{"role":"subheading","contentGuide":"補足テキスト（小さい文字）。＼ ／で囲む。10〜20文字","example":"＼ まずはお気軽にご相談ください ／"}},"textMain":{"type":"string","default":"資料をダウンロード","aiHint":{"role":"button","contentGuide":"メインボタンテキスト。5〜15文字","example":"無料資料をダウンロード"}},"btnUrl":{"type":"string","default":"","aiHint":{"role":"url","contentGuide":"遷移先URL"}},"openNewTab":{"type":"boolean","default":false,"aiHint":{"skip":true}},"btnAlign":{"type":"string","default":"center","aiHint":{"skip":true}},"btnAlignSp":{"type":"string","default":"default","aiHint":{"skip":true}},"bgColor":{"type":"string","default":"#3e3a39","aiHint":{"skip":true}},"bgColorHover":{"type":"string","default":"#483c39ff","aiHint":{"skip":true}},"bgColorSub":{"type":"string","default":"#f9bb00","aiHint":{"skip":true}},"textColorMain":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"textColorSub":{"type":"string","default":"#000000","aiHint":{"skip":true}},"borderWidth":{"type":"number","default":3,"aiHint":{"skip":true}},"borderColor":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"borderRadius":{"type":"number","default":64,"aiHint":{"skip":true}},"iconMain":{"type":"string","default":"","aiHint":{"skip":true}},"iconRight":{"type":"string","default":"<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 320 512\\"><path d=\\"M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z\\"/></svg>","aiHint":{"skip":true}},"iconMainColor":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"iconRightColor":{"type":"string","default":"#ffffff","aiHint":{"skip":true}},"iconMainSize":{"type":"number","default":20,"aiHint":{"skip":true}},"iconRightSize":{"type":"number","default":12,"aiHint":{"skip":true}},"iconMainMarginRight":{"type":"number","default":8,"aiHint":{"skip":true}},"FontSet":{"type":"string","default":"","aiHint":{"skip":true}},"fontWeight":{"type":"string","default":"700","aiHint":{"skip":true}},"fontWeightSub":{"type":"string","default":"600","aiHint":{"skip":true}},"fontSizeMain":{"type":"number","default":20,"aiHint":{"skip":true}},"fontSizeMainSp":{"type":"number","default":18,"aiHint":{"skip":true}},"fontSizeSub":{"type":"number","default":12,"aiHint":{"skip":true}},"maxWidth":{"type":"number","default":340,"aiHint":{"skip":true}},"maxWidthSp":{"type":"number","default":300,"aiHint":{"skip":true}},"transitionDuration":{"type":"number","default":0.3,"aiHint":{"skip":true}},"shakeAnimation":{"type":"boolean","default":false,"aiHint":{"skip":true}},"shakeInterval":{"type":"number","default":3,"aiHint":{"skip":true}},"shakeIntensity":{"type":"string","default":"normal","aiHint":{"skip":true}},"shadowX":{"type":"number","default":0,"aiHint":{"skip":true}},"shadowY":{"type":"number","default":0,"aiHint":{"skip":true}},"shadowBlur":{"type":"number","default":6,"aiHint":{"skip":true}},"shadowOpacity":{"type":"number","default":0.2,"aiHint":{"skip":true}},"btnLinkType":{"type":"string","default":"url","aiHint":{"skip":true}},"btnPageId":{"type":"number","default":0,"aiHint":{"skip":true}},"btnCategoryId":{"type":"number","default":0,"aiHint":{"skip":true}}},"editorScript":"file:./lw-pr-button-1.js","no":1}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-button-1"], () => (__webpack_require__("./src/lw-pr-button-1/index.js")))
