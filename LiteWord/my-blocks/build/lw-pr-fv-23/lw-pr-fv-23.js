...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-23/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-23/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-23/block.json");
...
var styleVars = function styleVars(a) {
  var _a$filterOpacity, _a$maxWidth, _a$cardWidth, _a$titleFontSizePc, _a$titleFontSizeSp, _a$ctaBorderRadius, _a$cardBorderRadius, _a$qrSize;
  return {
    '--fv23-bg': a.bgColor,
    '--fv23-filter-color': a.filterColor,
    '--fv23-filter-opacity': String((_a$filterOpacity = a.filterOpacity) !== null && _a$filterOpacity !== void 0 ? _a$filterOpacity : 0.88),
    '--fv23-max-width': "".concat((_a$maxWidth = a.maxWidth) !== null && _a$maxWidth !== void 0 ? _a$maxWidth : 1120, "px"),
    '--fv23-card-width': "".concat((_a$cardWidth = a.cardWidth) !== null && _a$cardWidth !== void 0 ? _a$cardWidth : 340, "px"),
    '--fv23-eyebrow-color': a.eyebrowColor,
    '--fv23-title-color': a.titleColor,
    '--fv23-title-weight': a.titleFontWeight,
    '--fv23-title-size-pc': "".concat((_a$titleFontSizePc = a.titleFontSizePc) !== null && _a$titleFontSizePc !== void 0 ? _a$titleFontSizePc : 40, "px"),
    '--fv23-title-size-sp': "".concat((_a$titleFontSizeSp = a.titleFontSizeSp) !== null && _a$titleFontSizeSp !== void 0 ? _a$titleFontSizeSp : 27, "px"),
    ...
    '--fv23-cta-radius': "".concat((_a$ctaBorderRadius = a.ctaBorderRadius) !== null && _a$ctaBorderRadius !== void 0 ? _a$ctaBorderRadius : 8, "px"),
    '--fv23-card-bg': a.cardBgColor,
    '--fv23-card-text': a.cardTextColor,
    '--fv23-card-border': a.cardBorderColor,
    '--fv23-card-radius': "".concat((_a$cardBorderRadius = a.cardBorderRadius) !== null && _a$cardBorderRadius !== void 0 ? _a$cardBorderRadius : 12, "px"),
    '--fv23-qr-size': "".concat((_a$qrSize = a.qrSize) !== null && _a$qrSize !== void 0 ? _a$qrSize : 180, "px"),
    '--fv23-note-color': a.noteColor
  };
};
var rootClass = function rootClass(a) {
  return ['lw-pr-fv-23', a.backgroundType === 'image' ? 'bg_image' : 'bg_color', a.showQrOnSp ? 'qr_on_sp' : 'qr_off_sp'].filter(Boolean).join(' ');
};
var innerClass = function innerClass(a) {
  return ['fv23_inner', a.minHeightPc, a.minHeightTb, a.minHeightSp].filter(Boolean).join(' ');
};
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      cardWidth = attributes.cardWidth,
      showEyebrow = attributes.showEyebrow,
      eyebrow = attributes.eyebrow,
      eyebrowColor = attributes.eyebrowColor,
      ...
      showBenefits = attributes.showBenefits,
      _attributes$benefitIt = attributes.benefitItems,
      benefitItems = _attributes$benefitIt === void 0 ? [] : _attributes$benefitIt,
      benefitTextColor = attributes.benefitTextColor,
      benefitMarkColor = attributes.benefitMarkColor,
      benefitMarkBgColor = attributes.benefitMarkBgColor,
      buttonText = attributes.buttonText,
      buttonSub = attributes.buttonSub,
      buttonUrl = attributes.buttonUrl,
      buttonOpenNewTab = attributes.buttonOpenNewTab,
      ctaBgColor = attributes.ctaBgColor,
      ctaTextColor = attributes.ctaTextColor,
      ctaSubColor = attributes.ctaSubColor,
      ...
      cardBorderRadius = attributes.cardBorderRadius,
      showQr = attributes.showQr,
      qrUrl = attributes.qrUrl,
      qrAlt = attributes.qrAlt,
      qrSize = attributes.qrSize,
      qrCaption = attributes.qrCaption,
      showQrOnSp = attributes.showQrOnSp,
      showAccount = attributes.showAccount,
      accountLabel = attributes.accountLabel,
      accountName = attributes.accountName,
      noteText = attributes.noteText,
      noteColor = attributes.noteColor;
    var HeadingTag = "h".concat(headingLevel);
    var updateBenefit = function updateBenefit(i, v) {
      return setAttributes({
        benefitItems: benefitItems.map(function (it, n) {
          return n === i ? _objectSpread(_objectSpread({}, it), {}, {
            text: v
          }) : it;
        })
      });
    };
    var addBenefit = function addBenefit() {
      return setAttributes({
        benefitItems: [].concat(_toConsumableArray(benefitItems), [{
          text: '登録するとできること'
        }])
      });
    };
    var removeBenefit = function removeBenefit(i) {
      return setAttributes({
        benefitItems: benefitItems.filter(function (_, n) {
          return n !== i;
        })
      });
    };
    var moveBenefit = function moveBenefit(i, d) {
      var to = i + d;
      if (to < 0 || to >= benefitItems.length) return;
      var next = _toConsumableArray(benefitItems);
      var _next$splice = next.splice(i, 1),
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u5730\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: bgColor,
      onChange: function onChange(v) {
        return setAttributes({
          bgColor: v
    ...
    }, "\u30D1\u30BD\u30B3\u30F3\u7528"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
    ...
    }, "\u30B9\u30DE\u30DB\u7528\uFF08\u7A7A\u306A\u3089\u30D1\u30BD\u30B3\u30F3\u7528\uFF09"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: function onSelect(m) {
        return setAttributes({
          imageUrlSp: m.url
        });
    ...
    }, "\u5199\u771F\u306B\u91CD\u306D\u308B\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: filterColor,
      onChange: function onChange(v) {
        return setAttributes({
          filterColor: v
    ...
    }), showEyebrow && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u80A9\u30E9\u30D9\u30EB\u306E\u6587\u5B57",
      value: eyebrow,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }, "\u80A9\u30E9\u30D9\u30EB\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: eyebrowColor,
      onChange: function onChange(v) {
        return setAttributes({
          eyebrowColor: v
    ...
    }), showBenefits && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '4px 0 12px',
        fontSize: 12,
        color: '#a04a28'
      }
    }, "\uD83D\uDEA8 \u767B\u9332\u3055\u308C\u306A\u3044\u7406\u7531\u306F\u307B\u3068\u3093\u3069\u300C\u4F55\u304C\u5C4A\u304F\u304B\u5206\u304B\u3089\u306A\u3044\u300D\u3067\u3059\u30023\u3064\u524D\u5F8C\u3067\u5177\u4F53\u7684\u306B\u66F8\u3044\u3066\u304F\u3060\u3055\u3044\u3002"), benefitItems.map(function (it, i) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        disabled: i === benefitItems.length - 1
      }, "\u2193"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isDestructive: true,
        onClick: function onClick() {
          return removeBenefit(i);
        }
      }, "\u524A\u9664")));
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "primary",
    ...
    }, "1\u3064\u8FFD\u52A0"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '12px 0 4px'
      }
    }, "\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\u30C1\u30A7\u30C3\u30AF\u5370\u306E\u4E38\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: benefitMarkBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          benefitMarkBgColor: v
        });
      }
    }))), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u767B\u9332\u30DC\u30BF\u30F3",
      ...
      help: "\u5916\u306E\u30B5\u30FC\u30D3\u30B9\u3078\u98DB\u3070\u3059\u3068\u304D\u306F\u5165\u308C\u305F\u307E\u307E\u306B\u3057\u307E\u3059\u3002"
    }), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '12px 0 4px'
      }
    }, "\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: ctaBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          ctaBgColor: v
    ...
    }, "LINE\u516C\u5F0F\u30A2\u30AB\u30A6\u30F3\u30C8\u306B\u5408\u308F\u305B\u3066\u7DD1\uFF08#06C755\uFF09\u306B\u3059\u308B\u3068\u304D\u306F\u3001\u6587\u5B57\u8272\u3082\u4E00\u7DD2\u306B\u898B\u76F4\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u767D\u6587\u5B57\u306E\u307E\u307E\u3060\u3068\u8584\u304F\u3066\u8AAD\u3081\u307E\u305B\u3093\u3002"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '12px 0 4px'
      }
    }, "\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\u5C0F\u3055\u3044\u6587\u5B57\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: ctaSubColor,
      onChange: function onChange(v) {
        return setAttributes({
          ctaSubColor: v
    ...
    }), showQr && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '4px 0 12px',
        fontSize: 12,
        color: '#a04a28'
      }
    }, "\uD83D\uDEA8 \u3054\u81EA\u5206\u306E\u30A2\u30AB\u30A6\u30F3\u30C8\u306EQR\u30B3\u30FC\u30C9\u753B\u50CF\u3092\u5165\u308C\u3066\u304F\u3060\u3055\u3044\u3002\u898B\u672C\u306F\u5165\u3063\u3066\u3044\u307E\u305B\u3093\u3002"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: function onSelect(m) {
        return setAttributes({
          qrUrl: m.url
        });
      ...
      help: "\u30B9\u30DE\u30DB\u3067\u306F\u81EA\u5206\u306E\u753B\u9762\u306EQR\u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093\u3002\u5370\u5237\u3084\u5E97\u982D\u306E\u63B2\u793A\u306B\u4F7F\u3046\u30DA\u30FC\u30B8\u306E\u3068\u304D\u3060\u3051\u5165\u308C\u307E\u3059\u3002"
    })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: "\u30A2\u30AB\u30A6\u30F3\u30C8\u540D\u3092\u51FA\u3059",
      checked: showAccount,
      onChange: function onChange(v) {
    ...
    }), showAccount && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u898B\u51FA\u3057\uFF08ID \u306A\u3069\uFF09",
      value: accountLabel,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }, "\u30AB\u30FC\u30C9\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cardBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          cardBgColor: v
    ...
    }, "\u30AB\u30FC\u30C9\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cardTextColor,
      onChange: function onChange(v) {
        return setAttributes({
          cardTextColor: v
    ...
    }, "\u30AB\u30FC\u30C9\u306E\u67A0\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      ...
      help: "\u300C\u3084\u3081\u65B9\u300D\u3092\u66F8\u304F\u3068\u767B\u9332\u304C\u5897\u3048\u307E\u3059\u3002\u6D88\u3055\u306A\u3044\u3067\u304F\u3060\u3055\u3044\u3002"
    }), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '12px 0 4px'
      }
    ...
    }))), /*#__PURE__*/React.createElement("div", blockProps, backgroundType === 'image' && /*#__PURE__*/React.createElement("div", {
      className: "bg_filter"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bg_filter_inner"
    }), imageUrlPc && /*#__PURE__*/React.createElement("img", {
      src: imageUrlPc,
      alt: imageAlt
    })), /*#__PURE__*/React.createElement("div", {
      className: innerClass(attributes)
    }, /*#__PURE__*/React.createElement("div", {
      className: "lead_side"
    }, showEyebrow && eyebrow && /*#__PURE__*/React.createElement("p", {
      className: "eyebrow"
    }, eyebrow), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: HeadingTag,
      className: "main_ttl",
      ...
      placeholder: "\u3053\u3053\u306B\u8AAC\u660E\u6587"
    }), showBenefits && benefitItems.length > 0 && /*#__PURE__*/React.createElement("ul", {
      className: "benefit_list"
    }, benefitItems.map(function (it, i) {
      ...
      className: "cta_btn"
    }, buttonText, buttonSub && /*#__PURE__*/React.createElement("small", null, buttonSub)), noteText && /*#__PURE__*/React.createElement("p", {
      className: "note"
    }, noteText)), /*#__PURE__*/React.createElement("div", {
      className: "join_card"
    }, showQr && (qrUrl ? /*#__PURE__*/React.createElement("span", {
      className: "qr_box"
    }, /*#__PURE__*/React.createElement("img", {
      src: qrUrl,
      alt: qrAlt
    })) : /*#__PURE__*/React.createElement("span", {
      className: "qr_box is_empty"
    }, "QR\u30B3\u30FC\u30C9\u306E\u753B\u50CF\u3092\u5165\u308C\u3066\u304F\u3060\u3055\u3044")), showQr && qrCaption && /*#__PURE__*/React.createElement("p", {
      className: "qr_caption"
    }, qrCaption), showAccount && (accountLabel || accountName) && /*#__PURE__*/React.createElement("p", {
      className: "account"
    }, accountLabel && /*#__PURE__*/React.createElement("b", null, accountLabel), accountName && /*#__PURE__*/React.createElement("span", null, accountName))))));
  },
  save: function save(_ref5) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      description = attributes.description,
      showBenefits = attributes.showBenefits,
      _attributes$benefitIt2 = attributes.benefitItems,
      benefitItems = _attributes$benefitIt2 === void 0 ? [] : _attributes$benefitIt2,
      buttonText = attributes.buttonText,
      buttonSub = attributes.buttonSub,
      buttonUrl = attributes.buttonUrl,
      buttonOpenNewTab = attributes.buttonOpenNewTab,
    ...
    var qrPx = qrSize !== null && qrSize !== void 0 ? qrSize : 180;
    var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
      className: rootClass(attributes),
      style: styleVars(attributes)
    });
    return /*#__PURE__*/React.createElement("div", blockProps, backgroundType === 'image' && /*#__PURE__*/React.createElement("div", {
      className: "bg_filter"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bg_filter_inner"
    }), imageUrlPc && /*#__PURE__*/React.createElement("picture", null, /*#__PURE__*/React.createElement("source", {
      ...
      className: "eyebrow"
    }, eyebrow), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: HeadingTag,
      className: "main_ttl",
      "data-lw_font_set": titleFont,
      value: mainTitle
      ...
      width: qrPx,
      height: qrPx
    })), showQr && qrUrl && qrCaption && /*#__PURE__*/React.createElement("p", {
      className: "qr_caption"
    }, qrCaption), showAccount && (accountLabel || accountName) && /*#__PURE__*/React.createElement("p", {
      className: "account"
    }, accountLabel && /*#__PURE__*/React.createElement("b", null, accountLabel), accountName && /*#__PURE__*/React.createElement("span", null, accountName)))));
...
/***/ "./src/lw-pr-fv-23/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-23/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-23","version":"1.0.0","title":"FV 23 リード獲得（QRコードで登録）","category":"lw-firstview","icon":"smartphone","editorScript":"file:./lw-pr-fv-23.js","aiHint":{"description":"リード獲得ページ専用のFV。左に「登録するとできること」と大きな登録ボタン、右に白いカードでQRコードとアカウント名を出す。パソコンの人はQRコードを読み取り、スマホの人はボタンを押す、という2つの道が1画面で完結する。LINE公式アカウント・メールマガジン・アプリ・会員登録・オンラインサロンの入口に使う","excludeFromAutoSelect":false,"contentAttributes":["eyebrow","mainTitle","description","benefitItems","buttonText","buttonSub","qrCaption","accountLabel","accountName","noteText"],"imageAttributes":["imageUrlPc","imageUrlSp","qrUrl"],"notes":["qrUrl には自分のQRコードの画像を入れる。空のままだと右のカードからQRコードだけが消え、アカウント名とボタンだけが残る（壊れはしないが、パソコンの人の入口が無くなる）。","🚨 QRコードの画像は必ず自分のアカウントのものを入れる。見本の画像は入っていない。","showQrOnSp は既定 false。スマホで自分の画面のQRコードは読み取れないので、スマホではQRを隠してボタンだけにする。ここを true にするのは、印刷や店頭の掲示に使うページのときだけ。","buttonUrl には登録の飛び先を入れる（LINEなら友だち追加のURL、メルマガなら登録フォーム）。外のサービスへ飛ばすので buttonOpenNewTab は既定 true。","LINE公式アカウントに合わせてボタンを緑（#06C755）にするときは、文字色（ctaTextColor）も一緒に見直すこと。白文字＋#06C755 は 2.6:1 しかなく読みにくい。既定は白いボタンに濃い緑の文字で、濃い地色の上でいちばん目立つ組み合わせにしてある。","benefitItems は { text } の並び。「登録するとできること」を3つ前後で書く。🚨 登録されない理由はほとんど「何が届くか分からない」「やめ方が分からない」の2つなので、できることの一覧と、noteText の「いつでも解除できます」は両方とも残すこと。","accountLabel と accountName は「ID @lite-word」のように出る。検索で探す人のための逃げ道。要らなければ showAccount を false に。","🚨 自分から全幅になる背景ブロック。次の段も全幅の帯なら、あいだにスペーサーを置かない。"]},"supports":{"anchor":true},"attributes":{"backgroundType":{"type":"string","default":"color"},"bgColor":{"type":"string","default":"#1c4532"},"imageUrlPc":{"type":"string","default":""},"imageUrlSp":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"filterColor":{"type":"string","default":"#1c4532"},"filterOpacity":{"type":"number","default":0.88},"minHeightPc":{"type":"string","default":"min-h-pc-520px"},"minHeightTb":{"type":"string","default":"min-h-tb-440px"},"minHeightSp":{"type":"string","default":""},"maxWidth":{"type":"number","default":1120},"cardWidth":{"type":"number","default":340},"showEyebrow":{"type":"boolean","default":true},"eyebrow":{"type":"string","default":"登録は無料・30秒"},"eyebrowColor":{"type":"string","default":"#9fd9b8"},"headingLevel":{"type":"number","default":1},"mainTitle":{"type":"string","default":"ご予約も空き状況も、<br>ここでお知らせします"},"titleColor":{"type":"string","default":"#ffffff"},"titleFontWeight":{"type":"string","default":"700"},"titleFont":{"type":"string","default":""},"titleFontSizePc":{"type":"number","default":40},"titleFontSizeSp":{"type":"number","default":27},"description":{"type":"string","default":"電話がつながらない時間でも、こちらからならご相談いただけます。営業のご連絡は送りません。"},"descriptionColor":{"type":"string","default":"#d5e7dc"},"showBenefits":{"type":"boolean","default":true},"benefitItems":{"type":"array","default":[{"text":"その日の空き状況が届きます"},{"text":"ご予約の変更がひと言で済みます"},{"text":"登録した方だけのご案内があります"}]},"benefitTextColor":{"type":"string","default":"#eaf4ee"},"benefitMarkColor":{"type":"string","default":"#1c4532"},"benefitMarkBgColor":{"type":"string","default":"#9fd9b8"},"buttonText":{"type":"string","default":"無料で登録する"},"buttonSub":{"type":"string","default":"登録は30秒で終わります"},"buttonUrl":{"type":"string","default":""},"buttonLinkType":{"type":"string","default":"url"},"buttonPageId":{"type":"number","default":0},"buttonCategoryId":{"type":"number","default":0},"buttonOpenNewTab":{"type":"boolean","default":true},"ctaBgColor":{"type":"string","default":"#ffffff"},"ctaTextColor":{"type":"string","default":"#0d5c36"},"ctaSubColor":{"type":"string","default":"#2f6b4d"},"ctaBorderRadius":{"type":"number","default":8},"cardBgColor":{"type":"string","default":"#ffffff"},"cardTextColor":{"type":"string","default":"#3a4640"},"cardBorderColor":{"type":"string","default":"#d7e4dc"},"cardBorderRadius":{"type":"number","default":12},"showQr":{"type":"boolean","default":true},"qrUrl":{"type":"string","default":""},"qrAlt":{"type":"string","default":"登録用のQRコード"},"qrSize":{"type":"number","default":180},"qrCaption":{"type":"string","default":"スマホのカメラをかざすと開きます"},"showQrOnSp":{"type":"boolean","default":false},"showAccount":{"type":"boolean","default":true},"accountLabel":{"type":"string","default":"ID"},"accountName":{"type":"string","default":"@your-account"},"noteText":{"type":"string","default":"登録は無料です。いつでもご自分で解除できます。"},"noteColor":{"type":"string","default":"#b8d3c4"}},"no":23}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-23"], () => (__webpack_require__("./src/lw-pr-fv-23/index.js")))
