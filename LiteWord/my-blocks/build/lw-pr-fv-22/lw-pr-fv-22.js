...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-22/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-22/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-22/block.json");
...
var styleVars = function styleVars(a) {
  var _a$filterOpacity, _a$maxWidth, _a$titleFontSizePc, _a$titleFontSizeSp, _a$columnsPc, _a$columnsSp, _a$cardBorderRadius;
  return {
    '--fv22-bg': a.bgColor,
    '--fv22-filter-color': a.filterColor,
    '--fv22-filter-opacity': String((_a$filterOpacity = a.filterOpacity) !== null && _a$filterOpacity !== void 0 ? _a$filterOpacity : 0.88),
    '--fv22-max-width': "".concat((_a$maxWidth = a.maxWidth) !== null && _a$maxWidth !== void 0 ? _a$maxWidth : 1080, "px"),
    '--fv22-eyebrow-color': a.eyebrowColor,
    '--fv22-title-color': a.titleColor,
    '--fv22-title-weight': a.titleFontWeight,
    '--fv22-title-size-pc': "".concat((_a$titleFontSizePc = a.titleFontSizePc) !== null && _a$titleFontSizePc !== void 0 ? _a$titleFontSizePc : 42, "px"),
    '--fv22-title-size-sp': "".concat((_a$titleFontSizeSp = a.titleFontSizeSp) !== null && _a$titleFontSizeSp !== void 0 ? _a$titleFontSizeSp : 28, "px"),
    '--fv22-description-color': a.descriptionColor,
    '--fv22-cols-pc': String((_a$columnsPc = a.columnsPc) !== null && _a$columnsPc !== void 0 ? _a$columnsPc : 3),
    '--fv22-cols-sp': String((_a$columnsSp = a.columnsSp) !== null && _a$columnsSp !== void 0 ? _a$columnsSp : 1),
    ...
    '--fv22-card-radius': "".concat((_a$cardBorderRadius = a.cardBorderRadius) !== null && _a$cardBorderRadius !== void 0 ? _a$cardBorderRadius : 8, "px"),
    '--fv22-note-color': a.noteColor,
    '--fv22-note-link': a.noteLinkColor
  };
};
var rootClass = function rootClass(a) {
  return ['lw-pr-fv-22', a.backgroundType === 'image' ? 'bg_image' : 'bg_color', a.showNum ? 'with_num' : 'no_num'].filter(Boolean).join(' ');
};
var innerClass = function innerClass(a) {
  return ['fv22_inner', a.minHeightPc, a.minHeightTb, a.minHeightSp].filter(Boolean).join(' ');
};
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      showNum = attributes.showNum,
      _attributes$choiceIte = attributes.choiceItems,
      choiceItems = _attributes$choiceIte === void 0 ? [] : _attributes$choiceIte,
      ...
      cardNumColor = attributes.cardNumColor,
      cardArrowColor = attributes.cardArrowColor,
      cardBadgeBgColor = attributes.cardBadgeBgColor,
      cardBadgeTextColor = attributes.cardBadgeTextColor,
      cardBorderRadius = attributes.cardBorderRadius,
      showNote = attributes.showNote,
      noteText = attributes.noteText,
      noteLinkText = attributes.noteLinkText,
      noteColor = attributes.noteColor,
      noteLinkColor = attributes.noteLinkColor,
      noteUrl = attributes.noteUrl;
    var HeadingTag = "h".concat(headingLevel);
    var updateChoice = function updateChoice(i, patch) {
      return setAttributes({
        choiceItems: choiceItems.map(function (it, n) {
          return n === i ? _objectSpread(_objectSpread({}, it), patch) : it;
        })
      });
    };
    var addChoice = function addChoice() {
      return setAttributes({
        choiceItems: [].concat(_toConsumableArray(choiceItems), [{
          num: String(choiceItems.length + 1).padStart(2, '0'),
          title: '選択肢の言葉',
          sub: '',
          badge: '',
          url: '',
    ...
    var removeChoice = function removeChoice(i) {
      return setAttributes({
        choiceItems: choiceItems.filter(function (_, n) {
          return n !== i;
        })
      });
    };
    var moveChoice = function moveChoice(i, d) {
      var to = i + d;
      if (to < 0 || to >= choiceItems.length) return;
      var next = _toConsumableArray(choiceItems);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\uD83D\uDEA8 \u9078\u629E\u80A2\u306F\u300C\u304A\u5BA2\u69D8\u306E\u8A00\u8449\u300D\u3067\u66F8\u3044\u3066\u304F\u3060\u3055\u3044\u3002\u5546\u54C1\u540D\u3092\u4E26\u3079\u308B\u3068\u9078\u3079\u307E\u305B\u3093\u3002"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: "\u756A\u53F7\u3092\u51FA\u3059",
      checked: showNum,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        label: "".concat(i + 1, "\u679A\u76EE\uFF1A\u756A\u53F7"),
        value: it.num,
        onChange: function onChange(v) {
          return updateChoice(i, {
            num: v
          });
        },
        help: "01\u30FB02 \u306A\u3069\u3002"
        ...
        link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromItem)(it),
        onChange: function onChange(patch) {
          return updateChoice(i, (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToItem)(patch));
        }
        ...
        disabled: i === choiceItems.length - 1
      }, "\u2193"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isDestructive: true,
        onClick: function onClick() {
          return removeChoice(i);
        }
      }, "\u524A\u9664")));
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "primary",
    ...
    }, "\u9078\u629E\u80A2\u3092\u8FFD\u52A0")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u9078\u629E\u80A2\u306E\u898B\u305F\u76EE",
      initialOpen: false
    }, /*#__PURE__*/React.createElement("p", {
      style: {
    ...
    }, "\u9078\u629E\u80A2\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
    ...
    }, "\u4E00\u8A00\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cardSubColor,
      onChange: function onChange(v) {
        return setAttributes({
          cardSubColor: v
    ...
    }, "\u756A\u53F7\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: cardNumColor,
      onChange: function onChange(v) {
        return setAttributes({
          cardNumColor: v
    ...
    }, "\u77E2\u5370\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      ...
      value: cardBadgeTextColor,
      onChange: function onChange(v) {
        return setAttributes({
          cardBadgeTextColor: v
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\u89D2\u306E\u4E38\u307F",
    ...
    }), showNote && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u6587\u7AE0",
      value: noteText,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      help: "\u9078\u3079\u306A\u304B\u3063\u305F\u65B9\u306E\u9003\u3052\u9053\u3067\u3059\u3002\u6D88\u3055\u306A\u3044\u307B\u3046\u304C\u554F\u3044\u5408\u308F\u305B\u306F\u5897\u3048\u307E\u3059\u3002"
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u30EA\u30F3\u30AF\u306E\u6587\u5B57\uFF08\u7A7A\u306A\u3089\u51FA\u307E\u305B\u3093\uFF09",
      value: noteLinkText,
      onChange: function onChange(v) {
        return setAttributes({
          noteLinkText: v
      ...
      link: (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkFromAttrs)(attributes, NOTE_LINK_KEYS),
      onChange: function onChange(patch) {
        return setAttributes((0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkToAttrs)(patch, NOTE_LINK_KEYS));
      }
    }), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '12px 0 4px'
    ...
    }, "\u30EA\u30F3\u30AF\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: noteLinkColor,
      onChange: function onChange(v) {
        return setAttributes({
          noteLinkColor: v
      ...
      placeholder: "\u3053\u3053\u306B\u8AAC\u660E\u6587"
    })), choiceItems.length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "choice_list"
    }, choiceItems.map(function (it, i) {
      return /*#__PURE__*/React.createElement("span", {
        ...
        className: "c_badge"
      }, it.badge), showNum && it.num && /*#__PURE__*/React.createElement("span", {
        className: "c_num"
    ...
    })), showNote && (noteText || noteLinkText) && /*#__PURE__*/React.createElement("p", {
      className: "note"
    }, noteText, noteLinkText && /*#__PURE__*/React.createElement("span", {
      className: "note_link"
    }, noteLinkText)))));
  },
  save: function save(_ref4) {
    ...
    var backgroundType = attributes.backgroundType,
      ...
      description = attributes.description,
      showNum = attributes.showNum,
      _attributes$choiceIte2 = attributes.choiceItems,
      choiceItems = _attributes$choiceIte2 === void 0 ? [] : _attributes$choiceIte2,
      showNote = attributes.showNote,
      noteText = attributes.noteText,
      noteLinkText = attributes.noteLinkText,
      noteUrl = attributes.noteUrl;
    var HeadingTag = "h".concat(headingLevel);
    var noteLink = (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromAttrs)(attributes, NOTE_LINK_KEYS);
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, backgroundType === 'image' && /*#__PURE__*/React.createElement("div", {
      ...
      var lp = (0,_link_picker_js__WEBPACK_IMPORTED_MODULE_7__.lwLinkDataPropsFromItem)(it);
      ...
      className: "note"
    }, noteText, noteLinkText && /*#__PURE__*/React.createElement("a", {
      className: "note_link",
      href: noteUrl,
      "data-lw-link-type": noteLink.linkType,
      "data-lw-link-id": noteLink.linkId
    }, noteLinkText))));
  }
};
...
/***/ "./src/lw-pr-fv-22/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-22/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-22","version":"1.0.0","title":"FV 22 リード獲得（選んで進む入口）","category":"lw-firstview","icon":"list-view","editorScript":"file:./lw-pr-fv-22.js","aiHint":{"description":"リード獲得ページ専用のFV。見出しの下に「あてはまるものを選ぶだけ」の入口カードを2〜4枚ならべ、1枚ずつ別のページへ飛ばせる。いきなり申し込ませず、まず選ばせるので最初の一歩が軽い。淡い地色に濃い文字なので、他のリード獲得FVが暗い面なのに対して明るく見える。お悩み別の入口・診断・見積りの種類分け・お問い合わせの振り分けに使う","excludeFromAutoSelect":false,"contentAttributes":["eyebrow","mainTitle","description","choiceItems","noteText","noteLinkText"],"imageAttributes":["imageUrlPc","imageUrlSp"],"notes":["choiceItems は { num, title, sub, badge, url, linkType, linkId } の並び。title が選択肢の言葉、sub はその下の一言、badge は「いちばん多いご相談」のような小さな札（空なら出ない）。2〜4枚が読みやすい。","🚨 選択肢は「利用者の言葉」で書く。「外壁塗装」ではなく「外壁の色を塗り替えたい」。自分の商品名を並べると選べない。","num は 01・02 のような通し番号。番号が要らないときは showNum を false にすると、その分だけ文字が大きく見える。","columnsPc は既定 3。選択肢が4枚のときは 2 にすると1枚あたりが広くなって読みやすい。columnsSp は既定 1（スマホで横に2枚並べると文が折り返して読めない）。","飛び先は url に直接書くほか、LinkPicker で固定ページを選べる。ページを選ぶと後からスラッグを変えてもリンクが古くならない。","背景は既定で「色」。写真にしたいときは backgroundType を image にして imageUrlPc を入れる。そのときは文字の色（titleColor / descriptionColor）を明るい色に変えること（既定は濃い文字なので写真の上では読めない）。","noteText は「どれか分からない方は…」の1行。選べなかった人の逃げ道になるので、消さずに残すほうが問い合わせは増える。","🚨 自分から全幅になる背景ブロック。次の段も全幅の帯なら、あいだにスペーサーを置かない。"]},"supports":{"anchor":true},"attributes":{"backgroundType":{"type":"string","default":"color"},"bgColor":{"type":"string","default":"#f3f0e9"},"imageUrlPc":{"type":"string","default":""},"imageUrlSp":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"filterColor":{"type":"string","default":"#f3f0e9"},"filterOpacity":{"type":"number","default":0.88},"minHeightPc":{"type":"string","default":"min-h-pc-560px"},"minHeightTb":{"type":"string","default":"min-h-tb-480px"},"minHeightSp":{"type":"string","default":""},"maxWidth":{"type":"number","default":1080},"showEyebrow":{"type":"boolean","default":true},"eyebrow":{"type":"string","default":"選ぶだけ・30秒"},"eyebrowColor":{"type":"string","default":"#2e6b52"},"headingLevel":{"type":"number","default":1},"mainTitle":{"type":"string","default":"いちばん近いのは<br>どれですか？"},"titleColor":{"type":"string","default":"#2b2a26"},"titleFontWeight":{"type":"string","default":"700"},"titleFont":{"type":"string","default":""},"titleFontSizePc":{"type":"number","default":42},"titleFontSizeSp":{"type":"number","default":28},"description":{"type":"string","default":"選んでいただくと、そのご相談に合ったご案内へ進みます。ご相談は無料で、その場でお断りいただけます。"},"descriptionColor":{"type":"string","default":"#4c4740"},"showNum":{"type":"boolean","default":true},"choiceItems":{"type":"array","default":[{"num":"01","title":"はじめて相談します","sub":"何から決めればよいかを、一緒に整理します","badge":"いちばん多いご相談","url":"","linkType":"url","linkId":""},{"num":"02","title":"見積りがほしい","sub":"現地を見てから、金額の根拠までお渡しします","badge":"","url":"","linkType":"url","linkId":""},{"num":"03","title":"いまの見積りと比べたい","sub":"お手元の書類を見ながらご説明します","badge":"","url":"","linkType":"url","linkId":""}]},"columnsPc":{"type":"number","default":3},"columnsSp":{"type":"number","default":1},"cardBgColor":{"type":"string","default":"#ffffff"},"cardBorderColor":{"type":"string","default":"#ddd6c8"},"cardTitleColor":{"type":"string","default":"#2b2a26"},"cardSubColor":{"type":"string","default":"#6a635a"},"cardNumColor":{"type":"string","default":"#2e6b52"},"cardArrowColor":{"type":"string","default":"#2e6b52"},"cardBadgeBgColor":{"type":"string","default":"#2e6b52"},"cardBadgeTextColor":{"type":"string","default":"#ffffff"},"cardBorderRadius":{"type":"number","default":8},"showNote":{"type":"boolean","default":true},"noteText":{"type":"string","default":"どれか分からないときは、そのままご相談ください。"},"noteLinkText":{"type":"string","default":"とりあえず話を聞いてみる"},"noteColor":{"type":"string","default":"#4c4740"},"noteLinkColor":{"type":"string","default":"#2e6b52"},"noteUrl":{"type":"string","default":""},"noteLinkType":{"type":"string","default":"url"},"notePageId":{"type":"number","default":0},"noteCategoryId":{"type":"number","default":0}},"no":22}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-22"], () => (__webpack_require__("./src/lw-pr-fv-22/index.js")))
