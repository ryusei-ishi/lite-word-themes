...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-calendar-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-calendar-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-calendar-1/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: function edit(props) {
    var _props$attributes = props.attributes,
      colorTableItemBd = _props$attributes.colorTableItemBd,
      colorTableHeadItemBg = _props$attributes.colorTableHeadItemBg,
      colorTableHeadItemText = _props$attributes.colorTableHeadItemText,
      colorTableBodyItemText = _props$attributes.colorTableBodyItemText,
      colorTableBodyItemFirstText = _props$attributes.colorTableBodyItemFirstText,
      fontSet = _props$attributes.fontSet,
      fontWeight = _props$attributes.fontWeight,
      headItems = _props$attributes.headItems,
      bodyRows = _props$attributes.bodyRows,
      setAttributes = props.setAttributes;
    var updateHeadItem = function updateHeadItem(index, value) {
      var newHeadItems = _toConsumableArray(headItems);
    ...
    var addRow = function addRow() {
      var newRow = Array(headItems.length).fill('');
      setAttributes({
        bodyRows: [].concat(_toConsumableArray(bodyRows), [newRow])
      });
    };
    var removeRow = function removeRow(index) {
      var newBodyRows = bodyRows.filter(function (_, i) {
        return i !== index;
      });
      setAttributes({
        bodyRows: newBodyRows
    ...
    var moveRow = function moveRow(index, direction) {
      ...
      var reordered = _toConsumableArray(bodyRows);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u8272\u8A2D\u5B9A",
      initialOpen: true
    }, /*#__PURE__*/React.createElement("p", null, "\u30C6\u30FC\u30D6\u30EB\u30A2\u30A4\u30C6\u30E0\u306E\u30DC\u30FC\u30C0\u30FC\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorTableItemBd,
      onChange: function onChange(color) {
        return setAttributes({
          colorTableItemBd: color
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C6\u30FC\u30D6\u30EB\u30D8\u30C3\u30C9\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorTableHeadItemBg,
      onChange: function onChange(color) {
        return setAttributes({
          colorTableHeadItemBg: color
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C6\u30FC\u30D6\u30EB\u30D8\u30C3\u30C9\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorTableHeadItemText,
      onChange: function onChange(color) {
        return setAttributes({
          colorTableHeadItemText: color
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C6\u30FC\u30D6\u30EB\u30DC\u30C7\u30A3\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorTableBodyItemText,
      onChange: function onChange(color) {
        return setAttributes({
          colorTableBodyItemText: color
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C6\u30FC\u30D6\u30EB\u30DC\u30C7\u30A3\u306E\u6700\u521D\u306E\u5217\u306E\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorTableBodyItemFirstText,
      onChange: function onChange(color) {
        return setAttributes({
          colorTableBodyItemFirstText: color
        });
      }
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        value: item,
        onChange: function onChange(value) {
          return updateHeadItem(index, value);
        },
        placeholder: "\u30D8\u30C3\u30C0\u30FC"
      }));
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          value: cell,
          onChange: function onChange(value) {
            return updateBodyCell(rowIndex, cellIndex, value);
          },
          placeholder: "\u5185\u5BB9"
        }));
      })), /*#__PURE__*/React.createElement("div", {
  ...
  save: function save(props) {
    var _props$attributes2 = props.attributes,
      colorTableItemBd = _props$attributes2.colorTableItemBd,
      colorTableHeadItemBg = _props$attributes2.colorTableHeadItemBg,
      colorTableHeadItemText = _props$attributes2.colorTableHeadItemText,
      colorTableBodyItemText = _props$attributes2.colorTableBodyItemText,
      colorTableBodyItemFirstText = _props$attributes2.colorTableBodyItemFirstText,
      fontSet = _props$attributes2.fontSet,
...
/***/ "./src/lw-pr-calendar-1/editor.scss":
/*!******************************************!*\
  !*** ./src/lw-pr-calendar-1/editor.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-calendar-1/style.scss":
/*!*****************************************!*\
  !*** ./src/lw-pr-calendar-1/style.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-calendar-1/block.json":
/*!*****************************************!*\
  !*** ./src/lw-pr-calendar-1/block.json ***!
  \*****************************************/
/***/ ((module) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-calendar-1"], () => (__webpack_require__("./src/lw-pr-calendar-1/index.js")))
