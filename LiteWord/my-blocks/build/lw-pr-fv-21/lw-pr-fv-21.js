...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-fv-21/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-fv-21/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-fv-21/block.json");
...
var styleVars = function styleVars(a) {
  var _a$maxWidth, _a$imageColWidth, _a$imageTilt, _a$imageHeightPc, _a$imageHeightSp, _a$titleFontSizePc, _a$titleFontSizeSp, _a$ctaBorderRadius, _a$buttonMaxWidth;
  return {
    '--fv21-bg': a.bgColor,
    '--fv21-max-width': "".concat((_a$maxWidth = a.maxWidth) !== null && _a$maxWidth !== void 0 ? _a$maxWidth : 1140, "px"),
    '--fv21-pic-width': "".concat((_a$imageColWidth = a.imageColWidth) !== null && _a$imageColWidth !== void 0 ? _a$imageColWidth : 430, "px"),
    '--fv21-pic-tilt': "".concat((_a$imageTilt = a.imageTilt) !== null && _a$imageTilt !== void 0 ? _a$imageTilt : -2.4, "deg"),
    '--fv21-pic-height-pc': "".concat((_a$imageHeightPc = a.imageHeightPc) !== null && _a$imageHeightPc !== void 0 ? _a$imageHeightPc : 330, "px"),
    '--fv21-pic-height-sp': "".concat((_a$imageHeightSp = a.imageHeightSp) !== null && _a$imageHeightSp !== void 0 ? _a$imageHeightSp : 220, "px"),
    '--fv21-free-bg': a.freeBgColor,
    '--fv21-free-text': a.freeTextColor,
    '--fv21-title-color': a.titleColor,
    '--fv21-title-weight': a.titleFontWeight,
    '--fv21-title-size-pc': "".concat((_a$titleFontSizePc = a.titleFontSizePc) !== null && _a$titleFontSizePc !== void 0 ? _a$titleFontSizePc : 45, "px"),
    '--fv21-title-size-sp': "".concat((_a$titleFontSizeSp = a.titleFontSizeSp) !== null && _a$titleFontSizeSp !== void 0 ? _a$titleFontSizeSp : 30, "px"),
    ...
    '--fv21-cta-radius': "".concat((_a$ctaBorderRadius = a.ctaBorderRadius) !== null && _a$ctaBorderRadius !== void 0 ? _a$ctaBorderRadius : 7, "px"),
    '--fv21-cta-max': "".concat((_a$buttonMaxWidth = a.buttonMaxWidth) !== null && _a$buttonMaxWidth !== void 0 ? _a$buttonMaxWidth : 400, "px"),
    '--fv21-tag-bg': a.tagBgColor,
    '--fv21-tag-text': a.tagTextColor
  };
};
var rootClass = function rootClass(a) {
  return ['lw-pr-fv-21', a.minHeightPc, a.minHeightTb, a.minHeightSp, a.imageSide === 'left' ? 'image_left' : 'image_right'].filter(Boolean).join(' ');
};
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var bgColor = attributes.bgColor,
      ...
      imageSide = attributes.imageSide,
      imageColWidth = attributes.imageColWidth,
      imageUrl = attributes.imageUrl,
      imageAlt = attributes.imageAlt,
      imageTilt = attributes.imageTilt,
      imageHeightPc = attributes.imageHeightPc,
      imageHeightSp = attributes.imageHeightSp,
      showFree = attributes.showFree,
      freeLabel = attributes.freeLabel,
      freeText = attributes.freeText,
      freeBgColor = attributes.freeBgColor,
      freeTextColor = attributes.freeTextColor,
      ...
      showInbox = attributes.showInbox,
      inboxTitle = attributes.inboxTitle,
      _attributes$inboxItem = attributes.inboxItems,
      inboxItems = _attributes$inboxItem === void 0 ? [] : _attributes$inboxItem,
      inboxBgColor = attributes.inboxBgColor,
      inboxBorderColor = attributes.inboxBorderColor,
      inboxTitleColor = attributes.inboxTitleColor,
      inboxTextColor = attributes.inboxTextColor,
      inboxNumBgColor = attributes.inboxNumBgColor,
      inboxNumColor = attributes.inboxNumColor,
      ...
      tagTop = attributes.tagTop,
      tagMain = attributes.tagMain,
      tagUnit = attributes.tagUnit,
      tagBottom = attributes.tagBottom,
      tagBgColor = attributes.tagBgColor,
      tagTextColor = attributes.tagTextColor;
    var HeadingTag = "h".concat(headingLevel);
    var updateInbox = function updateInbox(i, v) {
      return setAttributes({
        inboxItems: inboxItems.map(function (it, n) {
    ...
    var addInbox = function addInbox() {
      return setAttributes({
        inboxItems: [].concat(_toConsumableArray(inboxItems), [{
          text: '新しい中身'
        }])
      });
    };
    var removeInbox = function removeInbox(i) {
      return setAttributes({
        inboxItems: inboxItems.filter(function (_, n) {
          return n !== i;
        })
      });
    };
    var moveInbox = function moveInbox(i, d) {
      var to = i + d;
      if (to < 0 || to >= inboxItems.length) return;
      var next = _toConsumableArray(inboxItems);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }), showFree && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u5927\u304D\u304F\u51FA\u3059\u8A00\u8449",
      value: freeLabel,
      onChange: function onChange(v) {
        return setAttributes({
    ...
    }), showInbox && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u7BB1\u306E\u898B\u51FA\u3057",
      value: inboxTitle,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        disabled: i === inboxItems.length - 1
      }, "\u2193"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        isDestructive: true,
        onClick: function onClick() {
          return removeInbox(i);
        }
      }, "\u524A\u9664")));
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "primary",
    ...
    }, "\u4E2D\u8EAB\u3092\u8FFD\u52A0"), /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '16px 0 4px'
      }
    ...
    }, "\u7BB1\u306E\u67A0\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: inboxBorderColor,
      onChange: function onChange(v) {
        return setAttributes({
          inboxBorderColor: v
        });
    ...
    }, "\u4E2D\u8EAB\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: inboxTextColor,
      onChange: function onChange(v) {
        return setAttributes({
          inboxTextColor: v
        });
    ...
    }, "\u756A\u53F7\u306E\u4E38\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: inboxNumBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          inboxNumBgColor: v
        });
    ...
    }, "\u756A\u53F7\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: inboxNumColor,
      onChange: function onChange(v) {
        return setAttributes({
          inboxNumColor: v
    ...
    }), showTag && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '4px 0 12px',
        fontSize: 12,
        color: '#a04a28'
      }
    }, "\uD83D\uDEA8 \u672C\u5F53\u306B\u7DE0\u5207\u304C\u3042\u308B\u3068\u304D\u3060\u3051\u51FA\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u305A\u3063\u3068\u300C\u6B8B\u308A3\u65E5\u300D\u306E\u307E\u307E\u306B\u3057\u306A\u3044\u3002"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u4E0A\u306E\u8A00\u8449",
      value: tagTop,
      onChange: function onChange(v) {
        return setAttributes({
      ...
      className: "lead_side"
    }, showFree && (freeLabel || freeText) && /*#__PURE__*/React.createElement("span", {
      className: "free_badge"
    }, freeLabel && /*#__PURE__*/React.createElement("b", null, freeLabel), freeText && /*#__PURE__*/React.createElement("span", null, freeText)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      tagName: HeadingTag,
      className: "main_ttl",
      ...
      placeholder: "\u3053\u3053\u306B\u8AAC\u660E\u6587"
    }), showInbox && inboxItems.length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "inbox"
    }, inboxTitle && /*#__PURE__*/React.createElement("p", {
      className: "inbox_ttl"
    }, inboxTitle), /*#__PURE__*/React.createElement("ul", null, inboxItems.map(function (it, i) {
      return /*#__PURE__*/React.createElement("li", {
        key: i
      }, /*#__PURE__*/React.createElement("i", null, i + 1), /*#__PURE__*/React.createElement("span", null, it.text));
    }))), buttonText && /*#__PURE__*/React.createElement("span", {
      className: "cta_btn"
    }, buttonText, buttonSub && /*#__PURE__*/React.createElement("small", null, buttonSub))), /*#__PURE__*/React.createElement("div", {
      className: "pic_side"
    }, /*#__PURE__*/React.createElement("div", {
      className: "shot"
      ...
      src: imageUrl,
      alt: imageAlt
    })), showTag && tagMain && /*#__PURE__*/React.createElement("span", {
      className: "dl_tag"
    }, tagTop && /*#__PURE__*/React.createElement("span", {
      className: "t"
    }, tagTop), /*#__PURE__*/React.createElement("span", {
      className: "d"
    }, tagMain, tagUnit && /*#__PURE__*/React.createElement("span", {
      className: "u"
    }, tagUnit)), tagBottom && /*#__PURE__*/React.createElement("span", {
      className: "t"
    }, tagBottom))))));
  },
  save: function save(_ref3) {
    ...
    var imageUrl = attributes.imageUrl,
      ...
      showInbox = attributes.showInbox,
      inboxTitle = attributes.inboxTitle,
      _attributes$inboxItem2 = attributes.inboxItems,
      inboxItems = _attributes$inboxItem2 === void 0 ? [] : _attributes$inboxItem2,
      buttonText = attributes.buttonText,
      buttonSub = attributes.buttonSub,
      buttonUrl = attributes.buttonUrl,
      showTag = attributes.showTag,
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      className: "free_badge"
    }, freeLabel && /*#__PURE__*/React.createElement("b", null, freeLabel), freeText && /*#__PURE__*/React.createElement("span", null, freeText)), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: HeadingTag,
      className: "main_ttl",
      "data-lw_font_set": titleFont,
      value: mainTitle
...
/***/ "./src/lw-pr-fv-21/block.json":
/*!************************************!*\
  !*** ./src/lw-pr-fv-21/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-fv-21","version":"1.0.0","title":"FV 21 リード獲得（もらえる物と締切）","category":"lw-firstview","icon":"products","editorScript":"file:./lw-pr-fv-21.js","aiHint":{"description":"リード獲得ページ専用のFV。左に「無料」の札・見出し・もらえる物の中身を番号で並べ、右にその写真を少し傾けて置く。写真の角に締切や残り枠の丸い札を添えられる。無料サンプル・資料請求・キャンペーン応募・先行案内に使う","excludeFromAutoSelect":false,"contentAttributes":["freeLabel","freeText","mainTitle","description","inboxTitle","inboxItems","buttonText","buttonSub","tagTop","tagMain","tagUnit","tagBottom"],"imageAttributes":["imageUrl"],"notes":["背景は淡い色が既定（bgColor）。写真の上に文字を置くFVではないので、白っぽい面のまま使うほうが中身のリストが読みやすい。","inboxItems は「箱の中に入っているもの」を番号付きで並べる箱。3つが読みやすい。空にすると箱ごと消える。","🚨 締切の札（showTag）は本当に締切があるときだけ出す。ずっと「残り3日」と出したままにしない。tagMain に数字、tagUnit に単位（日・名）、tagTop と tagBottom に前後の言葉が入る。","imageTilt で写真の傾きを決める（-6〜6度）。0 にすると傾かない。","🚨 スマホでは締切の札が写真の左上角に付く。写真の上端にCTAボタンが接するので、締切を使うときは buttonSub を短めにすると重なって見えない。","🚨 自分から全幅になる背景ブロック。次の段も全幅の帯なら、あいだにスペーサーを置かない。"]},"supports":{"anchor":true},"attributes":{"bgColor":{"type":"string","default":"#f7f1ea"},"minHeightPc":{"type":"string","default":"min-h-pc-560px"},"minHeightTb":{"type":"string","default":"min-h-tb-460px"},"minHeightSp":{"type":"string","default":""},"maxWidth":{"type":"number","default":1140},"imageSide":{"type":"string","default":"right"},"imageColWidth":{"type":"number","default":430},"imageUrl":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/background/6.webp"},"imageAlt":{"type":"string","default":""},"imageTilt":{"type":"number","default":-2.4},"imageHeightPc":{"type":"number","default":330},"imageHeightSp":{"type":"number","default":220},"showFree":{"type":"boolean","default":true},"freeLabel":{"type":"string","default":"無料"},"freeText":{"type":"string","default":"送料もいただきません"},"freeBgColor":{"type":"string","default":"#b5642c"},"freeTextColor":{"type":"string","default":"#ffffff"},"headingLevel":{"type":"number","default":1},"mainTitle":{"type":"string","default":"お試し3種が<br>ポストに届きます"},"titleColor":{"type":"string","default":"#3f2618"},"titleFontWeight":{"type":"string","default":"700"},"titleFont":{"type":"string","default":""},"titleFontSizePc":{"type":"number","default":45},"titleFontSizeSp":{"type":"number","default":30},"description":{"type":"string","default":"封筒1つでポストに入ります。ご不在でも受け取れます。自動でお届けが始まることはありません。"},"descriptionColor":{"type":"string","default":"#5f544c"},"showInbox":{"type":"boolean","default":true},"inboxTitle":{"type":"string","default":"箱の中に入っているもの"},"inboxItems":{"type":"array","default":[{"text":"焙煎したての豆 3種（各20g・挽き方が選べます）"},{"text":"おいしく淹れるための紙 1枚"},{"text":"次に使える割引券（有効期限なし）"}]},"inboxBgColor":{"type":"string","default":"#ffffff"},"inboxBorderColor":{"type":"string","default":"#e6dbd0"},"inboxTitleColor":{"type":"string","default":"#b5642c"},"inboxTextColor":{"type":"string","default":"#33302c"},"inboxNumBgColor":{"type":"string","default":"#5c3d2e"},"inboxNumColor":{"type":"string","default":"#ffffff"},"buttonText":{"type":"string","default":"お試しを申し込む"},"buttonSub":{"type":"string","default":"入力は30秒・最短3日でお届け"},"buttonUrl":{"type":"string","default":""},"buttonLinkType":{"type":"string","default":"url"},"buttonPageId":{"type":"number","default":0},"buttonCategoryId":{"type":"number","default":0},"buttonMaxWidth":{"type":"number","default":400},"ctaBgColor":{"type":"string","default":"#b5642c"},"ctaTextColor":{"type":"string","default":"#ffffff"},"ctaSubColor":{"type":"string","default":"#ffe9d8"},"ctaBorderRadius":{"type":"number","default":7},"showTag":{"type":"boolean","default":true},"tagTop":{"type":"string","default":"お申込み"},"tagMain":{"type":"string","default":"3"},"tagUnit":{"type":"string","default":"日"},"tagBottom":{"type":"string","default":"まで"},"tagBgColor":{"type":"string","default":"#3f2618"},"tagTextColor":{"type":"string","default":"#ffffff"}}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-21"], () => (__webpack_require__("./src/lw-pr-fv-21/index.js")))
