...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-step-2/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-step-2/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-step-2/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(props) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      label: "\u67A0\u306E\u8272",
      value: bgGradient,
      onChange: function onChange(newBgGradient) {
        return setAttributes({
          bgGradient: newBgGradient
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C0\u30A6\u30F3\u30A2\u30A4\u30B3\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      label: "\u30C0\u30A6\u30F3\u30A2\u30A4\u30B3\u30F3\u306E\u8272",
      value: colorLiSvg,
      ...
      value: fontH3,
      options: fontOptions,
      onChange: function onChange(newFontH3) {
        return setAttributes({
          fontH3: newFontH3
        });
      }
      ...
      onChange: function onChange(newFontWeightH3) {
        return setAttributes({
          fontWeightH3: newFontWeightH3
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: "\u6BB5\u843D\u306E\u30D5\u30A9\u30F3\u30C8\u306E\u7A2E\u985E",
      value: fontP,
      options: fontOptions,
      onChange: function onChange(newFontP) {
        return setAttributes({
          fontP: newFontP
        });
      }
      ...
      value: fontWeightP,
      options: fontWeightOptions,
      onChange: function onChange(newFontWeightP) {
        return setAttributes({
          fontWeightP: newFontWeightP
        });
      }
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        onChange: function onChange(value) {
          return updateContent(index, 'title', value);
        },
        placeholder: "\u30BF\u30A4\u30C8\u30EB\u3092\u5165\u529B",
        style: {
  ...
  save: function save(props) {
    var attributes = props.attributes;
    var ulMaxWidth = attributes.ulMaxWidth,
      fontH3 = attributes.fontH3,
      fontWeightH3 = attributes.fontWeightH3,
      fontP = attributes.fontP,
      fontWeightP = attributes.fontWeightP,
...
/***/ "./src/lw-step-2/block.json":
/*!**********************************!*\
  !*** ./src/lw-step-2/block.json ***!
  \**********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-step-2","version":"1.0.0","title":"step 02","category":"lw-step","icon":"lightbulb","supports":{"anchor":true},"editorScript":"file:./lw-step-2.js","aiHint":{"description":"カード型ステップ。ボーダー付きカード+番号+見出し+説明の繰り返し。サービス手順に","excludeFromAutoSelect":false,"contentAttributes":["contents"],"imageAttributes":[]},"no":2,"attributes":{"bgGradient":{"type":"string","default":"var(--color-main)"},"ulMaxWidth":{"type":"number","default":800},"fontH3":{"type":"string","default":""},"fontWeightH3":{"type":"string","default":""},"fontP":{"type":"string","default":""},"fontWeightP":{"type":"string","default":""},"colorLiSvg":{"type":"string","default":"var(--color-main)"},"borderWidth":{"type":"number","default":1},"contents":{"type":"array","source":"query","selector":".lw-step-2__li","query":{"title":{"type":"string","source":"html","selector":"h3"},"text":{"type":"string","source":"html","selector":"p"}},"default":[{"title":"応募","text":"応募フォームより必要事項を入力し、送信してください。応募内容を確認し、追って担当者よりご連絡いたします。"},{"title":"書類選考","text":"ご応募いただいた内容をもとに、書類選考を行います。結果は1週間以内にメールにてお知らせいたします。"},{"title":"面接","text":"書類選考に通過された方には、担当者による面接を実施します。面接日時はご相談の上、決定いたします。"},{"title":"最終選考","text":"面接後、最終選考を行い、採用の可否を決定します。結果はメールにてご連絡いたします。"},{"title":"内定","text":"最終選考を通過された方には、内定通知をお送りし、入社手続きを進めていただきます。"}]}}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-step-2"], () => (__webpack_require__("./src/lw-step-2/index.js")))
