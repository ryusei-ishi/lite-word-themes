...
/***/ "./src/lw-pr-custom-title-12/block.json":
/*!**********************************************!*\
  !*** ./src/lw-pr-custom-title-12/block.json ***!
  \**********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-custom-title-12","version":"1.0.0","title":"見出しタイトル 12","category":"lw-heading","icon":"editor-textcolor","description":"2色カスタムカラー対応見出しブロック","supports":{"anchor":true},"aiHint":{"description":"2色カスタムカラー見出し。メイン+サブタイトル。2色グラデーション装飾","excludeFromAutoSelect":false,"contentAttributes":["mainTitle","subTitle"],"imageAttributes":[]},"attributes":{"mainTitle":{"type":"string","default":"カスタムタイトル","aiHint":{"role":"heading","contentGuide":"セクション見出し。3〜15文字","example":"お客様の声"}},"subTitle":{"type":"string","default":"サブタイトル","aiHint":{"role":"subheading","contentGuide":"英語表記 or 補足テキスト","example":"VOICE"}},"headingLevel":{"type":"number","default":2,"aiHint":{"skip":true}},"colorMain":{"type":"string","default":"#0a71c0","aiHint":{"skip":true}},"colorSub":{"type":"string","default":"#13214c","aiHint":{"skip":true}},"colorMainText":{"type":"string","default":"","aiHint":{"skip":true}},"colorSubText":{"type":"string","default":"","aiHint":{"skip":true}},"orderReversed":{"type":"boolean","default":false,"aiHint":{"skip":true}},"maxWidth":{"type":"number","default":0,"aiHint":{"skip":true}}},"editorScript":"file:./lw-pr-custom-title-12.js","no":12}');
...
/*!********************************************!*\
  !*** ./src/lw-pr-custom-title-12/index.js ***!
  \********************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-custom-title-12/block.json");
/**
 * LiteWord – 見出しタイトル 12
 * カスタムブロック
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var onChangeColorSub = function onChangeColorSub(value) {
      return setAttributes({
        colorSub: value
      });
    };
    ...
    }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "\u30B5\u30D6\u30AB\u30E9\u30FC")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: colorSub,
  ...
  save: function save(_ref2) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(TagName, {
      className: "ttl"
    }, !orderReversed ? /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, mainTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      className: "main",
      value: mainTitle
      ...
      className: "sub",
      value: subTitle
    })) : /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, subTitle && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "span",
      className: "sub",
      value: subTitle
