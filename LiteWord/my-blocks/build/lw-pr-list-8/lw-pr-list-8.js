...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-list-8/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-list-8/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-list-8/block.json");
...
var lwBlockDef = {
  edit: function edit(_ref) {
    ...
    var leftItems = attributes.leftItems,
      rightItems = attributes.rightItems,
      imageUrl = attributes.imageUrl,
      imageAlt = attributes.imageAlt,
      bgColor = attributes.bgColor,
      textColor = attributes.textColor,
      listFontSet = attributes.listFontSet,
      listFontWeight = attributes.listFontWeight,
      listColumns = attributes.listColumns;
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "lw-pr-list-8 columns-".concat(listColumns),
      style: {
        '--list_items_bg_color': bgColor,
        '--list_items_color': textColor
      }
    });
    var updateLeftItem = function updateLeftItem(index, value) {
      var updated = _toConsumableArray(leftItems);
      updated[index] = value;
      setAttributes({
        leftItems: updated
      });
    };
    var addLeftItem = function addLeftItem() {
      setAttributes({
        leftItems: [].concat(_toConsumableArray(leftItems), ['新しい項目'])
      });
    };
    var removeLeftItem = function removeLeftItem(index) {
      setAttributes({
        leftItems: leftItems.filter(function (_, i) {
          return i !== index;
        })
      });
    };
    var updateRightItem = function updateRightItem(index, value) {
      var updated = _toConsumableArray(rightItems);
      updated[index] = value;
      setAttributes({
        rightItems: updated
      });
    };
    var addRightItem = function addRightItem() {
      setAttributes({
        rightItems: [].concat(_toConsumableArray(rightItems), ['新しい項目'])
      });
    };
    var removeRightItem = function removeRightItem(index) {
      setAttributes({
        rightItems: rightItems.filter(function (_, i) {
          return i !== index;
        })
      });
    };
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\u753B\u50CF\u306F\u30EA\u30B9\u30C8\u5074\u306E\u9AD8\u3055\u3044\u3063\u3071\u3044\u306B\u30C8\u30EA\u30DF\u30F3\u30B0\u8868\u793A\u3055\u308C\u307E\u3059\uFF08\u4E0B\u306B\u4F59\u767D\u306F\u6B8B\u308A\u307E\u305B\u3093\uFF09\u3002")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u8272\u8A2D\u5B9A"
    }, /*#__PURE__*/React.createElement("p", null, "\u30EA\u30B9\u30C8\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: bgColor,
      onChange: function onChange(color) {
        return setAttributes({
          bgColor: color || '#f7f7f7'
        });
      }
    }), /*#__PURE__*/React.createElement("p", null, "\u30C6\u30AD\u30B9\u30C8\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: textColor,
      onChange: function onChange(color) {
        return setAttributes({
          textColor: color || 'var(--color-main)'
        });
      }
    })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      title: "\u30D5\u30A9\u30F3\u30C8\u8A2D\u5B9A"
      ...
      className: "lw-pr-list-8_wrap"
    }, /*#__PURE__*/React.createElement("div", {
      className: "list_items"
    }, /*#__PURE__*/React.createElement("div", {
      className: "list_items_inner"
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        value: item,
        onChange: function onChange(value) {
          return updateLeftItem(index, value);
        },
        placeholder: "\u9805\u76EE\u3092\u5165\u529B"
      ...
      type: "button",
      onClick: addLeftItem
    }, "\uFF0B"))), listColumns === 2 && /*#__PURE__*/React.createElement("ul", {
      ...
      return /*#__PURE__*/React.createElement("li", {
        ...
        value: item,
        onChange: function onChange(value) {
          return updateRightItem(index, value);
        },
        placeholder: "\u9805\u76EE\u3092\u5165\u529B"
      }), /*#__PURE__*/React.createElement("button", {
        type: "button",
...
/***/ "./src/lw-pr-list-8/block.json":
/*!*************************************!*\
  !*** ./src/lw-pr-list-8/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-list-8","version":"1.0.0","title":"List 08","category":"lw-list","icon":"editor-ul","description":"リスト+画像ブロック（1列/2列選択可・画像は高さいっぱいに敷き詰め）","aiDescription":"リストと画像を組み合わせたレイアウト。1列または2列のリスト表示を選択可能。List 05と違い、画像は縦横比を保ったままリスト側の高さいっぱいにトリミング表示され、下に余白が残らない。サービス内容や特徴を箇条書きで説明する際に最適。","aiNotes":"List 05（lw-pr-list-5）の画像が縦横比のまま表示されリスト側より短くなり、下に空白ができる不具合の修正版（2026-09-04新設）。画像はobject-fit:coverでリスト側の高さいっぱいにトリミング表示する。listColumnsで1列/2列を切替。leftItemsとrightItems（2列時のみ）でリスト項目を管理。背景色とテキスト色をカスタマイズ可能。スマホ幅（1列表示）では画像は通常どおり縦横比のまま表示する（heightが定まらないため）。","aiHint":{"description":"リスト+画像。1列/2列のチェックリスト＋右（またはスマホでは下）に画像。List 05と違い画像はトリミングして高さを合わせるので下に空白ができない。サービス内容・特徴一覧に","excludeFromAutoSelect":false,"contentAttributes":["leftItems","rightItems"],"imageAttributes":["imageUrl"],"notes":"画像は正方形に近い比率だとトリミングが少なく収まりが良い。極端に横長・縦長の画像は主要な被写体が切れることがあるので、貼る前にプレビューで確認する。"},"supports":{"anchor":true},"attributes":{"leftItems":{"type":"array","default":["テキストテキ","テキストテキ","テキストテキ"],"ai_description":"左列のリスト項目。3～5項目推奨"},"rightItems":{"type":"array","default":["テキストテキ","テキストテキ","テキストテキ"],"ai_description":"右列のリスト項目。3～5項目推奨"},"imageUrl":{"type":"string","default":"https://liteword-assets.bigi-ishikawa.workers.dev/t/sample/slide/1.webp","ai_description":"画像URL"},"imageAlt":{"type":"string","default":"","ai_description":"画像のalt属性"},"bgColor":{"type":"string","default":"#f7f7f7","ai_description":"リスト部分の背景色"},"textColor":{"type":"string","default":"var(--color-main)","ai_description":"リストテキストの色"},"listFontSet":{"type":"string","default":"","ai_description":"リストのフォント"},"listFontWeight":{"type":"string","default":"","ai_description":"リストのフォントウェイト"},"listColumns":{"type":"number","default":2,"ai_description":"リストの列数（1または2）"}},"editorScript":"file:./lw-pr-list-8.js","no":8}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-list-8"], () => (__webpack_require__("./src/lw-pr-list-8/index.js")))
