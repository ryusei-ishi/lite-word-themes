...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-table-3/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-table-3/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-table-3/block.json");
...
// --- セル正規化 ---
var normalizeCell = function normalizeCell(cell) {
...
var normalizeRow = function normalizeRow(row) {
  return {
    header: row.header || "",
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: function edit(_ref) {
    ...
    var columnCount = attributes.columnCount,
      ...
      hideMainHead = attributes.hideMainHead,
      hideRowHead = attributes.hideRowHead,
      headers = attributes.headers,
      headerBgColors = attributes.headerBgColors,
      headerOutlineColors = attributes.headerOutlineColors,
      headerOutlineWidths = attributes.headerOutlineWidths,
      rawRows = attributes.rows,
      fontFamilyMainHead = attributes.fontFamilyMainHead,
      fontWeightMainHead = attributes.fontWeightMainHead,
      fontSizeMainHead = attributes.fontSizeMainHead,
      fontSizeMainHeadSp = attributes.fontSizeMainHeadSp,
      lineHeightMainHead = attributes.lineHeightMainHead,
      mainHeadBgColor = attributes.mainHeadBgColor,
      mainHeadTextColor = attributes.mainHeadTextColor,
      fontFamilyRowHead = attributes.fontFamilyRowHead,
      fontWeightRowHead = attributes.fontWeightRowHead,
      fontSizeRowHead = attributes.fontSizeRowHead,
      fontSizeRowHeadSp = attributes.fontSizeRowHeadSp,
      lineHeightRowHead = attributes.lineHeightRowHead,
      rowHeadBgColor = attributes.rowHeadBgColor,
      rowHeadTextColor = attributes.rowHeadTextColor,
      fontFamilyCell = attributes.fontFamilyCell,
      fontWeightCell = attributes.fontWeightCell,
      fontSizeCell = attributes.fontSizeCell,
      fontSizeCellSp = attributes.fontSizeCellSp,
      lineHeightCell = attributes.lineHeightCell,
      cellBgColor = attributes.cellBgColor,
      cellTextColor = attributes.cellTextColor,
      textAlignMainHead = attributes.textAlignMainHead,
      textAlignRowHead = attributes.textAlignRowHead,
      textAlignCell = attributes.textAlignCell,
      verticalAlignMainHead = attributes.verticalAlignMainHead,
      verticalAlignRowHead = attributes.verticalAlignRowHead,
      verticalAlignCell = attributes.verticalAlignCell,
    ...
    // --- 位置クラス算出 ---
    var firstRowHeadIdx = rows.findIndex(function (r) {
      return !r.headerHidden;
    });
    var lastRowHeadIdx = function () {
      for (var i = rows.length - 1; i >= 0; i--) {
        if (!rows[i].headerHidden) return i;
      }
      return -1;
    }();
    ...
    var _useState3 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null),
      ...
      setShowPopover = _useState4[1]; // null | "bg" | "outline"

    // CSS変数を生成
    var cssVars = {
      "--table-3-gap": gapSize + "px"
    };
    var totalSpWidth = 0;
    if (hideRowHead) {
      for (var i = 0; i < dataCols; i++) {
        cssVars["--table-3-clm-".concat(i + 1, "-pc")] = (colWidthPc[i + 1] || 200) + "px";
        cssVars["--table-3-clm-".concat(i + 1, "-sp")] = (colWidthSp[i + 1] || 120) + "px";
        totalSpWidth += colWidthSp[i + 1] || 120;
      }
    } else {
      for (var _i = 0; _i < columnCount; _i++) {
        cssVars["--table-3-clm-".concat(_i + 1, "-pc")] = (colWidthPc[_i] || 200) + "px";
        cssVars["--table-3-clm-".concat(_i + 1, "-sp")] = (colWidthSp[_i] || 120) + "px";
        totalSpWidth += colWidthSp[_i] || 120;
      }
    }
    cssVars["--table-3-total-sp"] = totalSpWidth + 80 + "px";
    // フォント系CSS変数
    cssVars["--table-3-fs-main-head"] = "".concat(fontSizeMainHead, "px");
    cssVars["--table-3-fs-main-head-sp"] = "".concat(fontSizeMainHeadSp, "px");
    cssVars["--table-3-lh-main-head"] = lineHeightMainHead;
    cssVars["--table-3-fs-row-head"] = "".concat(fontSizeRowHead, "px");
    cssVars["--table-3-fs-row-head-sp"] = "".concat(fontSizeRowHeadSp, "px");
    cssVars["--table-3-lh-row-head"] = lineHeightRowHead;
    cssVars["--table-3-fs-cell"] = "".concat(fontSizeCell, "px");
    cssVars["--table-3-fs-cell-sp"] = "".concat(fontSizeCellSp, "px");
    ...
    var updateHeader = function updateHeader(index, value) {
      var h = _toConsumableArray(headers);
      h[index] = value;
      setAttributes({
        headers: h
      });
    };
    var updateRowHeader = function updateRowHeader(ri, value) {
      var r = _toConsumableArray(rows);
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
        header: value
      });
      updateRows(r);
    };
    var updateCell = function updateCell(ri, ci, value) {
      var r = _toConsumableArray(rows);
      var cells = _toConsumableArray(r[ri].cells);
      cells[ci] = _objectSpread(_objectSpread({}, cells[ci]), {}, {
        content: value
      });
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
        cells: cells
    ...
    var addRow = function addRow() {
      var newCells = Array(dataCols).fill(null).map(function () {
        return {
          content: "",
          spanRow: 1,
          spanCol: 1,
      ...
      updateRows([].concat(_toConsumableArray(rows), [{
        header: "新しい項目",
        headerSpanRow: 1,
        headerHidden: false,
        cells: newCells
    ...
    var removeRow = function removeRow(index) {
      return updateRows(rows.filter(function (_, i) {
        return i !== index;
      }));
    };
    var handleColumnCountChange = function handleColumnCountChange(newCount) {
      var newHeaders = _toConsumableArray(headers);
      var newBgColors = _toConsumableArray(headerBgColors);
      var newOutlineColors = _toConsumableArray(headerOutlineColors);
      var newOutlineWidths = _toConsumableArray(headerOutlineWidths);
      var newWidthPc = _toConsumableArray(colWidthPc);
      var newWidthSp = _toConsumableArray(colWidthSp);
      while (newHeaders.length < newCount) {
        newHeaders.push("\u30D7\u30E9\u30F3".concat(newHeaders.length));
        newBgColors.push("");
      ...
      var newRows = rows.map(function (row) {
        var c = _toConsumableArray(row.cells);
        while (c.length < newCount - 1) c.push({
          content: "",
          spanRow: 1,
          spanCol: 1,
          hidden: false,
    ...
    var updateColWidth = function updateColWidth(index, value, type) {
      var key = type === "pc" ? "colWidthPc" : "colWidthSp";
      var arr = type === "pc" ? _toConsumableArray(colWidthPc) : _toConsumableArray(colWidthSp);
      arr[index] = value;
      setAttributes(_defineProperty({}, key, arr));
    };

    // --- 個別背景色更新 ---
    var updateMainHeadBgColor = function updateMainHeadBgColor(index, color) {
      var c = _toConsumableArray(headerBgColors);
      c[index] = color || "";
      setAttributes({
        headerBgColors: c
      });
    };
    var updateRowHeadBgColor = function updateRowHeadBgColor(ri, color) {
      var r = _toConsumableArray(rows);
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
        headerBgColor: color || ""
      });
    ...
    var updateCellBgColor = function updateCellBgColor(ri, ci, color) {
      var r = _toConsumableArray(rows);
      var cells = _toConsumableArray(r[ri].cells);
      cells[ci] = _objectSpread(_objectSpread({}, cells[ci]), {}, {
        bgColor: color || ""
    ...
    // --- 個別アウトライン更新 ---
    var updateMainHeadOutlineColor = function updateMainHeadOutlineColor(index, color) {
      var c = _toConsumableArray(headerOutlineColors);
      c[index] = color || "";
      setAttributes({
        headerOutlineColors: c
      });
    };
    var updateMainHeadOutlineWidth = function updateMainHeadOutlineWidth(index, width) {
      var w = _toConsumableArray(headerOutlineWidths);
      w[index] = width;
      setAttributes({
        headerOutlineWidths: w
      });
    };
    var updateRowHeadOutlineColor = function updateRowHeadOutlineColor(ri, color) {
      var r = _toConsumableArray(rows);
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
    ...
    var updateRowHeadOutlineWidth = function updateRowHeadOutlineWidth(ri, width) {
      var r = _toConsumableArray(rows);
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
        headerOutlineWidth: width
      });
      updateRows(r);
    };
    var updateCellOutlineColor = function updateCellOutlineColor(ri, ci, color) {
      var r = _toConsumableArray(rows);
      var cells = _toConsumableArray(r[ri].cells);
      cells[ci] = _objectSpread(_objectSpread({}, cells[ci]), {}, {
        outlineColor: color || ""
    ...
    var updateCellOutlineWidth = function updateCellOutlineWidth(ri, ci, width) {
      var r = _toConsumableArray(rows);
      var cells = _toConsumableArray(r[ri].cells);
      cells[ci] = _objectSpread(_objectSpread({}, cells[ci]), {}, {
        outlineWidth: width
    ...
    // データセル: 下と統合
    var mergeCellDown = function mergeCellDown(ri, ci) {
      var r = rows.map(function (row) {
        return _objectSpread(_objectSpread({}, row), {}, {
          cells: _toConsumableArray(row.cells)
        });
      });
      var cell = r[ri].cells[ci];
      var newSpanRow = cell.spanRow + 1;
      r[ri].cells[ci] = _objectSpread(_objectSpread({}, cell), {}, {
        spanRow: newSpanRow
      });
      var targetRow = ri + newSpanRow - 1;
      if (targetRow < r.length) {
        // spanCol分すべてhiddenにする
        for (var dc = 0; dc < cell.spanCol; dc++) {
          var tc = ci + dc;
          if (tc < dataCols) {
            r[targetRow].cells[tc] = _objectSpread(_objectSpread({}, r[targetRow].cells[tc]), {}, {
              hidden: true
            });
          }
        }
    ...
    // データセル: 右と統合
    var mergeCellRight = function mergeCellRight(ri, ci) {
      var r = rows.map(function (row) {
        return _objectSpread(_objectSpread({}, row), {}, {
          cells: _toConsumableArray(row.cells)
        });
      ...
      var cell = r[ri].cells[ci];
      var newSpanCol = cell.spanCol + 1;
      r[ri].cells[ci] = _objectSpread(_objectSpread({}, cell), {}, {
        spanCol: newSpanCol
      });
      var targetCol = ci + newSpanCol - 1;
      if (targetCol < dataCols) {
        // spanRow分すべてhiddenにする
        for (var dr = 0; dr < cell.spanRow; dr++) {
          var tr = ri + dr;
          if (tr < r.length) {
            r[tr].cells[targetCol] = _objectSpread(_objectSpread({}, r[tr].cells[targetCol]), {}, {
              hidden: true
            });
          }
        }
    ...
    // データセル: 統合解除
    var unmergeCellAll = function unmergeCellAll(ri, ci) {
      var r = rows.map(function (row) {
        return _objectSpread(_objectSpread({}, row), {}, {
          cells: _toConsumableArray(row.cells)
        });
      ...
      for (var dr = 0; dr < cell.spanRow; dr++) {
        for (var dc = 0; dc < cell.spanCol; dc++) {
          ...
          if (tr < r.length && tc < dataCols) {
            r[tr].cells[tc] = _objectSpread(_objectSpread({}, r[tr].cells[tc]), {}, {
              hidden: false
            });
          }
        }
    ...
    // 行ヘッダー: 下と統合
    var mergeRowHeadDown = function mergeRowHeadDown(ri) {
      var r = rows.map(function (row) {
        return _objectSpread(_objectSpread({}, row), {}, {
          cells: _toConsumableArray(row.cells)
        });
      ...
      r[ri] = _objectSpread(_objectSpread({}, r[ri]), {}, {
        headerSpanRow: (r[ri].headerSpanRow || 1) + 1
      });
      var targetRow = ri + r[ri].headerSpanRow - 1;
      if (targetRow < r.length) {
        r[targetRow] = _objectSpread(_objectSpread({}, r[targetRow]), {}, {
          headerHidden: true
        });
      }
      updateRows(r);
    ...
    // 行ヘッダー: 統合解除
    var unmergeRowHead = function unmergeRowHead(ri) {
      var r = rows.map(function (row) {
        return _objectSpread(_objectSpread({}, row), {}, {
          cells: _toConsumableArray(row.cells)
        });
      });
      var span = r[ri].headerSpanRow || 1;
      for (var dr = 1; dr < span; dr++) {
        var tr = ri + dr;
        if (tr < r.length) {
          r[tr] = _objectSpread(_objectSpread({}, r[tr]), {}, {
            headerHidden: false
          });
        }
      }
    ...
    // --- 統合可否チェック ---
    var canMergeCellDown = function canMergeCellDown(ri, ci) {
      var cell = rows[ri].cells[ci];
      var targetRow = ri + (cell.spanRow || 1);
      if (targetRow >= rows.length) return false;
      // spanCol分すべてが hidden でないことを確認
      for (var dc = 0; dc < (cell.spanCol || 1); dc++) {
        var tc = ci + dc;
        if (tc >= dataCols || rows[targetRow].cells[tc].hidden) return false;
      }
      return true;
    };
    var canMergeCellRight = function canMergeCellRight(ri, ci) {
      var cell = rows[ri].cells[ci];
      var targetCol = ci + (cell.spanCol || 1);
      if (targetCol >= dataCols) return false;
      // spanRow分すべてが hidden でないことを確認
      for (var dr = 0; dr < (cell.spanRow || 1); dr++) {
        var tr = ri + dr;
        if (tr >= rows.length || rows[tr].cells[targetCol].hidden) return false;
      }
      return true;
    };
    var isCellMerged = function isCellMerged(ri, ci) {
      var cell = rows[ri].cells[ci];
      return (cell.spanRow || 1) > 1 || (cell.spanCol || 1) > 1;
    };
    var canRowHeadDown = function canRowHeadDown(ri) {
      var targetRow = ri + (rows[ri].headerSpanRow || 1);
      return targetRow < rows.length && !rows[targetRow].headerHidden;
    };
    var isRowHeadMerged = function isRowHeadMerged(ri) {
      return (rows[ri].headerSpanRow || 1) > 1;
    };

    // --- 縦統合チェック ---
    var isRowInvolvedInVerticalMerge = function isRowInvolvedInVerticalMerge(ri) {
      var row = rows[ri];
      if ((row.headerSpanRow || 1) > 1 || row.headerHidden) return true;
      return row.cells.some(function (cell) {
        return (cell.spanRow || 1) > 1 || cell.hidden;
      });
    };

    // --- 行移動 ---
    var canMoveRowUp = function canMoveRowUp(ri) {
      return ri > 0 && !isRowInvolvedInVerticalMerge(ri) && !isRowInvolvedInVerticalMerge(ri - 1);
    };
    var canMoveRowDown = function canMoveRowDown(ri) {
      return ri < rows.length - 1 && !isRowInvolvedInVerticalMerge(ri) && !isRowInvolvedInVerticalMerge(ri + 1);
    };
    var moveRowUp = function moveRowUp(ri) {
      var r = _toConsumableArray(rows);
      var _ref2 = [r[ri], r[ri - 1]];
      r[ri - 1] = _ref2[0];
      r[ri] = _ref2[1];
      updateRows(r);
      setSelected(null);
    };
    var moveRowDown = function moveRowDown(ri) {
      var r = _toConsumableArray(rows);
      var _ref3 = [r[ri + 1], r[ri]];
      r[ri] = _ref3[0];
      r[ri + 1] = _ref3[1];
      updateRows(r);
      setSelected(null);
    ...
    var isSelectedRowHead = function isSelectedRowHead(ri) {
      return selected && selected.type === "rowHead" && selected.row === ri;
    };
    var isSelectedMainHead = function isSelectedMainHead(i) {
      return selected && selected.type === "mainHead" && selected.col === i;
    };

    // --- 色ピッカーPopover ---
    var renderColorPopover = function renderColorPopover(currentColor, _onChange) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Popover, {
      ...
      }, "\u500B\u5225\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ColorPalette, {
    ...
    // --- アウトラインPopover ---
    var renderOutlinePopover = function renderOutlinePopover(currentColor, currentWidth, onColorChange, onWidthChange) {
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Popover, {
        placement: "bottom-start",
        onClose: function onClose() {
          return setShowPopover(null);
      ...
      }, "\u30A2\u30A6\u30C8\u30E9\u30A4\u30F3\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ColorPalette, {
        value: currentColor || undefined,
        onChange: function onChange(color) {
    ...
    // --- ツールバー (データセル) ---
    var renderCellToolbar = function renderCellToolbar(ri, ci) {
      return /*#__PURE__*/React.createElement("div", {
        className: "lw-pr-table-3__merge-toolbar",
        onClick: function onClick(e) {
          return e.stopPropagation();
        }
      }, hideRowHead && ci === 0 && canMoveRowUp(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return moveRowUp(ri);
        },
        title: "\u4E0A\u306B\u79FB\u52D5"
      }, "\u79FB\u52D5\u2191"), hideRowHead && ci === 0 && canMoveRowDown(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
        ...
        title: "\u4E0B\u3068\u7D71\u5408"
      }, "\u7D71\u5408\u2193"), canMergeCellRight(ri, ci) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return mergeCellRight(ri, ci);
        },
        title: "\u53F3\u3068\u7D71\u5408"
      }, "\u7D71\u5408\u2192"), isCellMerged(ri, ci) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return unmergeCellAll(ri, ci);
        },
        title: "\u7D71\u5408\u89E3\u9664",
        className: "unmerge"
        ...
        type: "button",
        onClick: function onClick() {
          return setShowPopover(showPopover === "outline" ? null : "outline");
        },
        title: "\u30A2\u30A6\u30C8\u30E9\u30A4\u30F3",
        className: "color-btn",
        style: {
        ...
        style: {
          ...
          border: "2px solid ".concat(rows[ri].cells[ci].outlineColor || '#999')
        }
      }), "\u67A0"), showPopover === "bg" && renderColorPopover(rows[ri].cells[ci].bgColor, function (color) {
        return updateCellBgColor(ri, ci, color);
      }), showPopover === "outline" && renderOutlinePopover(rows[ri].cells[ci].outlineColor, rows[ri].cells[ci].outlineWidth, function (color) {
        return updateCellOutlineColor(ri, ci, color);
      }, function (width) {
        return updateCellOutlineWidth(ri, ci, width);
      }));
    };

    // --- ツールバー (行ヘッダー) ---
    var renderRowHeadToolbar = function renderRowHeadToolbar(ri) {
      return /*#__PURE__*/React.createElement("div", {
        className: "lw-pr-table-3__merge-toolbar",
        onClick: function onClick(e) {
          return e.stopPropagation();
        }
      }, canMoveRowUp(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return moveRowUp(ri);
        },
        title: "\u4E0A\u306B\u79FB\u52D5"
      }, "\u79FB\u52D5\u2191"), canMoveRowDown(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return moveRowDown(ri);
        },
        title: "\u4E0B\u306B\u79FB\u52D5"
      }, "\u79FB\u52D5\u2193"), canRowHeadDown(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return mergeRowHeadDown(ri);
        },
        title: "\u4E0B\u3068\u7D71\u5408"
      }, "\u7D71\u5408\u2193"), isRowHeadMerged(ri) && /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return unmergeRowHead(ri);
        },
        title: "\u7D71\u5408\u89E3\u9664",
        className: "unmerge"
      }, "\u89E3\u9664"), /*#__PURE__*/React.createElement("button", {
        ...
        style: {
          ...
          borderRadius: '2px',
          background: 'transparent',
          border: "2px solid ".concat(rows[ri].headerOutlineColor || '#999')
        }
      }), "\u67A0"), showPopover === "bg" && renderColorPopover(rows[ri].headerBgColor, function (color) {
        return updateRowHeadBgColor(ri, color);
      }), showPopover === "outline" && renderOutlinePopover(rows[ri].headerOutlineColor, rows[ri].headerOutlineWidth, function (color) {
        return updateRowHeadOutlineColor(ri, color);
      }, function (width) {
        return updateRowHeadOutlineWidth(ri, width);
      }));
    };

    // --- ツールバー (列ヘッダー) ---
    var renderMainHeadToolbar = function renderMainHeadToolbar(i) {
      return /*#__PURE__*/React.createElement("div", {
        className: "lw-pr-table-3__merge-toolbar",
        onClick: function onClick(e) {
          return e.stopPropagation();
        ...
        style: {
          ...
          borderRadius: '2px',
          background: 'transparent',
          border: "2px solid ".concat(headerOutlineColors[i] || '#999')
        }
      }), "\u67A0"), showPopover === "bg" && renderColorPopover(headerBgColors[i], function (color) {
        return updateMainHeadBgColor(i, color);
      }), showPopover === "outline" && renderOutlinePopover(headerOutlineColors[i], headerOutlineWidths[i], function (color) {
        return updateMainHeadOutlineColor(i, color);
      }, function (width) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      ...
      label: "\u5217\u30D8\u30C3\u30C0\u30FC\uFF08main_head\uFF09\u3092\u975E\u8868\u793A",
      checked: hideMainHead,
      onChange: function onChange(v) {
        return setAttributes({
          hideMainHead: v
        });
      ...
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
        key: "pc-".concat(i),
        label: "".concat(i === 0 ? "項目列" : "\u30AB\u30E9\u30E0".concat(i + 1), " (px)"),
        value: colWidthPc[i] || 200,
        onChange: function onChange(v) {
          return updateColWidth(i, v, "pc");
        },
        min: 50,
        max: 800,
        step: 1
      ...
      return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
        key: "sp-".concat(i),
        label: "".concat(i === 0 ? "項目列" : "\u30AB\u30E9\u30E0".concat(i + 1), " (px)"),
        value: colWidthSp[i] || 120,
        onChange: function onChange(v) {
          return updateColWidth(i, v, "sp");
        },
        min: 50,
        max: 600,
        step: 1
    ...
    }, "\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ColorPalette, {
      value: mainHeadBgColor,
      onChange: function onChange(color) {
        return setAttributes({
          mainHeadBgColor: color
        });
      }
    })), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ColorPalette, {
      value: mainHeadTextColor,
      onChange: function onChange(color) {
        return setAttributes({
          mainHeadTextColor: color
        });
      }
    }))), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: "\u5217\u30D8\u30C3\u30C0\u30FC \u30D5\u30A9\u30F3\u30C8\u8A2D\u5B9A",
      ...
      onChange: function onChange(value) {
        return setAttributes({
          verticalAlignMainHead: value
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
      label: "\u6587\u5B57\u30B5\u30A4\u30BA PC (px)",
      value: fontSizeMainHead,
      onChange: function onChange(v) {
        return setAttributes({
          fontSizeMainHead: v
        });
      ...
      label: "\u6587\u5B57\u30B5\u30A4\u30BA SP (px)",
      value: fontSizeMainHeadSp,
      onChange: function onChange(v) {
        return setAttributes({
          fontSizeMainHeadSp: v
        });
      },
      min: 10,
      max: 24
      ...
      label: "\u884C\u9593",
      value: lineHeightMainHead,
      onChange: function onChange(v) {
        return setAttributes({
          lineHeightMainHead: v
        });
      },
      min: 1,
      max: 2.5,
      ...
      onChange: function onChange(value) {
        return setAttributes({
          verticalAlignRowHead: value
        });
      }
    }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
      label: "\u6587\u5B57\u30B5\u30A4\u30BA PC (px)",
      value: fontSizeRowHead,
      onChange: function onChange(v) {
        return setAttributes({
          fontSizeRowHead: v
        });
      ...
      style: cssVars
    }, !hideMainHead && headers.slice(0, columnCount).map(function (header, i) {
      if (hideRowHead && i === 0) return null;
      var firstMainHead = hideRowHead ? 1 : 0;
      var lastMainHead = columnCount - 1;
      var posClass = (i === firstMainHead ? " main_head_first" : "") + (i === lastMainHead ? " main_head_last" : "");
      var cellClass = "lw-pr-table-3__cell main_head".concat(posClass).concat(isSelectedMainHead(i) ? " is-selected" : "");
      var individualBg = headerBgColors[i];
      var olColor = headerOutlineColors[i];
      var olWidth = headerOutlineWidths[i];
      return /*#__PURE__*/React.createElement("div", {
        key: "mh-".concat(i),
        className: cellClass,
        ...
        style: _objectSpread({
          ...
          fontSize: "".concat(fontSizeMainHead, "px"),
          lineHeight: lineHeightMainHead,
          textAlign: textAlignMainHead,
          paddingTop: "".concat(mainHeadPaddingY, "px"),
          paddingBottom: "".concat(mainHeadPaddingY, "px")
        }, olWidth && olColor ? {
          outline: "".concat(olWidth, "px solid ").concat(olColor),
          outlineOffset: "-".concat(olWidth, "px")
        } : {}),
        onClick: function onClick(e) {
          e.stopPropagation();
          setShowPopover(null);
        ...
        className: "lw-pr-table-3__cell-inner"
      }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
        value: header,
        onChange: function onChange(v) {
          return updateHeader(i, v);
        },
        placeholder: i === 0 ? "" : "ヘッダー"
      })), isSelectedMainHead(i) && renderMainHeadToolbar(i));
    }), rows.map(function (row, ri) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, !hideRowHead && !row.headerHidden && /*#__PURE__*/React.createElement("div", {
        key: "rh-".concat(ri),
        className: "lw-pr-table-3__cell row_head".concat(ri === firstRowHeadIdx ? " row_head_first" : "").concat(ri === lastRowHeadIdx ? " row_head_last" : "").concat(isSelectedRowHead(ri) ? " is-selected" : ""),
        "data-lw_font_set": fontFamilyRowHead,
        style: _objectSpread(_objectSpread({}, (row.headerSpanRow || 1) > 1 ? {
          gridRow: "span ".concat(row.headerSpanRow)
        } : {}), {}, {
          display: 'flex',
          ...
          fontSize: "".concat(fontSizeRowHead, "px"),
          lineHeight: lineHeightRowHead,
          textAlign: textAlignRowHead,
          paddingTop: "".concat(rowHeadPaddingY, "px"),
          paddingBottom: "".concat(rowHeadPaddingY, "px")
        }, row.headerOutlineWidth && row.headerOutlineColor ? {
          outline: "".concat(row.headerOutlineWidth, "px solid ").concat(row.headerOutlineColor),
          outlineOffset: "-".concat(row.headerOutlineWidth, "px")
        } : {}),
        onClick: function onClick(e) {
          e.stopPropagation();
          setShowPopover(null);
        ...
        value: row.header,
        onChange: function onChange(v) {
          return updateRowHeader(ri, v);
        },
        placeholder: "\u9805\u76EE\u540D"
      })), isSelectedRowHead(ri) && renderRowHeadToolbar(ri)), !hideRowHead && row.headerHidden && /*#__PURE__*/React.createElement("div", {
        key: "rh-".concat(ri),
        className: "lw-pr-table-3__cell row_head",
        style: {
          display: "none"
        }
      }), row.cells.slice(0, dataCols).map(function (cell, ci) {
        if (cell.hidden) {
          return /*#__PURE__*/React.createElement("div", {
            key: "c-".concat(ri, "-").concat(ci),
            className: "lw-pr-table-3__cell",
            style: {
              display: "none"
            }
          });
        ...
        var cellStyle = {
          ...
          paddingTop: "".concat(cellPaddingY, "px"),
          paddingBottom: "".concat(cellPaddingY, "px")
        };
        if (cell.outlineWidth && cell.outlineColor) {
          cellStyle.outline = "".concat(cell.outlineWidth, "px solid ").concat(cell.outlineColor);
          cellStyle.outlineOffset = "-".concat(cell.outlineWidth, "px");
        }
        if ((cell.spanRow || 1) > 1) cellStyle.gridRow = "span ".concat(cell.spanRow);
        if ((cell.spanCol || 1) > 1) cellStyle.gridColumn = "span ".concat(cell.spanCol);
        var isLastRow = ri === rows.length - 1;
        var isLastCol = ci === dataCols - 1;
        var isFirstRow = ri === 0;
        var cellPosClass = (isFirstRow && isLastCol ? " cell_first_row_last_col" : "") + (isLastRow && isLastCol ? " cell_last_row_last_col" : "");
        return /*#__PURE__*/React.createElement("div", {
          key: "c-".concat(ri, "-").concat(ci),
          className: "lw-pr-table-3__cell".concat(cellPosClass).concat(isSelectedCell(ri, ci) ? " is-selected" : ""),
      ...
      onClick: addRow,
      size: "small"
    }, "\u884C\u3092\u8FFD\u52A0"), rows.length > 1 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
      variant: "secondary",
      onClick: function onClick() {
        return removeRow(rows.length - 1);
      },
      size: "small",
      isDestructive: true
    }, "\u6700\u5F8C\u306E\u884C\u3092\u524A\u9664"))));
  ...
  save: function save(_ref4) {
    ...
    if (hideRowHead) {
      ...
      for (var _i2 = 0; _i2 < columnCount; _i2++) {
        cssVars["--table-3-clm-".concat(_i2 + 1, "-pc")] = (colWidthPc[_i2] || 200) + "px";
        cssVars["--table-3-clm-".concat(_i2 + 1, "-sp")] = (colWidthSp[_i2] || 120) + "px";
        totalSpWidth += colWidthSp[_i2] || 120;
      }
    }
    cssVars["--table-3-total-sp"] = totalSpWidth + 80 + "px";
    // フォント系CSS変数
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      var lastMainHead = columnCount - 1;
      var posClass = (i === firstMainHead ? " main_head_first" : "") + (i === lastMainHead ? " main_head_last" : "");
      var cellClass = "lw-pr-table-3__cell main_head".concat(posClass);
      var individualBg = headerBgColors[i];
      var olColor = headerOutlineColors[i];
      var olWidth = headerOutlineWidths[i];
      return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, !hideRowHead && !row.headerHidden && /*#__PURE__*/React.createElement("div", {
        key: "rh-".concat(ri),
        className: "lw-pr-table-3__cell row_head".concat(ri === firstRowHeadIdx ? " row_head_first" : "").concat(ri === lastRowHeadIdx ? " row_head_last" : ""),
        "data-lw_font_set": fontFamilyRowHead,
        style: _objectSpread(_objectSpread({}, (row.headerSpanRow || 1) > 1 ? {
          gridRow: "span ".concat(row.headerSpanRow)
        } : {}), {}, {
        ...
        value: row.header
      }))), !hideRowHead && row.headerHidden && /*#__PURE__*/React.createElement("div", {
        key: "rh-".concat(ri),
        className: "lw-pr-table-3__cell row_head",
        style: {
          display: "none"
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: "c-".concat(ri, "-").concat(ci),
          className: "lw-pr-table-3__cell".concat(cellPosClass),
          "data-lw_font_set": fontFamilyCell,
          style: cellStyle
        }, /*#__PURE__*/React.createElement("div", {
          className: "lw-pr-table-3__cell-inner"
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-table-3"], () => (__webpack_require__("./src/lw-pr-table-3/index.js")))
