...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-list-5/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-list-5/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-list-5/block.json");
...
var htmlToArray = function htmlToArray(html) {
  if (!html || typeof html !== 'string') return [];
  // <li>タグの中身を抽出
  var matches = html.match(/<li[^>]*>([\s\S]*?)<\/li>/gi);
  if (!matches) return [html]; // liタグがなければそのまま返す
  return matches.map(function (li) {
    return li.replace(/<\/?li[^>]*>/gi, '').trim();
  });
};
...
var deprecated = [{
  ...
  save: function save(_ref) {
    ...
    var leftItems = attributes.leftItems,
      ...
      _attributes$listColum = attributes.listColumns,
      listColumns = _attributes$listColum === void 0 ? 2 : _attributes$listColum;
    var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
      className: "lw-pr-list-5 columns-".concat(listColumns),
      style: {
    ...
    }), listColumns === 2 && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "ul",
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-list-5"], () => (__webpack_require__("./src/lw-pr-list-5/index.js")))
