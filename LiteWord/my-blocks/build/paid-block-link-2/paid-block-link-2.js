...
/***/ "./src/paid-block-link-2/index.js":
/*!****************************************!*\
  !*** ./src/paid-block-link-2/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var iconSvgOptions = (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.serviceInfoIconSvgArr)();
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: function edit(props) {
    ...
    var mainTitle = attributes.mainTitle,
      ...
      mainExplanation = attributes.mainExplanation,
      titleBdColor = attributes.titleBdColor,
    ...
    var addContent = function addContent() {
      ...
      setAttributes({
        contents: [].concat(_toConsumableArray(contents), [newItem])
      });
    };

    // リスト削除
    var removeContent = function removeContent(index) {
      var newContents = contents.filter(function (_, i) {
        return i !== index;
      });
      setAttributes({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    }, "\uD83C\uDFA5 \u3053\u306E\u30D6\u30ED\u30C3\u30AF\u306E\u4F7F\u3044\u65B9\u3092\u898B\u308B")), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: '13px',
        color: '#666',
        lineHeight: '1.4'
    ...
    }, "\uD83D\uDCF8 \u80CC\u666F\u753B\u50CF"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
    ...
    }), bgImageUrl && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
      src: bgImageUrl,
      alt: "\u30D7\u30EC\u30D3\u30E5\u30FC",
      style: {
        maxWidth: '100%',
    ...
    }, "\u80CC\u666F\u753B\u50CF\u3092\u524A\u9664"))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: '20px'
      }
    }, /*#__PURE__*/React.createElement("p", {
    ...
    }, "\uD83C\uDF2B\uFE0F \u80CC\u666F\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: bgFilterColor,
    ...
    }, "\u80CC\u666F\u753B\u50CF\u306E\u4E0A\u306B\u91CD\u306D\u308B\u8272\u3092\u8A2D\u5B9A\u3057\u307E\u3059")), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
      label: "\uD83D\uDD0D \u80CC\u666F\u30D5\u30A3\u30EB\u30BF\u30FC\u306E\u900F\u660E\u5EA6",
    ...
    }, "\uD83C\uDFAF \u30BF\u30A4\u30C8\u30EB\u4E0B\u7DDA\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: titleBdColor,
      onChange: function onChange(color) {
        return setAttributes({
          titleBdColor: color
    ...
    }, "\uD83C\uDFF7\uFE0F \u5404\u9805\u76EE\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
    ...
    }, "\uD83D\uDD8D\uFE0F \u9805\u76EE\u306E\u67A0\u7DDA\u8272"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
      value: borderColor,
      onChange: function onChange(c) {
        return setAttributes({
          borderColor: c
    ...
    }, "\uD83D\uDCCB \u30EA\u30B9\u30C8\u9805\u76EE\u306E\u30BF\u30A4\u30C8\u30EB"), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: '15px'
      }
    }, /*#__PURE__*/React.createElement("p", {
    ...
    }, "\uD83D\uDCC4 \u8AAC\u660E\u6587"), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: '15px'
      }
    }, /*#__PURE__*/React.createElement("p", {
      ...
      return /*#__PURE__*/React.createElement("li", {
      ...
      }), content.imageUrl && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        onClick: function onClick() {
          return updateContent(index, 'imageUrl', '');
        },
        style: {
        ...
        onChange: function onChange(v) {
          return updateContent(index, 'imageAlt', v);
        },
        style: {
          marginTop: '8px'
        }
      ...
      React.createElement("div", {
        ...
        value: content.ttl,
        onChange: function onChange(val) {
          return updateContent(index, 'ttl', val);
        },
        placeholder: "\u30BF\u30A4\u30C8\u30EB\u3092\u5165\u529B",
        ...
        value: content.text,
        onChange: function onChange(val) {
          return updateContent(index, 'text', val);
        },
        placeholder: "\u30C6\u30AD\u30B9\u30C8\u3092\u5165\u529B",
        ...
        value: content.url,
        onChange: function onChange(val) {
          return updateContent(index, 'url', val);
        },
        style: {
          marginTop: '12px',
          maxWidth: '300px'
      ...
      onClick: addContent
    }, "\u30EA\u30B9\u30C8\u3092\u8FFD\u52A0\u3059\u308B")), /*#__PURE__*/React.createElement("div", {
      className: "bg_filter",
      style: {
  ...
  save: function save(props) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement("div", {
      ...
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(TagName, linkProps, /*#__PURE__*/React.createElement(React.Fragment, null, content.imageUrl ?
      /*#__PURE__*/
      // 画像がある場合は画像を優先
      React.createElement("div", {
        className: "selected_image_area"
        ...
        src: content.imageUrl,
        alt: content.imageAlt || ''
      })) : content.icon ? /*#__PURE__*/React.createElement("div", {
        className: "selected_icon",
        "data-icon": content.icon,
        dangerouslySetInnerHTML: {
          __html: content.icon
...
/***/ "./src/paid-block-link-2/editor.scss":
/*!*******************************************!*\
  !*** ./src/paid-block-link-2/editor.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/paid-block-link-2/style.scss":
/*!******************************************!*\
  !*** ./src/paid-block-link-2/style.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-paid-block-link-2"], () => (__webpack_require__("./src/paid-block-link-2/index.js")))
