...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-pr-product-1/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-pr-product-1/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-pr-product-1/block.json");
...
function boxVars(a, shopCount) {
  var n = Math.max(shopCount || 0, 1);
  return {
    marginTop: "".concat(a.marginTop, "px"),
    marginBottom: "".concat(a.marginBottom, "px"),
    '--pd1-max-width': "".concat(a.maxWidth, "px"),
    '--pd1-img-w': "".concat(a.imageWidth, "px"),
    '--pd1-img-w-sp': "".concat(a.imageWidthSp, "px"),
    '--pd1-name-size': "".concat(a.nameFontSize, "px"),
    '--pd1-name-size-sp': "".concat(a.nameFontSizeSp, "px"),
    '--pd1-btn-col': String(Math.min(a.buttonColumnsPc, n)),
    '--pd1-btn-col-sp': String(Math.min(a.buttonColumnsSp, n)),
    '--pd1-btn-size': "".concat(a.buttonFontSize, "px")
  };
}
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, _objectSpread(_objectSpread({}, _block_json__WEBPACK_IMPORTED_MODULE_6__), {}, {
  edit: function edit(_ref) {
    ...
    var showPr = attributes.showPr,
      ...
      imageWidthSp = attributes.imageWidthSp,
      nameColor = attributes.nameColor,
      nameFontSize = attributes.nameFontSize,
      nameFontSizeSp = attributes.nameFontSizeSp,
      ...
      buttonColumnsPc = attributes.buttonColumnsPc,
      buttonColumnsSp = attributes.buttonColumnsSp,
    ...
    var updateShop = function updateShop(i, key, value) {
      var next = shops.map(function (s, k) {
        return k === i ? _objectSpread(_objectSpread({}, s), {}, _defineProperty({}, key, value)) : s;
      });
      setAttributes({
        shops: next
      });
    ...
    var addShop = function addShop() {
      setAttributes({
        shops: [].concat(_toConsumableArray(shops), [{
          label: 'お店で見る',
          url: '',
          bgColor: '#555555',
          textColor: '#ffffff'
    ...
    var removeShop = function removeShop(i) {
      setAttributes({
        shops: shops.filter(function (s, k) {
          return k !== i;
        })
      });
    };
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      render: function render(_ref2) {
        ...
        }, imageUrl ? '画像を選び直す' : '画像を選ぶ'), imageUrl && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          variant: "link",
          isDestructive: true,
    ...
    }, "Amazon \u3084\u697D\u5929\u306E\u5546\u54C1\u753B\u50CF\u3092\u4FDD\u5B58\u3057\u3066\u4F7F\u3046\u306E\u306F\u5404\u793E\u306E\u898F\u7D04\u9055\u53CD\u306B\u306A\u308A\u307E\u3059\u3002\u3054\u81EA\u8EAB\u3067\u64AE\u3063\u305F\u5199\u771F\u304B\u3001\u4F7F\u3063\u3066\u3088\u3044\u3068\u8A31\u53EF\u3055\u308C\u3066\u3044\u308B\u753B\u50CF\u3092\u5165\u308C\u3066\u304F\u3060\u3055\u3044\u3002"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: "\u753B\u50CF\u306E\u8AAC\u660E\uFF08alt\uFF09",
      value: imageAlt,
    ...
    }, "\u30A2\u30C9\u30EC\u30B9\u3092\u5165\u308C\u305F\u304A\u5E97\u3060\u3051\u30DC\u30BF\u30F3\u304C\u51FA\u307E\u3059\u30023\u3064\u3068\u3082\u57CB\u3081\u308B\u5FC5\u8981\u306F\u3042\u308A\u307E\u305B\u3093\u3002"), shown.map(function (s, i) {
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, i + 1, "\u3064\u76EE\u306E\u304A\u5E97"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u30DC\u30BF\u30F3\u306E\u6587\u5B57",
        value: s.label,
        onChange: function onChange(v) {
          return updateShop(i, 'label', v);
        }
      }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
        label: "\u30EA\u30F3\u30AF\u5148\u306E\u30A2\u30C9\u30EC\u30B9",
        value: s.url,
        onChange: function onChange(v) {
          return updateShop(i, 'url', v);
        },
      ...
      }, "\u30DC\u30BF\u30F3\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
        value: s.bgColor,
        onChange: function onChange(v) {
          return updateShop(i, 'bgColor', v);
        }
      }), /*#__PURE__*/React.createElement("p", {
        style: {
          fontSize: '12px',
        ...
        value: s.textColor,
        onChange: function onChange(v) {
          return updateShop(i, 'textColor', v);
        }
      }), shown.length > 1 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
        variant: "link",
        isDestructive: true,
        onClick: function onClick() {
          return removeShop(i);
    ...
    }, "\uFF0B \u304A\u5E97\u3092\u5897\u3084\u3059"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.RangeControl, {
    ...
    }, "\u5546\u54C1\u540D\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: nameColor,
      onChange: function onChange(v) {
        return setAttributes({
          nameColor: v
    ...
    }, "\u4FA1\u683C\u306E\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: priceColor,
      onChange: function onChange(v) {
        return setAttributes({
          priceColor: v
    ...
    }, "PR\u306E\u672D\u306E\u80CC\u666F\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: prBgColor,
      onChange: function onChange(v) {
        return setAttributes({
          prBgColor: v
    ...
    }, "PR\u306E\u672D\u306E\u6587\u5B57\u8272"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorPalette, {
      value: prTextColor,
      onChange: function onChange(v) {
        return setAttributes({
          prTextColor: v
      ...
      className: "lw-pr-product-1__box",
      style: boxStyle(attributes)
    }, showPr && /*#__PURE__*/React.createElement("span", {
      className: "lw-pr-product-1__pr",
      style: {
        backgroundColor: prBgColor,
        color: prTextColor
      }
    }, prText), /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-product-1__main"
    }, /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-product-1__img"
    }, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
      onSelect: function onSelect(media) {
        return setAttributes({
          imageUrl: media.url,
      ...
      render: function render(_ref3) {
        ...
        return imageUrl ? /*#__PURE__*/React.createElement("img", {
          ...
          type: "button",
          className: "lw-pr-product-1__imgpick",
          onClick: open
        }, "\u5546\u54C1\u306E\u753B\u50CF\u3092\u9078\u3076");
      }
    })), /*#__PURE__*/React.createElement("div", {
      className: "lw-pr-product-1__body"
      ...
      className: "lw-pr-product-1__shops"
      ...
      className: "lw-pr-product-1__note"
    }, priceNote))));
  },
  save: function save(_ref4) {
    ...
    }), productPrice && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      tagName: "p",
      className: "lw-pr-product-1__price",
      value: productPrice,
      style: {
...
/***/ "./src/lw-pr-product-1/editor.scss":
/*!*****************************************!*\
  !*** ./src/lw-pr-product-1/editor.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-product-1/style.scss":
/*!****************************************!*\
  !*** ./src/lw-pr-product-1/style.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lw-pr-product-1/block.json":
/*!****************************************!*\
  !*** ./src/lw-pr-product-1/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wdl/lw-pr-product-1","version":"1.0.0","title":"商品リンク 01","category":"lw-content","icon":"cart","description":"商品を紹介して、Amazon・楽天・Yahoo!など複数のお店へのボタンを並べるブロックです。広告リンクに必要な印とPR表示が最初から入っています。","aiHint":{"description":"商品リンクボックス。商品画像・商品名・ひとこと・参考価格と、Amazon/楽天/Yahoo!など複数店舗へのボタンを並べる。アフィリエイト（広告）リンク用。比較記事・レビュー記事・おすすめ紹介に","excludeFromAutoSelect":false,"contentAttributes":["productName","productDesc","productPrice","shops"],"imageAttributes":["imageUrl"],"notes":"✅ **URLが空のお店のボタンは出ない。** 3つ全部埋める必要はなく、Amazonだけでもよい。🚨 **`isAffiliate` の既定は true**（＝広告リンクとして rel=\\"sponsored nofollow\\" と別タブが付く）。報酬の出ないただの公式サイトへのリンクとして使うときだけ false にする。🚨 **`showPr` の既定も true**（左上に「PR」の札）。ステマ規制（景品表示法）で広告であることの表示が要るので、アフィリエイトなら消さないこと。🚨 **商品画像は自分で撮った写真か、使用許諾のあるものだけ。** Amazonの商品画像を保存して貼るのは規約違反（PA-APIかリンクツール経由のみ許される）。`shops` は `[{label, url, bgColor, textColor}]`。既定色は Amazon #ff9900 / 楽天 #bf0000 / Yahoo! #ff0033。`productPrice` は文字列なので「3,980円（税込）」のように単位ごと書く。価格を書いたら `priceNote`（掲載時点である旨）を消さない。"},"supports":{"anchor":true,"className":true},"attributes":{"showPr":{"type":"boolean","default":true},"prText":{"type":"string","default":"PR"},"imageUrl":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"productName":{"type":"string","default":"商品名を入れてください","aiHint":{"role":"heading","contentGuide":"商品名。10〜30文字。メーカー名を頭に付けると分かりやすい"}},"productDesc":{"type":"string","default":"この商品のひとこと説明を入れます。どんな人に向いているかを書くと選びやすくなります。","aiHint":{"role":"text","contentGuide":"ひとこと説明。40〜90文字。誰に向くかを書く。効果を断定しない（薬機法）"}},"productPrice":{"type":"string","default":"","aiHint":{"role":"text","contentGuide":"参考価格。単位ごと書く（例 3,980円（税込））。空なら価格の行は出ない"}},"priceNote":{"type":"string","default":"※価格は掲載時点のものです。最新の価格は各サイトでご確認ください。"},"shops":{"type":"array","default":[{"label":"Amazonで見る","url":"","bgColor":"#ff9900","textColor":"#ffffff"},{"label":"楽天市場で見る","url":"","bgColor":"#bf0000","textColor":"#ffffff"},{"label":"Yahoo!で見る","url":"","bgColor":"#ff0033","textColor":"#ffffff"}],"aiHint":{"role":"list","contentGuide":"お店のボタン。各要素に label（8〜14文字）と url。URLが空の要素はボタンが出ない","example":[{"label":"Amazonで見る","url":"https://www.amazon.co.jp/dp/XXXXXXXXXX?tag=あなたのID"}]}},"isAffiliate":{"type":"boolean","default":true},"maxWidth":{"type":"number","default":720},"marginTop":{"type":"number","default":0},"marginBottom":{"type":"number","default":0},"boxBgColor":{"type":"string","default":"#ffffff"},"boxBorderColor":{"type":"string","default":"#e5e5e5"},"boxBorderWidth":{"type":"number","default":1},"borderRadius":{"type":"number","default":10},"imageWidth":{"type":"number","default":200},"imageWidthSp":{"type":"number","default":110},"nameColor":{"type":"string","default":"#222222"},"nameFontSize":{"type":"number","default":19},"nameFontSizeSp":{"type":"number","default":17},"descColor":{"type":"string","default":"#666666"},"priceColor":{"type":"string","default":"#222222"},"prBgColor":{"type":"string","default":"#f2f2f2"},"prTextColor":{"type":"string","default":"#8a8a8a"},"buttonColumnsPc":{"type":"number","default":3},"buttonColumnsSp":{"type":"number","default":1},"buttonRadius":{"type":"number","default":6},"buttonFontSize":{"type":"number","default":15},"FontSet":{"type":"string","default":""}},"editorScript":"file:./lw-pr-product-1.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-product-1"], () => (__webpack_require__("./src/lw-pr-product-1/index.js")))
