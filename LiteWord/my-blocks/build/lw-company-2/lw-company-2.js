...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/lw-company-2/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/lw-company-2/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lw-company-2/block.json");
 ...
 * ======================================================= */
var createDefaultItems = function createDefaultItems() {
  return [{
    dt: '会社名',
    dtPlaceholder: '会社名',
    dd: '株式会社〇〇不動産',
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit: function edit(_ref) {
    ...
    var _attributes$items = attributes.items,
      items = _attributes$items === void 0 ? createDefaultItems() : _attributes$items,
    ...
    var moveItem = function moveItem(index, direction) {
      ...
      var reordered = _toConsumableArray(items);
    ...
    var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
      className: "".concat(fontSizeClass),
      style: {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      className: "".concat(spFullDt ? 'sp_clm_1' : ''),
      style: {
        borderColor: borderColor,
        maxWidth: maxWidth,
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: index,
        className: "company-profile-item ".concat(fontSizeClass, " ").concat(dtWidthClass),
        style: {
          borderColor: borderColor
        }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-company-2"], () => (__webpack_require__("./src/lw-company-2/index.js")))
