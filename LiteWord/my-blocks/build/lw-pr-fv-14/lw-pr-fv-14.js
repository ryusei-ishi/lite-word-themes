...
if (wp.blocks.getBlockType(_block_json__WEBPACK_IMPORTED_MODULE_8__.name)) {
  ...
  (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_8__.name, {
    ...
    edit: function edit(_ref) {
      ...
      /* --- ハンドラ --- */
      var onSelectBgPc = function onSelectBgPc(m) {
        return setAttributes({
          bgImgPc: m.url
        });
      };
      var onSelectBgSp = function onSelectBgSp(m) {
        return setAttributes({
          bgImgSp: m.url
        });
      };
      ...
      /* --- 判定 --- */
      var showCTA1 = cta1Enable;
      var showCTA2 = cta2Enable;
      ...
      var blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
        className: "lw-pr-fv-14 ".concat(minHeightPc, " ").concat(minHeightTb, " ").concat(minHeightSp),
        style: {
      ...
      /* --- JSX (editor) --- */
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, [1, 2, 3, 4].map(function (level) {
        ...
        title: "CTA\u30DC\u30BF\u30F3",
        initialOpen: false
      }, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("h3", null, "CTA1 \u8A2D\u5B9A\uFF08\u80CC\u666F\u30DC\u30BF\u30F3\uFF09"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "CTA1\u3092\u8868\u793A",
        checked: cta1Enable,
        onChange: function onChange(v) {
          return setAttributes({
      ...
      }, "\u8272\u3092\u9078\u629E")), attributes.showCta1BgPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
        ...
        enableAlpha: true
      }))), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("h3", null, "CTA2 \u8A2D\u5B9A\uFF08\u30C6\u30AD\u30B9\u30C8\u30EA\u30F3\u30AF\uFF09"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
        label: "CTA2\u3092\u8868\u793A",
        checked: cta2Enable,
        onChange: function onChange(v) {
          return setAttributes({
      ...
      }), bgType === 'image' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
        style: {
          fontWeight: 'bold',
          marginBottom: '8px'
        }
      }, "PC\u7528\u753B\u50CF"), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
        allowedTypes: ['image'],
        value: bgImgPc,
      ...
      }), bgType === 'image' && (bgImgPc || bgImgSp) && /*#__PURE__*/React.createElement("div", {
        className: "bg_image"
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-lw-pr-fv-14"], () => (__webpack_require__("./src/lw-pr-fv-14/index.js")))
