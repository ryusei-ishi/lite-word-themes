<!-- wp:wdl/paid-block-fv-12 {"logoText":"CAFE & BAR","cta1Text":"ご予約","cta1Url":"#reserve","cta2Text":"メニュー","cta2Url":"#menu","headline":"夜だけ、開けています","bgType":"video","bgImg":"https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/cafe_3.webp","videoUrl":"https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/v/cafe_fv12.mp4","bgFilterColor":"#241a12","bgFilterOpacity":35,"navMenuItems":[{"title":"メニュー","url":"#menu"},{"title":"店内のようす","url":"#gallery"},{"title":"アクセス","url":"#access"},{"title":"ご予約","url":"#reserve"}]} -->
<div class="wp-block-wdl-paid-block-fv-12 paid-block-fv-12 min-h-pc-100vh min-h-tb-100vh min-h-sp-100vh"><header class="fv_in_header"><h1 class="logo"><a href="#" data-home-url=""><span>CAFE & BAR</span></a></h1><nav class="fv_in_nav"><ul class="header_menu_pc"><li class=""><a href="#menu">メニュー</a></li><li class=""><a href="#gallery">店内のようす</a></li><li class=""><a href="#access">アクセス</a></li><li class=""><a href="#reserve">ご予約</a></li></ul></nav><div class="ham_btn drawer_nav_open"><div class="in"><div></div><div></div></div></div></header><div class="fv_inner"><h2>夜だけ、開けています</h2><div class="cta_wrap"><a href="#reserve" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>ご予約</span></a><a href="#menu" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>メニュー</span></a></div></div><nav class="fv-12_news_list" data-source-type="latest" data-post-ids="" data-post-count="4"><h3><span class="text">NEWS</span></h3><div class="pagination"><div class="prev">←</div><div class="page">1/1</div><div class="next">→</div></div><ul></ul></nav><div class="bg_filter" style="background-color:#241a1259"></div><div class="bg_video"><video autoplay="" muted="" loop="" playsinline="" class="lazy-video" data-playback-rate="1" preload="metadata"><source src="https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/v/cafe_fv12.mp4" type="video/mp4"/></video></div><script>(() => {
'use strict';
