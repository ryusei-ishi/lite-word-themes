<!-- wp:wdl/paid-block-fv-12 {"logoText":"NAIL SALON","cta1Text":"ご予約","cta1Url":"#reserve","cta2Text":"メニュー","cta2Url":"#menu","headline":"指先から、機嫌をよく","bgImg":"https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/nail_2.webp","bgFilterColor":"#3b2229","bgFilterOpacity":45,"navMenuItems":[{"title":"メニュー","url":"#menu"},{"title":"ギャラリー","url":"#gallery"},{"title":"ご予約","url":"#reserve"},{"title":"アクセス","url":"#access"}]} -->
<div class="wp-block-wdl-paid-block-fv-12 paid-block-fv-12 min-h-pc-100vh min-h-tb-100vh min-h-sp-100vh"><header class="fv_in_header"><h1 class="logo"><a href="#" data-home-url=""><span>NAIL SALON</span></a></h1><nav class="fv_in_nav"><ul class="header_menu_pc"><li class=""><a href="#menu">メニュー</a></li><li class=""><a href="#gallery">ギャラリー</a></li><li class=""><a href="#reserve">ご予約</a></li><li class=""><a href="#access">アクセス</a></li></ul></nav><div class="ham_btn drawer_nav_open"><div class="in"><div></div><div></div></div></div></header><div class="fv_inner"><h2>指先から、機嫌をよく</h2><div class="cta_wrap"><a href="#reserve" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>ご予約</span></a><a href="#menu" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>メニュー</span></a></div></div><nav class="fv-12_news_list" data-source-type="latest" data-post-ids="" data-post-count="4"><h3><span class="text">NEWS</span></h3><div class="pagination"><div class="prev">←</div><div class="page">1/1</div><div class="next">→</div></div><ul></ul></nav><div class="bg_filter" style="background-color:#3b222973"></div><div class="bg_image"><img src="https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/nail_2.webp" alt="" loading="eager"/></div><script>(() => {
'use strict';
