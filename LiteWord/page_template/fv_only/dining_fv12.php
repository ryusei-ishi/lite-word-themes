<!-- wp:wdl/paid-block-fv-12 {"logoText":"DINING BAR","cta1Text":"ご予約","cta1Url":"#reserve","cta2Text":"メニュー","cta2Url":"#food","headline":"一日の終わりに、一杯","newsLabel":"INFO","bgImg":"https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/izakaya_1.webp","bgFilterType":"gradient","bgFilterGradient":"linear-gradient(180deg, rgba(36,24,18,0.10) 0%, rgba(36,24,18,0.92) 100%)","bgFilterOpacity":100,"navMenuItems":[{"title":"フード","url":"#food"},{"title":"ドリンク","url":"#drink"},{"title":"店内のようす","url":"#gallery"},{"title":"ご予約","url":"#reserve"}],"minHeightPc":"min-h-pc-680px","minHeightTb":"min-h-tb-600px","minHeightSp":"min-h-sp-560px"} -->
<div class="wp-block-wdl-paid-block-fv-12 paid-block-fv-12 min-h-pc-680px min-h-tb-600px min-h-sp-560px"><header class="fv_in_header"><h1 class="logo"><a href="#" data-home-url=""><span>DINING BAR</span></a></h1><nav class="fv_in_nav"><ul class="header_menu_pc"><li class=""><a href="#food">フード</a></li><li class=""><a href="#drink">ドリンク</a></li><li class=""><a href="#gallery">店内のようす</a></li><li class=""><a href="#reserve">ご予約</a></li></ul></nav><div class="ham_btn drawer_nav_open"><div class="in"><div></div><div></div></div></div></header><div class="fv_inner"><h2>一日の終わりに、一杯</h2><div class="cta_wrap"><a href="#reserve" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>ご予約</span></a><a href="#food" style="background-color:transparent;color:#ffffff;border:1px solid #ffffff;border-radius:100px"><span>メニュー</span></a></div></div><nav class="fv-12_news_list" data-source-type="latest" data-post-ids="" data-post-count="4"><h3><span class="text">INFO</span></h3><div class="pagination"><div class="prev">←</div><div class="page">1/1</div><div class="next">→</div></div><ul></ul></nav><div class="bg_filter" style="background:linear-gradient(180deg, rgba(36,24,18,0.10) 0%, rgba(36,24,18,0.92) 100%);opacity:1"></div><div class="bg_image"><img src="https://liteword-assets.bigi-ishikawa.workers.dev/t/fv/izakaya_1.webp" alt="" loading="eager"/></div><script>(() => {
'use strict';
