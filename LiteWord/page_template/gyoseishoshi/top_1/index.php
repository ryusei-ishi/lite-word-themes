...
<!-- /wp:wdl/custom-title-2 --><!-- wp:wdl/paid-block-lw-step-6 -->
...
<!-- /wp:wdl/custom-title-2 --><!-- wp:wdl/paid-block-lw-step-6 {"showNumber":false} -->
<div class="wp-block-wdl-paid-block-lw-step-6 paid-block-lw-step-6"><ul class="paid-block-lw-step-6__inner"><li class="paid-block-lw-step-6__li" style="border-color:#ccc;border-width:1px;border-style:solid;border-radius:0px"><div class="link"><h3 class="ttl font_size_m" data-lw_font_set="" style="font-weight:600;color:;border-bottom-color:var(--color-main);border-bottom-width:2px;border-bottom-style:solid">建設業許可を最短で取得</h3><p class="paid-block-lw-step-6__text font_size_m" data-lw_font_set="" style="font-weight:400;color:var(--color-black)">建設業許可の新規取得をご依頼いただきました。要件の確認から書類の収集、申請までを代行し、ご相談から二か月で許可が下りました。工事の受注にも間に合わせることができました。</p></div></li><li class="paid-block-lw-step-6__li" style="border-color:#ccc;border-width:1px;border-style:solid;border-radius:0px"><div class="link"><h3 class="ttl font_size_m" data-lw_font_set="" style="font-weight:600;color:;border-bottom-color:var(--color-main);border-bottom-width:2px;border-bottom-style:solid">複雑な相続手続きを完了</h3><p class="paid-block-lw-step-6__text font_size_m" data-lw_font_set="" style="font-weight:400;color:var(--color-black)">相続人が多数いる案件でご相談いただきました。戸籍の収集から遺産分割協議書の作成までを一括してお引き受けし、相続手続きをスムーズに完了させました。</p></div></li><li class="paid-block-lw-step-6__li" style="border-color:#ccc;border-width:1px;border-style:solid;border-radius:0px"><div class="link"><h3 class="ttl font_size_m" data-lw_font_set="" style="font-weight:600;color:;border-bottom-color:var(--color-main);border-bottom-width:2px;border-bottom-style:solid">補助金の採択に成功</h3><p class="paid-block-lw-step-6__text font_size_m" data-lw_font_set="" style="font-weight:400;color:var(--color-black)">補助金の申請でご相談いただきました。事業計画の整理から必要書類の作成までを一貫してお手伝いし、無事に採択となりました。申請期限にも余裕を持って提出できました。</p></div></li></ul></div>
<!-- /wp:wdl/paid-block-lw-step-6 -->
...
<div class="wp-block-wdl-lw-button-01 wp-block-wdl-button-01 padding-M align-flex-end align-sp-center" style="margin-top:10px;margin-bottom:10px;--button-01-max-width-sp:208px"><a href="" style="max-width:208px;font-size:97%;background-color:#ffffff;color:#002f5f;padding:0.9em 1.4em;text-align:center;text-decoration:none;border-radius:0px;border-width:1px;border-style:solid;border-color:#002f5f">お知らせ一覧</a></div>
<!-- /wp:wdl/lw-button-01 -->

<!-- wp:wdl/lw-space-1 {"pcHeight":78,"tbHeight":62,"spHeight":38} -->
<div class="wp-block-wdl-lw-space-1 lw_space_1"><div class="pc" style="height:78px"></div><div class="tb" style="height:62px"></div><div class="sp" style="height:38px"></div></div>
<!-- /wp:wdl/lw-space-1 -->
...
<!-- /wp:wdl/custom-title-2 --><!-- wp:wdl/paid-block-lw-step-5 -->
