...
// CSSの読み込み
wp_enqueue_style('post_list_ptn_1_style', get_template_directory_uri() . '/templates/archive/post_list/ptn_1/style.min.css', array(), css_version(), 'all');
?>
<section class="lw_post_list post_list_ptn_1">
    <div class="post_list_put">
        ...
        if ($the_query->have_posts()):
            while ($the_query->have_posts()): 
                ...
                ?>
                <a href="<?php the_permalink(); ?>" class="post_item" itemscope itemtype="http://schema.org/BlogPosting">
