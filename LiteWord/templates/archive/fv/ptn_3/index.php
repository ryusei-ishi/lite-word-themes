...
// css, jsの読み込み
wp_enqueue_style('archive_fv_ptn_3_style', get_template_directory_uri() . '/templates/archive/fv/ptn_3/style.min.css', array(), css_version(), 'all');
$fv_data = LwTitlePut();
...
?>
<section id="archive_fv_ptn_3" class="archive_fv_ptn_3" itemscope itemtype="http://schema.org/WebPage">
...
<style>
    .archive_fv_ptn_3{
        min-height: 320px;
        background-color: <?=Lw_theme_mod_set("archive_page_layout_fv_df_bg_color", "#FFF8D4")?>;
    }
    .archive_fv_ptn_3 h1.title{
...
<div class="archive_fv_ptn_3_breadcrumbs">
