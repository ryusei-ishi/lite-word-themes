...
// css, jsの読み込み
wp_enqueue_style('archive_fv_ptn_1_style', get_template_directory_uri() . '/templates/archive/fv/ptn_1/style.min.css', array(), css_version(), 'all');
$fv_data = LwTitlePut();
...
?>
<section id="archive_fv_ptn_1" class="archive_fv_ptn_1" itemscope itemtype="http://schema.org/WebPage">
