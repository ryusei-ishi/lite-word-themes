...
(function () {
  ...
  function detectCategory(question) {
    ...
    var rules = [
      // 🚨 ブログの見た目は「設定」で決まる。ここが無いと design か general に落ちて、
      //    投稿ページ設定・アーカイブ設定に永久に届かない。**先に当たった語で決まる**ので先頭に置く。
      { cat: 'blog', words: ['ブログ','記事','投稿ページ','記事一覧','サイドバー','目次','アイキャッチ','お知らせ','ニュース','抜粋','パーマリンク'] },
      { cat: 'design', words: ['ヘッダー','フッター','ロゴ','メニュー','色','カラー','フォント','デザイン','レスポンシブ','スマホ','モバイル','追従','cta','固定表示','インフォメーションバー','ピックアップ','ドロワー','パンくず','背景','見た目','レイアウト'] },
      { cat: 'blocks', words: ['ランキング','商品リンク','メリット','デメリット','ブロック','fv','ファーストビュー','ボタン','リスト','テーブル','ギャラリー','バナー','ステップ','faq','お客様の声','吹き出し','コメント','会社概要','プロフィール','lp','ランディング','トップページ','ページ作成','テンプレート','コンテンツ','見出し','カラム'] },
      { cat: 'settings', words: ['アフィリエイト','広告リンク','ステマ','pr表記','景品表示法','sponsored','nofollow','リンク切れ','リンク一覧','リンクチェック','seo','analytics','gtm','フォーム','メール','問い合わせ','マイパーツ','リダイレクト','301','会員','権限','カウントダウン','期限','コード','拡張','トグル','ウィジェット','カテゴリ','アーカイブ','投稿','固定ページ','編集画面','ai生成','ページ生成'] },
