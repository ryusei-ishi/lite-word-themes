...
add_action( 'customize_register', 'side_follow_sns_ptn_1_set_custom' );
function side_follow_sns_ptn_1_set_custom( $wp_customize ) {
    $panel = 'side_follow_sns_set';
    $set = 'side_follow_sns_ptn_1_set';
    $set_ttl = ' - パターン１の設定';
    $sec = 'side_follow_sns_ptn_1_sec';
    $wp_customize->add_section($sec, [
        'title' => $set_ttl,
        'panel' => $panel,
        'description' => lw_side_follow_sns_preview_description('ptn_1'),
