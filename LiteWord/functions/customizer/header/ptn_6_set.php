...
add_action( 'customize_register', 'header_ptn_6_set_custom' );
function header_ptn_6_set_custom( $wp_customize ) {
    $panel = 'header_set';
    $set = 'header_ptn_6_set'; 
    // 設定
    $set_ttl = ' - パターン６の設定'; // セクションタイトル
    $sec = 'header_ptn_6_sec'; // セクションID
