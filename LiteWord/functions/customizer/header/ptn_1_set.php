...
add_action( 'customize_register', 'header_ptn_1_set_custom' );
function header_ptn_1_set_custom( $wp_customize ) {
    $panel = 'header_set';
    $set = 'header_ptn_1_set'; 
    // 設定
    $set_ttl = ' - パターン１の設定'; // セクションタイトル
    $sec = 'header_ptn_1_sec'; // セクションID
