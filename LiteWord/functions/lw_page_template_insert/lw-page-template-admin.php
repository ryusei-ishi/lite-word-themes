        ...
        'lead-generation' => [
            ...
            'items' => [
                ...
                'route' => [
                    ...
                    'templates' => [
                        [
                            'name' => '入口の振り分けページ 01 売る・買う・貸す、どれに近いですか',
                            'description' => '【型L18：選んで、そこだけ読むのが主役】上から順に読ませるのをやめたページです。いちばん上で <b>売りたい・買いたい・貸したい</b> の3つから選ぶと、そのお話だけを書いた場所へ進みます。決めていない方の逃げ道（3つを並べて比べる）も入口の下に置いてあります。<br>地域密着の不動産店を例にしていますが、<b>相談の中身が人によって変わる商売</b>（保険の見直し・リフォーム・遺品整理・車の売買）すべてに向きます。<br>🚨🚨 <b>宅地建物取引業法の広告規制</b>があります。「必ず売れます」「高く売れます」のような書き方はしないでください。<br>🚨 金額・地域・受付時間はすべて架空です。<br>✅ いちばん上の3つのカードは<b>このページの中の見出しへ飛びます</b>。別のページへ飛ばしたいときは、カードごとにリンク先を変えられます。<br>🚨 <b>送信できるお問い合わせフォームが入っています。</b>中身は 管理画面の「Lwお問い合わせ」から変えられます（このテンプレートでは変えられません）。フォームを1つも作っていないサイトでも、お名前／メールアドレス／お問合せ内容 の3つが既定で出ます。',
                            'preview_url' => '',
                            'path' => 'page_template/route/ptn_1.php',
                            'public' => false,
                        ],
                    ]
                ],
                'offer' => [
                    ...
                    'templates' => [
                        [
                            'name' => '無料オファー選択ページ 01 いま欲しいのは、どれですか',
                            'description' => '【型L19：もらう物を選ぶのが主役】資料請求のページは「1つの資料を、欲しい人だけが取る」形がほとんどです。このページは逆で、<b>入口で3つ並べて選ばせます</b>。相手の段階（まだ調べている／もう困っている／人に会いたい）がばらばらなので、1つしか置かないと段階の合わない方がその場で帰ってしまうためです。3つとも見せ方を変えてあります（中身の一覧／当たり表／30分の使い方）。<br>社会保険労務士事務所（BtoB）を例にしていますが、税理士・行政書士・IT導入支援・保険代理店にもそのまま使えます。<br>🚨 助成金・補助金の話は<b>断定できません</b>。「もらえます」「必ず通ります」と書かないでください（支給は審査で決まります）。<br>🚨 氏名・制度の内容・受付時間はすべて架空です。<br>🚨 <b>送信できるお問い合わせフォームが入っています。</b>中身は 管理画面の「Lwお問い合わせ」から変えられます（このテンプレートでは変えられません）。フォームを1つも作っていないサイトでも、お名前／メールアドレス／お問合せ内容 の3つが既定で出ます。',
                            'preview_url' => '',
                            'path' => 'page_template/offer/ptn_1.php',
                            'public' => false,
                        ],
                    ]
                ],
                'membership' => [
                    ...
                    'templates' => [
                        [
                            'name' => '会員登録ページ 01 スタンプカードを、スマホの中に',
                            'description' => '【型L20：登録すると何が変わるかが主役】メッセージ配信の登録ページとは目的が別で、こちらは<b>紙のスタンプカードの置き換え</b>です。ファーストビューに<b>QRコード</b>を置き、パソコンでご覧の方は読み取り、スマホでご覧の方はボタン、と道が分かれます（スマホでは自分の画面のQRを読めないので、QRは自動で隠れます）。<br>パンと焼き菓子の店を例にしていますが、カフェ・美容室・整体・クリーニング・小売の会員証にもそのまま使えます。<br>🚨🚨 <b>QRコードの画像は見本です。</b>読み取っても「これは見本のQRコードです」と出るだけのものが入っています。<b>必ずご自分のアカウントのQRコードに差し替えてください。</b>ボタンの飛び先も同じです。<br>🚨 特典・個数・時間はすべて架空です。景品表示法の対象になるので、実際にお渡しできる内容に必ず直してください。<br>✅ このページに<b>お問い合わせフォームはありません。</b>登録の入口をQRとボタンの2つに絞ってあります（入口を増やすと、どれを押せばよいか分からなくなるためです）。',
                            'preview_url' => '',
                            'path' => 'page_template/membership/ptn_1.php',
                            'public' => false,
                        ],
                    ]
                ],
                'videolesson' => [
                    ...
                    'templates' => [
                        [
                            'name' => '無料の動画講座ページ 01 朝の5分を、5日間だけ',
                            'description' => '【型L21：届く中身の時間割が主役】メルマガ登録が「これから何が届くか分からないもの」に登録させるのに対し、こちらは<b>終わりの決まっている5日間</b>です。だから主役が「登録すると良いことがある」ではなく、<b>何日目に何が届くかの時間割</b>になっています。向いていない方も自分から書いています。<br>ヨガ・ピラティスのスタジオを例にしていますが、英会話・料理・写真・投資の入門講座、士業の実務講座にもそのまま使えます。<br>🚨 体の動かし方・健康を扱うページでは<b>効果を断定できません</b>。「やせます」「治ります」と書かないでください。<br>🚨🚨 <b>QRコードの画像は見本です。</b>必ずご自分のアカウントのQRコードに差し替えてください。ボタンの飛び先も同じです。<br>🚨 日数・お名前・お声はすべて架空です。<br>✅ このページにも<b>お問い合わせフォームはありません</b>（登録の入口はQRとボタンだけ）。',
                            'preview_url' => '',
                            'path' => 'page_template/videolesson/ptn_1.php',
                            'public' => false,
                        ],
                    ]
                ],
